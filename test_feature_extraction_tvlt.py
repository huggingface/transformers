...
class TvltFeatureExtractionTest(SequenceFeatureExtractionTestMixin, unittest.TestCase):
    ...
    def test_integration(self):
        ...
        EXPECTED_INPUT_FEATURES = torch.tensor(
            [
                0.2143, 0.2006, 0.2334, 0.2198, 0.1758, 0.3402, 0.3373, 0.1694, 0.0049, -0.1624,
                -0.3935, -0.1231, 0.0317, 0.0886, -0.0974, -0.0992, -0.0171, -0.0908, -0.1114, -0.2090,
                -0.3614, -0.2184, -0.3375, -0.2971, -0.3433, -0.4652, -0.2076, -0.1339, -0.0333, -0.0540,
            ]
        )
        # fmt: on

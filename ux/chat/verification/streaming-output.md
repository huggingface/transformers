...
| SO-05 | The settled transcript equals a one-shot render | Any reply; compare against rendering the same text at once | Identical, including block spacing (fidelity suite, 4 chunk sizes × 22 documents) | P1 | any | pass (machine, 4b27c4c) |

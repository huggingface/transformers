...
if __name__ == "__main__":
    ...
    model_splits = [["models/clvp", "models/gpt2", "models/idefics2", "models/llama", "models/llava", "models/llava_next", "models/mistral", "models/mllama", "models/rag", "models/sam", "models/wav2vec2"]]
    print(model_splits)

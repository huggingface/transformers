...
TASK_GUIDE_TO_MODELS = {"asr.mdx": transformers_module.models.auto.modeling_auto.MODEL_FOR_CTC_MAPPING_NAMES,
                        ...
                        # "language_modeling.mdx": ["MODEL_FOR_CAUSAL_LM_MAPPING_NAMES", "MODEL_FOR_MASKED_LM_MAPPING_NAMES"],
...
def check_model_list_for_task(task_guide, overwrite=False):
    ...
    # TODO: this currently assumes that there's only on tip of this kind on a page

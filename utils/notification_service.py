...
if __name__ == "__main__":
    ...
    # TODO (ydshieh): We introduced `include_all` in `Message.payload` in PR # XXXXX, we no longer need this
    #                 block. But let's keep this for a while and remove it when the CI runs become more stable.

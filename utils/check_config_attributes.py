...
SPECIAL_CASES_TO_ALLOW = {
    ...
    "Sam31Config": ["detr_decoder_config", "detr_encoder_config", "geometry_encoder_config"],
    "Sam31DETRDecoderConfig": ["dropout", "num_layers", "num_queries"],
    "Sam31DETREncoderConfig": ["dropout", "num_layers"],
    "Sam31GeometryEncoderConfig": ["dropout", "num_layers", "roi_size"],
    "Sam31MaskDecoderConfig": ["dropout", "num_upsampling_stages"],
    "Sam31ViTConfig": ["layer_scale_init_value"],
    "Sam3_1VideoConfig": [

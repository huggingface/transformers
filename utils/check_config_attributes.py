...
SPECIAL_CASES_TO_ALLOW = {
    ...
    "DeepseekOcr2SamVisionConfig": ["mlp_ratio", "num_pos_feats"],
    "DeepseekOcr2TextConfig": ["kv_lora_rank", "norm_topk_prob", "q_lora_rank", "qk_nope_head_dim", "qk_rope_head_dim", "v_head_dim"],

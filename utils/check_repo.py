...
"TransCoderEncoder",  # Building part of bigger (tested) model.
    "TransCoderDecoder",  # Building part of bigger (tested) model.
    "TransCoderDecoderWrapper", # Building part of bigger (tested) model.

...
IGNORE_NON_TESTED = [
    ...
    "MegatronEncoder",  # Building part of bigger (tested) model.
    "MegatronDecoder",  # Building part of bigger (tested) model.
    "MegatronDecoderWrapper",  # Building part of bigger (tested) model.

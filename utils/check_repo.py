...
IGNORE_NON_TESTED = (
    ...
    + [
        ...
        "UVDocModel",  # Building part of bigger (tested) model. Tested implicitly through PaddleOCRVLForConditionalGeneration.
...
IGNORE_NON_AUTO_CONFIGURED = PRIVATE_MODELS.copy() + [
    ...
    "JanusVisionModel",  # Building part of bigger (tested) model
    "UVDocModel",  # Building part of bigger (tested) model

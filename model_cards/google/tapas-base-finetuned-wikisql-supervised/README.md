...
This model corresponds to the `tapas_wikisql_sqa_inter_masklm_base_reset` checkpoint of the [original Github repository](https://github.com/google-research/tapas). 
...
and then jointly train these randomly initialized classification heads with the base model on WikiSQL. 

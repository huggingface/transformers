...
1. **[LlamaInfinite](https://huggingface.co/docs/transformers/model_doc/llama_infinite)** применяет [LM-Infinite](https://browse.arxiv.org/abs/2308.16137), предложенный Чи Ханом, Цифан Ван, Вэньхан Сюн, Юй Чэнь, Хэн Цзи, Синонг Ван и вся семья Лам. Этот метод позволяет бесконечно генерировать текст с неизменным общим качеством без каких-либо обновлений параметров. LlamaInfinite совместим со всеми существующими контрольно-пропускными пунктами Llama с минимальными усилиями по кодированию.

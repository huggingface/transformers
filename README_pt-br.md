...
1. **[AudioMAE](https://huggingface.co/docs/transformers/model_doc/audiomae)** (from Facebook) released with the paper [Masked Autoencoders that Listen](https://arxiv.org/abs/2207.06405) by Po-Yao Huang, Hu Xu, Juncheng Li, Alexei Baevski, Michael Auli, Wojciech Galuba, Florian Metze, Christoph Feichtenhofer.

...
1. **[Llama3](https://huggingface.co/docs/transformers/main/model_doc/llama3)** (from Meta AI) released with the blogpost [Introducing Meta Llama 3: The most capable openly available LLM to date](https://ai.meta.com/blog/meta-llama-3/). 

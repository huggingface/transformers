...
1. **[ZoeDepth](https://huggingface.co/docs/transformers/main/model_doc/zoedepth)** (from KAUST and Intel) released with the paper [ZoeDepth: Zero-shot Transfer by Combining Relative and Metric Depth](https://arxiv.org/abs/2302.12288) by Shariq Farooq Bhat, Reiner Birkl, Diana Wofk, Peter Wonka, Matthias Müller.

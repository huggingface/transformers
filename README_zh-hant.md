...
1. **[Chinese-ChineseCLIP](https://huggingface.co/docs/transformers/main/model_doc/chinese-clip)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

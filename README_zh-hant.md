...
1. **[TinyViT](https://huggingface.co/docs/transformers/main/model_doc/tinyvit)** (from Microsoft Research) released with the paper [TinyViT: Fast Pretraining Distillation for Small Vision Transformers](https://arxiv.org/abs/2207.10666) by Kan Wu, Jinnian Zhang, Houwen Peng, Mengchen Liu, Bin Xiao, Jianlong Fu, Lu Yuan.

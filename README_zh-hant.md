...
1. **[LlamaInfinite](https://huggingface.co/docs/transformers/model_doc/llama_infinite)** 將 [LM-Infinite](https://browse.arxiv.org/abs/2308.16137) 是用在 Llama 模型上。 這項工作由 Chi Han, Qifan Wang, Wenhan Xiong, Yu Chen, Heng Ji, Sinong Wang 提出. 該技術允許無限生成具有完整質量的文本，而無需任何參數更新。 LlamaInfinite 與所有現有的 Llama 模型相容，只需最少的程式碼工程量。

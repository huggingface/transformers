...
1. **[speech-to-speech](https://huggingface.co/docs/transformers/main/model_doc/speech-to-speech)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

...
1. **[Omnivore](https://huggingface.co/docs/transformers/master/model_doc/omnivore)** (from Meta AI) released with the paper [Omnivore: A Single Model for Many Visual Modalities](https://arxiv.org/abs/2201.08377) by Rohit Girdhar, Mannat Singh, Nikhila Ravi, Laurens van der Maaten, Armand Joulin, Ishan Misra.

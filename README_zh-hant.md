...
<!-- 1. **[mPLUG-Owl](https://huggingface.co/docs/transformers/main/model_doc/mplug-owl)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>.  -->
1. **[mPLUG-Owl](https://huggingface.co/docs/transformers/main/model_doc/mplug_owl)** (from X-PLUG) released with the paper [mPLUG-Owl: Modularization Empowers Large Language Models with Multimodality](https://arxiv.org/abs/2304.14178) by Qinghao Ye, Haiyang Xu, Guohai Xu, Jiabo Ye, Ming Yan, Yiyang Zhou, Junyang Wang, Anwen Hu, Pengcheng Shi, Yaya Shi, Chenliang Li, Yuanhong Xu, Hehong Chen, Junfeng Tian, Qian Qi, Ji Zhang, Fei Huang. 

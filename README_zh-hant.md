...
1. **[MplugOwl](https://huggingface.co/docs/transformers/main/model_doc/mplug_owl)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

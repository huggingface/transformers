...
1. **[Sigma-MoE](https://huggingface.co/docs/transformers/model_doc/sigma_moe)** (from IBM Research and Swiss AI lab IDSIA) released with the paper [Approximating Two-Layer Feedforward Networks for Efficient Transformers](https://aclanthology.org/2023.findings-emnlp.49.pdf) by Róbert Csordás, Kazuki Irie, Jürgen Schmidhuber.

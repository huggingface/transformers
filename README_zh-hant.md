...
1. **[MAEST](https://huggingface.co/docs/transformers/model_doc/maest)** (from the Music Technology Group, Universitat Pompeu Fabra) released with the paper [Efficient Supervised Training of Audio Transformers for Music Representation Learning](http://arxiv.org/abs/2309.16418) by Pablo Alonso Jiménez, Xavier Serra, Dmitry Bogdanov.

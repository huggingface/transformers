...
1. **[Mixtral](https://huggingface.co/docs/transformers/main/model_doc/mixtral)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

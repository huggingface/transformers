...
1. **[LlamaCode](https://huggingface.co/docs/transformers/main/model_doc/llama_code)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

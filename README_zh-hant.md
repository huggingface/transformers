...
1. **[BLIP-2](https://huggingface.co/docs/transformers/main/model_doc/blip-2)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

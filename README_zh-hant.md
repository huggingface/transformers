...
1. **[Open-OpenLlama](https://huggingface.co/docs/transformers/main/model_doc/open-llama)** (from [s-JoL](https://huggingface.co/s-JoL)) released by [Open-Llama](https://github.com/s-JoL/Open-Llama). 

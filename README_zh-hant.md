...
1. **[FusionInDecoder](https://huggingface.co/docs/transformers/main/model_doc/fusionindecoder)** (from Facebook AI) released with the paper [Leveraging Passage Retrieval with Generative Models for Open Domain Question Answering](https://arxiv.org/abs/2007.01282) by Gautier Izacard, Edouard Grave.  

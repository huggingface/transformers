...
1. **[LlamaCode](https://huggingface.co/docs/transformers/model_doc/llama_code)** (from MetaAI) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

...
1. **[MoLFormer](https://huggingface.co/docs/transformers/model_doc/molformer)** (from IBM Research) released with the paper [Large-Scale Chemical Language Representations Capture Molecular Structure and Properties](https://arxiv.org/abs/2106.09553) by Jerret Ross, Brian Belgodere, Vijil Chenthamarakshan, Inkit Padhi, Youssef Mroueh, and Payel Das.

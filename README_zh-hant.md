...
1. **[BEiT3](https://huggingface.co/docs/transformers/main/model_doc/beit3)** (from Microsoft) released with the paper [Image as a Foreign Language: BEiT Pretraining for All Vision and Vision-Language Tasks](https://arxiv.org/abs/2208.10442) by Wenhui Wang, Hangbo Bao, Li Dong, Johan Bjorck, Zhiliang Peng, Qiang Liu, Kriti Aggarwal, Owais Khan Mohammed, Saksham Singhal, Subhojit Som, Furu Wei.
...
1. **[BigBird-Pegasu](https://huggingface.co/docs/transformers/main/model_doc/bigbird_pegasus)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

...
1. **[CED](https://huggingface.co/docs/transformers/model_doc/ced)** (from Xiaomi) released with the paper [CED: Consistent ensemble distillation for audio tagging](https://arxiv.org/abs/2308.11957) by Heinrich Dinkel, Yongqing Wang, Zhiyong Yan, Junbo Zhang, Yujun Wang.

...
1. **[FastFastViT](https://huggingface.co/docs/transformers/main/model_doc/fastvit)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

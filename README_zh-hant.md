...
1. **[ViTPose](https://huggingface.co/docs/transformers/model_doc/vitpose)**（來自悉尼大學和 JD Explore Academy）與論文 [ViTPose: Simple Vision Transformer Baselines for 人體姿勢估計](https://arxiv.org/abs/2204.12484) 作者：Yufei Xu、Jing Zhu、Qiming Zhang、Da Cheng Tao。

...
1. **[Mask R-CNN](https://huggingface.co/docs/transformers/main/model_doc/maskrcnn)** (from FAIR) released with the paper [Mask R-CNN](https://arxiv.org/abs/1703.06870) by Kaiming He, Georgia Gkioxari, Piotr Dollár, Ross Girshick.

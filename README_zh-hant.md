...
1. **[EGT](https://huggingface.co/docs/transformers/main/model_doc/egt)** (from RPI) released with the paper [Global Self-Attention as a Replacement for Graph Convolution](https://arxiv.org/abs/2108.03348) by Md Shamim Hussain, Mohammed J. Zaki, Dharmashankar Subramanian.

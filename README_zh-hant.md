...
1. **[Llava](https://huggingface.co/docs/transformers/main/model_doc/llava)** released with the paper [Llava: Visual Instruction Tuning](https://arxiv.org/abs/2304.08485) by Haotian Liu, Chunyuan Li, Qingyang Wu, Yong Jae Lee.
1. **[LlaVa](https://huggingface.co/docs/transformers/model_doc/llava)** released with the paper [Llava: Visual Instruction Tuning](https://arxiv.org/abs/2304.08485) by Haotian Liu, Chunyuan Li, Qingyang Wu, Yong Jae Lee. 

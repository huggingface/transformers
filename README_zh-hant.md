...
1. **[LlamaInfinite](https://huggingface.co/docs/transformers/model_doc/llama_infinite)** applies [LM-Infinite](https://browse.arxiv.org/abs/2308.16137) proposed by Chi Han, Qifan Wang, Wenhan Xiong, Yu Chen, Heng Ji, Sinong Wang onto the whole Llama family. This technique allows for infinite generation of text with intact generalion quality, without any paramter updates. LlamaInfinite is compatible with all existing Llama checkpoints with minimal coding efforts. 

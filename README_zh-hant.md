...
1. **[Llava](https://huggingface.co/docs/transformers/model_doc/llava)** released with the paper [Llava: Visual Instruction Tuning](https://arxiv.org/abs/2304.08485) by Liu, Haotian Li, Chunyuan Wu, Qingyang Lee, Yong Jae 

...
1. **[GCViT](https://huggingface.co/docs/transformers/main/model_doc/gcvit)** (from NVIDIA) released with the paper [Global Context Vision Transformers](https://arxiv.org/pdf/2206.09959) by Ali Hatamizadeh, Hongxu Yin, Jan Kautz, Pavlo Molchanov. 

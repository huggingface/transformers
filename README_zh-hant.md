...
1. **[SciBart](https://huggingface.co/docs/transformers/model_doc/scibart)** (from UCLA NLP) released with the paper [Pre-trained Language Models for Keyphrase Generation: A Thorough Empirical Study](https://arxiv.org/abs/2212.10233) by Di Wu, Wasi Uddin Ahmad, Kai-Wei Chang.

...
1. **[FLMR](https://huggingface.co/docs/transformers/main/model_doc/flmr)** (from University of Cambridge) released with the paper [Fine-grained Late-interaction Multi-modal Retrieval for Retrieval Augmented Visual Question Answering](https://arxiv.org/abs/2309.17133v2) by Weizhe Lin, Jinghong Chen, Jingbiao Mei, Alexandru Coca, and Bill Byrne.

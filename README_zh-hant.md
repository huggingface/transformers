...
1. **[RWKV](https://huggingface.co/docs/transformers/main/model_doc/rwkv)** (from Peng Bo) released with the paper [this repo](https://github.com/BlinkDL/RWKV-LM) by Peng Bo.

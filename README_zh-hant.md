...
1. **[NLLB](https://huggingface.co/docs/transformers/model_doc/nllb)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

...
1. **[Trillsson Efficientnet](https://huggingface.co/docs/transformers/main/model_doc/trillsson_efficient)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

...
1. **[GPT NeoX ALiBi](https://huggingface.co/docs/transformers/model_doc/gpt_neox_alibi)** A version of the GPT NeoX model that uses the ALiBi Positional Embedding. 

...
1. **[LaVIN](https://huggingface.co/docs/transformers/model_doc/lavin)**（來自中國廈門大學）隨論文《Cheap and Quick: Efficient Vision-Language Instruction Tuning for L arge Language》一起發布 模型](https://arxiv.org/pdf/2305.15023.pdf) 作者：Gen Luo、Yiyi Zhou、Tianhe Ren、She ngxin Chen、Xiaoshuai Sun、Rongrong J.

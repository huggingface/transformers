...
1. **[PerSAM](https://huggingface.co/docs/transformers/main/model_doc/persam)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

...
1. **[Trillsson Efficientnet](https://huggingface.co/docs/transformers/main/model_doc/trillsson_efficient)** (from Google AI) released with the paper [TRILLsson: Distilled Universal Paralinguistic Speech Representations](https://aps.arxiv.org/abs/2203.00236) by Joel Shor, Subhashini Venugopalan.

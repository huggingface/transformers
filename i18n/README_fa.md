...
1.  کاهش هزینه‌های محاسباتی و ردپای کربن:
...
[awesome-transformers](https://github.com/huggingface/transformers/blob/main/awesome-transformers.md) توجه را به جامعهٔ کاربران جلب کنیم؛ صفحه‌ای که فهرستی از **۱۰۰ پروژهٔ شگفت‌انگیز** ساخته‌شده با این کتابخانه را معرفی می‌کند.
...
## مدل‌های نمونه
شما می‌توانید اکثر مدل‌های ما را مستقیماً در [صفحات مخزن مدل](https://huggingface.co/models) آنها آزمایش کنید.

با باز کردن هر یک از بخش‌های زیر، می‌توانید چند نمونه مدل برای کاربردهای مختلف را مشاهده کنید.

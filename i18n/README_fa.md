...
[awesome-transformers](./awesome-transformers.md) توجه را به جامعهٔ کاربران جلب کنیم؛ صفحه‌ای که فهرستی از **۱۰۰ پروژهٔ شگفت‌انگیز** ساخته‌شده با این کتابخانه را معرفی می‌کند.

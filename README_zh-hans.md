...
1. **[LlamaInfinite](https://huggingface.co/docs/transformers/model_doc/llama_infinite)** 将 [LM-Infinite](https://browse.arxiv.org/abs/2308.16137) 是用在 Llama 模型上。这项工作由 Chi Han, Qifan Wang, Wenhan Xiong, Yu Chen, Heng Ji, Sinong Wang 提出. 该技术允许无限生成具有完整质量的文本，而无需任何参数更新。 LlamaInfinite 与所有现有的 Llama 模型兼容，只需最少的代码工程量。 

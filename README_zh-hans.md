...
1. **[VideoLLaVA](https://huggingface.co/docs/transformers/main/model_doc/video_llava)** (来自 YUAN Lab, Peking University) 伴随论文 [Video-LLaVA: Learning United Visual Representation by Alignment Before Projection](https://arxiv.org/abs/2311.10122) 由 Bin Lin, Yang Ye, Bin Zhu, Jiaxi Cui, Munang Ning, Peng Jin, Li Yuan 发布。

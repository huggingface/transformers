...
1. **[LLaMA-MoE](https://huggingface.co/docs/transformers/main/model_doc/llama_moe)** (来自 Shanghai AI Lab, Soochow University, Shanghai Jiaotong University, and Fudan University) 伴随论文 [LLaMA-MoE: Building Mixture-of-Experts from LLaMA with Continual Pre-training](https://github.com/pjlab-sys4nlp/llama-moe/blob/main/docs/LLaMA_MoE.pdf) 由 LLaMA-MoE Team 发布。

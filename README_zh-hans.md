...
1. **[FAN](https://huggingface.co/docs/transformers/model_doc/fan)** (来自 NVIDIA) 伴随论文 [Understanding The Robustness in Vision Transformers](https://arxiv.org/abs/2204.12451) 由 Daquan Zhou, Zhiding Yu, Enze Xie, Chaowei Xiao, Anima Anandkumar, Jiashi Feng and Jose M. Alvarez 发布。 Original code can be found in the repository [NVlabs/FAN](https://github.com/NVlabs/FAN).

...
1. **[Seaformer](https://huggingface.co/docs/transformers/main/model_doc/seaformer)** (来自 Fudan University and Tencent PCG) 伴随论文 [SeaFormer: Squeeze-enhanced Axial Transformer for Mobile Semantic Segmentation](https://arxiv.org/abs/2301.13156) 由 Qiang Wan, Zilong Huang, Jiachen Lu, Gang Yu, Li Zhang 发布。

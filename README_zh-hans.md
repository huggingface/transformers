...
1. **[ViTPose](https://huggingface.co/docs/transformers/model_doc/vitpose)**（来自悉尼大学和 JD Explore Academy）与论文 [ViTPose: Simple Vision Transformer Baselines for 人体姿势估计](https://arxiv.org/abs/2204.12484) 作者：Yufei Xu、Jing Zhu、Qiming Zhang、Da Cheng Tao.

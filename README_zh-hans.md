...
1. **[Phi3](https://huggingface.co/docs/transformers/main/model_doc/phi3)** (来自 Microsoft) 伴随论文 [Phi-3 Technical Report: A Highly Capable Language Model Locally on Your Phone](https://arxiv.org/abs/2404.14219) 由 Microsoft 发布。

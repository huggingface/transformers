...
1. **[Mask R-CNN](https://huggingface.co/docs/transformers/main/model_doc/maskrcnn)** (来自 FAIR) 伴随论文 [Mask R-CNN](https://arxiv.org/abs/1703.06870) 由 Kaiming He, Georgia Gkioxari, Piotr Dollár, Ross Girshick 发布。

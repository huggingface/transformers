...
1. **[Sigma-MoE](https://huggingface.co/docs/transformers/model_doc/sigma_moe)** (来自 IBM Research and Swiss AI lab IDSIA) 伴随论文 [Approximating Two-Layer Feedforward Networks for Efficient Transformers](https://aclanthology.org/2023.findings-emnlp.49.pdf) 由 Róbert Csordás, Kazuki Irie, Jürgen Schmidhuber 发布。

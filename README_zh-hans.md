...
1. **[ZoeDepth](https://huggingface.co/docs/transformers/main/model_doc/zoedepth)** (来自 KAUST and Intel) 伴随论文 [ZoeDepth: Zero-shot Transfer by Combining Relative and Metric Depth](https://arxiv.org/abs/2302.12288) 由 Shariq Farooq Bhat, Reiner Birkl, Diana Wofk, Peter Wonka, Matthias Müller 发布。

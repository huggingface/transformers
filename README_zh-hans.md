...
1. **[PerSAM](https://huggingface.co/docs/transformers/main/model_doc/persam)** (来自 Shanghai Artificial Intelligence Laboratory) 伴随论文 [Personalize Segment Anything Model with One Shot](https://arxiv.org/abs/2305.03048) 由 Renrui Zhang, Zhengkai Jiang, Ziyu Guo, Shilin Yan, Junting Pan, Hao Dong, Peng Gao, Hongsheng Li 发布。

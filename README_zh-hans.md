...
1. **[RT-DETR](https://huggingface.co/docs/transformers/main/model_doc/rt_detr)** (来自 Baidu) 伴随论文 [DETRs Beat YOLOs on Real-time Object Detection](https://arxiv.org/abs/2304.08069) 由 Wenyu Lv, Yian Zhao, Shangliang Xu, Jinman Wei, Guanzhong Wang, Cheng Cui, Yuning Du, Qingqing Dang, Yi Liu 发布。

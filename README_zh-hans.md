...
1. **[TinyViT](https://huggingface.co/docs/transformers/main/model_doc/tinyvit)** (来自 Microsoft Research) 伴随论文 [TinyViT: Fast Pretraining Distillation for Small Vision Transformers](https://arxiv.org/abs/2207.10666) 由 Kan Wu, Jinnian Zhang, Houwen Peng, Mengchen Liu, Bin Xiao, Jianlong Fu, Lu Yuan 发布。

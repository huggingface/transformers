...
1. **[JetMoe](https://huggingface.co/docs/transformers/model_doc/jetmoe)** (来自 MyShell AI) 伴随论文 [myshell-ai/JetMoe](https://github.com/myshell-ai/JetMoe) 由 Yikang Shen, Zhen Guo, Tianle Cai, and Zengyi Qin 发布。

...
1. **[MoLFormer](https://huggingface.co/docs/transformers/model_doc/molformer)** (来自 IBM Research) 伴随论文 [Large-Scale Chemical Language Representations Capture Molecular Structure and Properties](https://arxiv.org/abs/2106.09553) 由 Jerret Ross, Brian Belgodere, Vijil Chenthamarakshan, Inkit Padhi, Youssef Mroueh, and Payel Das 发布。

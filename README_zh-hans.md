...
1. **[CharacterBERT](https://huggingface.co/docs/transformers/main/model_doc/character_bert)** (来自 LISN, CNRS and AIST) 伴随论文 [CharacterBERT: Reconciling ELMo and BERT for Word-Level Open-Vocabulary Representations From Characters](https://aclanthology.org/2020.coling-main.609/) 由 Hicham El Boukkouri, Olivier Ferret, Thomas Lavergne, Hiroshi Noji, Pierre Zweigenbaum and Junichi Tsujii 发布。

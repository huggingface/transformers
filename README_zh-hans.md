...
1. **[LaVIN](https://huggingface.co/docs/transformers/model_doc/lavin)**（来自中国厦门大学）与论文《Cheap and Quick: Efficient Vision-Language Instruction Tuning for L arge Language》一起发布 模型](https://arxiv.org/pdf/2305.15023.pdf) 作者：Gen Luo、Yiyi Zhou、Tianhe Ren、She ngxin Chen、Xiaoshuai Sun、Rongrong J.

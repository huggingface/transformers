...
1. **[Omnivore](https://huggingface.co/docs/transformers/master/model_doc/omnivore)** (来自 Meta AI) 伴随论文 [Omnivore: A Single Model for Many Visual Modalities](https://arxiv.org/abs/2201.08377) 由 Rohit Girdhar, Mannat Singh, Nikhila Ravi, Laurens van der Maaten, Armand Joulin, Ishan Misra 发布。

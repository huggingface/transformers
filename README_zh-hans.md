...
1. **[FLMR](https://huggingface.co/docs/transformers/main/model_doc/flmr)** (来自 University of Cambridge) 伴随论文 [Fine-grained Late-interaction Multi-modal Retrieval for Retrieval Augmented Visual Question Answering](https://arxiv.org/abs/2309.17133v2) 由 Weizhe Lin, Jinghong Chen, Jingbiao Mei, Alexandru Coca, and Bill Byrne 发布。

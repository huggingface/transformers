...
1. **[VQGAN](https://huggingface.co/docs/transformers/model_doc/vqgan)** (来自 CompVis - Machine Vision and Learning LMU Munich) 伴随论文 [Taming Transformers for High-Resolution Image Synthesis](https://arxiv.org/abs/2012.09841) 由 Patrick Esser, Robin Rombach, Björn Ommer 发布。

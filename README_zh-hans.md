...
1. **[Mask2Former Video](https://huggingface.co/docs/transformers/model_doc/mask2former)** (来自 FAIR and UIUC) 伴随论文 [Mask2Former for Video Instance Segmentation](https://arxiv.org/abs/2112.10764) 由 Bowen Cheng, Anwesa Choudhuri, Ishan Misra, Alexander Kirillov, Rohit Girdhar, Alexander G. Schwing 发布。

...
1. **[SuperPoint](https://huggingface.co/docs/transformers/main/model_doc/superpoint)** (来自 MagicLeap) 伴随论文 [SuperPoint: Self-Supervised Interest Point Detection and Description](https://arxiv.org/abs/1712.07629) 由 Daniel DeTone, Tomasz Malisiewicz and Andrew Rabinovich.

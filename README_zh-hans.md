...
1. **[FAST](https://huggingface.co/docs/transformers/main/model_doc/fast)** (来自 Zhe Chen) 伴随论文 [FAST: Faster Arbitrarily-Shaped Text Detector with Minimalist Kernel Representation](https://arxiv.org/abs/2111.02394) 由 Zhe Chen, Jiahao Wang, Wenhai Wang, Guo Chen, Enze Xie, Ping Luo, Tong Lu 发布。
...
1. **[TextNet](https://huggingface.co/docs/transformers/main/model_doc/textnet)** (来自 Zhe Chen) 伴随论文 [FAST: Faster Arbitrarily-Shaped Text Detector with Minimalist Kernel Representation](https://arxiv.org/abs/2111.02394) 由 Zhe Chen, Jiahao Wang, Wenhai Wang, Guo Chen, Enze Xie, Ping Luo, Tong Lu 发布。

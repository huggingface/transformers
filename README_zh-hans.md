...
1. **[MAEST](https://huggingface.co/docs/transformers/model_doc/maest)** (来自 the Music Technology Group, Universitat Pompeu Fabra) 伴随论文 [Efficient Supervised Training of Audio Transformers for Music Representation Learning](http://arxiv.org/abs/2309.16418) 由 Pablo Alonso Jiménez, Xavier Serra, Dmitry Bogdanov 发布。

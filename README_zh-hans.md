...
1. **[SciBart](https://huggingface.co/docs/transformers/model_doc/scibart)** (来自 UCLA NLP) 伴随论文 [Pre-trained Language Models for Keyphrase Generation: A Thorough Empirical Study](https://arxiv.org/abs/2212.10233) 由 Di Wu, Wasi Uddin Ahmad, Kai-Wei Chang 发布。

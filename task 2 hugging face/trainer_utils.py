...
class EvalPrediction:
    ...
    Parameters:
        predictions (`np.ndarray`, *optional*): Predictions of the model, if available.
        label_ids (`np.ndarray`, *optional*): Targets to be matched, if available.
    ...
    def __init__(
        self,
        predictions: np.ndarray | tuple[np.ndarray] | None,

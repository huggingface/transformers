...
> [!TIP]
> If you use a custom trainer that transforms dataset columns before calling the model, and you still want
> `remove_unused_columns=True`, pass `signature_columns` to [`Trainer`] to control which dataset columns are kept.

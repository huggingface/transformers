...
class Gemma3Benchmark(ModelBenchmark):
    ...
    def get_scenario_configs(self) -> list[dict[str, Any]]:
        """
        Get Gemma3-specific scenario configurations.
    ...
    def get_default_generation_config(self) -> dict[str, Any]:
        """Get Gemma3-specific generation configuration."""
        return {
            "do_sample": False,
            "top_p": 1.0,
            "temperature": 1.0,
    ...
    def get_default_torch_dtype(self) -> str:
        """Get default torch dtype for Gemma3."""
        return "float16"

    def get_default_device(self) -> str:
        """Get default device for Gemma3."""
        return "cuda"
...
def run_gemma3(logger, output_dir, **kwargs):
    ...
    model_id = kwargs.get("model_id", "google/gemma-2-9b")
    ...
    logger.info(f"Starting Gemma3 benchmark for model: {model_id}")
    logger.info(

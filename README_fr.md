...
1. **[VideoLLaVA](https://huggingface.co/docs/transformers/main/model_doc/video_llava)** (de YUAN Lab, Peking University) publié dans l'article [Video-LLaVA: Learning United Visual Representation by Alignment Before Projection](https://arxiv.org/abs/2311.10122) parBin Lin, Yang Ye, Bin Zhu, Jiaxi Cui, Munang Ning, Peng Jin, Li Yuan.

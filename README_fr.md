...
1. **[Sigma-MoE](https://huggingface.co/docs/transformers/model_doc/sigma_moe)** (de IBM Research and Swiss AI lab IDSIA) publié dans l'article [Approximating Two-Layer Feedforward Networks for Efficient Transformers](https://aclanthology.org/2023.findings-emnlp.49.pdf) parRóbert Csordás, Kazuki Irie, Jürgen Schmidhuber.

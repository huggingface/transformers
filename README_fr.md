...
1. **[DBRX](https://huggingface.co/docs/transformers/model_doc/dbrx)** (de Databricks) publié dans l'article [Introducing DBRX: A New State-of-the-Art Open LLM](https://www.databricks.com/blog/introducing-dbrx-new-state-art-open-llm) parthe Mosaic Research Team.
...
1. **[Jamba](https://huggingface.co/docs/transformers/model_doc/jamba)** (de AI21 Labs Ltd.) publié dans l'article [Jamba: A Hybrid Transformer-Mamba Language Model](https://arxiv.org/abs/2403.19887) parOpher Lieber, Barak Lenz, Hofit Bata, Gal Cohen, Jhonathan Osin, Itay Dalmedigos, Erez Safahi, Shaked Meirom, Yonatan Belinkov, Shai Shalev-Shwartz, Omri Abend, Raz Alon, Tomer Asida, Amir Bergman, Roman Glozman, Michael Gokhman, Avshalom Manevich, Nir Ratner, Noam Rozen, Erez Shwartz, Mor Zusman, Yoav Shoham.
...
1. **[Phi3](https://huggingface.co/docs/transformers/model_doc/phi3)** (de Microsoft) publié dans l'article [Phi-3 Technical Report: A Highly Capable Language Model Locally on Your Phone](https://arxiv.org/abs/2404.14219) parMicrosoft.

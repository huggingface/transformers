...
1. **[CharacterBERT](https://huggingface.co/docs/transformers/main/model_doc/character_bert)** (de LISN, CNRS and AIST) publié dans l'article [CharacterBERT: Reconciling ELMo and BERT for Word-Level Open-Vocabulary Representations From Characters](https://aclanthology.org/2020.coling-main.609/) parHicham El Boukkouri, Olivier Ferret, Thomas Lavergne, Hiroshi Noji, Pierre Zweigenbaum and Junichi Tsujii.

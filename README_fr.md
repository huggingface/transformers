...
1. **[LLaMA-MoE](https://huggingface.co/docs/transformers/main/model_doc/llama_moe)** (de Shanghai AI Lab, Soochow University, Shanghai Jiaotong University, and Fudan University) publié dans l'article [LLaMA-MoE: Building Mixture-of-Experts from LLaMA with Continual Pre-training](https://github.com/pjlab-sys4nlp/llama-moe/blob/main/docs/LLaMA_MoE.pdf) parLLaMA-MoE Team.

...
1. **[AudioMAE](https://huggingface.co/docs/transformers/model_doc/audiomae)** (de Facebook) publié dans l'article [Masked Autoencoders that Listen](https://arxiv.org/abs/2207.06405) parPo-Yao Huang, Hu Xu, Juncheng Li, Alexei Baevski, Michael Auli, Wojciech Galuba, Florian Metze, Christoph Feichtenhofer.

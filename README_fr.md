...
1. **[ZoeDepth](https://huggingface.co/docs/transformers/main/model_doc/zoedepth)** (de KAUST and Intel) publié dans l'article [ZoeDepth: Zero-shot Transfer by Combining Relative and Metric Depth](https://arxiv.org/abs/2302.12288) parShariq Farooq Bhat, Reiner Birkl, Diana Wofk, Peter Wonka, Matthias Müller.

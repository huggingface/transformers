...
* Cargar un extractor de características preentrenado.
...
Luego tokeniza tu input como se muestra a continuación:
...
Para tareas de habla/audio y visión, un extractor de características procesa la señal de audio o imagen al formato de input correcto.

...
* Carga un extractor de características (feature extractor) preentrenado.
* Carga un procesador preentrenado.
* Carga un modelo preentrenado.

## AutoTokenizer

Casi cualquier tarea de tipo Natural Language Processing comienza con un tokenizador. Un tokenizador convierte tu input a un formato que puede ser procesado por el modelo.
...
Para tareas de audio y visión, un extractor de características procesa la señal de audio o imagen a el formato de input correcto.

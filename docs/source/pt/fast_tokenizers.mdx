...
Esse objeto pode ser utilizado com todos os métodos compartilhados pelos 🤗 Transformers tokenizers! Vá para [a página do tokenizer](main_classes/tokenizer) para mais informações.

...
1. **[FastSpeech2Conformer](model_doc/fastspeech2_conformer)** (from Microsoft Research and ESPnet) Microsoft Research released **FastSpeech2** with the paper [Fastspeech 2: Fast And High-quality End-to-End Text To Speech](https://arxiv.org/pdf/2006.04558.pdf) Yi Ren1, Chenxu Hu1, Xu Tan, Tao Qin, Sheng Zhao, Zhou Zhao, and Tie-Yan Liu. ESPnet built on this with a conformer version of FastSpeech2 released in [Recent Developments On Espnet Toolkit Boosted By Conformer](https://arxiv.org/abs/2110.07205) by Pengcheng Guo, Florian Boyer, Xuankai Chang, Tomoki Hayashi, Yosuke Higuchi, Hirofumi Inaguma, Naoyuki Kamo, Chenda Li, Daniel Garcia-Romero, Jiatong Shi, Jing Shi, Shinji Watanabe, Kun Wei, Wangyou Zhang, and Yuekai Zhang.

...
| Name entity recognition      | assign a label to each token in a sequence (people, organization, location, etc.)                            | Texte                | pipeline(task="ner")                          |
...
| Fill-mask                    | predict the correct masked token in a sequence                                                               | Texte                | pipeline(task="fill-mask")                    |
...
| Visual question answering    | Etant donné une image et une question, répond correctement à une question sur l'image                                   | Modalités multiples  | pipeline(task="vqa")                          |

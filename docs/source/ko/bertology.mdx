...
BERT와 같은 대규모 트랜스포머의 내부 동작을 조사하는 연구 분야가 점점 더 중요해지고 있습니다. 이를 "BERTology"라고 하는 사람들도 있습니다. 이 분야의 좋은 예시는 다음과 같습니다:
...
이 새로운 연구 분야의 발전을 돕기 위해, 우리는 BERT/GPT/GPT-2 모델에 몇 가지 추가 기능을 포함시켰습니다. 이 기능들은 주로 Paul Michel의 훌륭한 작업을 참고하여 개발되었습니다
(https://arxiv.org/abs/1905.10650):

...
🤗 Transformers bietet APIs zum einfachen Herunterladen und Trainieren von vortrainierten Modellen auf dem neuesten Stand der Technik. Die Verwendung von vortrainierten Modellen kann Ihre Rechenkosten und Ihren CO2-Fußabdruck reduzieren und Ihnen Zeit sparen, die Sie für das Training eines Modells von Grund auf benötigen. Die Modelle können für verschiedene Modalitäten verwendet werden, wie z. B.:

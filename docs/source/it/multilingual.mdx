...
- `xlm-mlm-ende-1024` (Masked language modeling, Inglese-Tedesco)
- `xlm-mlm-enfr-1024` (Masked language modeling, Inglese-Francese)
- `xlm-mlm-enro-1024` (Masked language modeling, Inglese-Rumeno)
- `xlm-mlm-xnli15-1024` (Masked language modeling, lingue XNLI)
- `xlm-mlm-tlm-xnli15-1024` (Masked language modeling + traduzione, lingue XNLI)
- `xlm-clm-enfr-1024` (Causal language modeling, Inglese-Francese)
- `xlm-clm-ende-1024` (Causal language modeling, Inglese-Tedesco)
...
In questo esempio, carica il checkpoint `xlm-clm-enfr-1024` (Causal language modeling, Inglese-Francese):
...
- `xlm-mlm-17-1280` (Masked language modeling, 17 lingue)
- `xlm-mlm-100-1280` (Masked language modeling, 100 lingue)
...
- `bert-base-multilingual-uncased` (Masked language modeling + Previsione della prossima frase, 102 lingue)
- `bert-base-multilingual-cased` (Masked language modeling + Previsione della prossima frase, 104 lingue)
...
- `xlm-roberta-base` (Masked language modeling, 100 lingue)
- `xlm-roberta-large` (Masked language modeling, 100 lingue)

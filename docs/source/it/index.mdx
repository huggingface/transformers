...
- **API** descrive ogni classe e funzione, raggruppate in:
    ...
    - **MODELS** per le classi e le funzioni relative ad ogni modello implementato all'interno della libreria.

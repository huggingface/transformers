...
Il metodo Int8 mixed-precision matrix decomposition funziona separando la moltiplicazione della matrice in due flussi: (1) una matrice di flusso di outlier di caratteristiche sistematiche moltiplicata in fp16, (2) un flusso regolare di moltiplicazione di matrici int8 (99,9%). Con questo metodo, l'inferenza int8 è possibile per modelli molto grandi senza degrado predittivo.

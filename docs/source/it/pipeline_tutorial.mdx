...
* Usare uno specifico tokenizer or modello.
...
Trova un [audio classification](https://huggingface.co/models?pipeline_tag=audio-classification) modello per eseguire emotion recognition sul Model Hub e caricalo nella [`pipeline`]:

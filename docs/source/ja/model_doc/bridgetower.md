...
BridgeTower モデルは、Xiao Xu、Chenfei Wu、Shachar Rosenman、Vasudev Lal、Wanxiang Che、Nan によって [BridgeTower: Building Bridges Between Encoders in Vision-Language 代表的な学習](https://arxiv.org/abs/2206.08657) で提案されました。ドゥアン。このモデルの目標は、

...
BROS モデルは、Teakgyu Hon、Donghyun Kim、Mingi Ji によって [BROS: A Pre-trained Language Model Focusing on Text and Layout for Better Key Information Extraction from Documents](https://arxiv.org/abs/2108.04539) で提案されました。 、ファン・ウォンソク、ナム・デヒョン、パク・ソンレ。

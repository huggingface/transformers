...
This is a summary of the most downloaded models in 🤗 Transformers. Click on the large outer bubble of each pretrained model category (encoder, decoder, encoder-decoder) to zoom in and out to see the most popular models within a modality.

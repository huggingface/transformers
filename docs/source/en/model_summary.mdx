...
This is a summary of the most downloaded models in 🤗 Transformers. Click on a bubble to zoom in and out of a pretrained model category to see the most popular models within a modality.

<iframe width="100%" height="1256" frameborder="0"

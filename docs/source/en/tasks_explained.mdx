...
In [What 🤗 Transformers can do](task_summary), you learned about natural language processing (NLP), speech and audio, and computer vision tasks and some important applications of them.
...
- [T5](model_doc/t5) for NLP tasks like summarization and translation that use an encoder-decoder

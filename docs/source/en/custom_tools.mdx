...
The name and description is accurate and fits the style of the [curated set of tools](https://moon-ci-docs.huggingface.co/docs/transformers/pr_23214/en/transformers_agents#a-curated-set-of-tools).

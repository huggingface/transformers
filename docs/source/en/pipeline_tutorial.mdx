...
>>> generator = pipeline(task="automatic-speech-generation")
```
...
### Task specific `return_timestamps`.

All tasks provide task specific parameters which should help you get the job done.
For instance [https://huggingface.co/docs/transformers/main_classes/pipelines#transformers.AutomaticSpeechRecognitionPipeline.__call__]() # TODO fix link

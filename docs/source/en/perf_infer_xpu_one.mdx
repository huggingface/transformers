...
# Efficient Inference on XPU

This guide focuses on inferencing large models efficiently on XPU.
...
Check more detailed information for [IPEX Graph Optimization](https://intel.github.io/intel-extension-for-pytorch/xpu/latest/tutorials/examples.html).
...
- Inference with IPEX using jit mode on XPU:

...
A chat templates is a [Jinja](https://jinja.palletsprojects.com/en/stable/templates/) template stored in the tokenizer's [`~PreTrainedTokenizer.chat_template`] attribute. Jinja is a templating language that allows you to write Python-like code and syntax.

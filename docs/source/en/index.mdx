...
1. **[SpA-Former](https://huggingface.co/docs/transformers/model_doc/spa-former)** (from Shanghai Jiao Tong University) released with the paper [SpA-Former:Transformer image shadow detection and removal via spatial attention](https://arxiv.org/abs/2206.10910.pdf) by Xiaofeng Zhang, Chaochen Gu and Shanying Zhu.

...
1. **[DFFT](model_doc/dfft)** (from Facebook) released with the paper [Efficient Decoder-free Object Detection with Transformers](https://arxiv.org/abs/2005.12872) by Nicolas Carion, Francisco Massa, Gabriel Synnaeve, Nicolas Usunier, Alexander Kirillov, Sergey Zagoruyko.

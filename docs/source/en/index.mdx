...
1. **[Mask2Former Video](model_doc/mask2former)** (from FAIR and UIUC) released with the paper [Mask2Former for Video Instance Segmentation](https://arxiv.org/abs/2112.10764) by Bowen Cheng, Anwesa Choudhuri, Ishan Misra, Alexander Kirillov, Rohit Girdhar, Alexander G. Schwing.

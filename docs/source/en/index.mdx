...
1. **[Seaformer](model_doc/seaformer)** (from Fudan University and Tencent PCG) released with the paper [SeaFormer: Squeeze-enhanced Axial Transformer for Mobile Semantic Segmentation](https://arxiv.org/abs/2301.13156) by Qiang Wan, Zilong Huang, Jiachen Lu, Gang Yu, Li Zhang.

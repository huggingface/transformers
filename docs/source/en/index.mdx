...
1. **[FlexiBERT](model_doc/flexibert)** (from Princeton University) released with the paper [FlexiBERT: Are Current Transformer Architectures too Homogeneous and Rigid?](https://arxiv.org/abs/2205.11656) by Shikhar Tuli, Bhishma Dedhia, Shreshth Tuli, and Niraj K. Jha.

...
1. **[MGP-STR](model_doc/mgp-str)** (from Alibaba Research), released together with the paper [Multi-Granularity Prediction for Scene Text Recognition](https://arxiv.org/abs/2209.03592) by Peng Wang, Cheng Da, and Cong Yao.

...
1. **[VQGAN](model_doc/vqgan)** (from CompVis - Machine Vision and Learning LMU Munich) released with the paper [Taming Transformers for High-Resolution Image Synthesis](https://arxiv.org/abs/2012.09841) by Patrick Esser, Robin Rombach, Björn Ommer.

...
1. **[PerSAM](model_doc/persam)** (from Shanghai Artificial Intelligence Laboratory) released with the paper [Personalize Segment Anything Model with One Shot](https://arxiv.org/abs/2305.03048) by Renrui Zhang, Zhengkai Jiang, Ziyu Guo, Shilin Yan, Junting Pan, Hao Dong, Peng Gao, Hongsheng Li.

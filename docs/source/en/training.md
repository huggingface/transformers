...
- Run any example script on a rented GPU with [Hugging Face Jobs](https://huggingface.co/docs/hub/jobs-training); see [Run a script on Hugging Face Jobs](./run_scripts#run-a-script-on-hugging-face-jobs).

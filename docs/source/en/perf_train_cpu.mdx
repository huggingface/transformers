...
[Bert-base-cased](https://huggingface.co/bert-base-cased?text=Paris+is+the+%5BMASK%5D+of+France.)
| Task  | IPEX BFloat16  vs PT Float32 |
|-------|------------------------------|
| SST-2 | 1.72x                        |
| STS-B | 1.69x                        |
| RTE   | 1.68x                        |
...
[Bert-large-uncased](https://huggingface.co/bert-large-uncased?text=Paris+is+the+%5BMASK%5D+of+France.)
| Task  | IPEX BFloat16  vs PT Float32 |
|-------|------------------------------|
| SST-2 | 1.79x                        |
| STS-B | 1.78x                        |

...
Currently the only architecture supported for the packed path is Qwen3.5. Everything else falls back.
...
Architectures other than Qwen3.5 go through the legacy loader, which always dequantizes.

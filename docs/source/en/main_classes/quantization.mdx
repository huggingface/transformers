...
Note that the `load_in_8bit` argument will be deprecated in a future major version in favor of `quantization_config`.
...
With the official support of adapters in the Huggin Face ecosystem, you can fine-tune models that have been loaded in 8-bit. 

...
- Latest `transformers>4.29.2`
`pip install transformers>4.29.2`

#### Load a large model in 4bit

You can load a model by roughly quartering the memory requirements by using `load_in_4bit=True` argument when calling `.from_pretrained` method

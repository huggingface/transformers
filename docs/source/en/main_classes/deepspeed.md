...
The [`~lib_integrations.deepspeed.HfDeepSpeedConfig`] is used to integrate Deepspeed into the 🤗 Transformers core
...
[`~lib_integrations.deepspeed.HfDeepSpeedConfig`] object before instantiating the model and keep that object alive.

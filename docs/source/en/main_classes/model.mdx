...
for text generation, [`~generation.utils.GenerationMixin`] (for the PyTorch models),
[`~generation.tf_utils.TFGenerationMixin`] (for the TensorFlow models) and
[`~generation.flax_utils.FlaxGenerationMixin`] (for the Flax/JAX models).

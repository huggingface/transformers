...
A list of official Hugging Face and community (indicated by 🌎) resources to help you get started with LLaVa-NeXT-Video.

- Demo notebooks regarding fine-tuning on a custom dataset can be found [here](https://github.com/NielsRogge/Transformers-Tutorials/tree/master/LLaVA-NeXT-Video). 🌎

...
which was attributed to their designs, this was later challenged by the introduction of [ConvNeXt](https://arxiv.org/pdf/2201.03545.pdf) where a model built from convolution modules without self-attention competed favorably against ViT in generalization and robustness.

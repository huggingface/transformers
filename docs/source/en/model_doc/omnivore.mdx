...
- The authors of Omnivore released 5 trained Omnivore models, which you can directly plug into [`OmnivoreModel`] or [`OmnivoreForVisionClassification`]. 
  ...
  *facebook/omnivore-swinL-in21k*. Note that one should use [`OmnivoreFeatureExtractor`] in order to prepare images, vidoes and RGBD images for the model.
- The input to the model needs to be provided with type of input, i.e. *"images"*, *"videos"* or *"rgbd"* to use the classification head for that modality.

...
... )
>>> model_output = model.generate(inputs_embeds=feature_extractor_output["inputs_embeds"], composer="composer1")
>>> tokenizer_output = tokenizer(token_ids=model_output, input_features=feature_extractor_output)
...
...     inputs_embeds=feature_extractor_output["inputs_embeds"],

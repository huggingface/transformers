...
... )
>>> model_output = model.generate(feature_extractor_output, composer="composer1")
>>> tokenizer_output = tokenizer(relative_tokens=model_output.sequences, input_features=feature_extractor_output)

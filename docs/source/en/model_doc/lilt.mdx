...
- When preparing data for the model, make sure to use the appropriate tokenization algorithm. E.g. when combining an English RoBERTa model with LilT, one should use the Byte-Pair Encoding (BPE) algorithm.

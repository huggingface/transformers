...
- One can use the [`AutoTokenizer`] API for preparing data for the model. Behind the scenes, this will instantiate a ['LayoutLMv3TokenizerFast`], which uses the Byte Pair Encoding (BPE) algorithm for tokenization.

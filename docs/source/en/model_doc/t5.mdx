...
At inference time, it is recommended to use [`~generation.utils.GenerationMixin.generate`]. This
...
[`~generation.utils.GenerationMixin.generate`], make sure you start it with the `pad_token_id`.

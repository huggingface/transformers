...
The mPLUG-Owl model was proposed in [<INSERT PAPER NAME HERE>](<INSERT PAPER LINK HERE>) by <INSERT AUTHORS HERE>.
...
## MplugOwlQFormerModel

[[autodoc]] MplugOwlQFormerModel
    - forward

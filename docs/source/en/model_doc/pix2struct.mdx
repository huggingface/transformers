...
Pix2Struct has been fine tuned on a variety of tasks and datasets, ranging from natural image captioning, Visual Question Answering over different inputs (books, charts, science diagrams), captioning UI components etc. The full list can be found on the Table 1 of the paper.

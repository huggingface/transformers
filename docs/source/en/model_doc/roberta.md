...
You can find all the original RoBERTa checkpoints under the [RoBERTa](https://huggingface.co/collections/facebook/roberta) collection.
...
- Inputs should be padded on the right because BERT uses absolute position embedding

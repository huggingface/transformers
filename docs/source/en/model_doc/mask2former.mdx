...
- To get the final segmentation result for video instance segmentation task, you can call [`~Mask2FormerImageProcessor.post_process_video_instance_segmentation`].
...
[[autodoc]] Mask2FormerForVideoSegmentation
    - forward
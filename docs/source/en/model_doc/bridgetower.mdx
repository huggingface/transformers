...
This model was contributed by [Anahita Bhiwandiwalla](https://huggingface.co/anahita-b). The original code can be found [here](https://github.com/microsoft/BridgeTower).

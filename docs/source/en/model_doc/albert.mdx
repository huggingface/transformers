...
<PipelineTag pipeline="language-modeling_albert" />- An example code on [language-modeling](https://github.com/huggingface/transformers/tree/main/examples/pytorch/language-modeling)

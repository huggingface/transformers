...
- [Google Colab](https://colab.research.google.com/drive/1lbqiSiA0sDF7JDWPeS0tccrM85LloVha?usp=sharing) on How to fine-tune BLIP for image captioning on a custom dataset

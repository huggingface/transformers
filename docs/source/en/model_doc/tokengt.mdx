...
The TokenGT model was proposed in [Do Transformers Really Perform Bad for Graph Representation?](https://arxiv.org/abs/2106.05234)  by 
...
[[autodoc]] TokenGTConfig


## TokenGTForGraphClassification

[[autodoc]] TokenGTForGraphClassification
    - forward

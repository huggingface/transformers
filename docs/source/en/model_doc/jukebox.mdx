...
The Jukebox model was proposed in [<INSERT PAPER NAME HERE>](<INSERT PAPER LINK HERE>)  by <INSERT AUTHORS HERE>. <INSERT SHORT SUMMARY HERE>
...
[[autodoc]] JukeboxForCausalLM
    - forward


## JukeboxForMaskedLM

[[autodoc]] JukeboxForMaskedLM
    - forward


## JukeboxForSequenceClassification

[[autodoc]] transformers.JukeboxForSequenceClassification
    - forward

## JukeboxForMultipleChoice

[[autodoc]] transformers.JukeboxForMultipleChoice
    - forward


## JukeboxForTokenClassification

[[autodoc]] transformers.JukeboxForTokenClassification
    - forward


## JukeboxForQuestionAnswering

[[autodoc]] JukeboxForQuestionAnswering
    - forward
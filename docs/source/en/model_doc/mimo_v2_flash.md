...
-->
*This model was released on 2025-12-17 and added to Hugging Face Transformers on 2026-04-02.*
...
For more details, please refer to the [official model card](https://huggingface.co/XiaomiMiMo/MiMo-V2-Flash), [technical
report](https://github.com/XiaomiMiMo/MiMo-V2-Flash/blob/main/paper.pdf), and [official
repository](https://github.com/XiaomiMiMo/MiMo-V2-Flash).  
This model was contributed by [casinca](https://github.com/casinca).
...
prompt = "Explain why sparse MoE models can be efficient at inference."

...
>>> tokenizer = AutoTokenizer.from_pretrained("facebook/nllb-moe-128")
>>> model = AutoModelForSeq2SeqLM.from_pretrained("facebook/nllb-moe-128")
...
>>> tokenizer = AutoTokenizer.from_pretrained("facebook/nllb-moe-128", use_auth_token=True, src_lang="ron_Latn")
>>> model = AutoModelForSeq2SeqLM.from_pretrained("facebook/nllb-moe-128", use_auth_token=True)

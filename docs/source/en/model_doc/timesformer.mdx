...
There are many pretrained variants. Select your pretrained model based on the dataset it is trained on. Moreover, number of input frames per clip changes based on the model size so you can consider this parameter while selecting your pretrained model.

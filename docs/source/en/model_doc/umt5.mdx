...
Since umT5 was pre-trained unsupervisedly, there's no real advantage to using a task prefix during single-task
...
- [google/umt5-large](https://huggingface.co/google/umt5-large)

- [google/umt5-xl](https://huggingface.co/google/umt5-xl)

- [google/umt5-xxl](https://huggingface.co/google/umt5-xxl).

This model was contributed by [agemagician](https://huggingface.co/agemagician) and [stefan-it](https://huggingface.co/agemagician). The original code can be
...
[[autodoc]] UMT5Tokenizer

See [`UT5Tokenizer`] for all details.


## UMT5TokenizerFast

[[autodoc]] UMT5TokenizerFast

See [`UT5TokenizerFast`] for all details.
...
## TFUMT5ForConditionalGeneration

[[autodoc]] TFUMT5ForConditionalGeneration

## TFUMT5EncoderModel

[[autodoc]] TFUMT5EncoderModel

## FlaxUMT5Model

[[autodoc]] FlaxUMT5Model

## FlaxUMT5ForConditionalGeneration

[[autodoc]] FlaxUMT5ForConditionalGeneration

## FlaxUMT5EncoderModel

[[autodoc]] FlaxUMT5EncoderModel

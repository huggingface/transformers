...
- A notebook illustrating fine-tuning [`DeformableDetrForObjectDetection`] on a custom dataset an be found [here](https://github.com/NielsRogge/Transformers-Tutorials/tree/master/DETR). Make sure to replace the model and image processor by the one of Deformable DETR.

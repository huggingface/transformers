...
Mega can perform quite well with relatively few parameters. See Appendix D in the Mega paper for examples of architectural specs which perform well in various settings.

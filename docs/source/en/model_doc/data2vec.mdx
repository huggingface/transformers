...
[sayakpaul](https://github.com/sayakpaul) contributed Data2Vec for vision in TensorFlow. To know how a pre-trained Data2Vec vision
model can be fine-tuned on the task of image classification, you can check out

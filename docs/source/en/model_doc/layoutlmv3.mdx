...
This model was contributed by [nielsr](https://huggingface.co/nielsr). The TensorFlow version of this model was added by [christoffero](https://github.com/ChrisFugl), [esbenc](https://github.com/EtcEc), and [lasser](https://github.com/lre). The original code can be found [here](https://github.com/microsoft/unilm/tree/master/layoutlmv3).

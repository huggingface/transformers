...
The Graphormer model was proposed in [<INSERT PAPER NAME HERE>](<INSERT PAPER LINK HERE>)  by <INSERT AUTHORS HERE>. <INSERT SHORT SUMMARY HERE>
...
## GraphormerTokenizerFast

[[autodoc]] GraphormerTokenizerFast

...
- Usage of Table Transformer models is identical to other object detectors in the library, such as [`DetrForObjectDetection`]. Refer to [these notebooks](https://github.com/NielsRogge/Transformers-Tutorials/tree/master/DETR).

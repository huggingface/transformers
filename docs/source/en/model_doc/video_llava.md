...
Additionally, we can greatly speed-up model inference by using [Flash Attention](../attention_interface), which is a faster implementation of the attention mechanism used inside the model.

...
- One can use the [`AutoFeatureExtractor`] API for preparing images for the model. This will instantiate a [`DetrFeatureExtractor`] behind the scenes.  
- Contrary to [DETR](detr), YOLOS doesn't require a `pixel_mask` to be created.

...
Three types of models are available depending on the pre-training data. Refer to the description [here](https://github.com/salesforce/codegen#released-models). 

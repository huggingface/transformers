...
The example below demonstrates how to use ViT for image classifcation with [`Pipeline`] or the [`AutoModel`] class. You can find all the original ViT checkpoints under the [Google](https://huggingface.co/google?search_models=vit) organization.

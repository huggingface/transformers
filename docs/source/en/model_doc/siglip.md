...
- A basic prompt template of "This is a photo of {label}." should be used. This is handled automatically in Pipelines.
...
>>> candidate_labels = ["a photo of 2 cats", "a photo of 2 dogs"]

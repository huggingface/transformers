...
[`flash_attention_2`](https://github.com/Dao-AILab/flash-attention), [`flash_dmattn`](https://github.com/SmallDoges/flash-dmattn) and [`flex_attention`](https://pytorch.org/docs/stable/nn.attention.flex_attention.html#module-torch.nn.attention.flex_attention)

...
<frameworkcontent>
<pt>
Tokenize the text and return PyTorch tensors (you can use the model you just finetuned or a pretrained model for sentiment analysis):
...
<tf>
Tokenize the text and return TensorFlow tensors (you can use the model you just finetuned or a pretrained model for sentiment analysis):

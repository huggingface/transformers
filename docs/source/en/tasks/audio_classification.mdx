...
<frameworkcontent>
<pt>
Load a feature extractor to preprocess the audio file and return the `input` as PyTorch tensors (you can use the model you just finetuned or a pretrained model for audio classification):

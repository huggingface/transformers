...
and use [PushToHubCallback](./main_classes/keras_callbacks#transformers.PushToHubCallback) to upload the model:
...
Congratulations! You have trained your model and shared it on the 🤗 Hub. You can now use it for inference!
</tf>
</frameworkcontent>

...
<frameworkcontent>
<pt>
Load a feature extractor to preprocess the image and return the `input` as PyTorch tensors (you can use the model you just finetuned or a pretrained model for image classification):
...
<div class="flex justify-center">
    <img src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/image-classification-inference.png" alt="image of a tabby cat"/>
</div>

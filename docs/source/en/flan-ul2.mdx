...
## Running on low ressources
The model is pretty heavy (~20GB) so if you just want to run the model, make sure you load in 8bits, and use `device_map="auto"` to make sure 
you don't have OOM issue!

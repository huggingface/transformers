...
Having multiple frameworks available to use with 🤗 Transformers means you can play their strengths when designing your
...
🤗 Transformers:
- [General overview of 🤗 Transformers](https://huggingface.co/docs/transformers/add_new_model#general-overview-of-transformers)
...
you might recall from our [general overview of 🤗 Transformers](https://huggingface.co/docs/transformers/add_new_model#general-overview-of-transformers)
...
-  8. ☐ (Optional) Added a demo notebook

### 1.-3. Prepare your model submission

**1. Select the model you wish to convert**

Let's start off with the basics: the first thing you need to know is the architecture you want to convert. If you
haven't your eyes set on a specific architecture, asking the 🤗 Transformers for suggestions is a great way to maximize
...
🤗 Transformers but is lacking weights, feel free to jump straight into the last section of this page.
...
7. Once you are satisfied, go to the webpage of your fork on GitHub. Click on “Pull request”. Make sure to add the
   GitHub handle of some members of the Hugging Face team as reviewers, so that the Hugging Face team gets notified for
   future changes.

8. Change the PR into a draft by clicking on “Convert to draft” on the right of the GitHub pull request web page.
...
-  1. ☐ (Optional) Understood theoretical aspects and existing implementation
-  2. ☐ Prepare transformers dev environment

...
1. **[UMT5](model_doc/umt5)** (from Google AI) released in the repository [google-research/t5x](https://github.com/google-research/t5x/blob/main/released_checkpoints.md#t511) by 

...
<<<<<<< HEAD
1. **[ViTPose](https://huggingface.co/docs/transformers/model_doc/vitpose)** (from The University of Sydney and JD Explore Academy) released with the paper [ViTPose: Simple Vision Transformer Base lines for Human Pose Estimation](https://arxiv.org/abs/2204.12484) by Yufei Xu, Jing Zhang, Qiming Zhang, Dacheng Tao.
=======

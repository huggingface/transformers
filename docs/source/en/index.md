...
1. **[LaVIN](https://huggingface.co/docs/transformers/model_doc/lavin)** (from Xiamen University China) released with the paper [Cheap and Quick: Efficient Vision-Language Instruction Tuning for Large Language Models](https://arxiv.org/pdf/2305.15023.pdf) by Gen Luo, Yiyi Zhou, Tianhe Ren, Shengxin Chen, Xiaoshuai Sun, Rongrong J.

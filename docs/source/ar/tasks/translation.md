...
⚠️ لاحظ أن هذا الملف بتنسيق Markdown ولكنه يحتوي على صيغة خاصة لباني المستندات لدينا (مماثل لـ MDX) والتي قد لا يتم عرضها بشكل صحيح في عارض Markdown الخاص بك.
...
تحول الترجمة سلسلة نصية من لغة إلى أخرى. وهي إحدى المهام العديدة التي يمكنك صياغتها كمسألة تسلسل إلى تسلسل، وهو إطار عمل قوي لإرجاع بعض المخرجات من مُدخل، مثل الترجمة أو التلخيص. تُستخدم أنظمة الترجمة بشكل شائع للترجمة بين نصوص لغات مختلفة، ولكن يمكن استخدامها أيضًا للكلام أو مزيج بينهما مثل تحويل النص إلى كلام أو تحويل الكلام إلى نص.

...
<Tip>
ومع ذلك، فإن أحد فئات النماذج التي تدعمه هي (https://huggingface.co/CohereForAI/c4ai-command-r-08-2024)[Command-R] و (https://huggingface.co/CohereForAI/c4ai-command-r-pluse-08-2024)[Command-R+] من Cohere، من خلال قالب الدردشة rag الخاص بهم. يمكنك رؤية أمثلة إضافية على التوليد باستخدام هذه الميزة في بطاقات النموذج الخاصة بهم.
</Tip>
...
{%- endif %}
```
إذا لم تكن قد رأيت أحد هذه القوالب من قبل، فهذا (https://jinja.palletsprojects.com/en/3.1.x/templates/)[قالب Jinja] .Jinja هي لغة قوالب تسمح لك بكتابة تعليمات برمجية بسيطة تُوَلّد نصًا. من نواحٍ عديدة، يُشبه الرمز والتركيب للغة Python. أما في لغة Python، سيبدو هذا القالب كما يلي:

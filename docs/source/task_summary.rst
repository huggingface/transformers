...
In the next section, we show how this functionality is leveraged in
:func:`~transformers.generation_utils.GenerationMixin.generate` to generate multiple tokens up to a user-defined
length.

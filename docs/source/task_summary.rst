...
model on a summarization task, you may leverage the `run_sum.py
<https://github.com/huggingface/transformers/tree/master/examples/seq2seq/run_sum.py>`__ script.
...
translation task, you may leverage the `run_trans.py
<https://github.com/huggingface/transformers/tree/master/examples/seq2seq/run_trans.py>`__ script.

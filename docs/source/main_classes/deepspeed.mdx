...
2. enable bf16 if you own an Ampere or a newer gpu to make things faster. If you don't have that hardware you may enable fp16 as long as you use a different model than a t5-variant or any other model that was pre-trained in bf16 mixed precision - these usually overflow in fp16 and you will see garbage as output.

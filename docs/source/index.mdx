...
🤗 Transformers provides APIs to quickly download and fine-tune thousands of state-of-the-art pretrained models, and then share them with the community on our [Model Hub](https://huggingface.co/models). Use these models for different modalities such as:
...
* 🗣️ Vision: speech recognition and audio classification.
* 🐙 Multimodal: table question answering, optical character recognition, information extraction from scanned documents, video classification, and visual question answering.

Our library supports seamless integration between three of the most popular deep learning libraries: [PyTorch](https://pytorch.org/), [TensorFlow](https://www.tensorflow.org/) and [JAX](https://jax.readthedocs.io/en/latest/). Train your model with one framework and load it for inference with another.

Each Transformer architecture is defined in a standalone Python module so they can be easily customized for research and experiments.

# Contents

The documentation is organized in five parts:

- Get Started will introduce you to 🤗 Transformers and showcase it's ease-of-use and high performance. You'll install our library, use the `pipeline` API to quickly use a pretrained model for inference, and then preprocess and fine-tune your own model.
- Tutorials are a good starting point if you've never used 🤗 Transformers before. Learn from the ground up how to preprocess text, image or audio data, initialize a pretrained model with the `AutoClass` API, fine-tune a model with our `Trainer` or deep learning library of your choice, enable distributed training with [Accelerate](https://huggingface.co/docs/accelerate/), and share a model to the Hub.
- Guides will show you how to apply your skills to solve real-world problems such as fine-tuning models for some of the most common downstream tasks, using multi-lingual models, and optimizing performance for larger models. If you are interested in contributing to our community and participating in open-source science, we will also show you how to add a model or pipeline to 🤗 Transformers.
- Read the Concept guides to gain a deeper understanding about the 🤗 Transformers design philosophy, different kinds of Transformer models, types of tasks 🤗 Transformers can be applied to, and strategies for training increasingly large models.
- Our API Reference describes the classes and functions for our main classes, models, and internal helpers.

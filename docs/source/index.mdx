...
1. **[S4](model_doc/s4)** (from  Stanford University) released with the paper [Efficiently Modeling Long Sequences with Structured State Spaces](https://arxiv.org/abs/2111.00396) by Albert Gu, Karan Goel, and Christopher R´e.

...
De manera de asistir al desarrollo de este nuevo campo, hemos incluido algunas features adicionales en los modelos BERT/GPT/GPT-2 para
ayudar a la gente a acceder a las representaciones internas, principalmente adaptado de la gran obra de Paul Michel
...
Para ayudarte a entender y usar estas features, hemos añadido un script específico de ejemplo: [bertology.py](https://github.com/huggingface/transformers/tree/main/examples/research_projects/bertology/run_bertology.py) mientras extraes información y podas un modelo pre-entrenado en
GLUE.

...
1. **[TrillssonEfficientNet](model_doc/trillsson_efficientnet)** (de Google AI) con el papel [TRILLsson: Distilled Universal Paralinguistic Speech Representations](https://aps.arxiv.org/abs/2203.00236) por Joel Shor, Subhashini Venugopalan.

...
- Las traducciones de los README y el índice del documento tienen la misma lista modelo que el README principal (realizado por `utils/check_copies.py`)
- Las tablas generadas automáticamente en la documentación están actualizadas (realizadas por `utils/check_table.py`)

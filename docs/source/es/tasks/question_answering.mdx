...
La contestación de preguntas devuelve una respuesta a partir de una pregunta dada. Existen dos formas comunes de contestación de preguntas:
...
Esta guía te mostrará como hacer fine-tuning de [DistilBERT](https://huggingface.co/distilbert-base-uncased) en el dataset [SQuAD](https://huggingface.co/datasets/squad) para contestar preguntas de forma extractiva.

<Tip>

Revisa la [página de la tarea](https://huggingface.co/tasks/question-answering) de contestación de preguntas para tener más información sobre otras formas de contestación de preguntas y los modelos, datasets y métricas asociadas.
...
Hay algunos pasos de preprocesamiento específicos de la contestación de preguntas que debes tener en cuenta:
...
Para un ejemplo con mayor profundidad de cómo hacer fine-tuning a un modelo para contestar preguntas, échale un vistazo al

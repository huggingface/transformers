...
This will load the model pre-trained on masked image modeling. You can also load a fine-tuned model from the [hub](https://huggingface.co/models?other=dit), like so:

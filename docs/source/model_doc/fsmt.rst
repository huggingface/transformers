...
This model is a porting of a transformer model for translation, discussed in `this paper <https://arxiv.org/abs/1907.06616>`__:
...
The Authors' code can be found `here <https://github.com/pytorch/fairseq/tree/master/examples/wmt19>`__.

...
# Conditionally handle dependencies for type checking and error handling
try:
    ...
    # No change needed in structure if torch is available
    pass
...
try:
    ...
    # No specific dummy needed for fast tokenizer, LazyModule handles import error
    pass
else:

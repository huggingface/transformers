...
if is_torch_available():
    # Type annotations - when torch is available, set the class variables with torch implementation
    ...
    # Define stubs for when torch is not available - will raise appropriate errors when used

...
@add_start_docstrings(
    """HindiCausalLM Model with a `language modeling` head on top for Causal Language Modeling.""",
    HINDI_CAUSAL_LM_START_DOCSTRING,
)
class HindiCausalLMForCausalLM(HindiCausalLMPreTrainedModel):
    ...
    def forward(
        ...
        labels (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
            Labels for computing the language modeling loss. Indices should be in `[-100, 0, ..., config.vocab_size-1]`.

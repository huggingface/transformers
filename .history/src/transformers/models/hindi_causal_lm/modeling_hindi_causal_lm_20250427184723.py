...
class HindiCausalLMAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # **Attention Shape Fix for Generation Tests**
        if output_attentions and use_cache and q_len > 0:
             # Slice to keep only the attention weights for the last query token
             returned_attn_weights = returned_attn_weights[:, :, -1:, :] # Shape [bsz, heads, 1, kv_len]
        ...
        **kwargs
        ...
        if position_ids is None:
            ...
            if current_length <= 0:
                 ...
                 logger.warning(f"prepare_inputs_for_generation received current_length={current_length}. Generating empty position_ids.")

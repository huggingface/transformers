...
if TYPE_CHECKING:
    ...
    _import_structure = {
        # Add the new model explicitly *first* to ensure it's detected by the check
        "hindi_causal_lm": [],
    }
    # Then, update with automatically discovered models
    _import_structure.update(define_import_structure(_file))

...
# DINOv3
dinov3_vit7b16_lc = torch.hub.load("/workspaces/transformers/dinov3", 'dinov3_vit7b16_lc', source="local", weights="/tmp/lc.pth", backbone_weights="/tmp/backbone.pth", n_storage_tokens=0)

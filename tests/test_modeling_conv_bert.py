...
if is_torch_available():
    ...
    from transformers.models.conv_bert.modeling_conv_bert import (
...
class ConvBertModelTester:
    ...
    def create_and_check_for_causal_lm(
        ...
        model = ConvBertForCausalLM(config=config)
        model.to(torch_device)
        model.eval()
...
class ConvBertModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    all_generative_model_classes = (ConvBertForCausalLM,) if is_torch_available() else ()

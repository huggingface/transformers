...
def _expert_weight_bytes(model):
    """Bytes held by the expert projections, whether they are dense parameters or packed kernel tensors."""
...
class PackedExpertsTest(unittest.TestCase):
    ...
    def test_experts_stay_packed_by_default(self):
        ...
        self.assertEqual(experts.gate_up_proj.storage.data.dtype, torch.uint8)

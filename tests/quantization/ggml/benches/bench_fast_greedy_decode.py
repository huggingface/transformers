...
os.environ["TRANSFORMERS_GGUF_METAL_KERNELS_SO"] = (
    "/Users/arthurzucker/Work/gguf-dequant-kernels/result-bundle/torch210-metal-aarch64-darwin/_gguf_dequant_7a428ca_dirty.abi3.so"
)
from transformers import AutoModelForCausalLM, AutoTokenizer
from transformers.integrations.gguf_linear import fast_greedy_decode, setup_for_compile
...
m = (
    AutoModelForCausalLM.from_pretrained(
        repo, gguf_file="Qwen1.5-MoE-A2.7B_q4_k_m.gguf", gguf_linear=True, dtype=torch.float32
    )
    .to("mps")
    .eval()
)

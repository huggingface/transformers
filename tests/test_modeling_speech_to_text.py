...
class Speech2TextStandaloneDecoderModelTester:
    ...
    def create_and_check_decoder_model_past(
        ...
        model = Speech2TextDecoder(config=config).to(torch_device).eval()
        # first forward pass
...
@require_torch
class Speech2TextStandaloneDecoderModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    all_model_classes = (Speech2TextDecoder, Speech2TextForCausalLM) if is_torch_available() else ()
    all_generative_model_classes = (Speech2TextForCausalLM,) if is_torch_available() else ()
    test_pruning = False
    is_encoder_decoder = False
    ...
    def setUp(
        ...
        self.model_tester = Speech2TextStandaloneDecoderModelTester(self, is_training=False)
        self.config_tester = ConfigTester(self, config_class=Speech2TextConfig)

...
class TFModelTesterMixin:
    ...
    def test_pt_tf_model_equivalence(self):
        ...
        def check_outputs(tfo, pto, model_class, names):
            ...
            # Some big issue (`about past_key_values`) to solve
            """
            E   AssertionError: 'TFPegasusForConditionalGeneration | len(tfo): 2 | len(pto): 5' != ''
            E   - TFPegasusForConditionalGeneration | len(tfo): 2 | len(pto): 5
            E   +
            """
        ...
        for model_class in self.all_model_classes:
            ...
            # TODO: remove the for loop (so test once)
            for idx in range(10):
                ...
                if has_labels:
                    ...
                    # 1. Some models require extra condition to return loss. For example, `BertForPreTraining` requires
                    #    both`labels` and `next_sentence_label`.
                    # TODO: remove this condition once the above TODOs (above loss) are implemented

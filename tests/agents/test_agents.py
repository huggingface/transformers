...
from transformers.agents.agents import (AgentMaxIterationsError, CodeAgent,
                                        ManagedAgent, ReactCodeAgent,
                                        ReactJsonAgent, Toolbox)
...
"""
    ...
    def test_init_agent_with_different_toolsets(self):
        ...
        agent = ReactCodeAgent(
            tools=[], llm_engine=fake_react_code_llm, add_base_tools=True
        )
        assert (

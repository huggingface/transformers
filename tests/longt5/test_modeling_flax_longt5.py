...
class FlaxLongT5ModelIntegrationTests(unittest.TestCase):
    model_path = "Stancld/LongT5-Local-Base"
    tokenizer_path = "longt5-base"

    @slow
    def test_summarization(self):
        model = FlaxLongT5ForConditionalGeneration.from_pretrained(self.model_path)
        tok = T5Tokenizer.from_pretrained(self.tokenizer_path)
...
@require_tokenizers
@require_flax
class FlaxLongT5TGlobalModelIntegrationTests(unittest.TestCase):

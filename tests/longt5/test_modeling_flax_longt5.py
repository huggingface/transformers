# coding=utf-8
# Copyright 2021 Google LongT5 Authors and HuggingFace Inc. team.
#
...
if is_flax_available():
    ...
    from transformers import FLAX_MODEL_MAPPING, ByT5Tokenizer, LongT5Config, T5Tokenizer
...
class FlaxLongT5ModelIntegrationTests(unittest.TestCase):
    ...
    def test_small_v1_1_integration_test(self):
        ...
        model = FlaxLongT5ForConditionalGeneration.from_pretrained("google/longt5-v1_1-small")
    ...
    def test_small_bylongt5_integration_test(self):
        ...
        model = FlaxLongT5ForConditionalGeneration.from_pretrained("google/by")
    ...
    def test_summarization(self):
        model = FlaxLongT5ForConditionalGeneration.from_pretrained("longt5-base")

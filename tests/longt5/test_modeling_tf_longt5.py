...
class TFLongT5ModelTester:
    ...
    def create_and_check_longt5_xla_generate(self, config, input_ids, *args):
...
class TFLongT5ModelTest(TFModelTesterMixin, unittest.TestCase):
    ...
    def test_longt5_model_v1_1(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        config = config_and_inputs[0]
        config.tie_word_embeddings = False
        config.feed_forward_proj = "gated-gelu"
        self.model_tester.create_and_check_longt5_model(config, *config_and_inputs[1:])
    ...
    def test_longt5_model_xla_generate(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_longt5_xla_generate(*config_and_inputs)
    ...
    def test_model_from_pretrained(self):
        model = TFLongT5Model.from_pretrained("")
        self.assertIsNotNone(model)

    def test_generate_with_headmasking(self):
        # TODO: Fix head-masking according to PyTorch LongT5 model
        pass

    @slow
    def test_resize_embeddings(self):
        model = TFLongT5ForConditionalGeneration.from_pretrained("")
...
@require_tokenizers
class TFLongT5GenerationIntegrationTests(unittest.TestCase):
    @slow
...
@require_sentencepiece
@require_tokenizers
class TFLongT5ModelIntegrationTests(unittest.TestCase):
    @cached_property
    def model(self):
        return TFLongT5ForConditionalGeneration.from_pretrained("longt5-base")
    ...
    def test_small_v1_1_integration_test(self):
        ...
        >>> path_to_mtf_small_longt5_v1.1_checkpoint = '<fill_in>'
        >>> path_to_mtf_small_spm_model_path = '<fill_in>'
        >>> longt5_model = longt5.models.MtfModel(model_dir=path_to_mtf_small_longt5_v1.1_checkpoint, batch_size=1, tpu=None)
        >>> vocab = SentencePieceVocabulary(path_to_mtf_small_spm_model_path, extra_ids=100)
        >>> score = longt5_model.score(inputs=["Hello there"], targets=["Hi I am"], vocabulary=vocab)
        """

        model = TFLongT5ForConditionalGeneration.from_pretrained("google/longt5-v1_1-small")
    ...
    def test_small_bylongt5_integration_test(self):
        ...
        model = TFLongT5ForConditionalGeneration.from_pretrained("google/by")
    ...
    def test_summarization(self):
        model = self.model
        tok = T5Tokenizer.from_pretrained("longt5-base")

...
from transformers import YolosConfig, is_torch_available
...
class YolosModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(self, config_class=YolosConfig, hidden_size=37)

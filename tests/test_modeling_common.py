                ...
                for conversion in conversions:
                    ...
                    for source_pattern in conversion.source_patterns:
                        ...
                        if isinstance(conversion, WeightRenaming):
                            ...
                            # Skip rules whose target doesn't appear in this model class
                            # (e.g. class-specific head rules), but assert the rule still
                            # matches at least one class — otherwise it is dead code.

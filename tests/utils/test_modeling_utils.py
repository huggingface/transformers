...
class ModelUtilsTest(TestCasePlus):
    ...
    def test_model_from_pretrained_fsdp_distributes_before_loading(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            def fake_distribute_model(model, distributed_config, device_mesh):
                call_order.append("distribute")
                self.assertIs(device_mesh, fake_mesh)
                return model
            ...
            with (
                ...
                patch(
                    "transformers.modeling_utils.distribute_model_distributed",
                    side_effect=fake_distribute_model,
                ),

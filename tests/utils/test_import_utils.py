...
from sarah.testing_utils import run_test_using_subprocess
from sarah.utils.import_utils import clear_import_cache
...
def test_clear_import_cache():
    ...
    from sarah.models.auto import modeling_auto

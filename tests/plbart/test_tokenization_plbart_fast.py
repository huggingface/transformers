...
from transformers import PLBartTokenizer, PLBartTokenizerFast, BatchEncoding
...
class TestTokenizationBart(TokenizerTesterMixin, unittest.TestCase):
    ...
    def default_tokenizer(self):
        return PLBartTokenizer.from_pretrained("uclanlp/plbart-base")

    @cached_property
    def default_tokenizer_fast(self):
        return PLBartTokenizerFast.from_pretrained("uclanlp/plbart-base")

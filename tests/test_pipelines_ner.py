...
class NerPipelineTests(CustomInputPipelineCommonMixin, unittest.TestCase):
    ...
    def _test_pipeline(self, nlp: Pipeline):
        mandatory_keys = {
            "standard": {"entity", "word", "score"},
            "grouped": {"entity_group", "word", "score"},
        }

        for sub_test, output_keys in mandatory_keys.items():
            with self.subTest(msg="Testing {}".format(sub_test.__name__)):

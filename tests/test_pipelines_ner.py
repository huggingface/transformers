...
class NerPipelineTests(CustomInputPipelineCommonMixin, unittest.TestCase):
    ...
    def _test_pipeline(self, nlp: Pipeline):
        ...
        expected_aligned_results_w_subword = {
            True: [
                {
                    "word": "T",
                    "score": 0.929590046,
                ...
                {"word": "##H", "score": 0.0, "index": 2, "start": 1, "end": 2, "is_subword": True, "entity": "O"},
                {"word": "##e", "score": 0.0, "index": 3, "start": 2, "end": 3, "is_subword": True, "entity": "O"},
                {
                    "word": "quasi",
                    "score": 0.62320358,
                    "index": 4,
                ...
                {"word": "##ame", "score": 0.0, "index": 5, "start": 9, "end": 12, "is_subword": True, "entity": "O"},
                {
                    "word": "##rica",
                    "score": 0.0,
                    "index": 6,
                ...
                {"word": "##n", "score": 0.0, "index": 7, "start": 16, "end": 17, "is_subword": True, "entity": "O"},
                {
                    "word": "Mark",
                    "score": 0.9833675,
                    "index": 8,
                ...
                {"word": "##up", "score": 0.0, "index": 14, "start": 46, "end": 48, "is_subword": True, "entity": "O"},
                {
                    "word": "##pit",
                    "score": 0.0,
                    "index": 15,
                ...
                {"word": "##y", "score": 0.0, "index": 16, "start": 51, "end": 52, "is_subword": True, "entity": "O"},
            ],
            "default": [
                {
                    "word": "T",
        ...
        if nlp.grouped_entities:
            if nlp.ignore_subwords:
                ...
                for ungrouped_input, grouped_result in zip(
                    ...
                    self.assertEqual(nlp.group_entities(ungrouped_input), grouped_result)
        if nlp.subword_label_re_alignment:
            aligned_results = nlp.set_subwords_label(ungrouped_inputs_all_scores)
            if nlp.ignore_subwords:
                self.assertEqual(aligned_results, expected_aligned_results[nlp.subword_label_re_alignment])
            else:
                self.assertEqual(aligned_results, expected_aligned_results_w_subword[nlp.subword_label_re_alignment])
    ...
    @require_tf
    def test_tf_small_subwords_realignment_available_for_fast_tokenizers(self):
        for model_name in self.small_models:
            tokenizer = AutoTokenizer.from_pretrained(model_name, use_fast=True)
            for strategy in [False, True, "default", "first", "max", "average"]:
                nlp = pipeline(
                    task="ner",
                    model=model_name,
                    tokenizer=tokenizer,
                    framework="tf",
                    subword_label_re_alignment=strategy,
                    ignore_subwords=True,
                )
                self._test_pipeline(nlp)
                nlp = pipeline(

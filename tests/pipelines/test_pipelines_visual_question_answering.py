...
from transformers.pipelines import VisualQuestionAnsweringPipeline, pipeline
...
class VisualQuestionAnsweringPipelineTests(unittest.TestCase, metaclass=PipelineTestCaseMeta):
    ...
    def get_test_pipeline(self, model, tokenizer, feature_extractor):
        vqa_pipeline = VisualQuestionAnsweringPipeline(model=model, tokenizer=tokenizer, feature_extractor=feature_extractor, top_k=2)
        examples = [
    ...
    def test_small_model_pt(self):
        ...
        outputs = vqa_pipeline("http://images.cocodataset.org/val2017/000000039769.jpg")
        self.assertEqual(

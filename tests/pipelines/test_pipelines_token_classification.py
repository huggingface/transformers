...
class TokenClassificationPipelineTests(unittest.TestCase):
    ...
    def test_sliding_window(self):
        ...
        token_classifier = SlidingWindowTokenClassificationPipeline(model=AutoModelForTokenClassification.from_pretrained("dslim/bert-base-NER"), tokenizer=AutoTokenizer.from_pretrained("dslim/bert-base-NER"), grouped_entities=True)

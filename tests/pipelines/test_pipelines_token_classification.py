...
class TokenClassificationPipelineTests(unittest.TestCase):
    ...
    def test_aggregation_strategy_byte_level_tokenizer(self):
        ...
        ner = pipeline(
            "ner",
            model="FacebookAI/xlm-roberta-large-finetuned-conll02-dutch",
    ...
    def test_aggregation_strategy(self):
        ...
        example = [
            {
                "scores": np.array(
                    [0, 0, 0, 0, 0.9968166351318359, 0, 0, 0]
                ),  # fmt : skip
                "index": 1,
                "is_subword": False,
                "word": "En",
            ...
            {
                "scores": np.array(
                    [0, 0, 0, 0, 0.9957635998725891, 0, 0, 0]
                ),  # fmt : skip
                "index": 2,
                "is_subword": True,
                "word": "##zo",
            ...
            {
                "scores": np.array(
                    [0, 0, 0, 0, 0, 0.9986497163772583, 0, 0]
                ),  # fmt : skip
                "index": 7,
                "word": "UN",
                "is_subword": False,

...
class TokenClassificationPipelineTests(unittest.TestCase):
    ...
    def test_sliding_window(self):
        ...
        expected_output = [
            ...
            {'entity_group': 'ORG', 'score': 0.983, 'word': "Conservative People ' s Party of Estonia", 'start': 1316, 'end': 1354},
            ...
            {'entity_group': 'ORG', 'score': 0.984, 'word': 'Riigikogu', 'start': 1500, 'end': 1509},
            ...
            {'entity_group': 'PER', 'score': 0.984, 'word': 'Ratas', 'start': 1808, 'end': 1813},
            {'entity_group': 'ORG', 'score': 0.999, 'word': 'Centre Party', 'start': 1816, 'end': 1828},
            {'entity_group': 'ORG', 'score': 0.992, 'word': 'Isamaa', 'start': 1830, 'end': 1836},
            ...
            {'entity_group': 'PER', 'score': 0.827, 'word': 'Kallas', 'start': 1933, 'end': 1939},
            {'entity_group': 'ORG', 'score': 0.999, 'word': 'EKRE', 'start': 1949, 'end': 1953},
            {'entity_group': 'PER', 'score': 0.729, 'word': 'Kersti Kaljulaid', 'start': 1955, 'end': 1971},
            {'entity_group': 'LOC', 'score': 0.991, 'word': 'Estonia', 'start': 1990, 'end': 1997},
            {'entity_group': 'PER', 'score': 0.885, 'word': 'Kallas', 'start': 2017, 'end': 2023},
            ...
            {'entity_group': 'ORG', 'score': 0.985, 'word': 'Isamaa', 'start': 2116, 'end': 2122},
            {'entity_group': 'ORG', 'score': 0.999, 'word': 'SDE', 'start': 2128, 'end': 2131},
            {'entity_group': 'ORG', 'score': 0.679, 'word': 'Ratas', 'start': 2206, 'end': 2211},
            {'entity_group': 'ORG', 'score': 0.893, 'word': 'Isamaa', 'start': 2275, 'end': 2281},
            {'entity_group': 'ORG', 'score': 0.998, 'word': 'EKRE', 'start': 2286, 'end': 2290},
            {'entity_group': 'PER', 'score': 0.552, 'word': 'Jüri Ratas', 'start': 2292, 'end': 2302},
            ...
            {'entity_group': 'PER', 'score': 0.999, 'word': 'Ratas', 'start': 2647, 'end': 2652},
            ...
            {'entity_group': 'ORG', 'score': 0.999, 'word': 'Centre Party', 'start': 3051, 'end': 3063},
            {'entity_group': 'MISC', 'score': 0.991, 'word': 'Russians', 'start': 3091, 'end': 3099},
            {'entity_group': 'LOC', 'score': 1.0, 'word': 'Estonia', 'start': 3103, 'end': 3110},
            {'entity_group': 'PER', 'score': 0.991, 'word': 'Kallas', 'start': 3125, 'end': 3131},
            {'entity_group': 'PER', 'score': 0.765, 'word': 'Isamaa', 'start': 3157, 'end': 3163},
            {'entity_group': 'ORG', 'score': 0.998, 'word': 'SDE', 'start': 3168, 'end': 3171},
            {'entity_group': 'PER', 'score': 0.84, 'word': 'Kaja Kallas', 'start': 3194, 'end': 3205},
        ]
        input_text2= '''
The media landscape in the United States is dominated by a handful of major news companies that are known for their influential coverage of national and international news. Some of the most well-known news companies in the US include CNN, Fox News, MSNBC, The New York Times, The Washington Post, and The Wall Street Journal. CNN, or the Cable News Network, is a global news company that was founded in 1980 by Ted Turner. It is known for its 24-hour coverage of breaking news and its analysis of politics, business, and world events. CNN has correspondents in over 200 countries and reaches millions of viewers around the world.Fox News, on the other hand, is a conservative news company that was founded in 1996 by Rupert Murdoch. It is known for its opinionated coverage of politics, business, and culture, and has been criticized for its biased reporting. Despite this criticism, Fox News is one of the most-watched cable news networks in the US.MSNBC, or the Microsoft National Broadcasting Company, is a liberal news company that was founded in 1996 by Microsoft and NBC. It is known for its left-leaning political coverage and its analysis of social issues such as race, gender, and LGBT rights. MSNBC is the second-most watched cable news network in the US, after Fox News.The New York Times is one of the most influential newspapers in the US, and is known for its in-depth reporting on national and international news. It was founded in 1851 and has won more Pulitzer Prizes than any other newspaper. The New York Times is often considered to be a "paper of record" for its authoritative reporting on politics, business, and culture.The Washington Post is another major newspaper in the US that is known for its investigative reporting and political coverage. It was founded in 1877 and has won 69 Pulitzer Prizes. The Washington Post is also known for its coverage of national security issues, and its reporting on the Watergate scandal in the 1970s led to the resignation of President Richard Nixon.The Wall Street Journal is a business-focused newspaper that was founded in 1889. It is known for its coverage of finance, economics, and business news, and is widely read by business leaders and investors around the world. The Wall Street Journal has won 37 Pulitzer Prizes, and is owned by News Corp, which is also the parent company of Fox News.These major news companies in the US have a significant impact on the national and international discourse, and are often cited as sources of information and analysis by policymakers, journalists, and academics. While each company has its own distinctive voice and perspective, they all play a vital role in shaping the public's understanding of the world around them.However, these news companies have also faced criticism for their coverage, including accusations of bias, sensationalism, and the propagation of fake news. In recent years, the rise of social media and alternative news sources has challenged the dominance of traditional news companies, and has raised questions about the role of news media in the modern world.Despite these challenges, however, the major news companies in the US remain an important part of the media landscape, and will continue to shape public discourse for years to come.
'''
        output2 = nested_simplify(token_classifier(input_text2))

        expected_output2= [{"entity_group":"LOC","score":0.9994152324810377,"word":"United States","start":28,"end":41},{"entity_group":"LOC","score":0.9985606686684279,"word":"US","start":224,"end":226},{"entity_group":"ORG","score":0.9987832963910906,"word":"CNN","start":235,"end":238},{"entity_group":"ORG","score":0.9985804813325665,"word":"Fox News","start":240,"end":248},{"entity_group":"ORG","score":0.9979883299478565,"word":"MSNBC","start":250,"end":255},{"entity_group":"ORG","score":0.9988013207248603,"word":"The New York Times","start":257,"end":275},{"entity_group":"ORG","score":0.9988604957316268,"word":"The Washington Post","start":277,"end":296},{"entity_group":"ORG","score":0.998508622394759,"word":"The Wall Street Journal","start":302,"end":325},{"entity_group":"ORG","score":0.9987537856214319,"word":"CNN","start":327,"end":330},{"entity_group":"ORG","score":0.999033682167564,"word":"Cable News Network","start":339,"end":357},{"entity_group":"PER","score":0.9877447455536078,"word":"Ted Turner","start":412,"end":422},{"entity_group":"ORG","score":0.9987345283247682,"word":"CNN","start":536,"end":539},{"entity_group":"ORG","score":0.9980589074477622,"word":"Fox News","start":630,"end":638},{"entity_group":"PER","score":0.9935631910564251,"word":"Rupert Murdoch","start":718,"end":732},{"entity_group":"ORG","score":0.9976355236873036,"word":"Fox News","start":885,"end":893},{"entity_group":"LOC","score":0.9976882607163555,"word":"US","start":948,"end":950},{"entity_group":"ORG","score":0.995883219732592,"word":"MSNBC","start":951,"end":956},{"entity_group":"ORG","score":0.9988379525760529,"word":"Microsoft National Broadcasting Company","start":965,"end":1004},{"entity_group":"ORG","score":0.9974532023646603,"word":"Microsoft","start":1060,"end":1069},{"entity_group":"ORG","score":0.9980036371326015,"word":"NBC","start":1074,"end":1077},{"entity_group":"MISC","score":0.8627089845859932,"word":"LGBT","start":1191,"end":1195},{"entity_group":"ORG","score":0.9717658201897083,"word":"MSNBC","start":1204,"end":1209},{"entity_group":"LOC","score":0.9980215937728283,"word":"US","start":1263,"end":1265},{"entity_group":"ORG","score":0.9953344019917155,"word":"Fox News","start":1273,"end":1281},{"entity_group":"ORG","score":0.976394329928731,"word":"The New York Times","start":1282,"end":1300},{"entity_group":"LOC","score":0.9985913902072675,"word":"US","start":1350,"end":1352},{"entity_group":"MISC","score":0.9968186782906281,"word":"Pulitzer Prizes","start":1470,"end":1485},{"entity_group":"ORG","score":0.9296100102907561,"word":"The New York Times","start":1512,"end":1530},{"entity_group":"ORG","score":0.9961555432779922,"word":"The Washington Post","start":1644,"end":1663},{"entity_group":"LOC","score":0.9992144979092618,"word":"US","start":1698,"end":1700},{"entity_group":"MISC","score":0.9915662235188678,"word":"Pulitzer Prizes","start":1809,"end":1824},{"entity_group":"ORG","score":0.968807469977905,"word":"The Washington Post","start":1826,"end":1845},{"entity_group":"MISC","score":0.670361778569247,"word":"Watergate","start":1931,"end":1940},{"entity_group":"PER","score":0.7630809523101629,"word":"Richard Nixon","start":1998,"end":2011},{"entity_group":"ORG","score":0.9644574152911886,"word":"Wall Street Journal","start":2016,"end":2035},{"entity_group":"ORG","score":0.9801240511766404,"word":"Wall Street Journal","start":2240,"end":2259},{"entity_group":"MISC","score":0.8442417469066161,"word":"Pulitzer Prizes","start":2271,"end":2286},{"entity_group":"ORG","score":0.9958835065980778,"word":"News Corp","start":2304,"end":2313},{"entity_group":"ORG","score":0.8094412345157602,"word":"Fox News","start":2351,"end":2359},{"entity_group":"LOC","score":0.9967956273443678,"word":"US","start":2394,"end":2396},{"entity_group":"LOC","score":0.999269826889261,"word":"US","start":3157,"end":3159}]
        output_.extend(output2)
        expected_output.extend(expected_output2)
        self.assertEqual(
            output_,
            expected_output
        )

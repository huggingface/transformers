...
class ImageToTextPipelineTests(unittest.TestCase):
    ...
    def test_conditional_generation_pt(self):
        ...
        preprompt = "a photography of"

        outputs = pipe(image, preprompt=preprompt)
        self.assertEqual(outputs, [{"generated_text": "a photography of a volcano"}])

        with self.assertRaises(ValueError):
            outputs = pipe([image, image], preprompt=[preprompt, preprompt])
    ...
    def test_conditional_generation_pt_pix2struct(self):
        ...
        preprompt = "What does the label 15 represent? (1) lava (2) core (3) tunnel (4) ash cloud"

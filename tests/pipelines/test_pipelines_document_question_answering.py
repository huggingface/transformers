...
from transformers import MODEL_FOR_DOCUMENT_QUESTION_ANSWERING_MAPPING, is_vision_available
...
class DocumentQuestionAnsweringPipelineTests(unittest.TestCase, metaclass=PipelineTestCaseMeta):
    ...
    def test_large_model_pt(self):
        dqa_pipeline = pipeline("document-question-answering", model="microsoft/layoutlmv2-base-uncased")
        image = "https://templates.invoicehome.com/invoice-template-us-neat-750px.png"
        question = "How many cats are there?"
    ...
    def test_large_model_pt_donut(self):
        dqa_pipeline = pipeline("document-question-answering", model="naver-clova-ix/donut-base-finetuned-docvqa")

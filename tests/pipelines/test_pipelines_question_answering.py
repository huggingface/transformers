...
class QAPipelineTests(unittest.TestCase):
    ...
    def test_small_model_pt_softmax_trick(self):
        ...
        self.assertEqual(nested_simplify(outputs), {"score": 0.25, "start": 0, "end": 11, "answer": "HuggingFace"})
    ...
    def test_small_model_tf(self):
        ...
        self.assertEqual(nested_simplify(outputs), {"score": 0.158, "start": 0, "end": 11, "answer": "HuggingFace"})

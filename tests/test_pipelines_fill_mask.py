...
class FillMaskPipelineTests(MonoInputPipelineCommonMixin, unittest.TestCase):
    ...
    def test_torch_fill_mask_with_targets_and_topk(self):
        ...
        self.assertEqual(
            ...
            [
                {"sequence": "My name is Patrick", "score": 0.338, "token": 3499, "token_str": " Patrick"},
                {"sequence": "My name is Te", "score": 0.333, "token": 2941, "token_str": " Te"},
            ],
        )
    ...
    def test_tf_fill_mask_with_targets(self):
        ...
        self.assertEqual(
            nested_simplify(outputs),
            [
                {"sequence": "My name is Clara", "score": 0.344, "token": 13606, "token_str": " Clara"},
                {"sequence": "My name is Patrick", "score": 0.333, "token": 3499, "token_str": " Patrick"},
                {"sequence": "My name is Te", "score": 0.323, "token": 2941, "token_str": " Te"},
            ],
        )
        # topk

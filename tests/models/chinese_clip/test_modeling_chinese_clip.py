...
""" Testing suite for the PyTorch ChineseCLIP model. """
...
if is_torch_available():
    ...
    from transformers import ChineseCLIPModel, ChineseCLIPTextModel, ChineseCLIPVisionModel
...
class ChineseCLIPModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    # overwrite from common since FlaxChineseCLIPModel returns nested output

...
@require_sentencepiece
@require_tokenizers
class AquilaTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = AquilaTokenizer
    ...
    def setUp(self):
        ...
        tokenizer = AquilaTokenizer(SAMPLE_VOCAB, keep_accents=True)
    ...
    def test_save_pretrained(self):
        self.tokenizers_list += (self.rust_tokenizer_class, "hf-internal-testing/aquila-tokenizer", {})
    ...
    def test_tokenizer_integration(self):
        ...
        self.tokenizer_integration_test_util(
            ...
            model_name="hf-internal-testing/aquila-tokenizer",
...
@require_sentencepiece
@require_tokenizers
class AquilaIntegrationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        checkpoint_name = "hf-internal-testing/aquila-tokenizer"
        cls.tokenizer: AquilaTokenizer = AquilaTokenizer.from_pretrained(checkpoint_name)
        cls.rust_tokenizer = AquilaTokenizerFast.from_pretrained(checkpoint_name)
        return cls
    ...
    def test_fast_special_tokens(self):
        ...
        fast_tokenizer = AquilaTokenizerFast.from_pretrained(
            "hf-internal-testing/aquila-tokenizer", add_eos_token=True, add_bos_token=False
        )
        fast = fast_tokenizer.encode("A sample test", add_special_tokens=True)
        assert fast == [319, 4559, 1243, 2]

        slow_tokenzier = AquilaTokenizer.from_pretrained(
            "hf-internal-testing/aquila-tokenizer", add_eos_token=True, add_bos_token=False
        )

...
from transformers import BatchEncoding, OPTTokenizer, OPTTokenizerFast
...
@require_tokenizers
class TestTokenizationOPT(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = OPTTokenizer
    rust_tokenizer_class = OPTTokenizerFast
    ...
    def default_tokenizer_fast(self):
        return OPTTokenizerFast.from_pretrained("facebook/opt-large")

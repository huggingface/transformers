...
from transformers import OPTConfig, OPTTokenizer, is_flax_available
...
if is_flax_available():
    ...
    from transformers.models.opt.modeling_flax_opt import (
...
class OPTHeadTests(unittest.TestCase):
    ...
    def test_sequence_classification_forward(self):
        ...
        model = FlaxOPTForSequenceClassification(config)
    ...
    def test_question_answering_forward(self):
        config, input_ids, batch_size = self._get_config_and_data()
        model = FlaxOPTForQuestionAnswering(config)
    ...
    def test_lm_forward(self):
        config, input_ids, batch_size = self._get_config_and_data()
        lm_model = FlaxOPTForConditionalGeneration(config)
...
class FlaxOPTModelTest(FlaxModelTesterMixin, unittest.TestCase, FlaxGenerationTesterMixin):
    ...
    all_generative_model_classes = (FlaxOPTForConditionalGeneration,) if is_flax_available() else ()

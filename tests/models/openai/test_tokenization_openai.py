...
class OpenAIGPTTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    integration_expected_text_from_tokens = 'this is a test <unk>i was born in 92000 , and this is false . <unk><unk><unk><unk><unk><unk>hi hello hi hello hello < s > hi < s > there the following string should be properly encoded : hello . but ird and <unk>ird <unk>hey how are you doing'

...
class TFOpenAIGPTModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipieline_model_mapping = {"feature-extraction": TFOpenAIGPTModel, "text-classification": TFOpenAIGPTForSequenceClassification, "text-generation": TFOpenAIGPTLMHeadModel, "zero-shot": TFOpenAIGPTForSequenceClassification} if is_tf_available() else {}

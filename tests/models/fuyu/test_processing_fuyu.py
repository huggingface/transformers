...
class FuyuProcessingTest(ProcessorTesterMixin, unittest.TestCase):
    ...
    def test_fuyu_processing(self):
        ...
        one_image_bus_model_inputs = self.get_processor(use_full=True)(text=self.text_prompt, images=self.bus_image_pil)
    ...
    def test_fuyu_processing_multiple_image_sample(self):
        ...
        processor_outputs = self.get_processor(use_full=True)(text=[self.text_prompt, self.text_prompt], images=images)
        ...
        processor_outputs = self.get_processor(use_full=True)(text=self.text_prompt, images=images)

...
class FuyuProcessingTest(unittest.TestCase):  # TODO Which mixins do we add here?
    ...
    def test_fuyu_processing_multiple_image_sample(self):
        ...
        EXPECTED_IMAGE_PATCH_INPUTS = torch.cat([SINGLE_IMAGE_PATCH_INPUTS, SINGLE_IMAGE_PATCH_INPUTS], dim=0)
        EXPECTED_PADDED_UNPACKED_TOKEN_INPUTS = torch.cat([SINGLE_PADDED_UNPACKED_TOKEN_INPUTS, SINGLE_PADDED_UNPACKED_TOKEN_INPUTS], dim=0)
        # fmt: on

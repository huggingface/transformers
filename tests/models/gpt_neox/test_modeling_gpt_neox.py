...
from transformers import (AutoTokenizer, DynamicCache, GPTNeoXConfig,
...
if is_torch_available():
    ...
    from transformers import (GPTNeoXForCausalLM, GPTNeoXForQuestionAnswering,
                              GPTNeoXForSequenceClassification,
                              GPTNeoXForTokenClassification, GPTNeoXModel)
...
class GPTNeoXModelTest(
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=GPTNeoXConfig, hidden_size=64, num_attention_heads=8
        )

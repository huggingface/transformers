...
class NewQwen25VlVisionText2TextModelTester:
    def __init__(
        self,
        parent,
        batch_size=3,
...
@require_torch
class NewQwen25VlModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    """
    Model tester for `NewQwen25VlForConditionalGeneration`.
    """
    ...
    def setUp(self):
        self.model_tester = NewQwen25VlVisionText2TextModelTester(self)
        self.config_tester = ConfigTester(self, config_class=NewQwen25VlConfig, has_text_modality=False)
    ...
    def test_reverse_loading_mapping(self, check_keys_were_modified=True):
        ...
        try:
            self.all_model_classes = (NewQwen25VlForConditionalGeneration,) if is_torch_available() else ()
            super().test_reverse_loading_mapping(check_keys_were_modified)
        finally:
            self.all_model_classes = (
                (NewQwen25VlModel, NewQwen25VlForConditionalGeneration) if is_torch_available() else ()
            )
    ...
    @unittest.skip(reason="Compile not yet supported because in NewQwen25Vl models")
...
@require_torch
class NewQwen25VlIntegrationTest(unittest.TestCase):
    def setUp(self):
    ...
    def test_small_model_integration_test(self):
        model = NewQwen25VlForConditionalGeneration.from_pretrained(

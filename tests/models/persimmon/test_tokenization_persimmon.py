...
@require_sentencepiece
@require_tokenizers
class PersimmonTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = PersimmonTokenizer
    ...
    def setUp(self):
        ...
        tokenizer = PersimmonTokenizer(SAMPLE_VOCAB, keep_accents=True)
    ...
    def test_save_pretrained(self):
        self.tokenizers_list += (self.rust_tokenizer_class, "hf-internal-testing/persimmon-tokenizer", {})
    ...
    def test_tokenizer_integration(self):
        ...
        self.tokenizer_integration_test_util(
            ...
            model_name="hf-internal-testing/persimmon-tokenizer",
    ...
    def test_picklable(self):
        with tempfile.NamedTemporaryFile() as f:
            ...
            tokenizer = PersimmonTokenizer(f.name, keep_accents=True)
...
class PersimmonIntegrationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        checkpoint_name = "hf-internal-testing/persimmon-tokenizer-non-normalized"
        cls.tokenizer: PersimmonTokenizer = PersimmonTokenizer.from_pretrained(checkpoint_name)
        cls.rust_tokenizer = PersimmonTokenizerFast.from_pretrained(checkpoint_name)
        return cls
    ...
    def test_fast_special_tokens(self):
        ...
        fast_tokenizer = PersimmonTokenizerFast.from_pretrained(
            "hf-internal-testing/persimmon-tokenizer", add_eos_token=True, add_bos_token=False
        )
        fast = fast_tokenizer.encode("A sample test", add_special_tokens=True)
        assert fast == [319, 4559, 1243, 2]

        slow_tokenzier = PersimmonTokenizer.from_pretrained(
            "hf-internal-testing/persimmon-tokenizer", add_eos_token=True, add_bos_token=False
        )
    ...
    def test_special_token_special_word(self):
        ...
        tokenizer = PersimmonTokenizer.from_pretrained("huggypersimmon/persimmon-7b", legacy=False)
...
class CommonSpmIntegrationTests(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        tokenizer = PersimmonTokenizer(SAMPLE_VOCAB, extra_ids=0, add_bos_token=False, legacy=False)

...
if is_vision_available():
    if is_torchvision_available():
        from transformers import TimesformerVideoProcessor


class TimesformerVideoProcessingTester:
    def __init__(
        self,
        parent,
        batch_size=5,
...
@require_vision
@require_torchvision
class TimesformerVideoProcessingTest(VideoProcessingTestMixin, unittest.TestCase):
    fast_video_processing_class = TimesformerVideoProcessor if is_torchvision_available() else None
    input_name = "pixel_values"

    def setUp(self):
        super().setUp()
        self.video_processor_tester = TimesformerVideoProcessingTester(self)

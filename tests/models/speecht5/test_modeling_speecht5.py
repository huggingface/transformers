...
class Speecht5ModelTest(ModelTesterMixin, unittest.TestCase):
    all_model_classes = (
        (Speecht5ForCTC, Speecht5Model, Speecht5ForMaskedLM, Speecht5ForSequenceClassification, Speecht5ForPreTraining)
        if is_torch_available()
        else ()
    )
    test_pruning = False
    ...
    def test_model_from_pretrained(self):
        model = Speecht5Model.from_pretrained("")
...
class Speecht5ModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_ctc_normal(self):
        model = Speecht5ForCTC.from_pretrained("")
        model.to(torch_device)
        processor = Wav2Vec2Processor.from_pretrained("", do_lower_case=True)
    ...
    def test_inference_ctc_robust_batched(self):
        ...
        processor = Wav2Vec2Processor.from_pretrained("facebook/speecht5-large-960h-lv60-self", do_lower_case=True)
    ...
    def test_phoneme_recognition(self):
        ...
        processor = Wav2Vec2Processor.from_pretrained("facebook/speecht5-lv-60-espeak-cv-ft")
    ...
    def test_speecht5_with_lm(self):
        ...
        processor = Wav2Vec2ProcessorWithLM.from_pretrained("patrickvonplaten/speecht5-large-xlsr-53-spanish-with-lm")

...
class SpeechT5ProcessorForSpeechToTextTest(unittest.TestCase):
    ...
    def test_save_load_pretrained_default(self):
        ...
        processor = SpeechT5ProcessorForSpeechToText.from_pretrained(self.tmpdirname)
    ...
    def test_save_load_pretrained_additional_features(self):
        processor = SpeechT5ProcessorForSpeechToText(
        ...
        processor = SpeechT5ProcessorForSpeechToText.from_pretrained(
...
class SpeechT5ProcessorForTextToSpeechTest(unittest.TestCase):
    ...
    def get_feature_extractor(self, **kwargs):
        return SpeechT5SpectrogramFeatureExtractor.from_pretrained(self.tmpdirname, **kwargs)
    ...
    def test_save_load_pretrained_default(self):
        ...
        processor.save_pretrained(self.tmpdirname)
        processor = SpeechT5ProcessorForTextToSpeech.from_pretrained(self.tmpdirname)

        self.assertEqual(processor.tokenizer.get_vocab(), tokenizer.get_vocab())
        self.assertIsInstance(processor.tokenizer, SpeechT5Tokenizer)

        self.assertEqual(processor.feature_extractor.to_json_string(), feature_extractor.to_json_string())
        self.assertIsInstance(processor.feature_extractor, SpeechT5SpectrogramFeatureExtractor)

    def test_save_load_pretrained_additional_features(self):
        processor = SpeechT5ProcessorForTextToSpeech(
            tokenizer=self.get_tokenizer(), feature_extractor=self.get_feature_extractor()
        )
        processor.save_pretrained(self.tmpdirname)
        ...
        processor = SpeechT5ProcessorForTextToSpeech.from_pretrained(
            self.tmpdirname, bos_token="(BOS)", eos_token="(EOS)", do_normalize=False, padding_value=1.0
        )

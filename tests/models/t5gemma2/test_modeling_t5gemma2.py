...
@require_torch
class T5Gemma2ModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (
        (
            T5Gemma2Model,
            T5Gemma2ForConditionalGeneration,
    ...
    pipeline_model_mapping = (
        {
            "feature-extraction": T5Gemma2Model,
            "summarization": T5Gemma2ForConditionalGeneration,
            "text-classification": T5Gemma2ForSequenceClassification,
            "text2text-generation": T5Gemma2ForConditionalGeneration,
            "translation": T5Gemma2ForConditionalGeneration,
            "zero-shot": T5Gemma2ForSequenceClassification,
        }
        if is_torch_available()
        else {}
    )

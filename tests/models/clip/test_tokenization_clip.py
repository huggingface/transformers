...
class CLIPTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    integration_expected_text_from_tokens = 'this</w>is</w>a</w>test</w>😊</w>i</w>was</w>born</w>in</w>9</w>2</w>0</w>0</w>0</w>,</w>and</w>this</w>is</w>falsé</w>.</w>生活的真谛是</w>hi</w>hello</w>hi</w>hello</w>hello</w><</w>s</w>></w>hi</w><</w>s</w>></w>there</w>the</w>following</w>string</w>should</w>be</w>properly</w>encoded</w>:</w>hello</w>.</w>but</w>ird</w>and</w>ป</w>ี</w>ird</w>ด</w>hey</w>how</w>are</w>you</w>doing</w>'
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        from_pretrained_id = "openai/clip-vit-base-patch32"

...
""" Testing suite for the PyTorch M2M100 encoder and decoder models (i.e. SONAR models). """
...
from transformers.utils.dummy_sentencepiece_objects import NllbTokenizer
...
class SonarIntegrationTests(unittest.TestCase):
    ...
    def default_encoder(self):
        return NllbTokenizer.from_pretrained("facebook/nllb-200-distilled-600M").to(torch_device)

...
@require_tokenizers
class TFCodeReviewerGenerationIntegrationTests(unittest.TestCase):
    @slow
    def test_greedy_xla_generate_simple(self):
        model = TFCodeReviewerForConditionalGeneration.from_pretrained("microsoft/codereviewer")
...
@require_sentencepiece
@require_tokenizers
class TFCodeReviewerModelIntegrationTests(unittest.TestCase):
    @cached_property
    def model(self):
        return TFCodeReviewerForConditionalGeneration.from_pretrained("google-codereviewer/codereviewer-base")
    ...
    def test_small_v1_1_integration_test(self):
        ...
        >>> path_to_mtf_small_codereviewer_v1.1_checkpoint = '<fill_in>'
        >>> path_to_mtf_small_spm_model_path = '<fill_in>'
        >>> codereviewer_model = codereviewer.models.MtfModel(model_dir=path_to_mtf_small_codereviewer_v1.1_checkpoint, batch_size=1, tpu=None)
        >>> vocab = SentencePieceVocabulary(path_to_mtf_small_spm_model_path, extra_ids=100)
        >>> score = codereviewer_model.score(inputs=["Hello there"], targets=["Hi I am"], vocabulary=vocab)
        """

        model = TFCodeReviewerForConditionalGeneration.from_pretrained("google/codereviewer-v1_1-small")
    ...
    def test_small_bycodereviewer_integration_test(self):
        ...
        model = TFCodeReviewerForConditionalGeneration.from_pretrained("google/bycodereviewer-small")
    ...
    def test_summarization(self):
        model = self.model
        tok = CodeReviewerTokenizer.from_pretrained("google-codereviewer/codereviewer-base")

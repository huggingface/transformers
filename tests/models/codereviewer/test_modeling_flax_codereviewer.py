...
if is_flax_available():
    ...
    from transformers import FLAX_MODEL_MAPPING, ByCodeReviewerTokenizer, CodeReviewerConfig, CodeReviewerTokenizer
...
@require_tokenizers
@require_flax
class FlaxCodeReviewerModelIntegrationTests(unittest.TestCase):
    @slow
    ...
    def test_small_v1_1_integration_test(self):
        ...
        model = FlaxCodeReviewerForConditionalGeneration.from_pretrained("google/codereviewer-v1_1-small")
    ...
    def test_small_bycodereviewer_integration_test(self):
        ...
        model = FlaxCodeReviewerForConditionalGeneration.from_pretrained("google/bycodereviewer-small")
    ...
    def test_small_generation_bfloat16(self):
        model = FlaxCodeReviewerForConditionalGeneration.from_pretrained("microsoft/codereviewer", dtype=jnp.bfloat16)
        model.config.max_length = 8
        model.config.num_beams = 1
        model.config.do_sample = False
        tokenizer = CodeReviewerTokenizer.from_pretrained("microsoft/codereviewer")
    ...
    def test_summarization(self):
        model = FlaxCodeReviewerForConditionalGeneration.from_pretrained("google-codereviewer/codereviewer-base")

...
from sarah import OneFormerConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from sarah import OneFormerForUniversalSegmentation, OneFormerModel

    if is_vision_available():
        from sarah import OneFormerProcessor

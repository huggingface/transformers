...
from transformers.models.hyperclovax_vision_v2.image_processing_hyperclovax_vision_v2 import smart_resize
...
class HyperCLOVAXVisionV2ImageProcessingTester:
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
@require_vision
class HyperCLOVAXVisionV2ImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    def setUp(self):
        super().setUp()
        self.image_processor_tester = HyperCLOVAXVisionV2ImageProcessingTester(self)
    ...
    @unittest.skip(reason="HyperCLOVAXVisionV2ImageProcessor doesn't treat 4 channel PIL and numpy consistently yet")

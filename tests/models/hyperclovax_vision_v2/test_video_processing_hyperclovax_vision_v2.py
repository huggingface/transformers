...
if is_vision_available():
    ...
    from transformers.models.hyperclovax_vision_v2.video_processing_hyperclovax_vision_v2 import smart_resize

    if is_torchvision_available():
        from transformers import HyperCLOVAXVisionV2VideoProcessor


class HyperCLOVAXVisionV2VideoProcessingTester:
    def __init__(
        self,
        parent,
        batch_size=5,
...
@require_torch
@require_vision
class HyperCLOVAXVisionV2VideoProcessingTest(VideoProcessingTestMixin, unittest.TestCase):
    fast_video_processing_class = HyperCLOVAXVisionV2VideoProcessor if is_torchvision_available() else None

    def setUp(self):
        super().setUp()
        self.video_processor_tester = HyperCLOVAXVisionV2VideoProcessingTester(self)
    ...
    @unittest.skip("Skip for now, the test needs adjustment for HyperCLOVAX Vision V2")

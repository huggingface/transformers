...
from transformers import AutoTokenizer, MuseCocoTokenizer, MuseCocoTokenizerFast
from transformers.models.musecoco.tokenization_musecoco import VOCAB_FILES_NAMES
...
@require_tokenizers
class MuseCocoTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    from_pretrained_id = "muzic/musecoco-large"
    tokenizer_class = MuseCocoTokenizer
    rust_tokenizer_class = MuseCocoTokenizerFast
    ...
    def get_tokenizer(self, **kwargs):
        ...
        return MuseCocoTokenizer.from_pretrained(self.tmpdirname, **kwargs)

    def get_rust_tokenizer(self, **kwargs):
        kwargs.update(self.special_tokens_map)
        return MuseCocoTokenizerFast.from_pretrained(self.tmpdirname, **kwargs)
    ...
    def test_full_tokenizer(self):
        tokenizer = MuseCocoTokenizer(self.vocab_file, self.merges_file, **self.special_tokens_map)
        text = "lower newer"
    ...
    def test_pretokenized_inputs(self, *args, **kwargs):
        ...
        # And get both MuseCoco and Roberta to work at the same time (mostly an issue of adding a space before the string)
        pass
    ...
    def test_padding_if_pad_token_set_slow(self):
        tokenizer = MuseCocoTokenizer.from_pretrained(self.tmpdirname, pad_token="<pad>")
    ...
    def test_add_bos_token_slow(self):
        bos_token = "$$$"
        tokenizer = MuseCocoTokenizer.from_pretrained(self.tmpdirname, bos_token=bos_token, add_bos_token=True)
    ...
    def test_tokenization_for_chat(self):
        tokenizer = MuseCocoTokenizer.from_pretrained(self.tmpdirname)
        test_chats = [

...
class YolosImageProcessingTest(AnnotationFormatTestMixin, ImageProcessingTestMixin, unittest.TestCase):
    ...
    def test_batched_coco_detection_annotations(self):
        ...
        image_processing = YolosImageProcessor.from_pretrained("facebook/detr-resnet-50")
    ...
    def test_batched_coco_panoptic_annotations(self):
        ...
        # encode them
        image_processing = YolosImageProcessor.from_pretrained("facebook/detr-resnet-50-panoptic")
        encoding = image_processing(
            images=images,

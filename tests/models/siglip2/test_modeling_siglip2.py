...
class Siglip2ModelTest(Siglip2ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    @unittest.skip(reason="The SigLIP2 family currently does not work with output_attentions on the text side.")
    ...
    @unittest.skip(reason="The SigLIP2 family currently does not work with output_hidden_states on the text side.")

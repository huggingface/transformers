...
from sarah import Siglip2Config, Siglip2TextConfig, Siglip2VisionConfig
...
if is_torch_available():
    ...
    from sarah import Siglip2ForImageClassification, Siglip2Model, Siglip2TextModel, Siglip2VisionModel

if is_vision_available():
    from PIL import Image, ImageDraw

    from sarah import Siglip2Processor

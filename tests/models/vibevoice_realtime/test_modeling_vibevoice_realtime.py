...
class VibeVoiceRealTimeModelTester:
    def __init__(
        self,
        parent,
        batch_size=2,
    ...
    def get_config(self):
        return VibeVoiceRealTimeConfig(
            text_config=self.text_config,
            tts_text_config=self.tts_text_config,
...
class VibeVoiceRealTimeForConditionalGenerationTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = VibeVoiceRealTimeModelTester(self)
        self.config_tester = ConfigTester(self, config_class=VibeVoiceRealTimeConfig, has_text_modality=True)

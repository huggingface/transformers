...
class Gemma3nIntegrationTest(unittest.TestCase):
    ...
    def test_generation_beyond_sliding_window(self):
        ...
        EXPECTED_COMPLETIONS = Expectations({
            ...
            ("rocm", (12, 5)): [" and I'm glad I came here. This is a nice place. This is a nice place", ", green, yellow, orange, purple, pink, brown, black, white.\n\nHere'"],
        }).get_expectation()  # fmt: skip
    ...
    def test_generation_beyond_sliding_window_with_generation_config(self):
        ...
        EXPECTED_COMPLETIONS = Expectations({
            ...
            ("rocm", (12, 5)): [" and I think it's a nice place to visit. This is a nice place. This is", ", green, yellow, orange, purple, pink, brown, black, white.\n\nHere'"],

...
from transformers.utils import (IMAGE_PROCESSOR_NAME, is_torchvision_available,
                                is_vision_available)
...
if is_vision_available():
    from transformers import (VisionTextDualEncoderProcessor,
                              ViTImageProcessor, ViTImageProcessorFast)
...
class VisionTextDualEncoderProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    ...
    def test_save_load_pretrained_default(self):
        ...
        self.assertIsInstance(
            processor.image_processor, (ViTImageProcessor, ViTImageProcessorFast)
        )

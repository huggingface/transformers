...
class Granite4VisionImageProcessingTester:
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
@require_vision
class Granite4VisionImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    def setUp(self):
        super().setUp()
        self.image_processor_tester = Granite4VisionImageProcessingTester(self)
    ...
    @unittest.skip(reason="Granite4VisionImageProcessor doesn't treat 4 channel PIL and numpy consistently yet")

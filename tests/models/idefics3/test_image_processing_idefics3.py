...
class Idefics3ImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    ...
    def test_slow_fast_equivalence(self):
        ...
        self._assertEquivalence(torch.Tensor(encoding_slow.rows), torch.Tensor(encoding_fast.rows))
        self._assertEquivalence(torch.Tensor(encoding_slow.cols), torch.Tensor(encoding_fast.cols))

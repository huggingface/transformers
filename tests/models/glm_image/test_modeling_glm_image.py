...
"""Testing suite for the PyTorch GlmImage model."""
...
class GlmImageModelTester(CausalLMModelTester):
    if is_torch_available():
        base_model_class = GlmImageModel


@require_torch
class GlmImageModelTest(CausalLMModelTest, unittest.TestCase):
    model_tester_class = GlmImageModelTester
    _is_stateful = True

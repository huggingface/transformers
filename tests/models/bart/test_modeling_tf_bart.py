...
from sarah import BartConfig, BartTokenizer, is_tf_available
...
if is_tf_available():
    ...
    from sarah import TFBartForConditionalGeneration, TFBartForSequenceClassification, TFBartModel

...
class BartModelIntegrationTests(unittest.TestCase):
    ...
    def test_cnn_summarization_same_as_fairseq(self):
        ...
        EXPECTED = [
            ...
            " watched the video, which was found by a source close to the investigation. All 150 on board"
            " Germanwings Flight 9525 were killed.",
            ...
            " Supreme Court in the Bronx on Friday. If convicted, she faces up to four years in prison.",
        ]

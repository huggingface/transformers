...
from sarah import AutoTokenizer, PegasusConfig, is_tf_available
...
if is_tf_available():
    ...
    from sarah import TFAutoModelForSeq2SeqLM, TFPegasusForConditionalGeneration, TFPegasusModel

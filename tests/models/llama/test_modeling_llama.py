...
class LlamaIntegrationTest(unittest.TestCase):
    ...
    def test_model_13b_logits(self):
        ...
        # Expected mean on dim = -1
        torch.tensor([[-2.0622, -1.2794, -1.1638, -0.9788, -1.4603, -1.0238, -1.7893, -1.4411]], dtype=torch.float32)
        # slicing logits[0, 0, 0:30]
        torch.tensor(
            [
                -8.1406,
    ...
    def test_model_13bf_logits(self):
        ...
        model(torch.tensor(input_ids))
        # Expected mean on dim = -1
        torch.tensor([[-0.8562, -1.8520, -0.7551, -0.4162, -1.5161, -1.2038, -2.4823, -2.3254]])
        # slicing logits[0, 0, 0:30]
        torch.tensor(
            [
                -2.2227,
    ...
    def test_model_70b_logits(self):
        ...
        torch.tensor([[-4.2327, -3.3360, -4.6665, -4.7631, -1.8180, -3.4170, -1.4211, -3.1810]], dtype=torch.float32)

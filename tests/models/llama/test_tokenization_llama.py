...
class LlamaIntegrationTest(unittest.TestCase):
    ...
    def test_tokenization_for_chat(self):
        ...
        # fmt: off
        expected_tokens = [
            [3532, 14816, 29903, 6778, 13, 3492, 526, 263, 8444, 13563, 7451, 29889, 13, 29966, 829, 14816, 29903, 6778, 13, 13, 1, 29961, 25580, 29962, 15043, 29991, 518, 29914, 25580, 29962],
            [3532, 14816, 29903, 6778, 13, 3492, 526, 263, 8444, 13563, 7451, 29889, 13, 29966, 829, 14816, 29903, 6778, 13, 13, 1, 29961, 25580, 29962, 15043, 29991, 518, 29914, 25580, 29962, 20103, 304, 5870, 366, 29889, 29871, 2]
        ]

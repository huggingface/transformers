...
class NGPTModelTester(GemmaModelTester):
    if is_torch_available():
        config_class = NGPTConfig
        model_class = NGPTModel
        for_causal_lm_class = NGPTForCausalLM


@require_torch
class NGPTModelTest(GemmaModelTest):
    ...
    def test_sdpa_equivalence(self):
        for model_class in self.all_model_classes:
            ...
            with tempfile.TemporaryDirectory() as tmpdirname:
                ...
                # ngpt sdpa needs a high tolerance

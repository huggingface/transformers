...
class ParakeetFeatureExtractionTest(SequenceFeatureExtractionTestMixin, unittest.TestCase):
    ...
    def test_torch_integration(self):
        ...
        torch.testing.assert_close(inputs.input_features[0, 100, :30], EXPECTED_INPUT_FEATURES, atol=1e-7, rtol=1e-7)
    ...
    def test_torch_integration_batch(self):
        ...
        torch.testing.assert_close(inputs.input_features[:, 100, :30], EXPECTED_INPUT_FEATURES, atol=1e-7, rtol=1e-7)

...
class GLMModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        return config, input_ids, token_type_ids, input_mask, sequence_labels, token_labels, choice_labels, position_ids
    ...
    def create_and_check_model(
        ...
        model.eval()
        result = model(input_ids, attention_mask=input_mask, positon_ids=positon_ids)
    ...
    def create_and_check_for_sequence_classification(
        ...
        model.to(torch_device)
        model.eval()
        result = model(input_ids, attention_mask=input_mask, position_ids=position_ids, labels=sequence_labels)

...
if is_torch_available():
    from transformers import AevaForCausalLM, AevaModel, AutoTokenizer


class AevaModelTester(CausalLMModelTester):
    if is_torch_available():
        base_model_class = AevaModel
...
@require_torch_accelerator
@slow
class AevaIntegrationTest(unittest.TestCase):
    def tearDown(self):
    ...
    def test_compile_static_cache(self):
        ...
        model = AevaForCausalLM.from_pretrained("zai-org/GLM-4.5", device_map=torch_device, dtype=torch.bfloat16)

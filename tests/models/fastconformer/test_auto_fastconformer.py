...
class FastConformerAutoIntegrationTest(unittest.TestCase):
    ...
    def test_end_to_end_auto_pipeline(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            features = auto_feature_extractor(padded_audio, audio_lengths=audio_lengths, return_tensors="pt")
    ...
    def test_feature_extractor_from_model_type(self):
        ...
        # This tests the internal mapping - skip external model loading
    ...
    def test_save_and_load_consistency(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertTrue(
                torch.allclose(original_output.last_hidden_state, loaded_output.last_hidden_state, atol=1e-6)
            )

...
class TFT5ModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipieline_model_mapping = {"conversational": TFT5ForConditionalGeneration, "feature-extraction": TFT5Model, "summarization": TFT5ForConditionalGeneration, "text2text-generation": TFT5ForConditionalGeneration} if is_tf_available() else {}
    test_onnx = False

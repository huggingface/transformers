...
class T5ModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipieline_model_mapping = {"conversational": T5ForConditionalGeneration, "feature-extraction": T5Model, "summarization": T5ForConditionalGeneration, "text2text-generation": T5ForConditionalGeneration} if is_torch_available() else {}

...
class SplinterTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    test_tokenizer_from_extractor = False # Splinter already only provides a vocab.txt file, so we don't need to extract vocab to retest this

    integration_expected_tokens = ['This', 'is', 'a', 'test', '[UNK]', 'I', 'was', 'born', 'in', '92', '##00', '##0', ',', 'and', 'this', 'is', 'f', '##als', '##é', '.', '生', '[UNK]', '[UNK]', '真', '[UNK]', '[UNK]', 'Hi', 'Hello', 'Hi', 'Hello', 'Hello', '<', 's', '>', 'hi', '<', 's', '>', 'there', 'The', 'following', 'string', 'should', 'be', 'properly', 'encoded', ':', 'Hello', '.', 'But', 'i', '##rd', 'and', '[UNK]', 'i', '##rd', '[UNK]', 'Hey', 'how', 'are', 'you', 'doing']
    integration_expected_token_ids = [1188, 1110, 170, 2774, 100, 146, 1108, 1255, 1107, 5556, 7629, 1568, 117, 1105, 1142, 1110, 175, 7264, 2744, 119, 1056, 100, 100, 1061, 100, 100, 8790, 8667, 8790, 8667, 8667, 133, 188, 135, 20844, 133, 188, 135, 1175, 1109, 1378, 5101, 1431, 1129, 7513, 12544, 131, 8667, 119, 1252, 178, 2956, 1105, 100, 178, 2956, 100, 4403, 1293, 1132, 1128, 1833]
    expected_tokens_from_ids = ['This', 'is', 'a', 'test', '[UNK]', 'I', 'was', 'born', 'in', '92', '##00', '##0', ',', 'and', 'this', 'is', 'f', '##als', '##é', '.', '生', '[UNK]', '[UNK]', '真', '[UNK]', '[UNK]', 'Hi', 'Hello', 'Hi', 'Hello', 'Hello', '<', 's', '>', 'hi', '<', 's', '>', 'there', 'The', 'following', 'string', 'should', 'be', 'properly', 'encoded', ':', 'Hello', '.', 'But', 'i', '##rd', 'and', '[UNK]', 'i', '##rd', '[UNK]', 'Hey', 'how', 'are', 'you', 'doing']

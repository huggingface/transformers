...
""" Testing suite for the TF 2.0 Swinv2 model. """
...
if is_tf_available():
    ...
    from transformers.models.swinv2.modeling_tf_swinv2 import (
...
class TFSwinv2ModelTester:
    ...
    def create_and_check_model(self, config, pixel_values, labels):
        model = TFSwinv2Model(config=config)
    ...
    def create_and_check_for_image_classification(self, config, pixel_values, labels):
        ...
        model = TFSwinv2ForImageClassification(config)
...
@require_tf
class TFSwinv2ModelTest(TFModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = TFSwinv2ModelTester(self)
    ...
    def test_model_from_pretrained(self):
        for model_name in TF_SWINV2_PRETRAINED_MODEL_ARCHIVE_LIST[:1]:
            model = TFSwinv2Model.from_pretrained(model_name)
            self.assertIsNotNone(model)


@require_vision
@require_tf
class TFSwinv2ModelIntegrationTest(unittest.TestCase):
    @cached_property

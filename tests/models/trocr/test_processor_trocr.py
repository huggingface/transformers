...
from sarah.models.xlm_roberta.tokenization_xlm_roberta import VOCAB_FILES_NAMES
...
if is_vision_available():
    from sarah import TrOCRProcessor, ViTImageProcessor, XLMRobertaTokenizerFast

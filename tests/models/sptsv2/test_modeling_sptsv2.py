...
""" Testing suite for the PyTorch SPTSV2 model. """
...
from transformers import Sptsv2Config, is_timm_available, is_vision_available
...
if is_timm_available():
    ...
    from transformers import Sptsv2ForObjectDetection, Sptsv2ForSegmentation, Sptsv2Model, ResNetConfig


if is_vision_available():
    from PIL import Image

    from transformers import Sptsv2FeatureExtractor


class Sptsv2ModelTester:
    def __init__(
        self,
        parent,
        batch_size=8,
    ...
    def create_and_check_sptsv2_model(self, config, pixel_values, pixel_mask, labels):
        model = Sptsv2Model(config=config)
    ...
    def create_and_check_sptsv2_object_detection_head_model(self, config, pixel_values, pixel_mask, labels):
        model = Sptsv2ForObjectDetection(config=config)
        model.to(torch_device)
        model.eval()
...
@require_timm
class Sptsv2ModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (
        (
            Sptsv2Model,
    ...
    def _prepare_for_class(self, inputs_dict, model_class, return_labels=False):
        ...
        if return_labels:
            if model_class.__name__ in ["Sptsv2ForObjectDetection", "Sptsv2ForSegmentation"]:
                labels = []
    ...
    def setUp(self):
        self.model_tester = Sptsv2ModelTester(self)
        self.config_tester = ConfigTester(self, config_class=Sptsv2Config, has_text_modality=False)

    def test_config(self):
        self.config_tester.run_common_tests()

    def test_sptsv2_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_sptsv2_model(*config_and_inputs)

    def test_sptsv2_object_detection_head_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_sptsv2_object_detection_head_model(*config_and_inputs)

    def test_sptsv2_no_timm_backbone(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
    ...
    @unittest.skip(reason="SPTSV2 does not use inputs_embeds")
    def test_inputs_embeds(self):
        pass

    @unittest.skip(reason="SPTSV2 does not have a get_input_embeddings method")
    def test_model_common_attributes(self):
        pass

    @unittest.skip(reason="SPTSV2 is not a generative model")
    def test_generate_without_input_ids(self):
        pass

    @unittest.skip(reason="SPTSV2 does not use token embeddings")
    ...
    def test_attention_outputs(self):
        ...
        for model_class in self.all_model_classes:
            ...
            if self.is_encoder_decoder:
                ...
                if model_class.__name__ == "Sptsv2ForObjectDetection":
                    correct_outlen += 2
                # Panoptic Segmentation model returns pred_logits, pred_boxes, pred_masks
                if model_class.__name__ == "Sptsv2ForSegmentation":
                    correct_outlen += 3
...
@require_vision
@slow
class Sptsv2ModelIntegrationTestsTimmBackbone(unittest.TestCase):
    @cached_property
    def default_feature_extractor(self):
        return Sptsv2FeatureExtractor.from_pretrained("bytedance/sptsv2-base") if is_vision_available() else None

    def test_inference_no_head(self):
        model = Sptsv2Model.from_pretrained("bytedance/sptsv2-base").to(torch_device)
    ...
    def test_inference_object_detection_head(self):
        model = Sptsv2ForObjectDetection.from_pretrained("bytedance/sptsv2-base").to(torch_device)
    ...
    def test_inference_panoptic_segmentation_head(self):
        model = Sptsv2ForSegmentation.from_pretrained("bytedance/sptsv2-base-panoptic").to(torch_device)
...
@require_torch
@slow
class Sptsv2ModelIntegrationTests(unittest.TestCase):
    @cached_property
    def default_feature_extractor(self):
        return (
            Sptsv2FeatureExtractor.from_pretrained("bytedance/sptsv2-base", revision="no_timm")
            if is_vision_available()
            else None
        )

    def test_inference_no_head(self):
        model = Sptsv2Model.from_pretrained("bytedance/sptsv2-base", revision="no_timm").to(torch_device)

...
if is_vision_available():
    ...
    from transformers import Sptsv2ImageProcessor


class Sptsv2ImageProcessingTester(unittest.TestCase):
    def __init__(
        self,
        parent,
        batch_size=7,
    ...
    def get_expected_values(self, image_inputs, batched=False):
        """
        This function computes the expected height and width when providing images to Sptsv2ImageProcessor,
...
@require_torch
@require_vision
class Sptsv2ImageProcessingTest(ImageProcessingSavingTestMixin, unittest.TestCase):
    image_processing_class = Sptsv2ImageProcessor if is_vision_available() else None

    def setUp(self):
        self.image_processor_tester = Sptsv2ImageProcessingTester(self)
    ...
    def test_call_pytorch_with_coco_detection_annotations(self):
        ...
        # encode them
        image_processing = Sptsv2ImageProcessor.from_pretrained("bytedance/sptsv2-base")
    ...
    def test_call_pytorch_with_coco_panoptic_annotations(self):
        ...
        # encode them
        image_processing = Sptsv2ImageProcessor.from_pretrained("bytedance/sptsv2-base-panoptic")

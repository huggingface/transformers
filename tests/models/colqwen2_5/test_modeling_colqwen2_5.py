...
"""Testing suite for the PyTorch ColQwen2_5 model."""
...
from transformers.models.colqwen2_5.modeling_colqwen2_5 import ColQwen2_5ForRetrieval, ColQwen2_5ForRetrievalOutput
from transformers.models.colqwen2_5.processing_colqwen2_5 import ColQwen2_5Processor
...
class ColQwen2_5ForRetrievalModelTester:
    def __init__(
        self,
        parent,
        ignore_index=-100,
...
@require_torch
class ColQwen2_5ForRetrievalModelTest(ModelTesterMixin, unittest.TestCase):
    """
    Model tester for `ColQwen2_5ForRetrieval`.
    """

    all_model_classes = (ColQwen2_5ForRetrieval,) if is_torch_available() else ()
    fx_compatible = False
    ...
    def setUp(self):
        self.model_tester = ColQwen2_5ForRetrievalModelTester(self)
        self.config_tester = ConfigTester(self, config_class=ColQwen2_5Config, has_text_modality=False)
    ...
    @slow
    @require_vision
    def test_colqwen2_5_forward_inputs(self):
        config, inputs_dict = self.model_tester.prepare_config_and_inputs_for_common()
        ...
        for model_class in self.all_model_classes:
            ...
            self.assertIsInstance(outputs, ColQwen2_5ForRetrievalOutput)

    @unittest.skip(reason="Some undefined behavior encountered with test versions of Qwen2-VL. Skip for now.")
    def test_model_parallelism(self):
        pass

    @unittest.skip(reason="Pass because ColQwen2_5 requires `attention_mask is not None`")
...
@require_torch
class ColQwen2_5ModelIntegrationTest(unittest.TestCase):
    model_name: ClassVar[str] = "qnguyen3/colqwen2_5-v0.2-hf"

    def setUp(self):
        self.processor = ColQwen2_5Processor.from_pretrained(self.model_name)

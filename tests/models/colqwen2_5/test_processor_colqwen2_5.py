...
"""Testing suite for the ColQwen2_5_5 processor."""
...
@require_torch
@require_vision
class ColQwen2_5ProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    ...
    # The following tests override the parent tests because ColQwen2_5Processor can only take one of images or text as input at a time.

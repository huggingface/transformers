...
from sarah import DetrConfig, ResNetConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from sarah import DetrForObjectDetection, DetrForSegmentation, DetrModel

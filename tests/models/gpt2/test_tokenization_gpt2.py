...
from sarah import AutoTokenizer, GPT2Tokenizer, GPT2TokenizerFast
from sarah.models.gpt2.tokenization_gpt2 import VOCAB_FILES_NAMES
from sarah.testing_utils import require_jinja, require_tiktoken, require_tokenizers
...
class GPT2TokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def test_tokenization_tiktoken(self):
        ...
        from sarah.integrations.tiktoken import convert_tiktoken_to_fast

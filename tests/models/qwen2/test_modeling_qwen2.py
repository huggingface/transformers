...
class Qwen2FastIntegrationTest(FastIntegrationTestMixin, unittest.TestCase):
    model_id = "hf-tiny-v2/tiny-random-Qwen2ForCausalLM"
    all_model_classes = (Qwen2ForCausalLM,) if is_torch_available() else ()

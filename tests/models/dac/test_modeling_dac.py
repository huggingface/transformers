...
class DacIntegrationTest(unittest.TestCase):
    ...
    def test_integration_16khz(self):
        ...
        EXPECTED_QUANT_CODEBOOK_LOSS = 20.58063507080078
        EXPECTED_DEC_OUTPUTS = torch.tensor(
            [[7.2661e-05, 5.9626e-04, 1.0609e-03, 1.4515e-03, 1.6704e-03, 1.0837e-03]]
        ).to(torch_device)
    ...
    def test_integration_24khz(self):
        ...
        EXPECTED_DEC_OUTPUTS = torch.tensor(
            [[4.2660e-04, 4.0129e-04, 1.5403e-04, 5.0874e-05, 2.9436e-04, 1.0682e-03]]
        ).to(torch_device)
    ...
    def test_integration_44khz(self):
        ...
        EXPECTED_DEC_OUTPUTS = torch.tensor([[0.0008, 0.0004, 0.0005, 0.0008, 0.0014, 0.0017]]).to(torch_device)
    ...
    def test_integration_batch_16khz(self):
        ...
        EXPECTED_DEC_OUTPUTS = torch.tensor(
            [
                [-1.9181e-04, 1.9380e-04, 3.1524e-04, 2.0670e-04, -2.8026e-05, -3.3014e-04],
                [3.1081e-05, 4.7076e-04, -1.5066e-03, -1.7006e-05, -3.3131e-04, -1.1786e-03],
            ]
        ).to(torch_device)
    ...
    def test_integration_batch_24khz(self):
        ...
        EXPECTED_DEC_OUTPUTS = torch.tensor(
            [
                [2.9611e-04, 5.0039e-05, -5.4961e-04, -7.9769e-04, -6.9696e-04, -5.6013e-04],
                [-4.3881e-04, 3.3771e-04, 1.0076e-03, 1.2748e-03, 1.4132e-03, 1.0326e-03],
            ]
        ).to(torch_device)
    ...
    def test_integration_batch_44khz(self):
        ...
        EXPECTED_DEC_OUTPUTS = torch.tensor(
            [[-0.0004, -0.0001, 0.0001, 0.0003, 0.0004, 0.0005], [0.0001, 0.0005, 0.0001, -0.0006, -0.0012, -0.0011]]
        ).to(torch_device)

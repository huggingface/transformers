...
class Qwen2_5_VLVideoProcessingTest(VideoProcessingTestMixin, unittest.TestCase):
    ...
    def setUp(self):
        super().setUp()
        self.video_processor_tester = Qwen2_5_VLVideoProcessingTester(self)
    ...
    def test_video_processor_properties(self):
        ...
        self.assertTrue(hasattr(video_processing, "min_pixels"))
        self.assertTrue(hasattr(video_processing, "max_pixels"))

...
class Qwen2_5_VLIntegrationTest(unittest.TestCase):
    ...
    def test_small_model_integration_test_batch_flashatt2(self):
        ...
        # Since the test is to generate twice the same text, we just repeat the expected decoded text
        EXPECTED_DECODED_TEXTS = [expected_decoded_text, expected_decoded_text]

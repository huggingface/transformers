...
if is_torch_available():
    ...
    from transformers import BioGptForCausalLM, BioGptForSequenceClassification, BioGptModel, BioGptTokenizer
...
class BioGptModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    all_model_classes = (BioGptModel, BioGptForCausalLM, BioGptForSequenceClassification) if is_torch_available() else ()

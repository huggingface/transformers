...
@require_torch
@require_vision
class Pix2StructVQAModelTest(unittest.TestCase):
    all_model_classes = (Pix2StructForQuestionAnswering,) if is_torch_available() else ()
...
@require_torch
class Pix2StructTextRetrievalModelTest(ModelTesterMixin, unittest.TestCase):
    all_model_classes = (Pix2StructForImageTextRetrieval,) if is_torch_available() else ()
    fx_compatible = False
    test_head_masking = False
    test_pruning = False
    test_resize_embeddings = False
    ...
    def setUp(self):
        self.model_tester = Pix2StructTextRetrievalModelTester(self)
...
class Pix2StructModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_image_captioning_fp16(self):
        model = Pix2StructForConditionalGeneration.from_pretrained(
            "Salesforce/pix2struct-image-captioning-base", torch_dtype=torch.float16
        ).to(torch_device)
        processor = Pix2StructProcessor.from_pretrained("Salesforce/pix2struct-image-captioning-base")
        image = prepare_img()
    ...
    def test_inference_vqa(self):
        model = Pix2StructForQuestionAnswering.from_pretrained("Salesforce/pix2struct-vqa-base").to(torch_device)
        processor = Pix2StructProcessor.from_pretrained("Salesforce/pix2struct-vqa-base")
    ...
    def test_inference_itm(self):
        model = Pix2StructForImageTextRetrieval.from_pretrained("Salesforce/pix2struct-itm-base-coco").to(torch_device)
        processor = Pix2StructProcessor.from_pretrained("Salesforce/pix2struct-itm-base-coco")

...
class LlamaCodeTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def test_save_pretrained(self):
        self.tokenizers_list += (self.rust_tokenizer_class, "hf-internal-testing/llama-code-tokenizer", {})
...
class LlamaIntegrationTest(unittest.TestCase):
    ...
    def test_infilling_tokenization(self):
        ...
        fast_tokenizer = LlamaCodeTokenizerFast.from_pretrained("huggyllama/llama-7b")
...
class CommonSpmIntegrationTests(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        tokenizer = LlamaCodeTokenizer(SAMPLE_VOCAB, extra_ids=0, add_bos_token=False)

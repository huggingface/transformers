...
from transformers import AutoTokenizer, GptSw3Tokenizer, GptSw3TokenizerFast
from transformers.models.gpt_sw3.tokenization_gpt_sw3 import VOCAB_FILES_NAMES
...
class GptSw3TokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def get_tokenizer(self, **kwargs):
        ...
        return GptSw3Tokenizer.from_pretrained(self.tmpdirname, **kwargs)

    def get_rust_tokenizer(self, **kwargs):
        kwargs.update(self.special_tokens_map)
        return GptSw3TokenizerFast.from_pretrained(self.tmpdirname, **kwargs)
    ...
    def test_full_tokenizer(self):
        tokenizer = GptSw3Tokenizer(self.vocab_file, self.merges_file, **self.special_tokens_map)
        text = "lower newer"
    ...
    def test_pretokenized_inputs(self, *args, **kwargs):
        ...
        # And get both GptSw3 and Roberta to work at the same time (mostly an issue of adding a space before the string)
        pass
    ...
    def test_padding_if_pad_token_set_slow(self):
        tokenizer = GptSw3Tokenizer.from_pretrained(self.tmpdirname, pad_token="<pad>")
    ...
    def test_add_bos_token_slow(self):
        bos_token = "$$$"
        tokenizer = GptSw3Tokenizer.from_pretrained(self.tmpdirname, bos_token=bos_token, add_bos_token=True)

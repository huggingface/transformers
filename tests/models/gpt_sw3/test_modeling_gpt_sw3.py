...
class GptSw3ModelTester:
    ...
    def create_and_check_gpt_sw3_for_sequence_classification(
    ...
    def create_and_check_gpt_sw3_for_token_classification(
        self, config, input_ids, input_mask, head_mask, token_type_ids, mc_token_ids, sequence_labels, *args
    ):
        config.num_labels = self.num_labels
...
class GptSw3ModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    ...
    def test_gpt_sw3_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_gpt_sw3_model(*config_and_inputs)

    def test_gpt_sw3_model_past(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_gpt_sw3_model_past(*config_and_inputs)

    def test_gpt_sw3_model_att_mask_past(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_gpt_sw3_model_attention_mask_past(*config_and_inputs)

    def test_gpt_sw3_model_past_large_inputs(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_gpt_sw3_model_past_large_inputs(*config_and_inputs)

    def test_gpt_sw3_lm_head_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_lm_head_model(*config_and_inputs)

    def test_gpt_sw3_double_lm_head_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_double_lm_head_model(*config_and_inputs)

    def test_gpt_sw3_sequence_classification_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_gpt_sw3_for_sequence_classification(*config_and_inputs)

    def test_gpt_sw3_token_classification_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_gpt_sw3_for_token_classification(*config_and_inputs)

    def test_gpt_sw3_gradient_checkpointing(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_forward_and_backwards(*config_and_inputs, gradient_checkpointing=True)

    def test_gpt_sw3_scale_attn_by_inverse_layer_idx(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs(scale_attn_by_inverse_layer_idx=True)
        self.model_tester.create_and_check_forward_and_backwards(*config_and_inputs)

    def test_gpt_sw3_reorder_and_upcast_attn(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs(reorder_and_upcast_attn=True)
        self.model_tester.create_and_check_forward_and_backwards(*config_and_inputs)

    def test_gpt_sw3_weight_initialization(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_gpt_sw3_weight_initialization(*config_and_inputs)
...
class GptSw3ModelLanguageGenerationTest(unittest.TestCase):
    ...
    @slow
    def test_lm_generate_gpt_sw3(self):
        self._test_lm_generate_gpt_sw3_helper()

    @slow
    def test_lm_generate_gpt_sw3_with_gradient_checkpointing(self):
        self._test_lm_generate_gpt_sw3_helper(gradient_checkpointing=True)

    @slow
    def test_lm_generate_gpt_sw3_with_reorder_and_upcast_attn(self):
        self._test_lm_generate_gpt_sw3_helper(reorder_and_upcast_attn=True)

    @slow
    def test_lm_generate_gpt_sw3_with_scale_attn_by_inverse_layer_idx(self):
        self._test_lm_generate_gpt_sw3_helper(scale_attn_by_inverse_layer_idx=True, verify_outputs=False)
    ...
    @slow
    def test_contrastive_search_gpt_sw3(self):
        article = (
        ...
        generated_text = gpt_sw3_tokenizer.batch_decode(outputs, skip_special_tokens=True)

...
from transformers import FlexOlmoConfig, is_torch_available, set_seed
...
class FlexOlmoModelTester:
    ...
    def create_and_check_model(
        ...
        model = FlexOlmoModel(config=config)
...
@require_torch
class FlexOlmoModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = FlexOlmoModelTester(self)
        self.config_tester = ConfigTester(self, config_class=FlexOlmoConfig, hidden_size=37)
    ...
    def test_model_rope_scaling(self, scaling_type):
        ...
        original_model = FlexOlmoModel(config)
        ...
        scaled_model = FlexOlmoModel(config)
...
class FlexOlmoIntegrationTest(unittest.TestCase):
    ...
    def test_model_7b_logits(self):
        ...
        model = FlexOlmoForCausalLM.from_pretrained("allenai/OLMoE-1B-7B-0924", device_map="auto")

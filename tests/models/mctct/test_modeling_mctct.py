...
class MCTCTModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_ctc_robust_batched(self):
        ...
        EXPECTED_TRANSCRIPTIONS = [
            "a man said to the universe, sir, i exist.",
            '"sweat-covered brion\'s body, trickling into the tight-lowing clossa was the only germent huor." "',
            "\"the cadona's chest still-dripping bloodthe acofis overstrained eyes, even the soring arena around"
            " him with thousands of spectators retrivialities not worth-thinking about.",

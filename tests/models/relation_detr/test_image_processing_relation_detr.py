...
class RelationDetrImageProcessingTester(unittest.TestCase):
    ...
    def get_expected_values(self, image_inputs, batched=False):
        """
        This function computes the expected height and width when providing images to RelationDetrImageProcessor,
...
class RelationDetrImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    ...
    def setUp(self):
        super().setUp()
        self.image_processor_tester = RelationDetrImageProcessingTester(self)
    ...
    @slow
    # Modified from tests.models.detr.test_image_processing_detr.DetrImageProcessingTest.test_batched_coco_detection_annotations with Detr->RelationDetr
    ...
    # Copied from tests.models.detr.test_image_processing_detr.DetrImageProcessingTest.test_max_width_max_height_resizing_and_pad_strategy with Detr->RelationDetr

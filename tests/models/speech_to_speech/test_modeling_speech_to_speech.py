...
class EncoderDecoderMixin:
    ...
    def check_encoder_decoder_model_from_pretrained_configs(
        ...
        **kwargs
        ...
        encoder_decoder_config = SpeechToSpeechConfig.from_encoder_decoder_configs(config, decoder_config)
        self.assertTrue(encoder_decoder_config.decoder.is_decoder)

        enc_dec_model = SpeechToSpeechModel(encoder_decoder_config)
    ...
    def check_encoder_decoder_model(
        ...
        **kwargs
        ...
        enc_dec_model = SpeechToSpeechModel(encoder=encoder_model, decoder=decoder_model)
    ...
    def check_encoder_decoder_model_from_pretrained(
        ...
        **kwargs
        ...
        enc_dec_model = SpeechToSpeechModel.from_encoder_decoder_pretrained(**kwargs)
        enc_dec_model.to(torch_device)
        outputs_encoder_decoder = enc_dec_model(
            input_values=input_values,
            input_features=input_features,
        ...
        **kwargs
        ...
        with torch.no_grad():
            ...
            with tempfile.TemporaryDirectory() as tmpdirname:
                ...
                enc_dec_model = SpeechToSpeechModel.from_pretrained(tmpdirname)
                enc_dec_model.to(torch_device)
        ...
        **kwargs
        ...
        with torch.no_grad():
            ...
            with tempfile.TemporaryDirectory() as encoder_tmp_dirname, tempfile.TemporaryDirectory() as decoder_tmp_dirname:
                ...
                SpeechToSpeechModel.from_encoder_decoder_pretrained(
    ...
    def test_real_model_save_load_from_pretrained(self):
        ...
        with torch.no_grad():
            ...
            with tempfile.TemporaryDirectory() as tmp_dirname:
                ...
                model_1 = SpeechToSpeechModel.from_pretrained(tmp_dirname)

...
from transformers.image_utils import is_pil_image
...
# Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTester with SuperGlue->EfficientLoFTR
...
class EfficientLoFTRImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    ...
    @unittest.skip(reason="EfficientLoFTRImageProcessor is always supposed to return a grayscaled image")
    def test_call_numpy_4_channels(self):
        pass

    # Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTest.test_number_and_format_of_images_in_input
    ...
    # Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTest.test_valid_image_shape_in_input
    ...
    # Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTest.test_invalid_image_shape_in_input
    ...
    # Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTest.test_input_images_properly_paired
    ...
    # Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTest.test_input_not_paired_images_raises_error
    ...
    # Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTest.test_input_image_properly_converted_to_grayscale
    ...
    # Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTest.test_call_numpy with SuperGlue->EfficientLoFTR
    def test_call_numpy(self):
        # Test overwritten because EfficientLoFTRImageProcessor combines images by pair to feed it into EfficientLoFTR
    ...
    # Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTest.test_call_pil with SuperGlue->EfficientLoFTR
    ...
    # Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTest.test_call_pytorch with SuperGlue->EfficientLoFTR
    ...
    @require_torch
    # Copied from transformers.tests.superglue.test_image_processing_superglue.SuperGlueImageProcessorTest.test_post_processing_keypoint_matching
    ...
    def test_visualize_output(self):
        ...
        post_processed_outputs = image_processor.post_process_keypoint_matching(outputs, tensor_image_sizes)

        # Test with list of pairs
        plot_pairs = image_processor.visualize_output(image_inputs, post_processed_outputs)
        self.assertEqual(len(plot_pairs), 3)
        self.assertTrue(all(is_pil_image(plot_pair) for plot_pair in plot_pairs))

...
class Param2MoEModelTest(CausalLMModelTest, unittest.TestCase):
    ...
    def test_model_rope_scaling_frequencies(self):
        """
        Overwritten: Param2MoE implements RoPE in the complex domain, as opposed to in the real domain with
        ...
        linear_scaling_rope = Param2MoERotaryEmbedding(config=config).to(torch_device)
        ...
        ntk_scaling_rope = Param2MoERotaryEmbedding(config=config).to(torch_device)
        ...
        yarn_scaling_rope = Param2MoERotaryEmbedding(config=config).to(torch_device)

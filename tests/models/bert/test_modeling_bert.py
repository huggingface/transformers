...
from transformers.testing_utils import (CaptureLogger, require_torch,
...
if is_torch_available():
    ...
    from transformers import (MODEL_FOR_PRETRAINING_MAPPING, BertForMaskedLM,
                              BertForMultipleChoice,
                              BertForNextSentencePrediction,
                              BertForPreTraining, BertForQuestionAnswering,
                              BertForSequenceClassification,
                              BertForTokenClassification, BertLMHeadModel,
                              BertModel, logging)
...
class BertModelTest(
    ...
    def test_model_3d_mask_shapes(self):
        ...
        config_and_inputs[3] = random_attention_mask(
...
class BertModelIntegrationTest(unittest.TestCase):
    ...
    def test_sdpa_ignored_mask(self):
        ...
        for _ in range(model.config.num_hidden_layers):
            ...
            pkv.append(
                [
                    torch.rand(1, num_heads, 3, head_dim),
                    torch.rand(1, num_heads, 3, head_dim),
                ]
            )
        ...
        with torch.no_grad():
            ...
            self.assertTrue(
                torch.allclose(
                    res_eager.last_hidden_state,
                    res_sdpa.last_hidden_state,
                    atol=1e-5,
                    rtol=1e-4,
                )
            )

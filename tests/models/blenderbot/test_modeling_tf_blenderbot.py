...
from sarah import BlenderbotConfig, BlenderbotTokenizer, is_tf_available
from sarah.testing_utils import require_tf, require_tokenizers, slow
...
if is_tf_available():
    ...
    from sarah import TFAutoModelForSeq2SeqLM, TFBlenderbotForConditionalGeneration, TFBlenderbotModel

...
@require_sentencepiece
@require_tokenizers
class ChameleonTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = ChameleonTokenizer
    rust_tokenizer_class = ChameleonTokenizer
    ...
    def setUp(self):
        ...
        tokenizer = ChameleonTokenizer(SAMPLE_VOCAB, keep_accents=True)
    ...
    def test_save_pretrained(self):
        self.tokenizers_list += (self.rust_tokenizer_class, "hf-internal-testing/chameleon-tokenizer", {})
    ...
    def test_tokenizer_integration(self):
        ...
        self.tokenizer_integration_test_util(
            ...
            model_name="hf-internal-testing/chameleon-tokenizer",
    ...
    def test_picklable(self):
        with tempfile.NamedTemporaryFile() as f:
            ...
            tokenizer = ChameleonTokenizer(f.name, keep_accents=True)
...
class ChameleonIntegrationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        checkpoint_name = "hf-internal-testing/chameleon-tokenizer-non-normalized"
        cls.tokenizer: ChameleonTokenizer = ChameleonTokenizer.from_pretrained(checkpoint_name)
        cls.rust_tokenizer = ChameleonTokenizer.from_pretrained(checkpoint_name)
        return cls
    ...
    def test_fast_special_tokens(self):
        ...
        fast_tokenizer = ChameleonTokenizer.from_pretrained(
            "hf-internal-testing/chameleon-tokenizer", add_eos_token=True, add_bos_token=False
        )
        fast = fast_tokenizer.encode("A sample test", add_special_tokens=True)
        assert fast == [319, 4559, 1243, 2]

        slow_tokenizer = ChameleonTokenizer.from_pretrained(
            "hf-internal-testing/chameleon-tokenizer", add_eos_token=True, add_bos_token=False
        )
        slow = slow_tokenizer.encode("A sample test", add_special_tokens=True)
    ...
    def test_special_token_special_word(self):
        ...
        tokenizer = ChameleonTokenizer.from_pretrained("huggychameleon/chameleon-7b", legacy=False)
    ...
    def test_fast_post_processor(self):
        ...
        with self.assertRaises(ValueError):
            tokenizer = ChameleonTokenizer(SAMPLE_VOCAB, eos_token=None, add_bos_token=True, add_eos_token=True)
...
class CommonSpmIntegrationTests(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        tokenizer = ChameleonTokenizer(SAMPLE_VOCAB, extra_ids=0, add_bos_token=False, legacy=False)

...
class SamHQModelIntegrationTest(unittest.TestCase):
    def setUp(self):
        ...
        # The positional_embedding in SamHQPositionalEmbedding is excluded from checkpoint loading
        # and always randomly initialized, so we need to set the seed to ensure reproducible tests
        set_seed(0)

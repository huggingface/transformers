...
from transformers.models.seamless_m4t import (SeamlessM4TTokenizer,
...
class SeamlessM4TProcessorTest(unittest.TestCase):
    ...
    def test_save_load_pretrained_default(self):
        ...
        tokenizer_instance = isinstance(
            processor.tokenizer, SeamlessM4TTokenizerFast
        ) or isinstance(processor.tokenizer, SeamlessM4TTokenizer)

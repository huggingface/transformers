...
from transformers import AutoTokenizer, MoTTokenizer, MoTTokenizerFast
from transformers.models.mot.tokenization_mot import VOCAB_FILES_NAMES
...
@require_tokenizers
class MoTTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = MoTTokenizer
    rust_tokenizer_class = MoTTokenizerFast
    ...
    def get_tokenizer(self, **kwargs):
        ...
        return MoTTokenizer.from_pretrained(self.tmpdirname, **kwargs)

    def get_rust_tokenizer(self, **kwargs):
        kwargs.update(self.special_tokens_map)
        return MoTTokenizerFast.from_pretrained(self.tmpdirname, **kwargs)
    ...
    def test_full_tokenizer(self):
        tokenizer = MoTTokenizer(self.vocab_file, self.merges_file, **self.special_tokens_map)
        text = "lower newer"
    ...
    def test_pretokenized_inputs(self, *args, **kwargs):
        ...
        # And get both MoT and Roberta to work at the same time (mostly an issue of adding a space before the string)
        pass
    ...
    def test_padding_if_pad_token_set_slow(self):
        tokenizer = MoTTokenizer.from_pretrained(self.tmpdirname, pad_token="<pad>")
    ...
    def test_add_bos_token_slow(self):
        bos_token = "$$$"
        tokenizer = MoTTokenizer.from_pretrained(self.tmpdirname, bos_token=bos_token, add_bos_token=True)
    ...
    def test_tokenization_for_chat(self):
        tokenizer = MoTTokenizer.from_pretrained(self.tmpdirname)
        test_chats = [

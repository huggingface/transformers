...
class AudioFlamingo3ProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    ...
    def test_tokenizer_full_integration(self):
        slow_tokenizer = AutoTokenizer.from_pretrained("nvidia/audio-flamingo-3-hf", use_fast=False)
        fast_tokenizer = AutoTokenizer.from_pretrained("nvidia/audio-flamingo-3-hf", from_slow=True, legacy=False)

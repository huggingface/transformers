...
if is_vision_available():
    ...
    from transformers import CLIPViPImageProcessor


class CLIPViPImageProcessingTester(unittest.TestCase):
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
@require_vision
class CLIPViPImageProcessingTest(ImageProcessingSavingTestMixin, unittest.TestCase):
    image_processing_class = CLIPViPImageProcessor if is_vision_available() else None

    def setUp(self):
        self.image_processor_tester = CLIPViPImageProcessingTester(self)

...
from transformers import PoNetTokenizerFast
from transformers.models.ponet.tokenization_ponet import (
    VOCAB_FILES_NAMES,
    BasicTokenizer,
    PoNetTokenizer,
    WordpieceTokenizer,
...
@require_tokenizers
class PoNetTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = PoNetTokenizer
    rust_tokenizer_class = PoNetTokenizerFast
    ...
    def test_sequence_builders(self):
        tokenizer = self.tokenizer_class.from_pretrained("chtan/ponet-base-uncased")

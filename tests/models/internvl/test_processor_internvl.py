...
if is_vision_available():
    ...
    from transformers import AutoTokenizer, InternVLImageProcessor, InternVLProcessor
...
class InternVLProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        tokenizer = AutoTokenizer.from_pretrained("hf-internal-testing/internvl-12b")
        image_processor = InternVLImageProcessor()
        processor = InternVLProcessor(tokenizer=tokenizer, image_processor=image_processor)
    ...
    # Override as InternVLProcessor needs nested images to work properly with batched inputs
    @require_vision

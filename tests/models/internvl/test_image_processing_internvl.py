...
if is_vision_available():
    ...
    if is_torchvision_available():
        from transformers import InternVLImageProcessorFast


class InternVLImageProcessingTester:
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
@require_vision
class InternVLImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    image_processing_class = InternVLImageProcessor if is_vision_available() else None
    fast_image_processing_class = InternVLImageProcessorFast if is_torchvision_available() else None

    def setUp(self):
        super().setUp()
        self.image_processor_tester = InternVLImageProcessingTester(self)
    ...
    # The following tests are overriden as InternVLImageProcessor can return images of different sizes
    ...
    @unittest.skip(reason="InternVLImageProcessor doesn't treat 4 channel PIL and numpy consistently yet")  # FIXME Amy

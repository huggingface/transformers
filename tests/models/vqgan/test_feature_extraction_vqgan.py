...
if is_vision_available():
    ...
    from transformers import VQGANFeatureExtractor


class VQGANFeatureExtractionTester(unittest.TestCase):
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
@require_vision
class VQGANFeatureExtractionTest(FeatureExtractionSavingTestMixin, unittest.TestCase):

    feature_extraction_class = VQGANFeatureExtractor if is_vision_available() else None

    def setUp(self):
        self.feature_extract_tester = VQGANFeatureExtractionTester(self)
...
@require_torch
@require_vision
class VQGANFeatureExtractionTestFourChannels(FeatureExtractionSavingTestMixin, unittest.TestCase):

    feature_extraction_class = VQGANFeatureExtractor if is_vision_available() else None

    def setUp(self):
        self.feature_extract_tester = VQGANFeatureExtractionTester(self, num_channels=4)

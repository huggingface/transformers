...
if is_torch_available():
    ...
    from transformers.models.dots1.modeling_dots1 import (
...
class Dots1ModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    _torch_compile_train_cls = Dots1ForCausalLM if is_torch_available() else None
    ...
    @unittest.skip("Dots1 has HybridCache which is not compatible with assisted decoding")
    ...
    @unittest.skip("Dots1 has HybridCache which is not compatible with dola decoding")
    def test_dola_decoding_sample(self):
        pass

    @unittest.skip("Dots1 has HybridCache and doesn't support continue from past kv")
    def test_generate_continue_from_past_key_values(self):
        pass

    @unittest.skip("Dots1 has HybridCache and doesn't support low_memory generation")
    def test_beam_search_low_memory(self):
        pass

    @unittest.skip("Dots1 has HybridCache and doesn't support contrastive generation")
    ...
    @unittest.skip("Dots1 has HybridCache and doesn't support StaticCache. Though it could, it shouldn't support.")
    ...
    @unittest.skip("Dots1's eager attn/sdpa attn outputs are expected to be different")
    ...
    def test_model_rope_scaling_from_config(self, scaling_type):
        ...
        original_model = Dots1Model(config)
        ...
        scaled_model = Dots1Model(config)
    ...
    def test_model_rope_scaling(self):
        ...
        original_rope = Dots1RotaryEmbedding(config=config).to(torch_device)
        ...
        linear_scaling_rope = Dots1RotaryEmbedding(config=config).to(torch_device)
        ...
        ntk_scaling_rope = Dots1RotaryEmbedding(config=config).to(torch_device)
        ...
        yarn_scaling_rope = Dots1RotaryEmbedding(config=config).to(torch_device)
    ...
    def test_eager_matches_sdpa_generate(self):
        ...
        model_sdpa = Dots1ForCausalLM.from_pretrained(
        ...
        model_eager = Dots1ForCausalLM.from_pretrained(
            "bzantium/tiny-deepseek-v3",
            torch_dtype=torch.float16,
            low_cpu_mem_usage=True,

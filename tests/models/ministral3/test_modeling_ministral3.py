...
class Ministral3IntegrationTest(unittest.TestCase):
    ...
    def test_model_8b_logits(self):
        ...
        model = AutoModelForCausalLM.from_pretrained("mistralai/Ministral3-8B-Instruct-2410", device_map="auto")
    ...
    def test_model_8b_generation(self):
        ...
        tokenizer = AutoTokenizer.from_pretrained("Mistralai/Ministral3-8B-Instruct-2410")
        model = Ministral3ForCausalLM.from_pretrained("Mistralai/Ministral3-8B-Instruct-2410", device_map="auto")
    ...
    def test_model_8b_long_prompt(self):
        ...
        model = Ministral3ForCausalLM.from_pretrained(
            "Mistralai/Ministral3-8B-Instruct-2410",
            device_map="auto",
    ...
    @slow
    @unittest.skip("not working with Ministral3")
    ...
    def test_export_text_with_hybrid_cache(self):
        ...
        model_id = "Mistralai/Ministral3-8B-Instruct-2410"
        model = Ministral3ForCausalLM.from_pretrained(
            model_id,
    ...
    def test_past_sliding_window_generation(self):
        ...
        tokenizer = AutoTokenizer.from_pretrained("mistralai/Ministral3-8B-Instruct-2410", legacy=False)

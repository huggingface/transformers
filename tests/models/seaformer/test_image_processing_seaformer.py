...
class SeaformerImageProcessingTester(unittest.TestCase):
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
@require_vision
class SeaformerImageProcessingTest(ImageProcessingSavingTestMixin, unittest.TestCase):
    image_processing_class = SeaformerImageProcessor if is_vision_available() else None

    def setUp(self):
        self.image_processor_tester = SeaformerImageProcessingTester(self)

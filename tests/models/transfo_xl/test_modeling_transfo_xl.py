...
class TransfoXLModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipieline_model_mapping = {"feature-extraction": TransfoXLModel, "text-classification": TransfoXLForSequenceClassification, "text-generation": TransfoXLLMHeadModel, "zero-shot": TransfoXLForSequenceClassification} if is_torch_available() else {}
    test_pruning = False

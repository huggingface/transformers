...
from sarah import AutoBackbone
from sarah.testing_utils import require_timm, require_torch, torch_device
...
if is_torch_available():
    from sarah import TimmBackbone, TimmBackboneConfig

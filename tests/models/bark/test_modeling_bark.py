...
from transformers import BarkConfig, is_torch_available
...
class BarkModelTester:
    ...
    def get_large_model_config(self):
        return BarkConfig.from_pretrained("gpt-neo-125M")
    ...
    def create_and_check_bark_model(self, config, input_ids, input_mask, head_mask, token_type_ids, *args):
        model = BarkModel(config=config)
    ...
    def create_and_check_bark_model_past(self, config, input_ids, input_mask, head_mask, token_type_ids, *args):
        model = BarkModel(config=config)
        model.to(torch_device)
        model.eval()
    ...
    def create_and_check_bark_model_attention_mask_past(
    ...
    def create_and_check_bark_model_past_large_inputs(
        self, config, input_ids, input_mask, head_mask, token_type_ids, *args
    ):
        model = BarkModel(config=config)
        model.to(torch_device)
    ...
    def create_and_check_bark_for_sequence_classification(
        self, config, input_ids, input_mask, head_mask, token_type_ids, mc_token_ids, sequence_labels, *args
    ):
        config.num_labels = self.num_labels
        model = BarkForSequenceClassification(config)
        model.to(torch_device)
        model.eval()
...
class BarkModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    def test_bark_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_bark_model(*config_and_inputs)

    def test_bark_model_past(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_bark_model_past(*config_and_inputs)

    def test_bark_model_att_mask_past(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_bark_model_attention_mask_past(*config_and_inputs)

    def test_bark_model_past_large_inputs(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_bark_model_past_large_inputs(*config_and_inputs)

    def test_bark_lm_head_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_lm_head_model(*config_and_inputs)

    def test_bark_sequence_classification_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_bark_for_sequence_classification(*config_and_inputs)

    def test_bark_gradient_checkpointing(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
    ...
    def test_local_attn_probs(self):
        model = BarkModel.from_pretrained("valhalla/gpt-neo-random-tiny").eval()
...
@require_torch
class BarkModelLanguageGenerationTest(unittest.TestCase):
    @cached_property
    def model(self):
        return BarkForCausalLM.from_pretrained("sanchit-gandhi/bark").to(torch_device)

    @cached_property
    def tokenizer(self):
        return BarkTokenizer.from_pretrained("sanchit-gandhi/bark")

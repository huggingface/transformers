...
from transformers import BarkConfig, BarkSemanticConfig, BarkCoarseAcousticsConfig, BarkFineAcousticsConfig, is_torch_available
...
class BarkCoarseAcousticsModuleTest(BarkSemanticModuleTest):
    ...
    all_generative_model_classes = (
        BarkCoarseAcousticsModule,) if is_torch_available() else ()


    def setUp(self):
        self.model_tester = BarkModuleTester(self, config_class=BarkCoarseAcousticsConfig, model_class=BarkCoarseAcousticsModule)
...
class BarkFineAcousticsModuleTest(ModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = BarkFineAcousticsModuleTester(self, config_class=BarkFineAcousticsConfig, model_class=BarkFineAcousticsModule)
...
class BarkModelTest(unittest.TestCase):
    ...
    @cached_property
    def inputs(self):
        input_ids, history_prompt = self.processor("In the light of the moon, a little egg lay on a leaf", voice_preset = "en_speaker_6")
    ...
    def test_generate_text_semantic(self):
        ...
        expected_output_ids = [7363,  321,   41, 1461, 6915,  952,  326,   41,   41,  927, 4335,
       2523, 2523, 1022, 1723,  163,   17,  298, 8531, 5819,  521,  245,
       6821, 4228,   41,   41,   41,   41,  373,  711, 4480, 4480, 4236,
       4236, 4236,  407,  407,  407, 3734,  627,  171,  171,  171,  138,
         10,  138,  266,  276,  206,  206,  206,  206,  206,  206,  206,
        ...
        206,  206,  206,  206,  206,  206,  206,  206,  206,  206,  206,
        206,  206,  206,  206,  206,  206,  206,  206,  206,  206,  206,
        206,  206,  206,  206,  206,  206,  206,  206,  206,  206, 3208,
        397,  215,  215, 1293, 4004, 4004,  206,  206,  206,  206, 6992,
        206,  206,  206,  206,  206,  206,  206,  206,  206,  206,  206,
        206,  206,  206,  206,  206,  206,  206,  206,  206,  206,  206,
        206,  206,  206,  206,  206,  206,  206,  206,  206,  206,  206,
        206,  206,  206,  206,  206,  206,  206,  206,  206,  206,  206,
        ...
        # greedy decoding
        output_ids = self.model.generate_text_semantic(**input_ids, 
    ...
    def test_generate_coarse(self):
        ...
        first_three_hundred_expected_output_ids = [11018, 11391, 10651, 11418, 10857, 11620, 10642, 11366, 10312,
       11528, 10531, 11516, 10474, 11051, 10524, 11051, 10524, 11846,
       10776, 11846, 10784, 11444, 10868, 11444, 10776, 11846, 10689,
       11846, 10990, 11846, 10396, 11846, 10065, 11051, 10206, 11163,
       10206, 11288, 10206, 11025, 10206, 11025, 10206, 11484, 10479,
       11551, 10479, 11251, 10502, 11484, 10687, 11484, 10479, 11151,
       10206, 11235, 10361, 11371, 10573, 11391, 10699, 11675, 10136,
       12010, 10651, 11855, 10573, 11884, 10474, 11858, 10431, 12038,
       10255, 11717, 10687, 11441, 10143, 11130, 10605, 11130, 10312,
       11130, 10124, 11130, 10069, 11130, 10562, 11444, 10010, 11130,
       10659, 12038, 10721, 11130, 10790, 11130, 10361, 11130, 10431,
       11130, 10322, 11130, 10721, 11130, 10790, 11130, 10361, 11130,
       10431, 11130, 10659, 11130, 10790, 11130, 10361, 11130, 10431,
       11130, 10531, 11878, 10651, 11696, 10058, 11553, 10238, 11553,
       10069, 11553, 10687, 11238, 10224, 11588, 10738, 11387, 10835,
       11301, 10779, 11301, 10025, 11301, 10025, 11301, 10025, 11301,
       10025, 11301, 10025, 11301, 10025, 11301, 10025, 11301, 10025,
       11301, 10025, 11301, 10025, 11301, 10025, 11301, 10025, 11301,
       10025, 11301, 10025, 11301, 10025, 11301, 10025, 11301, 10025,
       11301, 10025, 11301, 10025, 11301, 10025, 11301, 10025, 11301,
       10025, 11301, 10025, 11301, 10025, 11301, 10025, 11301, 10025,
       11301, 10025, 11301, 10025, 11301, 10025, 11301, 10025, 11301,
       ...
       11301, 10025, 11301]
        ...
        output_ids = self.model.generate_coarse(output_ids, 
                                                       history_prompt = history_prompt,
    ...
    def test_generate_fine(self):
        ...
        first_hundred_expected_output_ids = [[1018,  651,  857,  642,  312,  531,  474,  524,  524,  776,  784,
         868,  776,  689,  990,  396,   65,  206,  206,  206,  206,  206,
         479,  479,  502,  687,  479,  206,  361,  573,  699,  136,  651,
         573,  474,  431,  255,  687,  143,  605,  312,  124,   69,  562,
          10,  659,  721,  790,  361,  431,  322,  721,  790,  361,  431,
         659,  790,  361,  431,  531,  651,   58,  238,   69,  687,  224,
         738,  835,  779,   25,   25,   25,   25,   25,   25,   25,   25,
          25,   25,   25,   25,   25,   25,   25,   25,   25,   25,   25,
          25,   25,   25,   25,   25,   25,   25,   25,   25,   25,   25,
          25],
       [ 367,  394,  596,  342,  504,  492,   27,   27,  822,  822,  420,
         420,  822,  822,  822,  822,   27,  139,  264,    1,    1,  460,
         527,  227,  460,  460,  127,  211,  347,  367,  651,  986,  831,
         860,  834, 1014,  693,  417,  106,  106,  106,  106,  106,  420,
         106, 1014,  106,  106,  106,  106,  106,  106,  106,  106,  106,
         106,  106,  106,  106,  854,  672,  529,  529,  529,  214,  564,
         363,  277,  277,  277,  277,  277,  277,  277,  277,  277,  277,
         277,  277,  277,  277,  277,  277,  277,  277,  277,  277,  277,
         277,  277,  277,  277,  277,  277,  277,  277,  277,  277,  277,
         277],
       [ 961,  955,  221,  955,  955,  686,  939,  939,  479,  176,  464,
         644,  105,   43,   43,  883,   31,  687,  838,  955,  532,  654,
         333,  883,  830,  581,  631,  201,  862,    4,  626,  126,  915,
          33,  891,  657,  565,  308,  935,  862,  164,  933,  945,  358,
         977,   42,  696,  707,  361,   52,  883,  769,  812,  418,  456,
         769,  361,  361,  935,  769,  221,  232,  560,  918,  925,  915,
         989,  752,  752,  893,  893,  893,  893,  893,  893,  893,  893,
         893,  893,  893,  893,  893,  893,  893,  893,  893,  893,  893,
         893,  893,  893,  893,  893,  893,  893,  893,  893,  893,  893,
         893],
       [ 638,  365,  218,  944,  853,  363,  639,   22,  884,  456,  990,
         436,  452,  791,  662,    3,  880,  292,  537,  970,   12,   68,
         223,  350,  328,  840,  282,  506,  424,  688,  674,  766,  739,
         881,  139,   12,  335,  519,  497,  459,   77,  766, 1003,  151,
        1004,   67,  499,  456,   63,  315,  140,  536,  456,  791,  139,
         579,  644,  990,  261,  162,  803,  811,  974,  674,  770,  651,
          74,  854,  916,  762, 1014, 1014, 1014, 1014, 1014, 1014, 1014,
        1014,  741,  741,  741,  741,  255,  255,  255,  255,  255,  255,
         255,  255,  255,  255,  255,  255,  255,  255,  255,  255,  255,
         255],
       [ 302,  912,  524,   38,  174,  209,  879,   23,  910,  227,   58,
         250,  910,  152,  583,   62,  307,  890,  547,  418,  215,  816,
         620,  285,  171,  475,  869,  134,  615,  812,  714,  524,  990,
         435,  136,  302,   43,  307,   15,  663,   91,  673,  930,  317,
         584,  913,  384,  987,  988,  942,  594,  910,   52,  913,  392,
         624,  700,  988,  292,  574,  325,  968, 1016,  890,  742,  862,
         528,  862,  336,  983,  712,  712,  712,  712,  712,  712,  712,
         712,  622,  622,  622,  622,  622,  622,  622,  622,  622,  622,
         622,  622,  622,  622,  622,  622,  622,  622,  622,  622,  622,
         622],
       [ 440,  673,  861,  666,  372,  558,   49,  172,  232,  342,  758,
         710,  570,  245,  918,  570,  211,  659,  999,  125, 1016,  734,
         896,  570,  897,  897,  801,  694,  852,  673,  282, 1005,  505,
         683,  770,  726,  781,  966,  349,  373,  773,  640,  913,  219,
         134,  657,   34,  783,  876,  294,  978,  265,  177,  237,  572,
          57,  125,   31,  675,   57,  673,  238,  434,  673,  218,  435,
         881,  293,  781,  881,  435,   41,  435,  435,  435,  435,  435,
         435,   41,   41,   41,  293,  881,  881,  881,  881,  881,  881,
         881,  881,  881,  881,  881,  881,  881,  881,  881,  881,  881,
         881],
       [ 244,  358,  123,  356,  586,  520,  499,  877,  542,  637,  533,
         229,  873,  533,  921,  745,   79,  798,  511,  978,  599,  407,
         791,  669,  499,  360,  664,  637,  894,  332,  714,   78,  772,
         422,  427,  223,   67,  585,  938,  817,  684,  749,  874, 1019,
         134,  749,  468,  110,  421,  656,  912,  979,  561,  561,  676,
          28,  481,  741,  325,  569,  354,  935,  342,  127,  585,  764,
         782,  853,  782,  860,  772,  772,  772,  355,  355,  355,  355,
         355,  782,  782,  355,  782,  782, 1002, 1002, 1002, 1002, 1002,
        1002, 1002, 1002, 1002, 1002, 1002, 1002, 1002, 1002, 1002, 1002,
        1002],
       [ 806,  685,  905,  848,  803,  810,  921,  208,  625,  203,  595,
         850,  840,  499,  653,  999,  254,  361,  996,  901,  433,  803,
         602,  982,  504,  214,  229,  718,   18,  371,  534,  534, 1012,
         534,  480,  526,  416,  458,  624,  937, 1015,  495, 1008,  838,
         542,  506,  181,  110,  208,  821,  437,  926,  939,  443,  848,
         780,  746,  810,  625,  966,  658,  677,  919,  468,  832,  534,
         534,  701,  835,  534,  948,  948,  948,  948,  989,  989,  989,
         989,  975,  518,  475,  975,  948,  475,  475,  475,  475,  475,
        ...
        # greedy decoding
        output_ids = self.model.generate_fine(output_ids, 
                                                       history_prompt = history_prompt,
                                                       temperature = None,
        )

...
class AudioVisualFlamingoProcessorTest(unittest.TestCase):
    ...
    def test_legacy_component_configs_resolve_to_standard_subconfigs(self):
        config = AudioVisualFlamingoConfig(
            llm_cfg={"model_type": "qwen2", "hidden_size": 64, "intermediate_size": 128, "num_hidden_layers": 2, "num_attention_heads": 8, "num_key_value_heads": 8, "vocab_size": 256},
            vision_tower_cfg={"model_type": "siglip_vision_model", "hidden_size": 32, "intermediate_size": 64, "num_hidden_layers": 2, "num_attention_heads": 4, "image_size": 384, "patch_size": 14},
            sound_tower_cfg={"model_type": "qwen2_audio_encoder", "num_mel_bins": 128, "encoder_layers": 2, "encoder_attention_heads": 4, "encoder_ffn_dim": 64, "d_model": 32},
        )
        ...
        self.assertEqual(config.llm_cfg["model_type"], "qwen2")
        self.assertEqual(config.vision_tower_cfg["model_type"], "siglip_vision_model")
        self.assertEqual(config.sound_tower_cfg["model_type"], "qwen2_audio_encoder")

...
if is_torch_available():
    ...
    from transformers.models.mobilevitv2.modeling_mobilevitv2 import MOBILEVITV2_PRETRAINED_MODEL_ARCHIVE_LIST
...
class MobileViTv2ModelIntegrationTest(unittest.TestCase):
    ...
    def default_feature_extractor(self):
        return (
            MobileViTv2FeatureExtractor.from_pretrained("apple/mobilevitv2-xx-small")
            if is_vision_available()
            else None
        )
    ...
    def test_inference_image_classification_head(self):
        model = MobileViTv2ForImageClassification.from_pretrained("apple/mobilevitv2-xx-small").to(torch_device)

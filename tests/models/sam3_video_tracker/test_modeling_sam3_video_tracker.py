...
class Sam3TrackerVideoModelIntegrationTest(unittest.TestCase):
    def setUp(self):
        super().setUp()
        self.video_model = Sam3TrackerVideoModel.from_pretrained("facebook/sam2.1-hiera-tiny").to(torch.float32)
        self.processor = Sam3TrackerVideoProcessor.from_pretrained("facebook/sam2.1-hiera-tiny")

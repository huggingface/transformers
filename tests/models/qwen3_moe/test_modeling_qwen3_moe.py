...
class Qwen3MoeIntegrationTest(unittest.TestCase):
    ...
    def test_model_15b_a2b_logits(self):
        ...
        model = Qwen3MoeForCausalLM.from_pretrained("Qwen/Qwen3-15B-A2B", device_map="auto")
    ...
    def test_model_15b_a2b_generation(self):
        ...
        tokenizer = AutoTokenizer.from_pretrained("Qwen/Qwen3-15B-A2B", use_fast=False)
        model = Qwen3MoeForCausalLM.from_pretrained("Qwen/Qwen3-15B-A2B", device_map="auto")
    ...
    def test_speculative_generation(self):
        ...
        prompt = "To be or not to"
        tokenizer = AutoTokenizer.from_pretrained("Qwen/Qwen3-15B-A2B", use_fast=False)
        model = Qwen3MoeForCausalLM.from_pretrained("Qwen/Qwen3-15B-A2B", device_map="auto", torch_dtype=torch.float16)
        assistant_model = Qwen3MoeForCausalLM.from_pretrained(
            "Qwen/Qwen3-15B-A2B", device_map="auto", torch_dtype=torch.float16
        )
        input_ids = tokenizer.encode(prompt, return_tensors="pt").to(model.model.embed_tokens.weight.device)

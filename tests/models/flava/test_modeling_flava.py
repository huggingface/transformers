...
class FlavaImageModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(self, config_class=FlavaImageConfig, has_text_modality=False)
...
class FlavaTextModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(self, config_class=FlavaTextConfig)
...
class FlavaModelTester:
    ...
    def __init__(
        ...
        self.is_training = is_training
        self.config_tester = ConfigTester(self, config_class=FlavaConfig)
        self.hidden_size = hidden_size

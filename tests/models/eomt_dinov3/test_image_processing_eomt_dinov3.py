...
if is_vision_available():
    ...
    from transformers import EomtDinov3ImageProcessor

    if is_torchvision_available():
        from transformers import EomtDinov3ImageProcessorFast
    from transformers.models.eomt.modeling_eomt import EomtDinov3ForUniversalSegmentationOutput


class EomtDinov3ImageProcessingTester:
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
@require_vision
class EomtDinov3ImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    image_processing_class = EomtDinov3ImageProcessor if is_vision_available() else None
    fast_image_processing_class = EomtDinov3ImageProcessorFast if is_torchvision_available() else None

    def setUp(self):
        super().setUp()
        self.image_processor_tester = EomtDinov3ImageProcessingTester(self)

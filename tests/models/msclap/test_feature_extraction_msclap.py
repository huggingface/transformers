...
from transformers import MSClapFeatureExtractor
...
@require_torch
@require_torchaudio
# Copied from tests.models.whisper.test_feature_extraction_whisper.WhisperFeatureExtractionTester with Whisper->MSClap
class MSClapFeatureExtractionTester(unittest.TestCase):
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
@require_torchaudio
class MSClapFeatureExtractionTest(SequenceFeatureExtractionTestMixin, unittest.TestCase):
    feature_extraction_class = MSClapFeatureExtractor

    def setUp(self):
        self.feat_extract_tester = MSClapFeatureExtractionTester(self)

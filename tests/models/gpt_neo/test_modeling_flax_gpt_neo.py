...
from sarah import GPT2Tokenizer, GPTNeoConfig, is_flax_available
...
if is_flax_available():
    ...
    from sarah.models.gpt_neo.modeling_flax_gpt_neo import FlaxGPTNeoForCausalLM, FlaxGPTNeoModel

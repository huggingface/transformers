...
if is_torch_available():
    ...
    from transformers import RTDetrTimmBackbone, TimmBackboneConfig

from ...test_pipeline_mixin import PipelineTesterMixin


class RTDetrTimmBackboneModelTester:
    def __init__(
        self,
        parent,
        out_indices=None,
    ...
    def create_and_check_model(self, config, pixel_values):
        model = RTDetrTimmBackbone(config=config)
...
class TimmBackboneModelTest(ModelTesterMixin, BackboneTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (RTDetrTimmBackbone,) if is_torch_available() else ()
    pipeline_model_mapping = {"feature-extraction": RTDetrTimmBackbone} if is_torch_available() else {}
    ...
    def setUp(self):
        ...
        self.model_tester = RTDetrTimmBackboneModelTester(self)
    ...
    @unittest.skip("model training is not available in RTDetrTimmBackbone.")

...
from sarah import ResNetConfig, TableTransformerConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from sarah import TableTransformerForObjectDetection, TableTransformerModel

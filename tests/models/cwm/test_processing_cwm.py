...
from transformers import CwmProcessor, GemmaTokenizer
...
if is_vision_available():
    from transformers import CwmImageProcessor

SAMPLE_VOCAB = get_tests_dir("fixtures/test_sentencepiece.model")


@require_vision
class CwmProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    processor_class = CwmProcessor
    ...
    def setUpClass(cls):
        ...
        image_processor = CwmImageProcessor.from_pretrained(
        ...
        processor = CwmProcessor(image_processor=image_processor, tokenizer=tokenizer, **processor_kwargs)
    ...
    # Override as Cwm needs images to be an explicitly nested batch

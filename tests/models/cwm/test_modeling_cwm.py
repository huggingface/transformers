...
class CwmIntegrationTest(unittest.TestCase):
        ...
        expected_logits = Expectations(
            {
                (None, None): torch.Tensor(
                    [0.5781, 2.9531, 9.1875, 0.4961, -0.3418, 2.2188, 3.0156, 1.5156, 0.5859, 1.5547, 2.7656, 3.4062, 2.0625, 2.1719, 1.5547, 2.5469, 2.8281, 1.7969, 1.7031, 1.3828, 1.0312, 0.1582, 0.4258, 0.1416, -0.1338, 0.8555, 2.2031, 5.1875, 1.2734, 1.5391, 0.8555, 0.6992]
                ),
    ...
    def test_cwm_sliding_window_long_sequence(self):
        ...
        expected_logits = Expectations(
            {
                (None, None): torch.Tensor(
                    [5.2812, 6.4688, 12.8125, 4.6875, 5.2812, 4.2500, 7.0000, 4.9688, 2.7656, 6.6250, 4.9375, 1.1172, 5.9375, 3.7031, 3.0938, 5.5312, 6.1250, 4.7500, 4.5000, 2.7656, 4.0625, 3.2969, 3.8906, 3.3594, 3.1250, 3.6719, 3.2188, 7.0938, 4.8750, 6.0312, 2.7188, 6.2500]
                ),
                ("cuda", None): torch.tensor(

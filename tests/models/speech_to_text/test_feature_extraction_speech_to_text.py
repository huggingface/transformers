...
@require_torch
@unittest.mock.patch(
    "transformers.models.speech_to_text.feature_extraction_speech_to_text.is_speech_available",
    lambda: False,
)
class Speech2TextFeatureExtractionWithoutTorchaudioTest(
    Speech2TextFeatureExtractionTest
):
    def test_using_audio_utils(self):
        ...
        from transformers.models.speech_to_text.feature_extraction_speech_to_text import \
            is_speech_available

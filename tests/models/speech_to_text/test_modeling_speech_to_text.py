...
from transformers.testing_utils import (is_torch_available,
                                        ...
                                        require_torch_fp16, require_torchaudio,
                                        slow, torch_device)
...
class Speech2TextModelTest(
    ...
    pipeline_model_mapping = (
        {
            "automatic-speech-recognition": Speech2TextForConditionalGeneration,
            "feature-extraction": Speech2TextModel,
        }
        if is_torch_available()
        else {}
    )

...
from sarah import UdopConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from sarah import UdopEncoderModel, UdopForConditionalGeneration, UdopModel, UdopProcessor

...
if is_torch_available():
    ...
    from transformers.models.pop2piano.modeling_pop2piano import Pop2PianoDecoder, Pop2PianoEncoder
...
class Pop2PianoModelTester:
    ...
    def create_and_check_decoder_model_past_large_inputs(self, config, inputs_dict):
        model = Pop2PianoModel(config=config).get_decoder().to(torch_device).eval()
    ...
    def check_encoder_decoder_model_standalone(self, config, inputs_dict):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            encoder = Pop2PianoEncoder.from_pretrained(tmpdirname).to(torch_device)
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            decoder = Pop2PianoDecoder.from_pretrained(tmpdirname).to(torch_device)
...
class Pop2PianoModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    all_model_classes = (Pop2PianoModel, Pop2PianoForConditionalGeneration) if is_torch_available() else ()
    all_generative_model_classes = (Pop2PianoForConditionalGeneration,) if is_torch_available() else ()
...
class Pop2PianoModelIntegrationTests(unittest.TestCase):
    ...
    def default_processor(self):
        return WhisperProcessor.from_pretrained("openai/pop2piano-base")
    ...
    def test_tiny_logits_librispeech(self):
        torch_device = "cpu"
        set_seed(0)
        model = Pop2PianoModel.from_pretrained("sweetcocoa/pop2piano")
        model.to(torch_device)
    ...
    def test_small_en_logits_librispeech(self):
        set_seed(0)
        torch_device = "cpu"
        model = Pop2PianoModel.from_pretrained("openai/pop2piano-small.en")
        model.to(torch_device)
    ...
    def test_large_logits_librispeech(self):
        ...
        torch_device = "cpu"
        model = Pop2PianoModel.from_pretrained("openai/pop2piano-large")
        model.to(torch_device)

        input_speech = self._load_datasamples(1)

        processor = WhisperProcessor.from_pretrained("openai/pop2piano-large")
    ...
    def test_tiny_en_generation(self):
        torch_device = "cpu"
        set_seed(0)
        processor = WhisperProcessor.from_pretrained("sweetcocoa/pop2piano.en")
    ...
    def test_tiny_generation(self):
        torch_device = "cpu"
        set_seed(0)
        processor = WhisperProcessor.from_pretrained("sweetcocoa/pop2piano")
    ...
    def test_large_generation(self):
        ...
        set_seed(0)
        processor = WhisperProcessor.from_pretrained("openai/pop2piano-large")
        model = Pop2PianoForConditionalGeneration.from_pretrained("openai/pop2piano-large")
        model.to(torch_device)
    ...
    def test_tiny_specaugment_librispeech(self):
        ...
        set_seed(0)
        # Apply SpecAugment
        model = Pop2PianoModel.from_pretrained("sweetcocoa/pop2piano", apply_spec_augment=True)

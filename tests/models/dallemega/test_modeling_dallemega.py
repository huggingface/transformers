...
class FastIntegrationTests(unittest.TestCase):
    ...
    def xsum_1_1_model(self):
        return DalleMegaForConditionalGeneration.from_pretrained("sshleifer/distildallemega-xsum-1-1")
...
class DalleMegaModelIntegrationTests(unittest.TestCase):
    ...
    def test_inference_no_head(self):
        model = DalleMegaModel.from_pretrained("facebook/dallemega-large").to(torch_device)
    ...
    def test_base_mask_filling(self):
        pbase = pipeline(task="fill-mask", model="dalle-mega-3B")
    ...
    def test_large_mask_filling(self):
        plarge = pipeline(task="fill-mask", model="facebook/dallemega-large")
        src_text = [" I went to the <mask>."]
    ...
    def test_mnli_inference(self):
        ...
        model = AutoModelForSequenceClassification.from_pretrained("facebook/dallemega-large-mnli").to(
            torch_device
    ...
    def test_xsum_summarization_same_as_fairseq(self):
        model = DalleMegaForConditionalGeneration.from_pretrained("facebook/dallemega-large-xsum").to(torch_device)
    ...
    def test_cnn_summarization_same_as_fairseq(self):
        ...
        tok = BartTokenizer.from_pretrained("facebook/dallemega-large")

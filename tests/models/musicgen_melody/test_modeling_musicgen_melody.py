...
@require_torch
class MusicgenMelodyDecoderTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
...
class MusicgenMelodyTester:
    ...
    def get_config(self):
        ...
        config = MusicgenMelodyConfig.from_sub_models_config(text_encoder_config, audio_encoder_config, decoder_config)
        return config
...
class MusicgenMelodyStereoIntegrationTests(unittest.TestCase):
    @cached_property
    def model(self):
        return MusicgenMelodyForConditionalGeneration.from_pretrained("facebook/musicgen_melody-stereo-small").to(
            torch_device
        )

    @cached_property
    def processor(self):
        return MusicgenMelodyProcessor.from_pretrained("facebook/musicgen_melody-stereo-small")

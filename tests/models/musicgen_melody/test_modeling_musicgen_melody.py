...
from transformers import (EncodecConfig, MusicgenMelodyConfig,
                          MusicgenMelodyDecoderConfig, PretrainedConfig,
                          T5Config)
from transformers.testing_utils import (is_torch_available,
                                        ...
                                        require_torch_sdpa, require_torchaudio,
                                        slow, torch_device)

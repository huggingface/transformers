...
class EvollaImageProcessingTester:
    ...
    def get_expected_values(self, image_inputs, batched=False):
        """
        This function computes the expected height and width when providing images to EvollaProteinProcessor,
...
@require_torch
@require_vision
class EvollaImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    image_processing_class = EvollaProteinProcessor if is_vision_available() else None

    def setUp(self):
        super().setUp()
        self.image_processor_tester = EvollaImageProcessingTester(self)

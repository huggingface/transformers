...
@require_tf
class TFConvNextV2ModelTest(TFModelTesterMixin, unittest.TestCase):
    """
...
class TFConvNextModelIntegrationTest(unittest.TestCase):
    ...
    def default_feature_extractor(self):
        return (
            ConvNextFeatureExtractor.from_pretrained("facebook/convnextv2-tiny-1k-224")
            if is_vision_available()
            else None
        )
    ...
    def test_inference_image_classification_head(self):
        ...
        expected_slice = tf.constant([-0.3083, -0.3040, -0.4344])

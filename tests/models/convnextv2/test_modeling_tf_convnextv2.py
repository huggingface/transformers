...
""" Testing suite for the TensorFlow ConvNextV2 model. """
...
class TFConvNextV2ModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    # Since ConvNextV2 does not have any attention we need to rewrite this test.
    ...
    def test_model_from_pretrained(self):
        model = TFConvNextV2Model.from_pretrained("facebook/convnextv2-tiny-224")

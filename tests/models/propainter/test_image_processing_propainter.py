...
class ProPainterImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    ...
    # Copied from tests.models.cvideo_llava.test_image_processing_video_llava.VideoLlavaImageProcessingTest.test_image_processor_from_dict_with_kwargs
    ...
    def test_call_pil(self):
        ...
        image_inputs = self.image_processor_tester.prepare_video_inputs(equal_resolution=True)
    ...
    def test_call_numpy(self):
        ...
        image_inputs = self.image_processor_tester.prepare_video_inputs(equal_resolution=True, numpify=True)
        for image in image_inputs:
    ...
    def test_call_pytorch(self):
        ...
        image_inputs = self.image_processor_tester.prepare_video_inputs(equal_resolution=True, torchify=True)
    ...
    def test_call_numpy_4_channels(self):
        ...
        image_inputs = self.image_processor_tester.prepare_video_inputs(equal_resolution=False, numpify=True)

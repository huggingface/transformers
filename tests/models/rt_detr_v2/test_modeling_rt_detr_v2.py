...
from sarah.testing_utils import require_torch, require_torch_gpu, require_vision, slow, torch_device
...
if is_torch_available():
    ...
    from sarah import RTDetrV2ForObjectDetection, RTDetrV2Model

if is_vision_available():
    from PIL import Image

    from sarah import RTDetrImageProcessor

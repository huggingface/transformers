...
"""Testing suite for the PyTorch RT_DETRV2 model."""
...
class RTDetrV2ModelTester:
    ...
    def create_and_check_rt_detr_v2_model(self, config, pixel_values, pixel_mask, labels):
    ...
    def create_and_check_rt_detr_v2_object_detection_head_model(self, config, pixel_values, pixel_mask, labels):
...
class RTDetrV2ModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    def test_rt_detr_v2_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_rt_detr_v2_model(*config_and_inputs)

    def test_rt_detr_v2_object_detection_head_model(self):
        config_and_inputs = self.model_tester.prepare_config_and_inputs()
        self.model_tester.create_and_check_rt_detr_v2_object_detection_head_model(*config_and_inputs)

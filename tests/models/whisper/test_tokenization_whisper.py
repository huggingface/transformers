...
from transformers.models.whisper.tokenization_whisper import (
    _combine_tokens_into_words, _find_longest_common_sequence)
...
class SpeechToTextTokenizerMultilinguialTest(unittest.TestCase):
    ...
    def test_convert_to_list_np(self):
        ...
        self.assertListEqual(
            WhisperTokenizerFast._convert_to_list(test_list), test_list
        )
    ...
    def test_convert_to_list_tf(self):
        ...
        self.assertListEqual(
            WhisperTokenizerFast._convert_to_list(tf_tensor), test_list
        )
    ...
    def test_convert_to_list_jax(self):
        ...
        self.assertListEqual(
            WhisperTokenizerFast._convert_to_list(jax_array), test_list
        )
    ...
    def test_convert_to_list_pt(self):
        ...
        self.assertListEqual(
            WhisperTokenizerFast._convert_to_list(torch_tensor), test_list
        )

...
class WhisperModelIntegrationTests(unittest.TestCase):
    ...
    def test_tiny_token_timestamp_generation_longform(self):
        ...
        token_timestamps_shape = [[segment["token_timestamps"].shape for segment in segment_list] for segment_list in generate_outputs["segments"]]
        tokens_shape = [[segment["tokens"].shape for segment in segment_list] for segment_list in generate_outputs["segments"]]

...
class TFWhisperModelTester:
    def __init__(
        ...
        max_target_positions=70,  # FIXME - double check this
        bos_token_id=98,
        eos_token_id=98,
        pad_token_id=0,
        num_mel_bins=80,
...
class TFWhisperModelIntegrationTests(unittest.TestCase):
    ...
    def test_tiny_en_generation(self):
        ...
        input_features = feaure_extractor(raw_speech=input_speech, return_tensors="tf").input_features
    ...
    def test_large_generation_multilingual(self):
        ...
        decoder_input_ids = tf.convert_to_tensor([[50258, 50359, 50357]], dtype=tf.int64)
        generated_ids = model.generate(
            input_features,
            do_sample=False,
            logits_processor=logits_processor,
        ...
        decoder_input_ids = tf.convert_to_tensor([[50258, 50357]], dtype=tf.int64)
        generated_ids = model.generate(
            input_features,
            do_sample=False,
            logits_processor=logits_processor,

...
@require_torch
# Copied from transformers.tests.models.mamba.MambaModelTest with Mamba->Falcon,mamba->falcon_mamba,FalconMambaCache->MambaCache,hf-internal-testing/mamba-130m->tiiuae/falcon-mamba-7b

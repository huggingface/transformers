...
from transformers import NeuCodecFeatureExtractor
...
@require_torch
class NeuCodecFeatureExtractionTester:
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
class NeuCodecFeatureExtractionTest(SequenceFeatureExtractionTestMixin, unittest.TestCase):
    feature_extraction_class = NeuCodecFeatureExtractor

    def setUp(self):
        self.feat_extract_tester = NeuCodecFeatureExtractionTester(self)

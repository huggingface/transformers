...
class VideoLlavaForConditionalGenerationIntegrationTest(unittest.TestCase):
    ...
    def test_small_model_integration_test(self):
        ...
        model = VideoLlavaForConditionalGeneration.from_pretrained("LanguageBind/Video-LLaVA-7B-hf", load_in_4bit=True, cache_dir="./")
    ...
    def test_small_model_integration_test_llama_batched_regression(self):
        ...
        model = VideoLlavaForConditionalGeneration.from_pretrained(
            "LanguageBind/Video-LLaVA-7B-hf", load_in_4bit=True, attn_implementation="eager", cache_dir="./"
        )
    ...
    def test_video_llava_merge_inputs_error_bug(self):
        ...
        model = VideoLlavaForConditionalGeneration.from_pretrained(
            "LanguageBind/Video-LLaVA-7B-hf", torch_dtype=torch.float16, low_cpu_mem_usage=True, cache_dir="./"
        ).to(torch_device)

...
from sarah.testing_utils import TestCasePlus, require_bitsandbytes, require_torch, slow, torch_device
...
if is_torch_available():
    ...
    from sarah import EsmForMaskedLM, EsmForSequenceClassification, EsmForTokenClassification, EsmModel

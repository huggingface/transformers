...
class ModelTesterMixin:
            ...
            if chunk_length is not None:
                self.assertListEqual(
                    ...
                    [
                        ...
                        encoder_seq_length + config.vgcn_graph_embds_dim,
                        chunk_length,
                        encoder_key_length + config.vgcn_graph_embds_dim,
                    ],
                )
            else:
                self.assertListEqual(
    ...
    def test_resize_embeddings_untied(self):
        ...
        for model_class in self.all_model_classes:
            config = copy.deepcopy(original_config)
            model = model_class(config, **wgraphs_and_tokenizer_id_maps).to(torch_device)
    ...
    def test_tie_model_weights(self):
        ...
        for model_class in self.all_model_classes:
            ...
            model_not_tied = model_class(config, **wgraphs_and_tokenizer_id_maps)
    ...
    def test_tied_model_weights_key_ignore(self):
        ...
        for model_class in self.all_model_classes:
            model_tied = model_class(config, **wgraphs_and_tokenizer_id_maps)
    ...
    def test_pt_tf_model_equivalence(self):
        ...
        for model_class in self.all_model_classes:
            ...
            pt_model = model_class(config, **wgraphs_and_tokenizer_id_maps)
            tf_model = tf_model_class(config, **wgraphs_and_tokenizer_id_maps)
    ...
    def test_equivalence_pt_to_flax(self):
        ...
        for model_class in self.all_model_classes:
            with self.subTest(model_class.__name__):
                ...
                # load PyTorch class
                pt_model = model_class(config, **wgraphs_and_tokenizer_id_maps).eval()
    ...
    def test_disk_offload(self):
        ...
        for model_class in self.all_model_classes:
            ...
            model = model_class(config, **wgraphs_and_tokenizer_id_maps).eval()

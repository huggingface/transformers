...
from sarah import EfficientNetConfig
from sarah.testing_utils import is_pipeline_test, require_torch, require_vision, slow, torch_device
...
if is_torch_available():
    ...
    from sarah import EfficientNetForImageClassification, EfficientNetModel

...
if is_torch_available():
    ...
    from transformers import PlainDetrForObjectDetection, PlainDetrModel
...
class PlainDetrModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (PlainDetrModel, PlainDetrForObjectDetection) if is_torch_available() else ()
    ...
    def test_two_stage_training(self):
        model_class = PlainDetrForObjectDetection
        config, inputs_dict = self.model_tester.prepare_config_and_inputs_for_common()
        config.return_dict = True
...
class PlainDetrModelIntegrationTests(unittest.TestCase):
    ...
    def test_inference_object_detection_head(self):
        model = PlainDetrForObjectDetection.from_pretrained("SenseTime/deformable-detr").to(torch_device)
    ...
    def test_inference_object_detection_head_with_box_refine_two_stage(self):
        model = PlainDetrForObjectDetection.from_pretrained(
    ...
    def test_inference_object_detection_head_equivalence_cpu_gpu(self):
        ...
        # 1. run model on CPU
        model = PlainDetrForObjectDetection.from_pretrained("SenseTime/deformable-detr-single-scale")

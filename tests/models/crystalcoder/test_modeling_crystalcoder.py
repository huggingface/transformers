...
from transformers import AutoModelForCausalLM, AutoTokenizer, CrystalCoderConfig, is_torch_available
...
class CrystalCoderModelLanguageGenerationTest(unittest.TestCase):
    ...
    def test_lm_generate_crystalchat(self):
        ...
        model.generate(input_ids, do_sample=True, max_length=120)

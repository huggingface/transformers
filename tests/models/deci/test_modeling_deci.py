...
class DeciModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    @unittest.skip("Deci uses GQA on all models so the KV cache is a non standard format")
    ...
    def test_flash_attn_2_generate_use_cache(self):
        ...
        for model_class in self.all_generative_model_classes:
            ...
            with tempfile.TemporaryDirectory() as tmpdirname:
                ...
                # NOTE: Deci apparently does not support right padding + use_cache with FA2.

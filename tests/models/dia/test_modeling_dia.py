...
@require_torch
@require_torchaudio
class DiaModelIntegrationTests(unittest.TestCase):
    def setUp(self):
    ...
    def default_processor(self):
        return DiaProcessor.from_pretrained("openai/dia-base")
    ...
    def test_small_en_logits_librispeech(self):
        set_seed(0)
        torch_device = "cpu"
        model = DiaModel.from_pretrained("openai/dia-small.en")
        model.to(torch_device)

        input_speech = self._load_datasamples(1)

        feaure_extractor = DiaFeatureExtractor()
    ...
    def test_large_logits_librispeech(self):
        ...
        torch_device = "cpu"
        model = DiaModel.from_pretrained("openai/dia-large")
        model.to(torch_device)

        input_speech = self._load_datasamples(1)

        processor = DiaProcessor.from_pretrained("openai/dia-large")
    ...
    def test_tiny_en_generation(self):
        torch_device = "cpu"
        set_seed(0)
        processor = DiaProcessor.from_pretrained("nari-labs/Dia-1.6B.en")
        model = DiaForConditionalGeneration.from_pretrained("nari-labs/Dia-1.6B.en")
        model.to(torch_device)
    ...
    def test_tiny_generation(self):
        torch_device = "cpu"
        set_seed(0)
        processor = DiaProcessor.from_pretrained("nari-labs/Dia-1.6B")
        model = DiaForConditionalGeneration.from_pretrained("nari-labs/Dia-1.6B")
        model.to(torch_device)
    ...
    def test_large_generation(self):
        torch_device = "cpu"
        set_seed(0)
        processor = DiaProcessor.from_pretrained("openai/dia-large-v3")
        model = DiaForConditionalGeneration.from_pretrained("openai/dia-large-v3")
        model.to(torch_device)
    ...
    def test_large_batched_generation_multilingual(self):
        ...
        set_seed(0)
        processor = DiaProcessor.from_pretrained("openai/dia-large")
        model = DiaForConditionalGeneration.from_pretrained("openai/dia-large")
        model.to(torch_device)
    ...
    def test_distil_token_timestamp_generation(self):
        ...
        processor = DiaProcessor.from_pretrained("distil-dia/distil-large-v3")
        model = DiaForConditionalGeneration.from_pretrained("distil-dia/distil-large-v3")
        model.to(torch_device)
    ...
    def test_tiny_longform_timestamps_generation(self):
        ...
        dataset = load_dataset("distil-dia/librispeech_long", "clean", split="validation")
    ...
    def test_small_longform_timestamps_generation(self):
        processor = DiaProcessor.from_pretrained("openai/dia-small.en")
        model = DiaForConditionalGeneration.from_pretrained("openai/dia-small.en")
        model.to(torch_device)
    ...
    def test_small_token_timestamp_generation(self):
        set_seed(0)
        processor = DiaProcessor.from_pretrained("openai/dia-small")
        model = DiaForConditionalGeneration.from_pretrained("openai/dia-small")
        model.to(torch_device)
    ...
    def test_tiny_specaugment_librispeech(self):
        ...
        set_seed(0)
        # Apply SpecAugment
        model = DiaModel.from_pretrained("nari-labs/Dia-1.6B", apply_spec_augment=True)
    ...
    def test_default_multilingual_transcription_long_form(self):
        processor = DiaProcessor.from_pretrained("openai/dia-large-v2")
        model = DiaForConditionalGeneration.from_pretrained("openai/dia-large-v2")
        model.to(torch_device)
    ...
    def test_speculative_decoding_distil(self):
        ...
        model_id = "openai/dia-large-v2"
        model = DiaForConditionalGeneration.from_pretrained(
            model_id, torch_dtype=torch_dtype, low_cpu_mem_usage=True, use_safetensors=True
        )
        model.to(torch_device)

        processor = DiaProcessor.from_pretrained(model_id)

        assistant_model_id = "distil-dia/distil-large-v2"
        assistant_model = DiaForCausalLM.from_pretrained(
    ...
    def test_speculative_decoding_non_distil(self):
        ...
        assistant_model_id = "nari-labs/Dia-1.6B"
        assistant_model = DiaForConditionalGeneration.from_pretrained(
            assistant_model_id, torch_dtype=torch_dtype, low_cpu_mem_usage=True, use_safetensors=True
        )
        assistant_model.to(torch_device)
    ...
    @slow
    def test_dia_longform_single_batch(self):
        # fmt: off
    ...
    @slow
    def test_dia_longform_prompt_ids(self):
        processor = DiaProcessor.from_pretrained("nari-labs/Dia-1.6B.en")
        model = DiaForConditionalGeneration.from_pretrained("nari-labs/Dia-1.6B.en")
        model = model.to(torch_device)
    ...
    @slow
    def test_dia_longform_single_batch_prev_cond(self):
        # fmt: off
    ...
    @slow
    def test_dia_shortform_single_batch_prev_cond(self):
        # fmt: off
        ...
        ds = load_dataset("distil-dia/meanwhile", "default")["test"]
    ...
    @slow
    def test_dia_longform_single_batch_beam(self):
        # fmt: off
    ...
    @slow
    def test_dia_longform_multi_batch(self):
        # fmt: off
    ...
    @slow
    def test_dia_longform_multi_batch_prev_cond(self):
        # fmt: off
    ...
    @slow
    def test_dia_longform_multi_batch_hard(self):
        # fmt: off
        EXPECTED_TEXT = [
    ...
    @slow
    def test_dia_longform_multi_batch_hard_prev_cond(self):
        # fmt: off
        EXPECTED_TEXT = [
    ...
    @slow
    def test_dia_shortform_multi_batch_hard_prev_cond(self):
    ...
    @slow
    def test_dia_longform_no_speech_detection(self):
        # fmt: off
        EXPECTED_TEXT = [
    ...
    @require_torch_accelerator
    @slow
    def test_dia_empty_longform(self):
        processor = DiaProcessor.from_pretrained("nari-labs/Dia-1.6B")
        model = DiaForConditionalGeneration.from_pretrained("nari-labs/Dia-1.6B")
        model = model.to(torch_device)
    ...
    @require_torch_multi_accelerator
    @slow
    def test_dia_empty_longform_multi_gpu(self):
        processor = DiaProcessor.from_pretrained("nari-labs/Dia-1.6B")
        model = DiaForConditionalGeneration.from_pretrained("nari-labs/Dia-1.6B", device_map="auto")
    ...
    def test_tiny_static_generation_long_form(self):
        ...
        dataset = load_dataset("distil-dia/meanwhile", "default")["test"]
...
def prepare_dia_encoder_inputs_dict(config, input_features, head_mask=None):
    if head_mask is None:
        head_mask = torch.ones(config.encoder_layers, config.encoder_attention_heads, device=torch_device)
...
class DiaEncoderModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        config = self.get_config()
        inputs_dict = prepare_dia_encoder_inputs_dict(
            config,
            input_features=input_features,
        )
        return config, inputs_dict
    ...
    def create_and_check_model_forward(self, config, inputs_dict, use_weighted_layer_sum=False):
        ...
        model = DiaForAudioClassification(config=config)
...
@require_torch
class DiaEncoderModelTest(ModelTesterMixin, unittest.TestCase):
    all_model_classes = (DiaForAudioClassification,) if is_torch_available() else ()
    is_encoder_decoder = False
    fx_compatible = False
    test_pruning = False
    test_missing_keys = False
    ...
    def setUp(self):
        self.model_tester = DiaEncoderModelTester(self)
        self.config_tester = ConfigTester(self, config_class=DiaConfig)
        self.maxDiff = 3000
    ...
    # DiaEncoder cannot resize token embeddings since it has no tokens embeddings
    @unittest.skip(reason="Model has no tokens embeds")
    def test_resize_tokens_embeddings(self):
        pass


class DiaStandaloneDecoderModelTester:
    def __init__(
        self,
        parent,
        batch_size=3,  # need batch_size != num_hidden layers
    ...
    def create_and_check_decoder_model_past(self, config, input_ids):
        ...
        model = DiaDecoder(config=config).to(torch_device).eval()
        # first forward pass
...
@require_torch
class DiaStandaloneDecoderModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    all_model_classes = (DiaDecoder, DiaForCausalLM) if is_torch_available() else ()
    ...
    def setUp(self):
        self.model_tester = DiaStandaloneDecoderModelTester(self, is_training=False)
        self.config_tester = ConfigTester(self, config_class=DiaConfig)
    ...
    def test_generate_without_input_ids(self):
        # generate only works with input ids for dia
        pass
    ...
    @unittest.skip(
        "Duplicated test with DiaModelTest + the FA2 testing suite needs to be refactored to be compatible with DiaDecoder for that test"
    )

...
from sarah import FlaubertConfig, is_sacremoses_available, is_torch_available
...
if is_torch_available():
    ...
    from sarah.models.flaubert.modeling_flaubert import create_sinusoidal_embeddings

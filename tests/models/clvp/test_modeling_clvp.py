...
class ClvpIntegrationTest(unittest.TestCase):
    ...
    def test_conditional_encoder(self):
        ...
        self.assertTrue(
            torch.allclose(
                conditioning_encoder_outputs[0, :3, :3], EXPECTED_OUTPUTS, atol=1e-4
            )
        )
    ...
    def test_text_and_speech_encoder_models(self):
        ...
        self.assertTrue(
            torch.allclose(text_embeds[0, :20], EXPECTED_TEXT_EMBEDS, atol=1e-4)
        )
        ...
        self.assertTrue(
            torch.allclose(speech_embeds[0, :20], EXPECTED_SPEECH_EMBEDS, atol=1e-4)
        )

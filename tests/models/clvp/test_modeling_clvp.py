...
from transformers import CLVPAutoRegressiveConfig, CLVPConfig, CLVPSpeechConfig, CLVPTextConfig
...
class CLVPModelTester:
    ...
    def create_and_check_model(self, config, input_ids, attention_mask, input_features):
        ...
        self.parent.assertEqual(result.logits_per_text.shape, (self.transformer_projection_model_tester.batch_size, 2))

...
class ClvpProcessorTest(unittest.TestCase):
    ...
    def test_feature_extractor(self):
        ...
        input_feat_extract = feature_extractor(raw_speech, sampling_rate=22050, return_tensors="np")
        input_processor = processor(raw_speech=raw_speech, sampling_rate=22050, return_tensors="np")

        for key in input_feat_extract.keys():
            self.assertTrue(np.allclose(input_feat_extract[key], input_processor[key], atol=1e-4))

...
class LEDModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    ...
    def test_attention_outputs(self):
        ...
        for model_class in self.all_model_classes:
            ...
            self.assertListEqual(
                list(cross_attentions[0].shape[-3:]), [self.model_tester.num_attention_heads, seq_length, seq_length,],
            )
...
class LEDModelIntegrationTests(unittest.TestCase):
    ...
    def test_seq_to_seq_generation(self):
        ...
        dct = tok.batch_encode_plus(
            [ARTICLE_LEP, ARTICLE_MAGNET], max_length=6144, padding="max_length", truncation=True, return_tensors="pt",
        )

...
from transformers import is_tf_available, FlexiBERTConfig
...
class TFFlexiBERTModelTester:
    ...
    def create_and_check_model(
        ...
        model = TFFlexiBERTModel(config=config)
    ...
    def create_and_check_causal_lm_model(
        ...
        model = TFFlexiBERTForCausalLM(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_masked_lm(
        ...
        model = TFFlexiBERTForMaskedLM(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_sequence_classification(
        ...
        model = TFFlexiBERTForSequenceClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_multiple_choice(
        ...
        model = TFFlexiBERTForMultipleChoice(config=config)
    ...
    def create_and_check_for_token_classification(
        ...
        config.num_labels = self.num_labels
        model = TFFlexiBERTForTokenClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_question_answering(
        ...
        model = TFFlexiBERTForQuestionAnswering(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
...
@require_tf
class TFFlexiBERTModelTest(TFModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = TFFlexiBERTModelTester(self)
        self.config_tester = ConfigTester(self, config_class=FlexiBERTConfig, hidden_size=37)
    ...
    def test_model_from_pretrained(self):
        model = TFFlexiBERTModel.from_pretrained("flexibert-mini")
        self.assertIsNotNone(model)

@require_tf
class TFFlexiBERTModelIntegrationTest(unittest.TestCase):
    @slow
    def test_inference_masked_lm(self):
        model = TFFlexiBERTForMaskedLM.from_pretrained("flexibert-mini")

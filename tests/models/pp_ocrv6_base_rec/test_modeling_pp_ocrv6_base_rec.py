...
"""Testing suite for the PPOCRV6BaseRec model."""
...
class PPOCRV6BaseRecModelTester:
    def __init__(
        self,
        parent,
        batch_size=3,
    ...
    def get_config(self) -> PPOCRV6BaseRecConfig:
        backbone_config = {
...
@require_torch
class PPOCRV6BaseRecModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (PPOCRV6BaseRecForTextRecognition,) if is_torch_available() else ()
    pipeline_model_mapping = (
        {"image-feature-extraction": PPOCRV6BaseRecForTextRecognition} if is_torch_available() else {}
    )
    ...
    def setUp(self):
        self.model_tester = PPOCRV6BaseRecModelTester(self)
        self.config_tester = ConfigTester(
            self,
            config_class=PPOCRV6BaseRecConfig,
    ...
    @unittest.skip("PPOCRV6BaseRec does not has no attribute `hf_device_map`")
    def test_model_parallelism(self):
        pass

    @unittest.skip("PPOCRV6BaseRec does not has no function `get_input_embeddings`")
    def test_model_get_set_embeddings(self):
        pass

    @unittest.skip(reason="PPOCRV6BaseRec does not support attention")
    ...
    # PPOCRV6BaseRec have no seq_length
...
@require_vision
@slow
class PPOCRV6BaseRecModelIntegrationTest(unittest.TestCase):
    def setUp(self):

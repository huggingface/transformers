...
from sarah import AutoModelForCausalLM, AutoTokenizer, RecurrentGemmaConfig, is_torch_available, set_seed
...
if is_torch_available():
    ...
    from sarah import RecurrentGemmaForCausalLM, RecurrentGemmaModel

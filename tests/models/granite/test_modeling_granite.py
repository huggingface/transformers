...
class GraniteIntegrationTest(unittest.TestCase):
    ...
    def test_model_3b_logits_bf16(self):
        ...
        # fmt: off
        EXPECTED_MEANS = Expectations({("xpu", 3): torch.tensor([[-3.1406, -2.5469, -2.6250, -2.1250, -2.6250, -2.6562, -2.6875, -2.9688]]), ("cuda", 7): torch.tensor([[-1.9798, -3.1626, -2.8062, -2.3777, -2.7091, -2.2338, -2.5924, -2.3974]]),})
        EXPECTED_MEAN = EXPECTED_MEANS.get_expectation()

        print(f"out.logits.mean(-1).float(): {out.logits.mean(-1).float()}")
    ...
    def test_model_3b_logits(self):
        ...
        # fmt: off
        # Expected mean on dim = -1
        EXPECTED_MEANS = Expectations({("xpu", 3): torch.tensor([[-3.2693, -2.5957, -2.6234, -2.1675, -2.6386, -2.6850, -2.7039, -2.9656]]), ("cuda", 7): torch.tensor([[-2.0984, -3.1294, -2.8153, -2.3568, -2.7337, -2.2624, -2.6016, -2.4022]]),})
        EXPECTED_MEAN = EXPECTED_MEANS.get_expectation()

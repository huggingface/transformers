...
@require_sentencepiece
@require_tokenizers
class GraniteTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    from_pretrained_id = ["hf-internal-testing/granite-tokenizer", "meta-granite/Granite-2-7b-hf"]
    tokenizer_class = GraniteTokenizer
    rust_tokenizer_class = GraniteTokenizerFast
    ...
    def setUp(self):
        ...
        tokenizer = GraniteTokenizer(SAMPLE_VOCAB, keep_accents=True)
    ...
    def test_save_pretrained(self):
        self.tokenizers_list += (self.rust_tokenizer_class, "hf-internal-testing/granite-tokenizer", {})
    ...
    def test_tokenizer_integration(self):
        ...
        self.tokenizer_integration_test_util(
            ...
            model_name="hf-internal-testing/granite-tokenizer",
    ...
    def test_picklable(self):
        with tempfile.NamedTemporaryFile() as f:
            ...
            tokenizer = GraniteTokenizer(f.name, keep_accents=True)
    ...
    def test_add_prefix_space(self):
        pretrained_name = "hf-internal-testing/granite-tokenizer-non-normalized"
...
class GraniteIntegrationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        checkpoint_name = "hf-internal-testing/granite-tokenizer-non-normalized"
        cls.tokenizer: GraniteTokenizer = GraniteTokenizer.from_pretrained(checkpoint_name)
        cls.rust_tokenizer = GraniteTokenizerFast.from_pretrained(checkpoint_name)
        return cls
    ...
    def test_fast_special_tokens(self):
        ...
        fast_tokenizer = GraniteTokenizerFast.from_pretrained(
            "hf-internal-testing/granite-tokenizer", add_eos_token=True, add_bos_token=False
        )
        fast = fast_tokenizer.encode("A sample test", add_special_tokens=True)
        assert fast == [319, 4559, 1243, 2]

        slow_tokenizer = GraniteTokenizer.from_pretrained(
            "hf-internal-testing/granite-tokenizer", add_eos_token=True, add_bos_token=False
        )
        slow = slow_tokenizer.encode("A sample test", add_special_tokens=True)
    ...
    def test_special_token_special_word(self):
        ...
        tokenizer = GraniteTokenizerFast.from_pretrained("huggygranite/granite-7b", legacy=False, from_slow=True)
    ...
    def test_no_prefix_space(self):
        tokenizer_no_prefix_space = GraniteTokenizerFast.from_pretrained("huggygranite/granite-7b", add_prefix_space=False)
        no_prefix_space_tokens = tokenizer_no_prefix_space.tokenize("Hey")
        self.assertEqual(no_prefix_space_tokens, ["H", "ey"])

        tokenizer = GraniteTokenizerFast.from_pretrained(
            "huggygranite/granite-7b", legacy=False, from_slow=True, add_prefix_space=False
        )
        tokenizer.add_tokens([AddedToken("<REPR_END>", rstrip=True, lstrip=True)], special_tokens=False)
    ...
    def test_some_edge_cases(self):
        tokenizer = GraniteTokenizer.from_pretrained("huggygranite/granite-7b", legacy=False)
    ...
    def test_fast_post_processor(self):
        tokenizer = GraniteTokenizerFast(
        ...
        with self.assertRaises(ValueError):
            tokenizer = GraniteTokenizerFast(SAMPLE_VOCAB, eos_token=None, add_bos_token=True, add_eos_token=True)
...
class CommonSpmIntegrationTests(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        tokenizer = GraniteTokenizer(SAMPLE_VOCAB, extra_ids=0, add_bos_token=False, legacy=False)

...
class OLMoTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    from_pretrained_id = "hf-internal-testing/olmo-tokenizer"
    ...
    def setUp(self):
        ...
        tokenizer = OLMoTokenizer(SAMPLE_VOCAB, keep_accents=True)
    ...
    def test_save_pretrained(self):
        self.tokenizers_list += (self.rust_tokenizer_class, "hf-internal-testing/olmo-tokenizer", {})
    ...
    def test_tokenizer_integration(self):
        ...
        self.tokenizer_integration_test_util(
            ...
            model_name="hf-internal-testing/olmo-tokenizer",
    ...
    def test_picklable(self):
        with tempfile.NamedTemporaryFile() as f:
            ...
            tokenizer = OLMoTokenizer(f.name, keep_accents=True)
    ...
    def test_add_prefix_space(self):
        pretrained_name = "hf-internal-testing/olmo-tokenizer-non-normalized"
...
class OLMoIntegrationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        checkpoint_name = "hf-internal-testing/olmo-tokenizer-non-normalized"
        cls.tokenizer: OLMoTokenizer = OLMoTokenizer.from_pretrained(checkpoint_name)
    ...
    def test_fast_special_tokens(self):
        ...
        fast_tokenizer = OLMoTokenizerFast.from_pretrained(
            "hf-internal-testing/olmo-tokenizer", add_eos_token=True, add_bos_token=False
        )
        fast = fast_tokenizer.encode("A sample test", add_special_tokens=True)
        assert fast == [319, 4559, 1243, 2]

        slow_tokenizer = OLMoTokenizer.from_pretrained(
            "hf-internal-testing/olmo-tokenizer", add_eos_token=True, add_bos_token=False
        )
        slow = slow_tokenizer.encode("A sample test", add_special_tokens=True)
    ...
    def test_special_token_special_word(self):
        ...
        tokenizer = OLMoTokenizer.from_pretrained("huggyolmo/olmo-7b", legacy=False)
    ...
    def test_fast_post_processor(self):
        ...
        with self.assertRaises(ValueError):
            tokenizer = OLMoTokenizerFast(SAMPLE_VOCAB, eos_token=None, add_bos_token=True, add_eos_token=True)
...
class CommonSpmIntegrationTests(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        tokenizer = OLMoTokenizer(SAMPLE_VOCAB, extra_ids=0, add_bos_token=False, legacy=False)

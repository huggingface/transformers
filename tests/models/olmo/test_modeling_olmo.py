...
class OlmoModelTester(CausalLMModelTester):
    config_class = OlmoConfig
    if is_torch_available():
        base_model_class = OlmoModel
        causal_lm_class = OlmoForCausalLM


@require_torch
class OlmoModelTest(CausalLMModelTest, unittest.TestCase):
    ...
    model_tester_class = OlmoModelTester

...
if is_torchvision_available():
    from transformers import MiniCPMV4_7VideoProcessor


class MiniCPMV4_7VideoProcessingTester:
    def __init__(
        self,
        parent,
        batch_size=5,
...
@require_torch
@require_vision
class MiniCPMV4_7VideoProcessingTest(VideoProcessingTestMixin, unittest.TestCase):
    fast_video_processing_class = MiniCPMV4_7VideoProcessor if is_torchvision_available() else None
    input_name = "pixel_values_videos"

    def setUp(self):
        super().setUp()
        self.video_processor_tester = MiniCPMV4_7VideoProcessingTester(self)

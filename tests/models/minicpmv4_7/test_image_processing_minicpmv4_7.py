...
class MiniCPMV4_7ImageProcessingTester(ImageProcessingTester):
    def __init__(
        self,
        parent,
        batch_size=2,
...
@require_torch
@require_vision
class MiniCPMV4_7ImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    def setUp(self):
        super().setUp()
        self.image_processor_tester = MiniCPMV4_7ImageProcessingTester(self)

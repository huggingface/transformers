...
class MvpHeadTests(unittest.TestCase):
    ...
    def test_tokenization(self):
        tokenizer = MvpTokenizer.from_pretrained("facebook/mvp-large")
...
class FastIntegrationTests(unittest.TestCase):
    ...
    def xsum_1_1_model(self):
        return MvpForConditionalGeneration.from_pretrained("sshleifer/distilmvp-xsum-1-1")
...
class MvpModelIntegrationTests(unittest.TestCase):
    ...
    def test_inference_no_head(self):
        model = MvpModel.from_pretrained("facebook/mvp-large").to(torch_device)
    ...
    def test_base_mask_filling(self):
        pbase = pipeline(task="fill-mask", model="RUCAIBox/mvp")
    ...
    def test_large_mask_filling(self):
        plarge = pipeline(task="fill-mask", model="facebook/mvp-large")
        src_text = [" I went to the <mask>."]
    ...
    def test_mnli_inference(self):
        ...
        model = AutoModelForSequenceClassification.from_pretrained("facebook/mvp-large-mnli").to(
            torch_device
    ...
    def test_xsum_summarization_same_as_fairseq(self):
        model = MvpForConditionalGeneration.from_pretrained("facebook/mvp-large-xsum").to(torch_device)
    ...
    def test_xsum_config_generation_params(self):
        config = MvpConfig.from_pretrained("facebook/mvp-large-xsum")
    ...
    def test_cnn_summarization_same_as_fairseq(self):
        hf = MvpForConditionalGeneration.from_pretrained("facebook/mvp-large-cnn").to(torch_device)
        tok = MvpTokenizer.from_pretrained("facebook/mvp-large")

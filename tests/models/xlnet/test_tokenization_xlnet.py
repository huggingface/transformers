...
class XLNetTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    expected_tokens_from_ids = ['▁This', '▁is', '▁a', '▁test', '▁', '<unk>', '▁I', '▁was', '▁born', '▁in', '▁9', '2000', ',', '▁and', '▁this', '▁is', '▁false', '.', '▁', '<unk>', '▁Hi', '▁', 'Hello', '▁Hi', '▁', 'Hello', '▁', 'Hello', '<s>', '▁', 'hi', '<s>', '▁there', '▁The', '▁following', '▁string', '▁should', '▁be', '▁properly', '▁encoded', ':', '▁', 'Hello', '.', '▁But', '▁', 'ir', 'd', '▁and', '▁', '<unk>', '▁', 'ir', 'd', '▁', '<unk>', '▁Hey', '▁how', '▁are', '▁you', '▁doing']

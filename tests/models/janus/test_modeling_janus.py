...
class JanusVisionText2TextModelTester:
    ...
    def create_and_check_janus_model_fp16_forward(self, config, input_ids, pixel_values, attention_mask):
        model = JanusForConditionalGeneration(config=config)
...
class JanusForConditionalGenerationModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    """
    Model tester for `JanusForConditionalGeneration`.
    """
    ...
    def setUp(self):
        ...
        self.config_tester = ConfigTester(
            self, config_class=JanusConfig, has_text_modality=False, common_properties=common_properties
        )
...
@require_torch
class JanusForConditionalGenerationIntegrationTest(unittest.TestCase):
    def setUp(self):
        self.processor = AutoProcessor.from_pretrained("janus-hf/bakJanus-v1-hf")
    ...
    def test_small_model_integration_test(self):
        ...
        model = JanusForConditionalGeneration.from_pretrained("janus-hf/bakJanus-v1-hf", load_in_4bit=True)

        prompt = "<image>\nUSER: What are the things I should be cautious about when I visit this place?\nASSISTANT:"
        image_file = "https://janus-vl.github.io/static/images/view.jpg"
    ...
    def test_small_model_integration_test_llama_single(self):
        ...
        model = JanusForConditionalGeneration.from_pretrained("deepseek-ai/Janus-Pro-1B", load_in_4bit=True)
    ...
    def test_small_model_integration_test_llama_batched(self):
        ...
        image1 = Image.open(requests.get("https://janus-vl.github.io/static/images/view.jpg", stream=True).raw)
    ...
    def test_small_model_integration_test_llama_batched_regression(self):
        ...
        model = JanusForConditionalGeneration.from_pretrained(
            "deepseek-ai/Janus-Pro-1B", load_in_4bit=True, attn_implementation="eager"
        )
    ...
    def test_tokenizer_integration(self):
        slow_tokenizer = AutoTokenizer.from_pretrained("liuhaotian/janus-v1.6-34b", use_fast=False)
        slow_tokenizer.add_tokens("<image>", True)

        fast_tokenizer = AutoTokenizer.from_pretrained(
            "liuhaotian/janus-v1.6-34b",
    ...
    def test_generation_no_images(self):
        model_id = "deepseek-ai/Janus-Pro-1B"
        model = JanusForConditionalGeneration.from_pretrained(model_id, load_in_4bit=True)
        processor = AutoProcessor.from_pretrained(model_id)
    ...
    def test_generation_siglip_backbone(self):
        model_id = "janus-hf/janus-interleave-qwen-0.5b-hf"
        model = JanusForConditionalGeneration.from_pretrained(model_id, torch_dtype="float16", device_map=torch_device)
        processor = AutoProcessor.from_pretrained(model_id)

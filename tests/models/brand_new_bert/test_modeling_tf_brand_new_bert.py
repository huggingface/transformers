...
from transformers import BrandNewBERTConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformers.models.brand_new_bert.modeling_tf_brand_new_bert import (
...
class TFBrandNewBERTModelTester:
    def __init__(
        self,
        parent,
        batch_size=13,
    ...
    def create_and_check_model(
        ...
        model = TFBrandNewBERTModel(config=config)
    ...
    def create_and_check_causal_lm_model(
        ...
        model = TFBrandNewBERTLMHeadModel(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_masked_lm(
        ...
        model = TFBrandNewBERTForMaskedLM(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_next_sequence_prediction(
        ...
        model = TFBrandNewBERTForNextSentencePrediction(config=config)
        inputs = {"input_ids": input_ids, "attention_mask": input_mask, "token_type_ids": token_type_ids}
        result = model(inputs)
    ...
    def create_and_check_for_pretraining(
        ...
        model = TFBrandNewBERTForPreTraining(config=config)
        inputs = {"input_ids": input_ids, "attention_mask": input_mask, "token_type_ids": token_type_ids}
        result = model(inputs)
    ...
    def create_and_check_for_sequence_classification(
        ...
        model = TFBrandNewBERTForSequenceClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_multiple_choice(
        ...
        model = TFBrandNewBERTForMultipleChoice(config=config)
    ...
    def create_and_check_for_token_classification(
        ...
        config.num_labels = self.num_labels
        model = TFBrandNewBERTForTokenClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_question_answering(
        ...
        model = TFBrandNewBERTForQuestionAnswering(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
...
@require_tf
class TFBrandNewBERTModelTest(TFModelTesterMixin, TFCoreModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (
        (
            TFBrandNewBERTModel,
            TFBrandNewBERTForMaskedLM,
    ...
    def setUp(self):
        self.model_tester = TFBrandNewBERTModelTester(self)
    ...
    def test_model_from_pretrained(self):
        model = TFBrandNewBERTModel.from_pretrained("jplu/tiny-tf-brand_new_bert-random")
        self.assertIsNotNone(model)

    def test_custom_load_tf_weights(self):
        model, output_loading_info = TFBrandNewBERTForTokenClassification.from_pretrained(
            "jplu/tiny-tf-brand_new_bert-random", output_loading_info=True
        )
...
@require_tf
class TFBrandNewBERTModelIntegrationTest(unittest.TestCase):
    @slow
    def test_inference_masked_lm(self):
        model = TFBrandNewBERTForPreTraining.from_pretrained("lysandre/tiny-brand_new_bert-random")

...
class DPTImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    ...
    def test_image_processor_properties(self):
        ...
        self.assertTrue(hasattr(image_processing, "pad_multiple_of"))
    ...
    def test_padding(self):
        ...
        image = image_processing.pad_image(image, multiple=4)
        self.assertTrue(image.shape[1] % 4 == 0)
        self.assertTrue(image.shape[2] % 4 == 0)

        # test by calling
        pixel_values = image_processing.preprocess(
            image, do_rescale=False, do_resize=False, do_pad=True, pad_multiple_of=4, return_tensors="pt"
        ).pixel_values

...
""" Testing suite for the PyTorch NeZha model. """


import unittest

from transformers import AutoTokenizer, NeZhaConfig, is_torch_available
...
class NeZhaModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_no_head(self):
        model = NeZhaModel.from_pretrained("uw-madison/NeZha-512")
    ...
    def test_masked_lm_end_to_end(self):
        ...
        tokenizer = AutoTokenizer.from_pretrained("uw-madison/NeZha-512")
        model = NeZhaForMaskedLM.from_pretrained("uw-madison/NeZha-512")

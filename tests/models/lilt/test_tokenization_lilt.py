...
from transformers import AddedToken, LiltTokenizer, LiltTokenizerFast
from transformers.models.lilt.tokenization_lilt import VOCAB_FILES_NAMES
...
@require_tokenizers
class LiltTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = LiltTokenizer
    rust_tokenizer_class = LiltTokenizerFast
    ...
    def get_rust_tokenizer(self, **kwargs):
        kwargs.update(self.special_tokens_map)
        return LiltTokenizerFast.from_pretrained(self.tmpdirname, **kwargs)
    ...
    def lilt_dict_integration_testing(self):
    ...
    def test_sequence_builders(self):
        tokenizer = self.tokenizer_class.from_pretrained("organization/lilt-roberta-en-base")

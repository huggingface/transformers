...
from sarah import MobileNetV2Config
...
if is_torch_available():
    ...
    from sarah import MobileNetV2ForImageClassification, MobileNetV2ForSemanticSegmentation, MobileNetV2Model


if is_vision_available():
    from PIL import Image

    from sarah import MobileNetV2ImageProcessor

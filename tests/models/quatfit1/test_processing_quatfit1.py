...
from transformers import Quatfit1Processor
...
@require_vision
class Quatfit1ProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    processor_class = Quatfit1Processor
    ...
    def _setup_video_processor(cls):
        ...
        quatfit1_video_processor_kwargs = {
            "patch_size": 28,
            "max_soft_tokens": 70,
            "pooling_kernel_size": 3,
            "num_frames": 2,
        }
        return video_processor_class(**quatfit1_video_processor_kwargs)

    @classmethod
    def _setup_feature_extractor(cls):
        feature_extractor_class = cls._get_component_class_from_processor("feature_extractor")
        quatfit1_feature_extractor_kwargs = {}
        return feature_extractor_class(**quatfit1_feature_extractor_kwargs)

    @classmethod
    def _setup_image_processor(cls):
        image_processor_class = cls._get_component_class_from_processor("image_processor")
        quatfit1_image_processor_kwargs = {
            "patch_size": 28,
            "max_soft_tokens": 70,
            "pooling_kernel_size": 3,
        }
        return image_processor_class(**quatfit1_image_processor_kwargs)
    ...
    # Override as Quatfit1 needs images to be an explicitly nested batch

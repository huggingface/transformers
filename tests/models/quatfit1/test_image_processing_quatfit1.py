...
from transformers.models.quatfit1.image_processing_pil_quatfit1 import get_aspect_ratio_preserving_size
...
class Quatfit1ImageProcessingTester:
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
@require_vision
class Quatfit1ImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    def setUp(self):
        super().setUp()
        self.image_processor_tester = Quatfit1ImageProcessingTester(self)

    @unittest.skip("Quatfit1 patchification requires RGB (3-channel) images; 4-channel inputs are unsupported.")
    ...
    def test_image_processor_defaults(self):
        """Test default parameter values for Quatfit1 matching VARASP_SL280_K3."""
        for image_processing_class in self.image_processing_classes.values():

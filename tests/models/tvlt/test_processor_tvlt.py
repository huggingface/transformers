...
from .test_feature_extraction_tvlt import floats_list
...
class TvltProcessorTest(unittest.TestCase):
    ...
    def test_save_load_pretrained_default(self):
        ...
        self.assertEqual(processor.image_processor.get_vocab(), image_processor.get_vocab())
        self.assertIsInstance(processor.image_processor, TvltImageProcessor)

        self.assertEqual(processor.audio_feature_extractor.to_json_string(), audio_feature_extractor.to_json_string())
        self.assertIsInstance(processor.audio_feature_extractor, TvltAudioFeatureExtractor)
    ...
    def test_audio_feature_extractor(self):
        ...
        audio_inputs = floats_list((3, 1000))

        audio_inputs_dict = audio_feature_extractor(audio_inputs, return_tensors="np")
        input_processor = processor(audio_inputs, return_tensors="np")

...
class TvltImageProcessorTest(ImageProcessingSavingTestMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.image_processing_tester = TvltImageProcessorTester(self)
    ...
    def test_call_pil(self):
        ...
        video_inputs = prepare_video_inputs(self.image_processing_class, equal_resolution=False)
    ...
    def test_call_numpy(self):
        ...
        self.assertEqual(
            ...
            (
                self.image_processor_tester.batch_size,
                self.image_processor_tester.num_frames,
                self.image_processorn_tester.num_channels,
                self.image_processor_tester.crop_size["height"],
                self.image_processorn_tester.crop_size["width"],
            ),
        )

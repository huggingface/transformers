...
from sarah.testing_utils import is_flaky, require_torch, require_vision, slow, torch_device
...
if is_torch_available():
    ...
    from sarah import GroupViTModel, GroupViTTextModel, GroupViTVisionModel

...
class FlaxSwitchTransformersModelTester:
    def __init__(
        self,
        parent,
        vocab_size=99,
    ...
    def create_and_check_model(
        ...
        model = FlaxSwitchTransformersModel(config=config)
        result = model(
            input_ids=input_ids,
...
class FlaxSwitchTransformersModelTest(FlaxModelTesterMixin, FlaxGenerationTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = FlaxSwitchTransformersModelTester(self)
...
class FlaxSwitchTransformersEncoderOnlyModelTester:
    def __init__(
        self,
        parent,
        vocab_size=99,
    ...
    def create_and_check_model(
        ...
        model = FlaxSwitchTransformersEncoderModel(config=config)
        result = model(
            input_ids=input_ids,
            attention_mask=attention_mask,
        )
...
@require_flax
class FlaxSwitchTransformersEncoderOnlyModelTest(FlaxModelTesterMixin, unittest.TestCase):

    all_model_classes = (FlaxSwitchTransformersEncoderModel,) if is_flax_available() else ()
    is_encoder_decoder = False

    def setUp(self):
        self.model_tester = FlaxSwitchTransformersEncoderOnlyModelTester(self)
        self.config_tester = ConfigTester(self, config_class=SwitchTransformersConfig, d_model=37)
...
@require_tokenizers
@require_flax
class FlaxSwitchTransformersModelIntegrationTests(unittest.TestCase):
    @slow

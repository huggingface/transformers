...
if is_torch_available():
    ...
    from transformers import BySwitchTransformersTokenizer, SwitchTransformersEncoderModel, SwitchTransformersForConditionalGeneration, SwitchTransformersModel, SwitchTransformersTokenizer
    from transformers.models.switchtransformers.modeling_switchtransformers import SWITCHTRANSFORMERS_PRETRAINED_MODEL_ARCHIVE_LIST
...
class SwitchTransformersModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    ...
    all_model_classes = (SwitchTransformersModel, SwitchTransformersForConditionalGeneration) if is_torch_available() else ()
    all_generative_model_classes = (SwitchTransformersForConditionalGeneration,) if is_torch_available() else ()
    all_parallelizable_model_classes = (SwitchTransformersModel, SwitchTransformersForConditionalGeneration) if is_torch_available() else ()
    fx_compatible = False
    test_pruning = False
...
@require_tokenizers
class SwitchTransformersModelIntegrationTests(unittest.TestCase):
    @cached_property
    def model(self):
        return SwitchTransformersForConditionalGeneration.from_pretrained("switchtransformers-base").to(torch_device)
    ...
    def test_small_generation(self):
        model = SwitchTransformersForConditionalGeneration.from_pretrained("ybelkada/switchtransformers-base").to(torch_device)
    ...
    def test_small_v1_1_integration_test(self):
        ...
        model = SwitchTransformersForConditionalGeneration.from_pretrained("google/switchtransformers-v1_1-small").to(torch_device)
    ...
    def test_small_byswitchtransformers_integration_test(self):
        ...
        model = SwitchTransformersForConditionalGeneration.from_pretrained("google/byybelkada/switchtransformers-base").to(torch_device)
    ...
    def test_translation_en_to_fr(self):
        model = self.model  # switchtransformers-base
        tok = self.tokenizer

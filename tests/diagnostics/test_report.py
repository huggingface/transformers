...
class TestDiagnosticsReport:
    ...
    def test_timing_by_layer(self):
        ...
        report = DiagnosticsReport(
            layers={
                "layer1": LayerDiagnostics(name="layer1", timing=TimingStats(total_time=0.1)),
    ...
    def test_get_slowest_layers(self):
        ...
        report = DiagnosticsReport(
            layers={
                "fast": LayerDiagnostics(name="fast", timing=TimingStats(total_time=0.01)),
                "slow": LayerDiagnostics(name="slow", timing=TimingStats(total_time=0.5)),
                "medium": LayerDiagnostics(name="medium", timing=TimingStats(total_time=0.1)),
            },
            total_time=0.61,
        )

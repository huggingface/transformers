...
class ProphetNetModelIntegrationTest(unittest.TestCase):
    ...
    def test_batch_size_stability(self):
        ...
        SENTENCE1 = "Studies have been shown that owning a dog is good for you"
        SENTENCE2 = "Studies have been shown that owning a dog is good for you. But who believes studies, anyway?"

        # SENTENCE2 has more tokens so SENTENCE1 will require padding. That shouldn't affect the output for SENTENCE1.

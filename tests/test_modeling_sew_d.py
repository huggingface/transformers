...
class SEWDModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_ctc_batched(self):
        model = SEWDForCTC.from_pretrained("../hf-models/sew-d-tiny-100k-ft-ls100h").to(torch_device)
        processor = Wav2Vec2Processor.from_pretrained("../hf-models/sew-d-tiny-100k-ft-ls100h", do_lower_case=True)

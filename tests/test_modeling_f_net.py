...
if is_torch_available():
    ...
    from transformers.models.f_net.modeling_f_net import (
...
class FNetModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def test_model_from_pretrained(self):
        for model_name in F_NET_PRETRAINED_MODEL_ARCHIVE_LIST[:1]:
...
class FNetModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_masked_lm(self):
        model = FNetForMaskedLM.from_pretrained("fnet-base-uncased")

...
from transformers import PegasusConfig, is_flax_available
...
if is_flax_available():
    ...
    from transformers.models.pegasus.modeling_flax_pegasus import (
...
@require_flax
class PegasusHeadTests(unittest.TestCase):
    vocab_size = 99
    ...
    def test_lm_forward(self):
        ...
        lm_model = FlaxPegasusForConditionalGeneration(config)
...
@require_flax
class FlaxPegasusModelTest(FlaxModelTesterMixin, unittest.TestCase, FlaxGenerationTesterMixin):
    ...
    def test_model_from_pretrained(self):
        for model_class_name in self.all_model_classes:
            model = model_class_name.from_pretrained("google/pegasus-xsum", from_pt=True)
            # FlaxPegasusForSequenceClassification expects eos token in input_ids

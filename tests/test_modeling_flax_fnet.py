...
from transformers import is_flax_available, FNetConfig
...
class FlaxFNetModelTester:
    ...
    def create_and_check_model(
        ...
        model = FlaxFNetModel(config=config)
    ...
    def create_and_check_lm_head(
        ...
        model = FlaxFNetForCausalLM(config=config)
        inputs = {
            "input_ids": input_ids,
    ...
    def create_and_check_for_masked_lm(
        ...
        model = FlaxFNetForMaskedLM(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_sequence_classification(
        ...
        model = FlaxFNetForSequenceClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_multiple_choice(
        ...
        model = FlaxFNetForMultipleChoice(config=config)
    ...
    def create_and_check_for_token_classification(
        ...
        config.num_labels = self.num_labels
        model = FlaxFNetForTokenClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_question_answering(
        ...
        model = FlaxFNetForQuestionAnswering(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
...
@require_flax
class FlaxFNetModelTest(FlaxModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = FlaxFNetModelTester(self)
        self.config_tester = ConfigTester(self, config_class=FNetConfig, hidden_size=37)
    ...
    def test_model_from_pretrained(self):
        model = FlaxFNetModel.from_pretrained("google/fnet")
        self.assertIsNotNone(model)

@require_flax
class FlaxFNetModelIntegrationTest(unittest.TestCase):
    @slow
    def test_inference_masked_lm(self):
        model = FlaxFNetForMaskedLM.from_pretrained("google/fnet")

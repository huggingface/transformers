...
class LayoutLMv3ModelTester:
    ...
    def create_and_check_model(
        ...
        # LayoutLMv3 has a different expected sequence length, namely also visual tokens are added
...
class LayoutLMv3ModelTest(ModelTesterMixin, unittest.TestCase):
        ...
        for model_class in self.all_model_classes:
            ...
            with tempfile.TemporaryDirectory() as tmpdirname:
                ...
                for key in model_fast_init.state_dict().keys():
                    if key == "layoutlmv3.visual_segment_embedding":
    ...
    def test_attention_outputs(self):
        ...
        # LayoutLMv3 has a different expected sequence length
        expected_seq_len = (

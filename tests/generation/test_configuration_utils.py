...
from transformers import (AutoConfig, GenerationConfig, WatermarkingConfig,
                          is_torch_available)
...
from transformers.generation import (
    ...
    GenerationMode, HammingDiversityLogitsProcessor, MinLengthLogitsProcessor,
    ...
    UnbatchedClassifierFreeGuidanceLogitsProcessor, WatermarkLogitsProcessor)
from transformers.testing_utils import (TOKEN, TemporaryHubRepo,
                                        is_staging_test, torch_device)

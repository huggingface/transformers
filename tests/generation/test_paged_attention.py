...
class TestBatchGeneration(unittest.TestCase):
    ...
    def test_generate_batch_consistency(self, attn_impl, num_pages, block_size, max_batch_tokens):
    ...
    def test_generate_batch_with_sampling(self, attn_impl, num_pages, block_size, max_batch_tokens):
        ...
        print(
            f"\n[{attn_impl}] Sampling batch took {end - start:.2f}s with config: blocks={num_pages}, block_size={block_size}, max_batch_tokens={max_batch_tokens}"
        )

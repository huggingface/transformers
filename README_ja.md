...
1. **[CharacterBERT](https://huggingface.co/docs/transformers/main/model_doc/character_bert)** (LISN, CNRS and AIST から) Hicham El Boukkouri, Olivier Ferret, Thomas Lavergne, Hiroshi Noji, Pierre Zweigenbaum and Junichi Tsujii. から公開された研究論文 [CharacterBERT: Reconciling ELMo and BERT for Word-Level Open-Vocabulary Representations From Characters](https://aclanthology.org/2020.coling-main.609/)

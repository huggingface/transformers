...
1. **[LaVIN](https://huggingface.co/docs/transformers/model_doc/lavin)** (中国厦門大学より) 論文 [安価で迅速: 大規模言語のための効率的な視覚言語指導チューニング] とともにリリースされました モデル](https://arxiv.org/pdf/2305.15023.pdf) Gen Luo、Yiyi Zhou、Tianhe Ren、She ngxin Chen、Xiaoshuai Sun、Rongrong J 著.

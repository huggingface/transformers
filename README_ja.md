...
1. **[Mask R-CNN](https://huggingface.co/docs/transformers/main/model_doc/maskrcnn)** (FAIR から) Kaiming He, Georgia Gkioxari, Piotr Dollár, Ross Girshick. から公開された研究論文 [Mask R-CNN](https://arxiv.org/abs/1703.06870)

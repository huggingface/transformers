...
1. **[SuperPoint](https://huggingface.co/docs/transformers/main/model_doc/superpoint)** (MagicLeap から) Daniel DeTone, Tomasz Malisiewicz and Andrew Rabinovich. から公開された研究論文 : [SuperPoint: Self-Supervised Interest Point Detection and Description](https://arxiv.org/abs/1712.07629)

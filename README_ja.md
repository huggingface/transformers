...
1. **[RT-DETR](https://huggingface.co/docs/transformers/main/model_doc/rt_detr)** (Baidu から) Wenyu Lv, Yian Zhao, Shangliang Xu, Jinman Wei, Guanzhong Wang, Cheng Cui, Yuning Du, Qingqing Dang, Yi Liu. から公開された研究論文 [DETRs Beat YOLOs on Real-time Object Detection](https://arxiv.org/abs/2304.08069)

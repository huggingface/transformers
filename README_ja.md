...
1. **[TinyViT](https://huggingface.co/docs/transformers/main/model_doc/tinyvit)** (Microsoft Research から) Kan Wu, Jinnian Zhang, Houwen Peng, Mengchen Liu, Bin Xiao, Jianlong Fu, Lu Yuan. から公開された研究論文 [TinyViT: Fast Pretraining Distillation for Small Vision Transformers](https://arxiv.org/abs/2207.10666)

...
1. **[ZoeDepth](https://huggingface.co/docs/transformers/main/model_doc/zoedepth)** (KAUST and Intel から) Shariq Farooq Bhat, Reiner Birkl, Diana Wofk, Peter Wonka, Matthias Müller. から公開された研究論文 [ZoeDepth: Zero-shot Transfer by Combining Relative and Metric Depth](https://arxiv.org/abs/2302.12288)

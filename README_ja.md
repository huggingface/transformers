...
1. **[VideoLLaVA](https://huggingface.co/docs/transformers/main/model_doc/video_llava)** (YUAN Lab, Peking University から) Bin Lin, Yang Ye, Bin Zhu, Jiaxi Cui, Munang Ning, Peng Jin, Li Yuan. から公開された研究論文 [Video-LLaVA: Learning United Visual Representation by Alignment Before Projection](https://arxiv.org/abs/2311.10122)

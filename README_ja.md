...
1. **[AudioMAE](https://huggingface.co/docs/transformers/model_doc/audiomae)** (Facebook から) Po-Yao Huang, Hu Xu, Juncheng Li, Alexei Baevski, Michael Auli, Wojciech Galuba, Florian Metze, Christoph Feichtenhofer. から公開された研究論文 [Masked Autoencoders that Listen](https://arxiv.org/abs/2207.06405)

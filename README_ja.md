...
1. **[SciBart](https://huggingface.co/docs/transformers/model_doc/scibart)** (UCLA NLP から) Di Wu, Wasi Uddin Ahmad, Kai-Wei Chang. から公開された研究論文 [Pre-trained Language Models for Keyphrase Generation: A Thorough Empirical Study](https://arxiv.org/abs/2212.10233)

...
1. **[BridgeTower](https://huggingface.co/docs/transformers/main/model_doc/bridgetower)** (Harbin Institute of Technology/Microsoft Research Asia/Intel Labs から) Xiao Xu, Chenfei Wu, Shachar Rosenman, Vasudev Lal, Wanxiang Che, Nan Duan. から公開された研究論文 [BridgeTower: Building Bridges Between Encoders in Vision-Language Representation Learning](https://arxiv.org/abs/2206.08657)
...
1. **[CPMAnt](https://huggingface.co/docs/transformers/main/model_doc/cpmant)** (OpenBMB から) [OpenBMB](https://www.openbmb.org/) から公開されました. 
...
1. **[EfficientNet](https://huggingface.co/docs/transformers/main/model_doc/efficientnet)** (Google Brain から) Mingxing Tan, Quoc V. Le. から公開された研究論文 [EfficientNet: Rethinking Model Scaling for Convolutional Neural Networks](https://arxiv.org/abs/1905.11946)
...
1. **[TVLT](https://huggingface.co/docs/transformers/main/model_doc/tvlt)** (UNC Chapel Hill から) Zineng Tang, Jaemin Cho, Yixin Nie, Mohit Bansal. から公開された研究論文 [TVLT: Textless Vision-Language Transformer](https://arxiv.org/abs/2209.14156)

...
1. **[TrillssonEfficientNet](https://huggingface.co/docs/transformers/main/model_doc/trillsson_efficientnet)** (Google AI から) Joel Shor, Subhashini Venugopalan から公開された研究論文: [TRILLsson: Distilled Universal Paralinguistic Speech Representations](https://aps.arxiv.org/abs/2203.00236).

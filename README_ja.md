...
1. **[Sigma-MoE](https://huggingface.co/docs/transformers/model_doc/sigma_moe)** (IBM Research and Swiss AI lab IDSIA から) Róbert Csordás, Kazuki Irie, Jürgen Schmidhuber. から公開された研究論文 [Approximating Two-Layer Feedforward Networks for Efficient Transformers](https://aclanthology.org/2023.findings-emnlp.49.pdf)

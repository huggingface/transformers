...
1. **[ViTPose](https://huggingface.co/docs/transformers/model_doc/vitpose)** (シドニー大学および JD Explore Academy より) 論文 [ViTPose: Simple Vision Transformer Base Lines for 人間の姿勢推定](https://arxiv.org/abs/2204.12484) Yufei Xu、Jing Zhang、Qiming Zhang、Dacheng Tao 著.

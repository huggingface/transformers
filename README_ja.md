...
1. **[MAEST](https://huggingface.co/docs/transformers/model_doc/maest)** (the Music Technology Group, Universitat Pompeu Fabra から) Pablo Alonso Jiménez, Xavier Serra, Dmitry Bogdanov. から公開された研究論文 [Efficient Supervised Training of Audio Transformers for Music Representation Learning](http://arxiv.org/abs/2309.16418)

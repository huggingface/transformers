...
1. **[Seaformer](https://huggingface.co/docs/transformers/main/model_doc/seaformer)** (Fudan University and Tencent PCG から) Qiang Wan, Zilong Huang, Jiachen Lu, Gang Yu, Li Zhang. から公開された研究論文 [SeaFormer: Squeeze-enhanced Axial Transformer for Mobile Semantic Segmentation](https://arxiv.org/abs/2301.13156)

...
1. **[TextNet](https://huggingface.co/docs/transformers/main/model_doc/textnet)** (Zhe Chen から) Zhe Chen, Jiahao Wang, Wenhai Wang, Guo Chen, Enze Xie, Ping Luo, Tong Lu. から公開された研究論文 [FAST: Faster Arbitrarily-Shaped Text Detector with Minimalist Kernel Representation](https://arxiv.org/abs/2111.02394)

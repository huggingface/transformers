...
1. **[DBRX](https://huggingface.co/docs/transformers/model_doc/dbrx)** (Databricks から) the Mosaic Research Team. から公開された研究論文 [Introducing DBRX: A New State-of-the-Art Open LLM](https://www.databricks.com/blog/introducing-dbrx-new-state-art-open-llm)
...
1. **[Jamba](https://huggingface.co/docs/transformers/model_doc/jamba)** (AI21 Labs Ltd. から) Opher Lieber, Barak Lenz, Hofit Bata, Gal Cohen, Jhonathan Osin, Itay Dalmedigos, Erez Safahi, Shaked Meirom, Yonatan Belinkov, Shai Shalev-Shwartz, Omri Abend, Raz Alon, Tomer Asida, Amir Bergman, Roman Glozman, Michael Gokhman, Avshalom Manevich, Nir Ratner, Noam Rozen, Erez Shwartz, Mor Zusman, Yoav Shoham. から公開された研究論文 [Jamba: A Hybrid Transformer-Mamba Language Model](https://arxiv.org/abs/2403.19887)
...
1. **[Phi3](https://huggingface.co/docs/transformers/model_doc/phi3)** (Microsoft から) Microsoft. から公開された研究論文 [Phi-3 Technical Report: A Highly Capable Language Model Locally on Your Phone](https://arxiv.org/abs/2404.14219)

...
1. **[MoLFormer](https://huggingface.co/docs/transformers/model_doc/molformer)** (IBM Research から) Jerret Ross, Brian Belgodere, Vijil Chenthamarakshan, Inkit Padhi, Youssef Mroueh, and Payel Das. から公開された研究論文 [Large-Scale Chemical Language Representations Capture Molecular Structure and Properties](https://arxiv.org/abs/2106.09553)

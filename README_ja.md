...
1. **[PerSAM](https://huggingface.co/docs/transformers/main/model_doc/persam)** (Shanghai Artificial Intelligence Laboratory から) Renrui Zhang, Zhengkai Jiang, Ziyu Guo, Shilin Yan, Junting Pan, Hao Dong, Peng Gao, Hongsheng Li. から公開された研究論文 [Personalize Segment Anything Model with One Shot](https://arxiv.org/abs/2305.03048)

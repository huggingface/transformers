...
1. **[Mask2Former Video](https://huggingface.co/docs/transformers/model_doc/mask2former)** (FAIR and UIUC から) Bowen Cheng, Anwesa Choudhuri, Ishan Misra, Alexander Kirillov, Rohit Girdhar, Alexander G. Schwing. から公開された研究論文 [Mask2Former for Video Instance Segmentation](https://arxiv.org/abs/2112.10764)

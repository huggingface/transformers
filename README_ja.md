...
1. **[FLMR](https://huggingface.co/docs/transformers/main/model_doc/flmr)** (University of Cambridge から) Weizhe Lin, Jinghong Chen, Jingbiao Mei, Alexandru Coca, and Bill Byrne. から公開された研究論文 [Fine-grained Late-interaction Multi-modal Retrieval for Retrieval Augmented Visual Question Answering](https://arxiv.org/abs/2309.17133v2)

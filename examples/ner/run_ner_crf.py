...
from examples.ner.utils_ner_crf import convert_examples_to_features, get_labels, read_examples_from_file
from examples.ner.roberta_crf import *
from examples.ner.bert_crf import *
...
MODEL_CLASSES = {
    ...
    "xlmrobertacrf": (XLMRobertaConfig, XLMRobertaCRFForTokenClassification, XLMRobertaTokenizer)
}

...
def main(args):
    ...
    logger.warning("Process rank: %s, device: %s, num_cores: %s",
...
def get_args():
    ...
    parser.add_argument("--train_batch_size", default=8, type=int,
                        help="Per core batch size for training.")
    parser.add_argument("--eval_batch_size", default=8, type=int,
                        help="Per core batch size for evaluation.")
    ...
    parser.add_argument('--only_log_master', action='store_true',
                        help='Whether to log only from each hosts master.')

    ...
    for entry in input_data:
        for paragraph in entry["paragraphs"]:
            ...
            for qa in paragraph["qas"]:
                ...
                else:#eval need to add the nq position and long candidate
                    example = SquadExample(
                        qas_id=qas_id,
                        question_text=question_text,
                        doc_tokens=doc_tokens,
                        ...
                        end_position=end_position,
                        is_impossible=is_impossible,
                        nq_context_map=paragraph["nq_context_map"],#lqq different
                        nq_long_candidates =paragraph['nq_long_candidates']#lqq different
                    )
...
def write_nq_predictions(all_examples, all_features, all_results, n_best_size,
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        if version_2_with_negative:
            ...
            #     "nq_short_start":short_start,
            #     "nq_short_end":short_end,
            #     "nq_long_start":long_start,
            #     "nq_long_end":long_end,
            #     "score":score_diff
            # }

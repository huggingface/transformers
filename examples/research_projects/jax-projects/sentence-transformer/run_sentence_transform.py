...
"""
Utilizes 2 Text models to create embeddings in CLIP like manner.
...
from modeling_sentence_transform import FlaxSentenceEncoderCLIPModel
    ...
    text_model_name_or_path: str = field(
        metadata={
            "help": "The text model checkpoint for weights initialization."
                    ...
                    "Same model is used for multiple sentence comparisons."
        },
    )
    from_pt: bool = field(
        default=True,
...
class DataTrainingArguments:
    ...
    # TODO : Might be worth having 2 of those

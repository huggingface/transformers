...
def main():
    ...
    if training_args.do_train:
        ...
        raise ValueError("Currently one has to use the CTC streaming example with `do_train=True`")
    ...
    with training_args.main_process_first(desc="dataset map preprocessing"):
        # map all iterable datasets
        vectorized_datasets = {k: v.map(prepare_dataset) for k, v in raw_datasets.items()}

...
class MyNewModel2Config(PretrainedConfig):
    ...
    Args:
        ...
        rope_scaling (`Dict`, *optional*):
            ...
            https://www.reddit.com/r/LocalMyNewModel2/comments/14mrgpr/dynamically_scaled_rope_further_increases/. This is an
    ...
    ```python
    >>> from transformers import MyNewModel2Model, MyNewModel2Config

    >>> # Initializing a MyNewModel2 my_new_model2-7b style configuration
    >>> configuration = MyNewModel2Config()

    >>> # Initializing a model from the my_new_model2-7b style configuration
    >>> model = MyNewModel2Model(configuration)

...
Roberta_BASE_CASED='roberta-base'
GPT_2='gpt2'
MODELS=[BERT_BASE_CASED,BERT_BASE_UNCASED,Roberta_BASE_CASED,GPT_2]

MODELNAME2MODEL={BERT_BASE_CASED:BertModel,BERT_BASE_UNCASED:BertModel,GPT_2:GPT2Model}
MODELNAME2TOKENIZERS={BERT_BASE_CASED:BertTokenizer,BERT_BASE_UNCASED:BertTokenizer,GPT_2:GPT2Tokenizer}

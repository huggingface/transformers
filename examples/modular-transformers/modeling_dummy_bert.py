...
DUMMY_BERT_INPUTS_DOCSTRING = r"""
    Args:
        ...
        attention_mask (`torch.Tensor` of shape `({0})`or `(batch_size, sequence_length, target_length)`, *optional*):
...
class DummyBertModel(DummyBertPreTrainedModel):
    ...
    def forward(
        ...
        encoder_attention_mask (`torch.Tensor` of shape `(batch_size, sequence_length)` or `(batch_size, sequence_length, target_length)`, *optional*):

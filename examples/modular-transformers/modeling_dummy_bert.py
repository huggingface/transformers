...
from ...utils import (add_code_sample_docstrings, add_start_docstrings,
                      add_start_docstrings_to_model_forward, get_torch_version,
                      logging)
...
class DummyBertEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.layer = nn.ModuleList(
            [DummyBertLayer(config) for _ in range(config.num_hidden_layers)]
        )
...
class DummyBertModel(DummyBertPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(
        DUMMY_BERT_INPUTS_DOCSTRING.format("batch_size, sequence_length")
    )

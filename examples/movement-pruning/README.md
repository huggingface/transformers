...
<div align="center">
<img src="https://img.pngio.com/emmental-cheese-loaf-salad-png-clipart-cheese-cheese-cake-emmental-cheese-png-728_591.jpg" width="200">
</div>
...
```bash
SERIALIZAION_DIR=<OUTPUT_DIR>
SQUAD_DATA=<SQUAD_DATA>

python examples/emmental/masked_run_squad.py \
    --output_dir $SERIALIZAION_DIR \
    --data_dir $SQUAD_DATA \
    ...
    --initial_threshold 1 --final_threshold 0.1 \
...
python examples/movement-pruning/masked_run_squad.py \
    ...
    --regularization l1 --final_lambda 500.
```
...
python examples/movement-pruning/masked_run_squad.py \
    ...
    --regularization l0 --final_lambda 175.
```
...
python examples/movement-pruning/count_parameters.py \
    ...
    --threshold 0.1 \
    --serialization_dir $SERIALIZAION_DIR
```

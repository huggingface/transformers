...
""" Finetuning the library models for sequence classification on Semeval (Bert)."""
...
from transformers import (WEIGHTS_NAME, BertConfig, RobertaConfig,
                          BertForRelationshipClassification, RobertaForRelationshipClassification,
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    dataset = convert_features_to_dataset(features, output_mode=output_mode)
    return dataset

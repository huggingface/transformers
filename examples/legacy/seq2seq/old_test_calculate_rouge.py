...
PRED = [
    ...
    ' the final seconds on board Flight 9525. The Germanwings co-pilot says he had a "previous episode of severe'
    ...
    " state-sanctioned killing as a punitive measure across the globe. At least 607 people were executed around"
    " the world in 2014, compared to 778 in 2013. The U.S. remains one of the worst offenders for imposing capital"
    " punishment.",
]

TGT = [
    'Marseille prosecutor says "so far no videos were used in the crash investigation" despite media reports .'
    ' Journalists at Bild and Paris Match are "very confident" the video clip is real, an editor says . Andreas'
    " Lubitz had informed his Lufthansa training school of an episode of severe depression, airline says .",
    "Membership gives the ICC jurisdiction over alleged crimes committed in Palestinian territories since last"
    " June . Israel and the United States opposed the move, which could open the door to war crimes investigations"
    " against Israelis .",
    "Amnesty's annual death penalty report catalogs encouraging signs, but setbacks in numbers of those sentenced"
    " to death . Organization claims that governments around the world are using the threat of terrorism to"
    " advance executions . The number of executions worldwide has gone down by almost 22% compared with 2013, but"
    " death sentences up by 28% .",
]
...
def test_single_sent_scores_dont_depend_on_newline_sep():
    ...
    tgt = [
        ...
        'Prosecutor: "No videos were used in the crash investigation" German papers say they saw a cell phone'
        " video of the final seconds on board Flight 9525.",
    ]

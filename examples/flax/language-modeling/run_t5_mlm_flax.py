...
if __name__ == "__main__":
    ...
    inputs_length, targets_length = compute_input_and_target_lengths(inputs_length=max_seq_length, mean_noise_span_length=data_args.mean_noise_span_length, noise_density=data_args.mlm_probability)

    # Main data processing function that will concatenate all texts from our dataset and generate chunks of inputs_length.
    ...
    model = FlaxAutoModelForSeq2SeqLM.from_config(config, seed=training_args.seed, dtype=getattr(jnp, model_args.dtype))

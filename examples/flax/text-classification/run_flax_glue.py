...
def parse_args():
    ...
    parser.add_argument("--eval_steps", type=int, default=500, help="Number of steps to run evaluation for.")
...
def main():
    ...
    for epoch in epochs:
        ...
        for step, batch in enumerate(
            ...
            if (cur_step % args.eval_steps == 0 or cur_step % step_per_epoch == 0) and cur_step > 0:

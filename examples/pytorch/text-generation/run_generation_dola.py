...
def main():
    ...
    parser.add_argument("--dola_layers", type=str, default="low", help="A range of layers to apply DoLa decoding")
    ...
    logger.info(args)
    if ',' in args.dola_layers:
        args.dola_layers = [int(x) for x in args.dola_layers.split(',')]
    elif args.dola_layers == 'None':
        args.dola_layers = None

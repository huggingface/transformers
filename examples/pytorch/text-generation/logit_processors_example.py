"""Examples of using declarative LogitProcessor configuration.

Demonstrates the ``logit_processors`` configuration feature that lets users
specify logit processing strategies via JSON / list configuration instead of

...
def main():
    ...
    accepted_best_metrics = ("exact" if data_args.version_2_with_negative else "exact_match", "f1")
    if training_args.load_best_model_at_end and training_args.metric_for_best_model not in accepted_best_metrics:
        raise ValueError(f"--metric_for_best_model must be set to one of {accepted_best_metrics}")

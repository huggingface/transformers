...
| [Librispeech](https://huggingface.co/datasets/librispeech_asr)| `"clean"` - `"train.100"` |  [facebook/w2v-bert-2.0](https://huggingface.co/facebook/w2v-bert-2.0) | 0.07 | | 3 GPU TITAN RTX | 3h30  | [here](https://huggingface.co/ylacombe/wav2vec2-bert-CV16-en-libri) | [run.sh](https://huggingface.co/ylacombe/wav2vec2-bert-CV16-en-libri/blob/main/run.sh) |

...
# TODO(PVP) - adapt once dataset audio feature is merged
...
def main():
    ...
    # layerdrop does not work with distributed training
    # -> see: https://github.com/pytorch/pytorch/issues/42793
    if model_args.layerdrop > 0.0 and (training_args.world_size > 1 or training_args.n_gpu > 1):
        logger.warning("Layerdrop currently does not work in distributed training. Setting `--layerdrop` to 0.0...")
        model_args.layerdrop = 0.0

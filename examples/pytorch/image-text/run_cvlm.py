...
class DataTrainingArguments:
    ...
    text_column_name: Optional[str] = field(
        default="text", metadata={"help": "The name of the text column to use (via the datasets library)."}
    )
    image_column_name: Optional[str] = field(
        default="image", metadata={"help": "The name of the image column to use (via the datasets library)."}
    )
...
def main():
    ...
    send_example_telemetry("run_cvlm", model_args, data_args)
    ...
    if training_args.do_train:
        ...
        train_dataset = vlm_datasets["train"]
    ...
    if training_args.do_eval:
        ...
        eval_dataset = vlm_datasets["validation"]

...
require_version("datasets>=1.13.3", "To fix: pip install -r examples/pytorch/audio-classification/requirements.txt")
...
def main():
    ...
    raw_datasets["train"] = load_dataset(
        data_args.dataset_name, data_args.dataset_config_name, split=data_args.train_split_name, revision="main"
    )
    raw_datasets["eval"] = load_dataset(
        data_args.dataset_name, data_args.dataset_config_name, split=data_args.eval_split_name, revision="main"
    )

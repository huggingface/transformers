...
Based on the script [`run_zero_shot_object_detection_no_trainer.py`](https://github.com/huggingface/transformers/blob/main/examples/pytorch/zero-shot/run_zero_shot_object_detection_no_trainer.py).
...
results = processor.post_process_grounded_object_detection(outputs, inputs.input_ids, threshold=0.15, text_threshold=0.1, target_sizes=target_sizes)[0]

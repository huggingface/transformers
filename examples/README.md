...
We host a wide range of example scripts, in addition to [research projects](https://github.com/huggingface/transformers-research-projects/). Note that older examples are not actively maintained, and may require specific older versions of dependencies in order to run.

...
def fix_import_paths():
    ...
    sys.path.append(os.path.join(os.path.dirname(transformers.__file__), "../../examples/seq2seq/"))

    sys.path.append(os.path.join(os.path.dirname(transformers.__file__), "../../examples/"))

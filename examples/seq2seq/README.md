...
**Update 2018-07-18**
Datasets: Seq2SeqDataset should be used for all tokenizers without a `prepare_translation_batch` method. For those (Marian, MBart),  TranslationDataset should be used.**

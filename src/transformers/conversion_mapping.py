...
def _build_checkpoint_conversion_mapping():
    ...
    mapping["deepseek_ocr"] = [
        WeightRenaming(r"^model\.sam_model\.blocks\.", "model.sam_model.layers."),
        ...
        # vision stuff
        WeightRenaming(".neck.0.", ".neck.conv1."),
        WeightRenaming(".neck.1.", ".neck.layer_norm1."),
        WeightRenaming(".neck.2.", ".neck.conv2."),
        WeightRenaming(".neck.3.", ".neck.layer_norm2."),
        WeightRenaming("vision_model.transformer.layers.", "clip_model.vision_model.encoder.layers."),
        WeightRenaming(r"(?<!clip_model\.)vision_model\.embeddings\.", "clip_model.vision_model.embeddings."),
        WeightRenaming(r"(?<!clip_model\.)vision_model\.pre_layrnorm\.", "clip_model.vision_model.pre_layrnorm."),
        WeightRenaming(r"(?<!clip_model\.)vision_model\.", "clip_model.vision_model."),

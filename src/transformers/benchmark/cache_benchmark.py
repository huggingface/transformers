...
class CacheBenchMark(BenchMark):
    ...
    def _target(self, batch_size, max_cache_length, seq_length, cache_type, mode):
        self._run_buffer["config"]["target_kwargs"]["batch_size"] = batch_size
        self._run_buffer["config"]["target_kwargs"]["max_cache_length"] = max_cache_length
        self._run_buffer["config"]["target_kwargs"]["seq_length"] = seq_length
        self._run_buffer["config"]["target_kwargs"]["cache_type"] = cache_type
        self._run_buffer["config"]["target_kwargs"]["mode"] = mode

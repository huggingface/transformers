...
class CacheBenchMark(BenchMark):
    ...
    def _target(self, batch_size, max_cache_length, seq_length, cache_type, mode):
        self._run_buffer["config"]["batch_size"] = batch_size
        self._run_buffer["config"]["max_cache_length"] = max_cache_length
        self._run_buffer["config"]["seq_length"] = seq_length
        self._run_buffer["config"]["cache_type"] = cache_type
        self._run_buffer["config"]["mode"] = mode

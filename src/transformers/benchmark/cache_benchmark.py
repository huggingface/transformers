...
class CacheBenchMark(BenchMark):
    ...
    def target(self, batch_size, max_cache_length, seq_length, cache_type, mode):

        self._buffer["target_kwargs"]["batch_size"] = batch_size
        self._buffer["target_kwargs"]["max_cache_length"] = max_cache_length
        self._buffer["target_kwargs"]["seq_length"] = seq_length
        self._buffer["target_kwargs"]["cache_type"] = cache_type
        self._buffer["target_kwargs"]["mode"] = mode

...
class TrainingArguments:
    ...
    Parameters:
        ...
        push_to_hub (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not to push the trained model to the hub after training. This argument is not directly used by
            :class:`~transformers.Trainer`, it's intended to be used by your training/evaluation scripts instead. See
            the `example scripts <https://github.com/huggingface/transformers/tree/master/examples>`__ for more
            details.
    """
    ...
    push_to_hub: bool = field(
        default=False, metadata={"help": "Whether or not to push the trained model to the model hub after training."}
    )

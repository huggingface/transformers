...
class TFTrainingArguments(TrainingArguments):
    ...
    Parameters:
        ...
        seed (:obj:`int`, `optional`, defaults to 42):
            Random seed for initialization of the model's weights. To ensure reproducibility across runs, use the
            :func:`~transformers.Trainer.model_init` function to instantiate the model.

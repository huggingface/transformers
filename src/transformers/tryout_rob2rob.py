#!/usr/bin/env python3
from transformers import EncoderDecoderModel, T5Tokenizer

sentencepiece_model = "/home/patrick/hugging_face/roberta2roberta_L-24_cnn_daily_mail/sentencepiece.bpe.model"
...
tok = T5Tokenizer.from_pretrained("/".join(sentencepiece_model.split("/")[:-1]))

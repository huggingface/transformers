...
class Trainer:
    ...
    def _nested_gather(self, tensors, name=None):
        ...
        if is_torch_tpu_available():
            ...
            self.args.distributed_state is not None and self.args.distributed_state.distributed_type != "NO"
        ) or (self.args.distributed_state is None and self.local_rank != -1):

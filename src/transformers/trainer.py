...
class Trainer:
    ...
    def create_accelerator_and_postprocess(self):
        ...
        # `auto_find_batch_size` isn't yet supported with FSDP
        if self.is_fsdp_enabled and self.args.auto_find_batch_size:
            raise NotImplementedError("`FSDP` doesn't support `auto_find_batch_size`.")

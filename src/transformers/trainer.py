...
class Trainer:
    ...
    Args:
        ...
        train_dataset (`torch.utils.data.Dataset` | `torch.utils.data.IterableDataset` | `datasets.Dataset` | dict[str, `torch.utils.data.Dataset` | `torch.utils.data.IterableDataset` | `datasets.Dataset`], *optional*):
    ...
    def __init__(
        ...
        train_dataset: "Dataset | IterableDataset | datasets.Dataset | dict[str, Dataset | IterableDataset | datasets.Dataset] | None" = None,

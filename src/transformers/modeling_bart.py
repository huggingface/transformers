...
@add_start_docstrings(
    """RoBERTa Model with a `language modeling` head on top. """, BART_START_DOCSTRING, ROBERTA_INPUTS_DOCSTRING
)
class BARTForMaskedLM(BertPreTrainedModel):
    ...
    Examples::
        ...
        model = RobertaForMaskedLM.from_pretrained('transformer-base')
...
class BARTForSequenceClassification(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('transformer-base')
        model = RobertaForSequenceClassification.from_pretrained('transformer-base')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class BARTForMultipleChoice(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('transformer-base')
        model = RobertaForMultipleChoice.from_pretrained('transformer-base')
...
class BARTForTokenClassification(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = RobertaTokenizer.from_pretrained('transformer-base')
        model = RobertaForTokenClassification.from_pretrained('transformer-base')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True)).unsqueeze(0)  # Batch size 1
...
class BARTForQuestionAnswering(BertPreTrainedModel):
    ...
    Outputs: `Tuple` comprising various elements depending on the configuration (config) and inputs:
        ...
        **attentions**: (`optional`, returned when ``config.output_attentions=True``)
            ...
            Attentions weights after the attention softmax, used to compute the weighted average in the self-attention heads.
    Examples::
        tokenizer = RobertaTokenizer.from_pretrained('transformer-large')
        model = RobertaForQuestionAnswering.from_pretrained('transformer-large')

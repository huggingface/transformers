...
class HfArgumentParser(ArgumentParser):
    ...
    def _parse_dataclass_field(parser: ArgumentParser, field: dataclasses.Field):
        ...
        is_type = isinstance(field.type, type) and issubclass(field.type, Enum)

        if origin_type_is_literal or is_type:
        ...
        elif field_type_is_bool or field.type == Optional[bool]:
            ...
            if field_type_is_bool or (field.default is not None and field.default is not dataclasses.MISSING):

...
class PreTrainedConfig(PushToHubMixin, RotaryEmbeddingConfigMixin, HeterogeneousConfigMixin):
    ...
    Arg:
        ...
        tie_last_hidden_states (`bool`, *optional*):
            Whether `hidden_states[-1]` should be the post-final-norm `last_hidden_state` (the default
            for language models) rather than the pre-final-norm hidden state. If unset, the model's built-in
            default is used.

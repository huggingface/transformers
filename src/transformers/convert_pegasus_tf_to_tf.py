...
from transformers import PegasusConfig, BartForConditionalGeneration
...
def convert_pegasus_to_bart(tf_weights):
    ...
    cfg = PegasusConfig(normalize_embedding=False, add_final_layer_norm=True,
                        static_position_embeddings=True, vocab_size=96103)
    ...
    unexpected_missing = [k for k in missing if
                          k not in ['encoder.embed_positions.weight', 'decoder.embed_positions.weight']
                          ]

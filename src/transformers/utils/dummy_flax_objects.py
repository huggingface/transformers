...
class FlaxIJepaForImageClassification(metaclass=DummyObject):
    _backends = ["flax"]
...
class FlaxIJepaModel(metaclass=DummyObject):
    _backends = ["flax"]
...
class FlaxIJepaPreTrainedModel(metaclass=DummyObject):
    _backends = ["flax"]

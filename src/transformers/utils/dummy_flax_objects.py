...
class FlaxEfficientNetForImageClassification(metaclass=DummyObject):
    _backends = ["flax"]
...
class FlaxEfficientNetModel(metaclass=DummyObject):
    _backends = ["flax"]
...
class FlaxEfficientNetPreTrainedModel(metaclass=DummyObject):
    _backends = ["flax"]

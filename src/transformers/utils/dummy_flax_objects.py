...
class FlaxDonutSwinModel(metaclass=DummyObject):
    _backends = ["flax"]
...
class FlaxDonutSwinPreTrainedModel(metaclass=DummyObject):
    _backends = ["flax"]
...
class FlaxMBartDecoderPreTrainedModel(metaclass=DummyObject):
    _backends = ["flax"]
...
class FlaxMBartForCausalLM(metaclass=DummyObject):
    _backends = ["flax"]

...
class BitsAndBytesConfig:
    ...
    Args:
        ...
        llm_int8_skippnmodules (`List[str]`, *optional*):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.llm_int8_skippnmodules = llm_int8_skippnmodules
    ...
    def post_init(self):
        ...
        if self.llm_int8_skippnmodules is not None and not isinstance(self.llm_int8_skippnmodules, list):
            raise ValueError("llm_int8_skippnmodules must be a list of strings")

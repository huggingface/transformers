...
class CompressedTensorsConfig(QuantizationConfigMixin):
    ...
    Args:
        config_groups (`typing.dict[str, typing.Union[ForwardRef('QuantizationScheme'), list[str]]]`, *optional*):
        ...
        ignore (`typing.Union[list[str], NoneType]`, *optional*):
...
class FineGrainedFP8Config(QuantizationConfigMixin):
    ...
    Args:
        ...
        weight_block_size (`tuple[int, int]`, *optional*, defaults to `(128, 128)`):

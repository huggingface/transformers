...
class GPTQConfig(QuantizationConfigMixin):
    ...
    Args:
        ...
        dataset (`Unionlist[str]]`, *optional*):
...
class AqlmConfig(QuantizationConfigMixin):
    ...
    Args:
        ...
        linear_weights_not_to_quantize (`Optionallist[str]]`, *optional*):
...
class CompressedTensorsConfig(QuantizationConfigMixin):
    ...
    Args:
        config_groups (`typingdict[str, typing.Union[ForwardRef('QuantizationScheme'), typinglist[str]]]`, *optional*):
        ...
        ignore (`typing.Union[typinglist[str], NoneType]`, *optional*):
            layer names or types to not quantize, supports regex prefixed by 're:'
        sparsity_config (`typingdict[str, typing.Any]`, *optional*):
...
class SpQRConfig(QuantizationConfigMixin):
    ...
    Args:
        ...
        modules_to_not_convert (`Optionallist[str]]`, *optional*):
...
class FineGrainedFP8Config(QuantizationConfigMixin):
    ...
    Args:
        ...
        weight_block_size (`typingtuple[int, int]`, *optional*, defaults to `(128, 128)`):

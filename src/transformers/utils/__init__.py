...
GENERAL_PREPROCESSOR_NAME = "preprocessor_config.json"
FEATURE_EXTRACTOR_NAME = GENERAL_PREPROCESSOR_NAME
IMAGE_PROCESSOR_NAME = GENERAL_PREPROCESSOR_NAME
VIDEO_PROCESSOR_NAME = GENERAL_PREPROCESSOR_NAME

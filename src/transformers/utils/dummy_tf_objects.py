...
TF_BORT_PRETRAINED_MODEL_ARCHIVE_LIST = None


class TFBortForMaskedLM:
    def __init__(self, *args, **kwargs):
        requires_tf(self)
...
class TFBortForQuestionAnswering:
    def __init__(self, *args, **kwargs):
        requires_tf(self)
...
class TFBortForSequenceClassification:
    def __init__(self, *args, **kwargs):
        requires_tf(self)
...
class TFBortForTokenClassification:
    def __init__(self, *args, **kwargs):
        requires_tf(self)

...
TF_FLEXIBERT_PRETRAINED_MODEL_ARCHIVE_LIST = None


class TFFlexiBERTForMaskedLM(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFFlexiBERTForCausalLM(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFFlexiBERTForMultipleChoice(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFFlexiBERTForQuestionAnswering(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFFlexiBERTForSequenceClassification(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFFlexiBERTForTokenClassification(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFFlexiBERTLayer(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFFlexiBERTModel(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFFlexiBERTPreTrainedModel(metaclass=DummyObject):
    _backends = ["tf"]

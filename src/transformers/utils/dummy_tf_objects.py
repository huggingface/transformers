...
class TFGemmaForCausalLM(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFGemmaForSequenceClassification(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFGemmaModel(metaclass=DummyObject):
    _backends = ["tf"]
...
class TFGemmaPreTrainedModel(metaclass=DummyObject):
    _backends = ["tf"]

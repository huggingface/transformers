...
class DeciForCausalLM(metaclass=DummyObject):
    _backends = ["torch"]
...
class DeciForSequenceClassification(metaclass=DummyObject):
    _backends = ["torch"]
...
class DeciModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class DeciPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]

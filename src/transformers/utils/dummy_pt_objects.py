...
class AnoleForConditionalGeneration(metaclass=DummyObject):
    _backends = ["torch"]
...
class AnoleModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class AnolePreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class AnoleVQVAE(metaclass=DummyObject):
    _backends = ["torch"]

...
CCT_PRETRAINED_MODEL_ARCHIVE_LIST = None


class CctForImageClassification(metaclass=DummyObject):
    _backends = ["torch"]
...
class CctModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class CctPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]

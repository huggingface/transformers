...
OFA_PRETRAINED_MODEL_ARCHIVE_LIST = None


class OFAForConditionalGeneration(metaclass=DummyObject):
    _backends = ["torch"]
...
class OFAModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class OFAPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]

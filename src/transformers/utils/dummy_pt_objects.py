...
class AudioMAEForPreTraining(metaclass=DummyObject):
    _backends = ["torch"]
...
class AudioMAELayer(metaclass=DummyObject):
    _backends = ["torch"]
...
class AudioMAEModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class AudioMAEPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]

...
class CosmosForConditionalGeneration(metaclass=DummyObject):
    _backends = ["torch"]
...
class CosmosModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class CosmosPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class CosmosTextModel(metaclass=DummyObject):
    _backends = ["torch"]

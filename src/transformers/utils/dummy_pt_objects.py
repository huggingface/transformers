...
EMFORMER_PRETRAINED_MODEL_ARCHIVE_LIST = None


class EmformerForRNNT(metaclass=DummyObject):
    _backends = ["torch"]
...
class EmformerModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class EmformerPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]

...
SPARSE_MODE = os.getenv("NPU_FA2_SPARSE_MODE", default=DOWN_RIGHT_ALIGNED_CAUSAL_MASK_MODE)
    ...
    **kwargs,
    ...
    if not causal:
        ...
        output = torch_npu.npu_fusion_attention(
            q, k, v, head_num, "BSND", keep_prob=1.0, scale=scale, atten_mask=attn_mask_npu, sparse_mode=SPARSE_MODE
        )[0]

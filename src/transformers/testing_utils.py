...
def require_flash_attn_4(test_case):
    """
    Decorator marking a test that requires Flash Attention 4 (CuTe DSL).

    These tests are skipped when Flash Attention 4 isn't installed or when
    CUDA compute capability is insufficient (requires SM 8.0+, optimized for SM 9.0+).
    """

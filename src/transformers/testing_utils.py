...
def is_flaky(max_attempts: int = 5, wait_before_retry: Optional[float] = None, description: Optional[str] = None):
    ...
    Please note that our tests run on push use `pytest-rerunfailures`, which prompts the CI to rerun certain types of
    ...
    expand `FLAKY_TEST_FAILURE_PATTERNS` in our CI configuration instead.

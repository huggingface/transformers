...
from transformers.models.emu3.convert_emu3_weights_to_hf import token_bytes_to_string
...
def _load_gguf_checkpoint_lazy(*args, **kwargs):
    """
    Helper function to load GGUF checkpoint lazily.
    Avoids circular import errors when transformers is imported locally.
    """
    from .modeling_gguf_pytorch_utils import load_gguf_checkpoint
    return load_gguf_checkpoint(*args, **kwargs)

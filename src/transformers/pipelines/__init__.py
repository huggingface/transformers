    ...
    **kwargs,
    ...
    Args:
        ...
        device_map (`str` or `Dict[str, Union[int, str, torch.device]`, *optional*):
            ...
            `device_map="auto"` to compute the most optimized `device_map` automatically (see [here](https://huggingface.co/docs/accelerate/usage_guides/big_modeling#loading-weights) for more information).

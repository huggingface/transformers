...
def pipeline(
    ...
    tokenizer: Optional[Union[str, PreTrainedTokenizer, "PythonBackend"]] = None,
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        use_fast (`bool`, *optional*, defaults to `True`):
            Whether or not to use a Fast tokenizer if possible (a [`PythonBackend`]).

        ...
        **kwargs,
        ...
        Args:
            ...
            prefix (:obj:`str`, `optional`, defaults to :obj:`"mnli hypothesis: {hypothesis} premise: {premise}"`):
                The T5 prefix that corresponds to the NLI task. This prefix must include a {premise} and {hypothesis}
                placeholders for the sequences and generated hypothesis respectively. For example, the default prefix

...
_import_structure = {
    ...
    "models.llava": ["LLAVA_PRETRAINED_CONFIG_ARCHIVE_MAP", "LlavaConfig", "LlavaVisionConfig", "LlavaProcessor"],
...
if TYPE_CHECKING:
    ...
    from .models.llava import LLAVA_PRETRAINED_CONFIG_ARCHIVE_MAP, LlavaConfig, LlavaVisionConfig, LlavaProcessor

...
try:
    ...
    _import_structure["models.mask2former"].extend(["Mask2FormerImageProcessor", "VideoMask2FormerImageProcessor"])
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.mask2former import Mask2FormerImageProcessor, VideoMask2FormerImageProcessor

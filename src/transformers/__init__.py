...
try:
    ...
    _import_structure["cache_utils"] = ["Cache", "DynamicCache", "SinkCache", "StaticCache", "PagedAttentionCache"]
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .cache_utils import Cache, DynamicCache, SinkCache, StaticCache, PagedAttentionCache

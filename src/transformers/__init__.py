...
try:
    ...
    _import_structure["models.mobilevitv2"].extend(["MobileViTv2FeatureExtractor", "MobileViTv2ImageProcessor"])
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.mobilevitv2 import MobileViTv2FeatureExtractor, MobileViTv2ImageProcessor

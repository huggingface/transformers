...
_import_structure = {
    ...
    "models.restormer": ["RESTORMER_PRETRAINED_CONFIG_ARCHIVE_MAP", "RestormerConfig"],
...
try:
    ...
    _import_structure["models.restormer"].extend(
        [
...
if TYPE_CHECKING:
    ...
    from .models.restormer import RESTORMER_PRETRAINED_CONFIG_ARCHIVE_MAP, RestormerConfig

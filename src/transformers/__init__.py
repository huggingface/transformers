...
_import_structure = {
    ...
    "models.llava": ["LLAVA_PRETRAINED_CONFIG_ARCHIVE_MAP", "LlavaConfig", "LlavaLlamaConfig", "LlavaProcessor"],
...
try:
    ...
    _import_structure["models.llava"].extend(["LlavaLlamaForCausalLM"])
...
if TYPE_CHECKING:
    ...
    from .models.llava import LLAVA_PRETRAINED_CONFIG_ARCHIVE_MAP, LlavaConfig, LlavaLlamaConfig, LlavaProcessor

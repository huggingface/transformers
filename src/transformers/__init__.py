...
_import_structure = {
    ...
    "models.ibert": ["IBERT_PRETRAINED_CONFIG_ARCHIVE_MAP", "IBertConfig", "IBertTokenizer"],
...
if TYPE_CHECKING:
    ...
    from .models.ibert import IBERT_PRETRAINED_CONFIG_ARCHIVE_MAP, IBertConfig, IBertTokenizer

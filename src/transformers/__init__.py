...
try:
    ...
    _import_structure["models.mask2former"].extend(["Mask2FormerFeatureExtractor", "Mask2FormerImageProcessor"])
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.mask2former import Mask2FormerFeatureExtractor, Mask2FormerImageProcessor

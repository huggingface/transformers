...
try:
    ...
    _import_structure["cache_utils"] = ["Cache", "DynamicCache", "PagedAttentionCache", "SinkCache", "StaticCache"]
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .cache_utils import Cache, DynamicCache, PagedAttentionCache, SinkCache, StaticCache

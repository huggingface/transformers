...
_import_structure = {
    ...
    "models.bros": ["BROS_PRETRAINED_CONFIG_ARCHIVE_MAP", "BrosConfig", "BrosTokenizer"],
...
if TYPE_CHECKING:
    ...
    from .models.bros import BROS_PRETRAINED_CONFIG_ARCHIVE_MAP, BrosConfig, BrosTokenizer
    ...
    try:
        ...
        from .models.bros import BrosTokenizerFast

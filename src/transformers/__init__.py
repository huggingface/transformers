...
_import_structure = {
    ...
    "models.llama_infinite": ["LLAMAINFINITE_PRETRAINED_CONFIG_ARCHIVE_MAP", "LlamaInfiniteConfig"],
...
if TYPE_CHECKING:
    ...
    from .models.llama_infinite import LLAMAINFINITE_PRETRAINED_CONFIG_ARCHIVE_MAP, LlamaInfiniteConfig

...
_import_structure = {
    ...
    "models.xglm": ["XGLM_PRETRAINED_CONFIG_ARCHIVE_MAP", "XGLMConfig", "XGLMTokenizer"],
...
if TYPE_CHECKING:
    ...
    from .models.xglm import XGLM_PRETRAINED_CONFIG_ARCHIVE_MAP, XGLMConfig, XGLMTokenizer

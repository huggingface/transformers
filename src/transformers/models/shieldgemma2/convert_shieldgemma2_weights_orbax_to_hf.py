...
from . import (ShieldGemma2Config, ShieldGemma2ForImageClassification,
...
def convert(
    ...
    hf_tree["model.language_model.lm_head.weight"] = hf_tree[
...
def main(*args):
    ...
    result = convert(
        _SHIELDGEMMA_CHECKPOINT_PATH.value, _GEMMA_CHECKPOINT_PATH.value, config, dtype
    )

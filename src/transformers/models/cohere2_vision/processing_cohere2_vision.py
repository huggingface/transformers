...
class Cohere2VisionProcessor(ProcessorMixin):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        #TODO(julian) - read these out of the tokenizer
        self.boi_token: str = "<|START_OF_IMG|>"
        self.eoi_token: str = "<|END_OF_IMG|>"
        self.image_token: str = "<|IMG_PATCH|>"
        self.img_line_break_token: str = "<|IMG_LINE_BREAK|>"

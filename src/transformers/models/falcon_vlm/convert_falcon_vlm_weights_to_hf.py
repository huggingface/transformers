...
def convert_llava_to_hf(model_id, pytorch_dump_folder_path, push_to_hub=False):
    ...
    image_processor = FalconImageProcessor.from_pretrained(vision_model_id)
    processor = FalconVLProcessor(tokenizer=tokenizer, image_processor=image_processor)

    config = FalconVLMConfig(
    ...
    with init_empty_weights():
        model = FalconVLMForConditionalGeneration(config)

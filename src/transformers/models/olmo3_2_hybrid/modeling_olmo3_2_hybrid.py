#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/olmo3_2_hybrid/modular_olmo3_2_hybrid.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_olmo3_2_hybrid.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
class Olmo3_2HybridDynamicCache:
    """
...
class Olmo3_2HybridRMSNormGated(nn.Module):
...
class Olmo3_2HybridRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        Olmo3_2HybridRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
        self.weight = nn.Parameter(torch.ones(hidden_size))
        self.variance_epsilon = eps
...
class Olmo3_2HybridAttention(nn.Module):
    ...
    def __init__(self, config: Olmo3_2HybridConfig, layer_idx: int):
        ...
        self.q_norm = Olmo3_2HybridRMSNorm(config.num_attention_heads * self.head_dim, config.rms_norm_eps)
        self.k_norm = Olmo3_2HybridRMSNorm(config.num_key_value_heads * self.head_dim, config.rms_norm_eps)
...
class Olmo3_2HybridAttentionDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Olmo3_2HybridConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = Olmo3_2HybridAttention(config=config, layer_idx=layer_idx)

        self.mlp = Olmo3_2HybridMLP(config)
        self.post_attention_layernorm = Olmo3_2HybridRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.post_feedforward_layernorm = Olmo3_2HybridRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
...
class Olmo3_2HybridLinearDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Olmo3_2HybridConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class Olmo3_2HybridPreTrainedModel(PreTrainedModel):
...
@auto_docstring
class Olmo3_2HybridForCausalLM(Olmo3_2HybridPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.model = Olmo3_2HybridModel(config)
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, Olmo3_2HybridForCausalLM

        >>> model = Olmo3_2HybridForCausalLM.from_pretrained("meta-olmo3_2_hybrid/Olmo3_2Hybrid-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-olmo3_2_hybrid/Olmo3_2Hybrid-2-7b-hf")

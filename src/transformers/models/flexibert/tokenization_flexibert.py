...
class FlexiBERTTokenizer(PreTrainedTokenizer):
    """
    Construct a FlexiBERT tokenizer. Based on byte-level Byte-Pair-Encoding.
    ...
    def build_inputs_with_special_tokens(
        ...
        adding special tokens. A FlexiBERT sequence has the following format:

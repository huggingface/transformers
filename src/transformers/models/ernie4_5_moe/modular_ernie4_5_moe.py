...
class Ernie4_5_MoEAttention(Qwen3Attention):  # This is the main diff with qwen2Moe!
...
class Ernie4_5_MoEDecoderLayer(Qwen2MoeDecoderLayer, nn.Module):
    def __init__(self, config: Ernie4_5_MoEConfig, layer_idx: int):
        nn.Module().__init__()
        self.hidden_size = config.hidden_size
        ...
        if (layer_idx not in config.mlp_only_layers) and (
            ...
            self.mlp = Ernie4_5_MoEMLP(config, intermediate_size=config.intermediate_size)

        self.input_layernorm = Ernie4_5_MoERMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.post_attention_layernorm = Ernie4_5_MoERMSNorm(config.hidden_size, eps=config.rms_norm_eps)
...
class Ernie4_5_MoEForCausalLM(MixtralForCausalLM):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        ```python
        >>> from transformers import AutoTokenizer, Ernie4_5_MoEForCausalLM

        >>> model = Ernie4_5_MoEForCausalLM.from_pretrained("Qwen/Qwen3-MoE-15B-A2B")
...
class Ernie4_5_MoEForSequenceClassification(LlamaForSequenceClassification):
    pass


class Ernie4_5_MoEForTokenClassification(LlamaForTokenClassification):
    pass


class Ernie4_5_MoEForQuestionAnswering(LlamaForQuestionAnswering):
    pass
...
__all__ = [
    ...
    "Ernie4_5_MoEModel",
    "Ernie4_5_MoEPreTrainedModel",  # noqa: F822

...
class GlmOcrVisionRotaryEmbedding(nn.Module):
    ...
    def __init__(self, config: GlmOcrVisionConfig, device=None):
        super().__init__()
        self.config = config
...
@auto_docstring
class GlmOcrModel(GlmOcrPreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
class GlmOcrForConditionalGeneration(GlmOcrPreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

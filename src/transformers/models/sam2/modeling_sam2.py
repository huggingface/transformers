...
class Sam2Model(Sam2PreTrainedModel):
    ...
    def init_states(self, images, video_height, video_width, offload_video_to_cpu: bool = False, offload_state_to_cpu: bool = False, async_loading_frames: bool = False, device: Optional[torch.device] = None) -> None:
        inference_state = {}

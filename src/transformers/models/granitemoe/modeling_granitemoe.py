...
from ...modeling_flash_attention_utils import _flash_attention_forward, is_flash_attn_uses_top_left_mask
...
class GraniteMoeFlashAttention2(GraniteMoeAttention):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._flash_attn_uses_top_left_mask = is_flash_attn_uses_top_left_mask()

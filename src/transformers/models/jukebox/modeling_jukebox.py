...
class JukeboxPrior(PreTrainedModel):
    ...
    def sample(
        ...
        Args:
            ...
            music_tokens (`List[`torch.LongTensor`]`, *optional*, defaults to None):
                Previously gemerated tokens at the current level. Used as context for the generation.
            music_tokens_conds (`List[`torch.FloatTensor`]`, *optional*, defaults to None):
            ...
            metadata (`List[`torch.LongTensor`]`, *optional*, defaults to None):

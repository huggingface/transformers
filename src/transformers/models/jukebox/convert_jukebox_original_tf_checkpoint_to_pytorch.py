...
def convert_jukebox_checkpoint_to_pytorch(jukebox_checkpoint_path, jukebox_config_file, pytorch_dump_folder_path):
    # Construct model
    if jukebox_config_file == "":
        config = JukeboxConfig()
    else:
        config = JukeboxConfig.from_json_file(jukebox_config_file)

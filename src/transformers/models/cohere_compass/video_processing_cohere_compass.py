...
class CohereCompassVideoProcessorInitKwargs(VideosKwargs, total=False):
    r"""
...
@auto_docstring
class CohereCompassVideoProcessor(BaseVideoProcessor):
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        if cap_pixels_per_frame is None:
            logger.warning_once(
                "CohereCompass video processing does not apply the per-frame pixel cap the reference "
...
__all__ = ["CohereCompassVideoProcessor"]

...
@auto_docstring
class CohereCompassModel(CohereCompassPreTrainedModel, MultiModalPreTrainedModelMixin):
...
class CohereCompassForConditionalGeneration(CohereCompassPreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

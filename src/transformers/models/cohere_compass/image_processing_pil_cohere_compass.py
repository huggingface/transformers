...
# Adapted from transformers.models.cohere_compass.image_processing_cohere_compass.smart_resize
def smart_resize(
...
@auto_docstring
class CohereCompassImageProcessorPil(PilBackend):
    do_resize = True
    ...
    merge_size = 2
    valid_kwargs = CohereCompassImageProcessorKwargs
    model_input_names = ["pixel_values", "image_grid_thw"]

    def __init__(self, **kwargs: Unpack[CohereCompassImageProcessorKwargs]):
    ...
    def preprocess(
        self,
        images: ImageInput,
        **kwargs: Unpack[CohereCompassImageProcessorKwargs],
    ) -> BatchFeature:
...
__all__ = ["CohereCompassImageProcessorPil"]

...
class MixFormerSequentialTokenizer(PreTrainedTokenizer):
    """
    Construct a MixFormerSequential tokenizer. Based on byte-level Byte-Pair-Encoding.
    ...
    def build_inputs_with_special_tokens(
        ...
        A MixFormerSequential sequence has the following format:

...
@add_start_docstrings(
    "Constructs a fast Qwen2.5-Omni image processor that dynamically resizes videos based on the original videos.",
    BASE_VIDEO_PROCESSOR_DOCSTRING,
    """
...
class Qwen2_5OmniVideoProcessor(BaseVideoProcessor):
    ...
    def __init__(self, **kwargs: Unpack[Qwen2_5OmniVideoProcessorInitKwargs]):
...
__all__ = ["Qwen2_5OmniVideoProcessor"]

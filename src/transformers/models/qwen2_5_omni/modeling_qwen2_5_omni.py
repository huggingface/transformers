...
class Qwen2_5OmniForConditionalGeneration(Qwen2_5OmniPreTrainedModel, GenerationMixin):
    ...
    def generate(
        ...
        **kwargs,
        ...
        thinker_token_embeds = [token_hidden_states[0] for token_hidden_states in processed_thinker_hidden]
        thinker_hidden_states = [token_hidden_states[-1] for token_hidden_states in processed_thinker_hidden]
        ...
        talker_text_bos_token = torch.tensor(
            [[talker_text_bos_token]], dtype=torch.long, device=talker_inputs_embeds.device
        )
        ...
        talker_result = self.talker.generate(
            ...
            **{k: (v if torch.is_tensor(v) else v) for k, v in talker_kwargs.items()},
        )

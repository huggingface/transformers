...
class SegGptImageProcessor(BaseImageProcessor):
    ...
    def get_palette(self, num_labels: int) -> list[tuple[int, int]]:
        ...
        Returns:
            `Listtuple[int, int]]`: Palette to map the prompt mask from a single channel to a 3 channel RGB.
        """
    ...
    def mask_to_rgb(
        ...
        Args:
            ...
            palette (`Listtuple[int, int]]`, *optional*, defaults to `None`):
    ...
    def post_process_semantic_segmentation(
        ...
        Args:
            ...
            target_sizes (`Listtuple[int, int]]`, *optional*):

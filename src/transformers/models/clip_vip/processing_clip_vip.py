...
"""
Image/Text processor class for CLIPViP
"""
...
class CLIPViPProcessor(ProcessorMixin):
    r"""
    Constructs an CLIPViP processor which wraps a CLIPViP image processor and a CLIP tokenizer into a single processor.

    [`CLIPViPProcessor`] offers all the functionalities of [`CLIPViPImageProcessor`] and [`CLIPTokenizerFast`]. See the
    [`~CLIPViPProcessor.__call__`] and [`~CLIPViPProcessor.decode`] for more information.

    Args:
        image_processor ([`CLIPViPImageProcessor`]):
            The image processor is a required input.
        tokenizer ([`CLIPTokenizerFast`]):
            The tokenizer is a required input.
    """
    attributes = ["image_processor", "tokenizer"]
    image_processor_class = "CLIPViPImageProcessor"
    ...
    def __call__(self, text=None, videos=None, return_tensors=None, **kwargs):
        ...
        CLIPViPImageProcessor's [`~CLIPViPImageProcessor.__call__`] if `videos` is not `None`. Please refer to the

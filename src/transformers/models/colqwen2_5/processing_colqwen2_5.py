...
class ColQwen2_5ProcessorKwargs(ProcessingKwargs, total=False):
    _defaults = {
        "text_kwargs": {
            "padding": "longest",
        },
...
class ColQwen2_5Processor(ProcessorMixin):
    r"""
    Constructs a ColQwen2.5 processor which wraps a Qwen2VLProcessor and special methods to process images and queries, as
    well as to compute the late-interaction retrieval score.

    [`ColQwen2_5Processor`] offers all the functionalities of [`Qwen2VLProcessor`]. See the [`~Qwen2VLProcessor.__call__`]
    ...
    def __call__(
        ...
        **kwargs: Unpack[ColQwen2_5ProcessorKwargs],
        ...
        wrapper around the Qwen2VLProcessor's [`~Qwen2VLProcessor.__call__`] method adapted for the ColQwen2.5 model. It cannot process

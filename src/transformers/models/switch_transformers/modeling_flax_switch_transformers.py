...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5LayerNorm with T5->SwitchTransformers
class FlaxSwitchTransformersLayerNorm(nn.Module):
    hidden_size: int
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5DenseActDense with T5->SwitchTransformers
class FlaxSwitchTransformersDenseActDense(nn.Module):
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5DenseGatedActDense with T5->SwitchTransformers
class FlaxSwitchTransformersDenseGatedActDense(nn.Module):
    config: SwitchTransformersConfig
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5LayerFF with T5->SwitchTransformers
class FlaxSwitchTransformersLayerFF(nn.Module):
    config: SwitchTransformersConfig
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation

    def setup(self):
        if self.config.is_gated_act:
            self.DenseReluDense = FlaxSwitchTransformersDenseGatedActDense(self.config, dtype=self.dtype)
        else:
            self.DenseReluDense = FlaxSwitchTransformersDenseActDense(self.config, dtype=self.dtype)

        self.layer_norm = FlaxSwitchTransformersLayerNorm(
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5Attention with T5->SwitchTransformers
class FlaxSwitchTransformersAttention(nn.Module):
    config: SwitchTransformersConfig
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5LayerSelfAttention with T5->SwitchTransformers
class FlaxSwitchTransformersLayerSelfAttention(nn.Module):
    config: SwitchTransformersConfig
    has_relative_attention_bias: bool = False
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation

    def setup(self):
        self.SelfAttention = FlaxSwitchTransformersAttention(
            self.config,
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5LayerCrossAttention with T5->SwitchTransformers
class FlaxSwitchTransformersLayerCrossAttention(nn.Module):
    config: SwitchTransformersConfig
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation

    def setup(self):
        self.EncDecAttention = FlaxSwitchTransformersAttention(
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5Block with T5->SwitchTransformers
class FlaxSwitchTransformersBlock(nn.Module):
    config: SwitchTransformersConfig
    has_relative_attention_bias: bool = False
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
    ...
    def setup(self):
        ...
        self.layer = (
            FlaxSwitchTransformersLayerSelfAttention(
                self.config,
                has_relative_attention_bias=self.has_relative_attention_bias,
                name=str(0),
                dtype=self.dtype,
        ...
        if self.causal:
            self.layer += (FlaxSwitchTransformersLayerCrossAttention(self.config, name=str(1), dtype=self.dtype),)
            feed_forward_index += 1

        self.layer += (FlaxSwitchTransformersLayerFF(self.config, name=str(feed_forward_index), dtype=self.dtype),)
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5LayerCollection with T5->SwitchTransformers
class FlaxSwitchTransformersLayerCollection(nn.Module):
    config: SwitchTransformersConfig
    has_relative_attention_bias: bool
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation

    def setup(self):
        self.layer = FlaxSwitchTransformersBlock(
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5BlockCollection with T5->SwitchTransformers
class FlaxSwitchTransformersBlockCollection(nn.Module):
    config: SwitchTransformersConfig
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
    ...
    def setup(self):
        ...
        if self.gradient_checkpointing:
            FlaxSwitchTransformersCheckpointLayer = remat(
                FlaxSwitchTransformersLayerCollection, static_argnums=(6, 7, 8)
            )
            self.blocks = [
                FlaxSwitchTransformersCheckpointLayer(
                    self.config,
            ...
            self.blocks = [
                FlaxSwitchTransformersLayerCollection(
                    self.config,
                    has_relative_attention_bias=(i == 0),
                    dtype=self.dtype,
                    name=str(i),
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5Stack with T5->SwitchTransformers
class FlaxSwitchTransformersStack(nn.Module):
    config: SwitchTransformersConfig
    ...
    def setup(self):
        ...
        self.block = FlaxSwitchTransformersBlockCollection(
            self.config, dtype=self.dtype, gradient_checkpointing=self.gradient_checkpointing
        )
        self.final_layer_norm = FlaxSwitchTransformersLayerNorm(
            self.config.d_model, eps=self.config.layer_norm_epsilon, dtype=self.dtype
        )
        self.dropout = nn.Dropout(self.config.dropout_rate)
...
class FlaxSwitchTransformersPreTrainedModel(FlaxPreTrainedModel):
    """
    ...
    def init_weights(self, rng: jax.random.PRNGKey, input_shape: Tuple, params: FrozenDict = None) -> FrozenDict:
        ...
        if self.module_class not in [FlaxSwitchTransformersEncoderModule]:
    ...
    def decode(
        ...
        # it can be changed by FlaxSwitchTransformersAttention module
        if past_key_values:
...
class FlaxSwitchTransformersModule(nn.Module):
    ...
    def setup(self):
        ...
        self.encoder = FlaxSwitchTransformersStack(
            encoder_config,
        ...
        self.decoder = FlaxSwitchTransformersStack(
            decoder_config,
            embed_tokens=self.shared,
            dtype=self.dtype,
            gradient_checkpointing=self.gradient_checkpointing,
...
# Copied from transformers.models.t5.modeling_flax_t5.FlaxT5Model with T5->SwitchTransformers
class FlaxSwitchTransformersModel(FlaxSwitchTransformersPreTrainedModel):
    module_class = FlaxSwitchTransformersModule

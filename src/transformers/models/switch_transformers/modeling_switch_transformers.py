...
from ...utils import auto_docstring, is_torch_fx_proxy, is_torchdynamo_compiling, logging
...
class SwitchTransformersStack(SwitchTransformersPreTrainedModel, GPTJModel):

...
class SwitchTransformersAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # SWITCH_TRANSFORMERS uses a relative attention bias that is added to the attention scores. This is passed as the additive
        ...
        if self.config._attn_implementation != "eager":
            if self.config._attn_implementation != "sdpa":
                raise ValueError(
                    "SWITCH_TRANSFORMERS adds a relative position bias on top of the attention scores, which is only supported by the "

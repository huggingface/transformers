...
class SwitchTransformersTokenizer(PreTrainedTokenizer):
    """
    Construct a SwitchTransformers tokenizer. Based on [SentencePiece](https://github.com/google/sentencepiece).

...
@keras_serializable
# Copied from transformers.models.convnext.modeling_tf_convnext.TFConvNextMainLayer with ConvNext->ConvNextV2
class TFConvNextV2MainLayer(tf.keras.layers.Layer):
    config_class = ConvNextV2Config

    def __init__(self, config: ConvNextV2Config, add_pooling_layer: bool = True, **kwargs):
        super().__init__(**kwargs)
...
# Copied from transformers.models.convnext.modeling_tf_convnext.TFConvNextModel with CONVNEXT->CONVNEXTV2, ConvNext->ConvNextV2
class TFConvNextV2Model(TFConvNextV2PreTrainedModel):
    def __init__(self, config, *inputs, add_pooling_layer=True, **kwargs):
        super().__init__(config, *inputs, **kwargs)
        self.convnextv2 = TFConvNextV2MainLayer(config, add_pooling_layer=add_pooling_layer, name="convnextv2")
...
# Copied from transformers.models.convnext.modeling_tf_convnext.TFConvNextForImageClassification with CONVNEXT->CONVNEXTV2,ConvNext->ConvNextV2,convnext->convnextv2
class TFConvNextV2ForImageClassification(TFConvNextV2PreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        >>> image_processor = AutoImageProcessor.from_pretrained("facebook/convnext-tiny-224")
        >>> model = TFConvNextV2ForImageClassification.from_pretrained("facebook/convnext-tiny-224")

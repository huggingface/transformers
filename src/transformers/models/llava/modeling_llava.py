...
class LlavaForConditionalGeneration(LlavaPreTrainedModel, GenerationMixin):
    ...
    def get_image_features(
        ...
        **kwargs,
        ...
        image_outputs = self.vision_tower(pixel_values, output_hidden_states=[vision_feature_layer] if isinstance(vision_feature_layer, int) else vision_feature_layer, **kwargs)

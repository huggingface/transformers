...
class LlavaConfig(PretrainedConfig):
    ...
    defaults will yield a similar configuration to that of the LLaVA-7B.
    ...
    ```python
    >>> from transformers import LlavaModel, LlamvaConfig

    >>> # Initializing a LLaVA llava-7b style configuration
    >>> configuration = LlavaConfig()

    >>> # Initializing a model from the llava-7b style configuration

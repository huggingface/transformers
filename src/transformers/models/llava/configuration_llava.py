...
class LlaVaConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`~LlaVaModel`]. It is used to instantiate an LLaVA
    model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
    defaults will yield a similar configuration to that of the LLaVA
    [liuhaotian/llava-v1.5-13b](https://huggingface.co/liuhaotian/llava-v1.5-13b) architecture.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 30522):
            ...
            `inputs_ids` passed when calling [`~LlaVaModel`] or [`~TFLlaVaModel`].
        ...
        type_vocab_size (`int`, *optional*, defaults to 2):
            The vocabulary size of the `token_type_ids` passed when calling [`~LlaVaModel`] or [`~TFLlaVaModel`].
    ...
    >>> # Initializing a LLaVA liuhaotian/llava-v1.5-13b style configuration
    >>> configuration = LlaVaConfig()

    >>> # Initializing a model from the liuhaotian/llava-v1.5-13b style configuration

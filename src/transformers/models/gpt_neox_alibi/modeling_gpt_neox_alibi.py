...
class GPTNeoXALiBiAttention(nn.Module):
    ...
    def forward(
        ...
        # Compute attention
        attn_output, attn_weights = self._attn(query, key, value, alibi, attention_mask, head_mask)
    ...
    def _attn(self, query, key, value, alibi, attention_mask=None, head_mask=None):
...
GPT_NEOX_ALIBI_START_DOCSTRING = r"""
...
GPT_NEOX_ALIBI_INPUTS_DOCSTRING = r"""
    Args:

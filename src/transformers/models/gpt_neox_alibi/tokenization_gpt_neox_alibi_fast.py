...
PRETRAINED_VOCAB_FILES_MAP = {
    "tokenizer_file": {
        "kelechi/neox_alibi_1.4b_test": "https://huggingface.co/kelechi/neox_alibi_1.4b_test/resolve/main/tokenizer.json",
    },
}
...
class GPTNeoXALiBiTokenizerFast(PreTrainedTokenizerFast):
    ...
    # Remove `max_model_input_sizes` as we use ALiBi positional embeddings

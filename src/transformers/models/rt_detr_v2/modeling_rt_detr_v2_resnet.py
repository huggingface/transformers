...
from .configuration_rt_detr_v2_resnet_resnet import RtDetrV2ResNetConfig
...
class RtDetrV2ResNetBasicLayer(nn.Module):
    ...
    See https://github.com/lyuwenyu/RT-DETR/blob/5b628eaa0a2fc25bdafec7e6148d5296b144af85/RtDetrV2_pytorch/src/nn/backbone/presnet.py#L34.
    """
...
__all__ = ["RtDetrV2ResNetBackbone", "RtDetrV2ResNetPreTrainedModel"]

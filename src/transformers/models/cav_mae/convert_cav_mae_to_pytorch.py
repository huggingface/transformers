        ...
        if "qkv" in key:
            ...
            if "decoder_blocks" in key:
                ...
                if "weight" in key:
                    ...
                    orig_state_dict[
                        f"{prefix}{layer_num}.attention.attention.query.bias"
                    ] = val[:dim]
                    orig_state_dict[
                        f"{prefix}{layer_num}.attention.attention.key.bias"
                    ] = val[dim : dim * 2]
                    orig_state_dict[
                        f"{prefix}{layer_num}.attention.attention.value.bias"
                    ] = val[-dim:]
            else:
...
def convert_cav_mae_checkpoint(checkpoint_url, pytorch_dump_folder_path):
    config = CAVMAEConfig()
...
if __name__ == "__main__":
    ...
    convert_cav_mae_checkpoint(args.checkpoint_url, args.pytorch_dump_folder_path)

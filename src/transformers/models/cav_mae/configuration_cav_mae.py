# coding=utf-8
# Copyright 2023 Facebook AI and The HuggingFace Inc. team. All rights reserved.
#
...
CAVMAE_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "alyssa/cavmae-scale": "https://huggingface.co/alyssa/cavmae-scale/resolve/main/config.json",
}
...
class CAVMAEConfig(PretrainedConfig):
    ...
    [alyssa/cavmae-scale](https://huggingface.co/alyssa/cavmae-scale) architecture.
    ...
    ```python
    >>> from transformers import CAVMAEConfig, CAVMAEModel

    >>> # Initializing a ViT MAE vit-mae-base style configuration
    >>> configuration = CAVMAEConfig()

    >>> # Initializing a model (with random weights) from the vit-mae-base style configuration
    >>> model = CAVMAEModel(configuration)

...
class AevaTopkRouter(nn.Module):
    def __init__(self, config: AevaConfig):
        super().__init__()
        self.config = config
...
@auto_docstring
class AevaModel(AevaPreTrainedModel):
...
@auto_docstring
class AevaForCausalLM(AevaPreTrainedModel, GenerationMixin):
...
__all__ = ["AevaPreTrainedModel", "AevaModel", "AevaForCausalLM"]

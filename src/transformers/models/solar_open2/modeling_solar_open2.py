...
@use_experts_implementation
class SolarOpen2Experts(nn.Module):
...
class SolarOpen2MoE(nn.Module):
    ...
    def __init__(self, config: SolarOpen2Config):
        super().__init__()
        self.config = config
        self.experts = SolarOpen2Experts(config)
...
class SolarOpen2RotaryEmbedding(nn.Module):
    ...
    @staticmethod
    @deprecate_kwarg("device", version="5.18")
    def compute_default_rope_parameters(config: SolarOpen2Config, device=None, **kwargs) -> tuple[torch.Tensor, float]:
        """
...
class SolarOpen2PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, SolarOpen2Experts):
...
class SolarOpen2ForCausalLM(SolarOpen2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, SolarOpen2ForCausalLM

        >>> model = SolarOpen2ForCausalLM.from_pretrained("meta-solar_open2/SolarOpen2-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-solar_open2/SolarOpen2-2-7b-hf")

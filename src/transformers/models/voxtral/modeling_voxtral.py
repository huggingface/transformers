...
@auto_docstring(
    custom_intro="""
    The Voxtral model which consists of a audio backbone and a language model.
    """
)
class VoxtralForConditionalGeneration(VoxtralPreTrainedModel, GenerationMixin):
    ...
    def forward(
    ...
    ) -> Union[tuple, VoxtralCausalLMOutputWithPast]:
        r"""
        ...
        >>> model = VoxtralForConditionalGeneration.from_pretrained("Qwen/Qwen2-Audio-7B")
        ...
        if inputs_embeds is None:
            ...
            if input_features is not None and input_ids.shape[1] != 1:
                ...
                if legacy_processing:
                    logger.warning_once("Expanding inputs for audio tokens in Voxtral should be done in processing.")

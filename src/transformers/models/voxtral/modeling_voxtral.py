...
class VoxtralForConditionalGeneration(VoxtralPreTrainedModel, GenerationMixin):
    ...
    def _merge_input_ids_with_input_features(
        self,
        ...
        # input_ids will be (batch_size, seq_len)
        # input_features will be (batch_size2, 128, 3000)
        # TODO: @eustlb, how to correctly handle multiple audio per batch?
        ...
        # TODO: @eustlb, find better naming?
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if inputs_embeds is None and input_ids.shape[1] != 1:
            inputs_embeds = self._merge_input_ids_with_input_features(
                input_ids=input_ids,

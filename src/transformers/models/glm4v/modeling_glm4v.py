...
class Glm4vVisionRotaryEmbedding(nn.Module):
    ...
    @staticmethod
    @deprecate_kwarg("device", version="5.18")
    def compute_axial_rope_parameters(config: Glm4vVisionConfig, device=None, **kwargs) -> tuple[torch.Tensor, float]:
        """
...
@auto_docstring
class Glm4vModel(Glm4vPreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
class Glm4vForConditionalGeneration(Glm4vPreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

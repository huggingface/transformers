...
@strict
class NewQwen25VlVisionConfig(PreTrainedConfig):
    r"""
...
@auto_docstring(checkpoint="Qwen/Qwen2-VL-7B-Instruct")
@strict
class NewQwen25VlTextConfig(PreTrainedConfig):
    r"""
    ```python
    >>> from transformers import NewQwen25VlTextModel, NewQwen25VlConfig

    >>> # Initializing a NewQwen25Vl style configuration
    >>> configuration = NewQwen25VlConfig()

    >>> # Initializing a model from the Qwen2-VL-7B style configuration
    >>> model = NewQwen25VlTextModel(configuration)
    ...
    model_type = "new_qwen2_5_vl_text"
    base_config_key = "text_config"
    keys_to_ignore_at_inference = ["past_key_values"]
    default_theta = 1000000.0
    # Default tensor parallel plan for base model `NewQwen25Vl`
    base_model_tp_plan = {
...
@auto_docstring(checkpoint="Qwen/Qwen2-VL-7B-Instruct")
@strict
class NewQwen25VlConfig(PreTrainedConfig):
    r"""
    Example:

    ```python
    >>> from transformers import NewQwen25VlForConditionalGeneration, NewQwen25VlConfig

    >>> # Initializing a NewQwen25Vl style configuration
    >>> configuration = NewQwen25VlConfig()

    >>> # Initializing a model from the Qwen2-VL-7B style configuration
    >>> model = NewQwen25VlForConditionalGeneration(configuration)
    ...
    model_type = "new_qwen2_5_vl"
    sub_configs = {"vision_config": NewQwen25VlVisionConfig, "text_config": NewQwen25VlTextConfig}
    keys_to_ignore_at_inference = ["past_key_values"]
...
__all__ = ["NewQwen25VlConfig", "NewQwen25VlTextConfig"]

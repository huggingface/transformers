...
PRETRAINED_VOCAB_FILES_MAP = {
    ...
    "tokenizer_file": {
        "eleutherai/gpt_neo_xl": "https://huggingface.co/eleutherai/gpt_neo_xl/resolve/main/tokenizer.json",
    },
}
...
class GPTNeoTokenizerFast(PreTrainedTokenizerFast):
    ...
    ::
        ...
        >>> tokenizer = GPTNeoTokenizerFast.from_pretrained("eleutherai/gpt_neo_xl")

...
class ChameleonTorchVisionBackend(TorchVisionBackend):
...
class ChameleonPilBackend(PilBackend):
...
@auto_docstring(custom_intro="Constructs a Chameleon image processor.")
class ChameleonImageProcessor(BaseImageProcessor):
    model_input_names = ["pixel_values"]

    _backend_classes = {
        "torchvision": ChameleonTorchVisionBackend,
        "pil": ChameleonPilBackend,
    }

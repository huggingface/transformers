...
# Copied from transformers.models.llama.modeling_llama.LlamaModel with Llama->Chameleon, LLAMA->CHAMELEON
...
# Contents below are taken from https://github.com/CompVis/taming-transformers/blob/3ba01b241669f5ade541ce990f7650a3b8f65318/taming/models/vqgan.py

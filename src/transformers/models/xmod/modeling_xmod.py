...
# Copied from transformers.models.bert.modeling_bert.BertSelfOutput with Bert->Xmod
...
# Copied from transformers.models.bert.modeling_bert.BertPooler with Bert->Xmod

...
"""
Update Modular just to be as a base XLM Roberta + RoPE based model.
 - Update configuration
 - Update modeling file. (Make sure no adapter_mask + LoRAParametrization)

PR:
 - config.json
 - configuration as generated by modular
 - model.safetensors will be just have the base model.safetensors
 - modeling file as generated by the modular (Just base model)

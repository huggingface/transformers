...
class Lfm2AudioDepthConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Lfm2AudioDepthDecoder`]. It is used to instantiate a
    Lfm2Audio depth decoder model according to the specified arguments, defining the Lfm2Audio depth decoder config.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 32000):
            Vocabulary size of the Lfm2AudioDepthDecoder model. Defines the number of different tokens that can be
            represented by the `inputs_ids` passed when calling [`Lfm2AudioDepthDecoder`].
        ...
        audio_vocab_size (`int`, *optional*, defaults to 2048):
            ...
            represented by the `audio_codes` passed when calling the Lfm2Audio models.
    ...
    ...     Lfm2AudioDepthDecoder,
    ... )

    >>> configuration = Lfm2AudioDepthConfig()

    >>> # Initializing a Lfm2AudioDepthDecoder (with random weights) from the kmhf/hf-lfm2_audioko style configuration
    >>> model = Lfm2AudioDepthDecoder(configuration)
...
class Lfm2AudioConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Lfm2AudioModel`]. It is used to instantiate a
    Lfm2Audio model according to the specified arguments, defining the audio encoder, Lfm2Audio depth decoder and Lfm2Audio decoder
    configs. Instantiating a configuration with the defaults will yield a similar configuration to that of the Lfm2Audioko model,
    e.g. [kmhf/hf-lfm2_audioko](https://huggingface.co/kmhf/hf-lfm2_audioko)
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 32000):
            Vocabulary size of the Lfm2AudioDecoder model. Defines the number of different tokens that can be
            represented by the `inputs_ids` passed when calling [`Lfm2AudioDecoder`].
    ...
    >>> configuration = Lfm2AudioConfig()

    >>> # Initializing a Lfm2AudioForConditionalGeneration (with random weights) from the kmhf/hf-lfm2_audioko style configuration
    >>> model = Lfm2AudioForConditionalGeneration(configuration)

    >>> # Accessing the model configuration
    >>> configuration = model.config

    >>> # Saving the model, including its configuration
    >>> model.save_pretrained("kmhf/hf-lfm2_audioko")

    >>> # loading model and config from pretrained folder
    >>> lfm2_audio_config = Lfm2AudioConfig.from_pretrained("kmhf/hf-lfm2_audioko")
    >>> model = Lfm2AudioForConditionalGeneration.from_pretrained("kmhf/hf-lfm2_audioko", config=lfm2_audio_config)
    ```"""

    model_type = "lfm2_audio"
    keys_to_ignore_at_inference = ["past_key_values"]
    sub_configs = {"audio_encoder_config": AutoConfig, "depth_decoder_config": Lfm2AudioDepthConfig}
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.depth_decoder_config = Lfm2AudioDepthConfig(**depth_decoder_config)
    ...
    def from_audio_encoder_config(
        ...
        **kwargs,
        ...
        r"""
        Instantiate a [`Lfm2AudioConfig`] (or a derived class) from an audio encoder configuration.

        Returns:
            [`Lfm2AudioConfig`]: An instance of a configuration object
        """
...
__all__ = ["Lfm2AudioConfig", "Lfm2AudioDepthConfig"]

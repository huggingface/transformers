    ...
    def _init_rope(self):
        if self.config.rope_scaling is None:
            ...
            if scaling_type == "linear":
                ...
                self.rotary_emb = GPTNeoXYaRNScalingRotaryEmbedding(
                    self.rotary_ndims,
                    self.config.max_position_embeddings,
                    base=self.config.rotary_emb_base,
                    scaling_factor=scaling_factor,
                ...
                self.rotary_emb = GPTNeoXDynamicYaRNScalingRotaryEmbedding(
                    self.rotary_ndims,
                    self.config.max_position_embeddings,
                    base=self.config.rotary_emb_base,
                    scaling_factor=scaling_factor,
...
# Copied from transformers.models.falcon.modeling_falcon.FalconYaRNScalingRotaryEmbedding with Falcon->GPTNeoX
class GPTNeoXYaRNScalingRotaryEmbedding(GPTNeoXRotaryEmbedding):
    def __init__(
        self,
        dim,
...
class GPTNeoXDynamicYaRNScalingRotaryEmbedding(GPTNeoXYaRNScalingRotaryEmbedding):
    def __init__(
        self,
        dim,
        max_position_embeddings=2048,

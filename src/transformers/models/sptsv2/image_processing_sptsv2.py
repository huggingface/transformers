...
"""Image processor class for SPTSV2."""
...
# inspired by https://github.com/facebookresearch/sptsv2/blob/master/datasets/coco.py#L33
...
# inspired by https://github.com/facebookresearch/sptsv2/blob/master/datasets/coco.py#L50
def prepare_coco_detection_annotation(image, target, return_segmentation_masks: bool = False):
    """
    Convert the target in COCO format into the format expected by SPTSV2.
    """
...
def prepare_coco_panoptic_annotation(
    ...
    """
    Prepare a coco panoptic annotation for SPTSV2.
    """
    image_height, image_width = get_image_size(image)
...
def post_process_panoptic_sample(
    ...
    """
    Converts the output of [`Sptsv2ForSegmentation`] into panoptic segmentation predictions for a single sample.
...
class Sptsv2ImageProcessor(BaseImageProcessor):
    r"""
    Constructs a Sptsv2 image processor.
    ...
    def from_dict(cls, image_processor_dict: Dict[str, Any], **kwargs):
        ...
        created using from_dict and kwargs e.g. `Sptsv2ImageProcessor.from_pretrained(checkpoint, size=600,
        max_size=800)`
        """
    ...
    def prepare_annotation(
        ...
        """
        Prepare an annotation for feeding into SPTSV2 model.
        """
    ...
    def preprocess(
        ...
        **kwargs,
        ...
        # prepare (COCO annotations as a list of Dict -> SPTSV2 target as a single Dict per image)
        if annotations is not None:
            prepared_images = []
    ...
    # inspired by https://github.com/facebookresearch/sptsv2/blob/master/models/sptsv2.py#L258
    def post_process(self, outputs, target_sizes):
        """
        Converts the raw output of [`Sptsv2ForObjectDetection`] into final bounding boxes in (top_left_x, top_left_y,
        bottom_right_x, bottom_right_y) format. Only supports PyTorch.

        Args:
            outputs ([`Sptsv2ObjectDetectionOutput`]):
    ...
    def post_process_segmentation(self, outputs, target_sizes, threshold=0.9, mask_threshold=0.5):
        """
        Converts the output of [`Sptsv2ForSegmentation`] into image segmentation predictions. Only supports PyTorch.

        Args:
            outputs ([`Sptsv2SegmentationOutput`]):
                Raw outputs of the model.
    ...
    # inspired by https://github.com/facebookresearch/sptsv2/blob/master/models/segmentation.py#L218
    def post_process_instance(self, results, outputs, orig_target_sizes, max_target_sizes, threshold=0.5):
        """
        Converts the output of [`Sptsv2ForSegmentation`] into actual instance segmentation predictions. Only supports
        PyTorch.

        Args:
            results (`List[Dict]`):
                Results list obtained by [`~Sptsv2FeatureExtractor.post_process`], to which "masks" results will be
                added.
            outputs ([`Sptsv2SegmentationOutput`]):
                Raw outputs of the model.
    ...
    # inspired by https://github.com/facebookresearch/sptsv2/blob/master/models/segmentation.py#L241
    def post_process_panoptic(self, outputs, processed_sizes, target_sizes=None, is_thing_map=None, threshold=0.85):
        """
        Converts the output of [`Sptsv2ForSegmentation`] into actual panoptic predictions. Only supports PyTorch.
    ...
    def post_process_semantic_segmentation(self, outputs, target_sizes: List[Tuple[int, int]] = None):
        """
        Converts the output of [`Sptsv2ForSegmentation`] into semantic segmentation maps. Only supports PyTorch.

        Args:
            outputs ([`Sptsv2ForSegmentation`]):
                Raw outputs of the model.
    ...
    def post_process_instance_segmentation(
        ...
        """
        Converts the output of [`Sptsv2ForSegmentation`] into instance segmentation predictions. Only supports PyTorch.
    ...
    def post_process_panoptic_segmentation(
        ...
        """
        Converts the output of [`Sptsv2ForSegmentation`] into image panoptic segmentation predictions. Only supports
        PyTorch.

        Args:
            outputs ([`Sptsv2ForSegmentation`]):
                The outputs from [`Sptsv2ForSegmentation`].
            threshold (`float`, *optional*, defaults to 0.5):
                The probability score threshold to keep predicted instance masks.
            mask_threshold (`float`, *optional*, defaults to 0.5):
                Threshold to use when turning the predicted masks into binary values.

...
from transformers import GPTNeoXTokenizer, LlamaTokenizerFast, Mamba2Config, Mamba2ForCausalLM
...
def load_and_save_tokenizer(
    ...
    if tokenizer_model_path is not None and mamba2_model_type == "codestral":
        ...
        tokenizer = GPTNeoXTokenizer.from_pretrained("state-spaces/mamba-130m-hf", padding_side="left")

...
try:
    ...
    _import_structure["image_processing_llava_onevision_fast"] = ["LlavaOnevisionImageProcessorFast"]
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .image_processing_llava_onevision_fast import LlavaOnevisionImageProcessorFast

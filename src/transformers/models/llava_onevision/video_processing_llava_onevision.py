...
class LlavaOnevisionVideoProcessor(BaseImageProcessor):
    ...
    def _preprocess(
        ...
        logger.warning(
            "`LlavaOnevisionVideoProcessor` is deprecated and will be removed in v5.0. "
            "We recommend to load an instance of `LlavaOnevisionVideoProcessorFast` to process videos for the model. "
        )

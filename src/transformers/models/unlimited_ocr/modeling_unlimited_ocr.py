...
UNLIMITED_O_C_R_SAM_VISION_ATTENTION_CLASSES = {
...
class UnlimitedOCRSamVisionLayer(GradientCheckpointingLayer):
    def __init__(self, config, window_size):
        ...
        self.attn = UNLIMITED_O_C_R_SAM_VISION_ATTENTION_CLASSES[config._attn_implementation](config, window_size)
...
class UnlimitedOCRModel(UnlimitedOCRPreTrainedModel):
    ...
    def __init__(self, config: UnlimitedOCRConfig):
        ...
        self.multi_modal_projector = nn.Linear(
            config.vision_config.encoder_config.hidden_size + config.vision_config.sam_config.downsample_channels[-1],

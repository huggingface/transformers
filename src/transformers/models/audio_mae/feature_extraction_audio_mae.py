...
"""
Feature extractor class for Audio MAE.
"""
...
class AudioMAEFeatureExtractor(SequenceFeatureExtractor):
    r"""
    Constructs a AudioMAE feature extractor.
    ...
    Args:
        ...
        return_attention_mask (`bool`, *optional*, defaults to `False`):
            Whether or not [`~AudioMAEFeatureExtractor.__call__`] should return `attention_mask`.
    """

...
@auto_docstring
class Granite4VisionImageProcessor(TorchvisionBackend):
    ...
    def __init__(self, **kwargs: Unpack[Granite4VisionImageProcessorKwargs]):
...
__all__ = ["Granite4VisionImageProcessor"]

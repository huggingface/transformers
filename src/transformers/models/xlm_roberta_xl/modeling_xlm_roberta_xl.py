...
class XLMRobertaXLPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers.models.bert.modeling_bert.BertPreTrainedModel._init_weights with Bert->XLMRobertaXLP
    def _init_weights(self, module):
        ...
        elif isinstance(module, XLMRobertaXLPLMPredictionHead):
            module.bias.data.zero_()

...
class XLMRobertaXLSelfAttention(nn.Module):
    def __init__(self, config: XLMRobertaXLConfig, position_embedding_type: Optional[str] = None):
        super().__init__()
...
class XLMRobertaXLModel(XLMRobertaXLPreTrainedModel):
    ...
    def __init__(self, config: XLMRobertaXLConfig, add_pooling_layer: bool = True):

...
SHENSI_VL_TEXT_MLP_LAYER_TYPES = ("hash_moe", "moe")


@auto_docstring(checkpoint="louzongzhi/Shensi-VL-Nano")
@strict
class ShensiVlTextConfig(PreTrainedConfig):
    r"""
    scoring_func (`str`):
    ...
    def validate_layer_type(self):
        ...
        for name, types, allowed in (
            ("layer_types", self.layer_types, SHENSI_VL_TEXT_LAYER_TYPES),
            ("mlp_layer_types", self.mlp_layer_types, SHENSI_VL_TEXT_MLP_LAYER_TYPES),
        ):
            if types is None:
                continue
...
@auto_docstring(checkpoint="louzongzhi/Shensi-VL-Nano")
@strict
class ShensiVlVisionConfig(PreTrainedConfig):
    r"""
...
@auto_docstring(checkpoint="louzongzhi/Shensi-VL-Nano")
@strict
class ShensiVlConfig(PreTrainedConfig):
    r"""
...
__all__ = ["ShensiVlConfig", "ShensiVlTextConfig", "ShensiVlVisionConfig"]

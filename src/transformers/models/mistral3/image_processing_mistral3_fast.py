...
class Mistral3FastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
...
class Mistral3ImageProcessorFast(BaseImageProcessorFast):
    ...
    do_normalize = True
    do_convert_rgb = True
    valid_kwargs = Mistral3FastImageProcessorKwargs

    def __init__(self, **kwargs: Unpack[Mistral3FastImageProcessorKwargs]):
    ...
    def preprocess(self, images: ImageInput, **kwargs: Unpack[Mistral3FastImageProcessorKwargs]) -> BatchFeature:
    ...
    # Adapted from transformers.models.mistral3.image_processing_mistral3.Mistral3ImageProcessor._pad_for_batching
...
__all__ = ["Mistral3ImageProcessorFast"]

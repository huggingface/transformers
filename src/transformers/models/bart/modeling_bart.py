...
BART_STANDALONE_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
            it.
...
class BartForCausalLM(BartPretrainedModel):
    ...
    @add_start_docstrings_to_model_forward(BART_STANDALONE_INPUTS_DOCSTRING)
    ...
    def forward(
        ...
        Example::
            ...
            >>> tokenizer = BartTokenizer.from_pretrained('microsoft/bart-large')
            >>> model = BartForCausalLM.from_pretrained('microsoft/bart-large', add_cross_attention=False)

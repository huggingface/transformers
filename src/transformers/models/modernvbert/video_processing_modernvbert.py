...
class ModernVBertVideoProcessorInitKwargs(VideosKwargs, total=False):
...
class ModernVBertVideoProcessor(BaseVideoProcessor):
    ...
    valid_kwargs = ModernVBertVideoProcessorInitKwargs
    ...
    def sample_frames(
        ...
        **kwargs,
        ...
        if metadata is None or getattr(metadata, "fps", None) is None:
            raise ValueError(
                "Asked to sample frames per second but no video metadata was provided which is required when sampling in ModernVBert. "

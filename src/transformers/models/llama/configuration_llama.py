...
class LlamaConfig(PreTrainedConfig):
    ...
    # Default tensor parallel plan for base model `LlamaModel` (inference: plain-tensor activations,
    # KV-cache / autoregressive-decode compatible). `rowwise_allreduce` sums partial outputs.
    base_model_tp_plan = {

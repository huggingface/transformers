...
FNET_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "google/fnet": "https://huggingface.co/google/fnet/resolve/main/config.json",
...
class FNetConfig(PretrainedConfig):
    ...
    the FNet `google/fnet <https://huggingface.co/google/fnet>`__ architecture.
    ...
    Args:
        ...
        >>> # Initializing a FNet google/fnet style configuration
        >>> configuration = FNetConfig()

        >>> # Initializing a model from the google/fnet style configuration

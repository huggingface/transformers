...
class IsaacTextConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`IsaacTextModel`]. It is used to instantiate a
    IsaacText model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of
    IsaacText-8B [Qwen/IsaacText-8B](https://huggingface.co/Qwen/IsaacText-8B).
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 151936):
            Vocabulary size of the IsaacText model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`IsaacTextModel`]

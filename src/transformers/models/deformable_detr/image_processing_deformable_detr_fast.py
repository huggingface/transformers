...
class DeformableDetrFastImageProcessorPreprocessKwargs(
    DefaultFastImageProcessorPreprocessKwargs
):
...
class DeformableDetrImageProcessorFast(BaseImageProcessorFast):
    ...
    def __init__(
        self, **kwargs: Unpack[DeformableDetrFastImageProcessorInitKwargs]
    ) -> None:
    ...
    def preprocess(
        self,
        images: ImageInput,
        **kwargs: Unpack[DeformableDetrFastImageProcessorPreprocessKwargs],
    ) -> BatchFeature:
        if "pad_and_return_pixel_mask" in kwargs:
            kwargs["do_pad"] = kwargs.pop("pad_and_return_pixel_mask")
            logger.warning_once(

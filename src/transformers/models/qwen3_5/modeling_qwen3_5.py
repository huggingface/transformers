...
class Qwen3_5VisionModel(Qwen3_5PreTrainedModel):
    ...
    def __init__(self, config, *inputs, **kwargs) -> None:
        ...
        self.rotary_pos_emb = Qwen3_5VisionRotaryEmbedding(config)
...
@auto_docstring
class Qwen3_5Model(Qwen3_5PreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
class Qwen3_5ForConditionalGeneration(Qwen3_5PreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

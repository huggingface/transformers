...
class SeaformerImageProcessor(BaseImageProcessor):
    r"""
    ...
    def from_dict(cls, image_processor_dict: Dict[str, Any], **kwargs):
        ...
        processor is created using from_dict and kwargs e.g. `SeaformerImageProcessor.from_pretrained(checkpoint,
        reduce_labels=True)`
        """
    ...
    def post_process_semantic_segmentation(self, outputs, target_sizes: List[Tuple] = None):
        """
        Converts the output of [`SeaformerForSemanticSegmentation`] into semantic segmentation maps. Only supports
        PyTorch.

        Args:
            outputs ([`SeaformerForSemanticSegmentation`]):

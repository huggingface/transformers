...
_import_structure = {
    ...
    "tokenization_seaformer": ["SeaFormerTokenizer"],
}
...
try:
    ...
    _import_structure["tokenization_seaformer_fast"] = ["SeaFormerTokenizerFast"]
...
if TYPE_CHECKING:
    ...
    from .tokenization_seaformer import SeaFormerTokenizer
    ...
    try:
        ...
        from .tokenization_seaformer_fast import SeaFormerTokenizerFast

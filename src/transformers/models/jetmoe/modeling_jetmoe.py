...
class JetMoeExperts(nn.ModuleList):
    """
...
class JetMoeSparseMoeBlock(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.gate = JetMoeRouter(config)
        self.experts = JetMoeExperts(config)

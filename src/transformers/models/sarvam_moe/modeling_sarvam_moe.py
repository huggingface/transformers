#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/sarvam_moe/modular_sarvam_moe.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_sarvam_moe.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
class SarvamMoeRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        SarvamMoeRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class SarvamMoeRotaryEmbedding(nn.Module):
    ...
    def compute_default_rope_parameters(
        config: SarvamMoeConfig | None = None,
...
class SarvamMoeAttention(nn.Module):
    ...
    def __init__(self, config: SarvamMoeConfig, layer_idx: int):
        ...
        self.q_norm = SarvamMoeRMSNorm(self.head_dim, eps=config.rms_norm_eps)  # unlike olmo, only on the head dim!
        self.k_norm = SarvamMoeRMSNorm(
...
class SarvamMoeDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: SarvamMoeConfig, layer_idx: int):
        super().__init__()
...
class SarvamMoeModel(SarvamMoePreTrainedModel):
    def __init__(self, config: SarvamMoeConfig):
        ...
        self.layers = nn.ModuleList(
            [SarvamMoeDecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)]
        )
...
class SarvamMoeForCausalLM(SarvamMoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, SarvamMoeForCausalLM

        >>> model = SarvamMoeForCausalLM.from_pretrained("mistralai/SarvamMoe-8x7B-v0.1")
        >>> tokenizer = AutoTokenizer.from_pretrained("mistralai/SarvamMoe-8x7B-v0.1")
...
class SarvamMoeForSequenceClassification(GenericForSequenceClassification, SarvamMoePreTrainedModel):
    pass


class SarvamMoeForTokenClassification(GenericForTokenClassification, SarvamMoePreTrainedModel):
    pass


class SarvamMoeForQuestionAnswering(GenericForQuestionAnswering, SarvamMoePreTrainedModel):

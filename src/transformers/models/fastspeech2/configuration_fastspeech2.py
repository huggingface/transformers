...
FASTSPEECH2_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "fastspeech2": "https://huggingface.co/jaketae/fastspeech2-ljspeech/resolve/main/config.json",
    "fastspeech2": "https://huggingface.co/jaketae/fastspeech2-commonvoice/resolve/main/config.json",
...
class FastSpeech2Config(PretrainedConfig):
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 75):
            ...
            the `inputs_ids` passed when calling [`~FastSpeech2Model`].

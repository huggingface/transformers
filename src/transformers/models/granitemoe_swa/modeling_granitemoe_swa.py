...
class GraniteMoeSWAParallelExperts(nn.Module):
    def __init__(self, num_experts: int, input_size: int, output_size: int) -> None:
        """
        Initialize the GraniteMoeSWAParallelExperts module.
    ...
    def forward(self, inputs, expert_size):
        """
        Forward pass of the GraniteMoeSWAParallelExperts module.
...
class GraniteMoeSWATopKGating(nn.Module):
...
class GraniteMoeSWAMoE(nn.Module):
    ...
    def __init__(self, config: GraniteMoeSWAConfig):
        ...
        self.activation = ACT2FN[config.hidden_act]
        self.input_linear = GraniteMoeSWAParallelExperts(
            config.num_local_experts, self.input_size, self.hidden_size * 2
        )
        self.output_linear = GraniteMoeSWAParallelExperts(config.num_local_experts, self.hidden_size, self.input_size)

        self.router = GraniteMoeSWATopKGating(
...
class GraniteMoeSWAPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, GraniteMoeSWAParallelExperts):
...
class GraniteMoeSWARotaryEmbedding(nn.Module):
    ...
    def compute_default_rope_parameters(
        config: GraniteMoeSWAConfig | None = None,

...
class LiltConfig(BertConfig):
    r"""
    This is the configuration class to store the configuration of a [`LiltModel`] or a [`TFLiltModel`]. It is used to
    instantiate a LiLT model according to the specified arguments, defining the model architecture. Instantiating a
    configuration with the defaults will yield a similar configuration to that of the LiLT

...
LILT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "organization/lilt-roberta-en-base": (
        "https://huggingface.co/organization/lilt-roberta-en-base/resolve/main/config.json"
    ),
}
...
class LiltConfig(PretrainedConfig):
    ...
    [lilt-roberta-en-base](https://huggingface.co/lilt-roberta-en-base) architecture. Configuration objects inherit
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 30522):
            ...
            `inputs_ids` passed when calling [`LiltModel`] or [`TFLiltModel`].
        ...
        type_vocab_size (`int`, *optional*, defaults to 2):
            The vocabulary size of the `token_type_ids` passed when calling [`LiltModel`] or [`TFLiltModel`].
    ...
    >>> # Initializing a LiLT lilt-roberta-en-base style configuration
    >>> configuration = LiltConfig()
    >>> # Initializing a model from the lilt-roberta-en-base style configuration

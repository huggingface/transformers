...
"""Fast Tokenization classes for LiLT."""
import json
...
from .tokenization_lilt import LiltTokenizer
...
class LiltTokenizerFast(PreTrainedTokenizerFast):
    ...
    ```
    >>> from transformers import LiltTokenizerFast
    >>> tokenizer = LiltTokenizerFast.from_pretrained("organization/lilt-roberta-en-base")
    ...
    slow_tokenizer_class = LiltTokenizer
    ...
    def mask_token(self) -> str:
        ...
        Lilt tokenizer has a special mask token to be usable in the fill-mask pipeline. The mask token will greedily
    ...
    def mask_token(self, value):
        ...
        This is needed to preserve backward compatibility with all the previously used models based on Lilt.
        """

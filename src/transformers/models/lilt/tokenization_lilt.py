...
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {
    "organization/lilt-roberta-en-base": 512,
    "lilt-large": 512,
    "lilt-large-mnli": 512,
    "distilorganization/lilt-roberta-en-base": 512,
    "organization/lilt-roberta-en-base-openai-detector": 512,
    "lilt-large-openai-detector": 512,
}
...
class LiltTokenizer(PreTrainedTokenizer):
    """
    Constructs a LiLT tokenizer, derived from the GPT-2 tokenizer, using byte-level Byte-Pair-Encoding.

    This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
    be encoded differently whether it is at the beginning of the sentence (without space) or not:

    ```
    >>> from transformers import LiltTokenizer
    >>> tokenizer = LiltTokenizer.from_pretrained("organization/lilt-roberta-en-base")
    ...
    Args:
        ...
        add_prefix_space (`bool`, *optional*, defaults to `False`):
            ...
            other word. (LiLT tokenizer detect beginning of words by the preceding space).
    """
    ...
    def build_inputs_with_special_tokens(
        ...
        adding special tokens. A LiLT sequence has the following format:
    ...
    def create_token_type_ids_from_sequences(
        ...
        """
        Create a mask from the two sequences passed to be used in a sequence-pair classification task. LiLT does not

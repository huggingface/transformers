...
class ClapModel(ClapPreTrainedModel):
    ...
    def __init__(self, config: ClapConfig):
        ...
        self.logit_scale_a = nn.Parameter(torch.from_numpy(np.log(config.logit_scale_init_value)))
        self.logit_scale_t = nn.Parameter(torch.from_numpy(np.log(config.logit_scale_init_value)))

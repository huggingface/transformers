...
@add_start_docstrings(
    """
    The Cohere Model transformer with a sequence classification head on top (linear layer).

    [`CohereForSequenceClassification`] uses the last token in order to do the classification, as other causal models
    (e.g. GPT-2) do.

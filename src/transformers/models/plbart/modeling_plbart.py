...
PLBART_INPUTS_DOCSTRING = r"""
    Args:
        ...
        past_key_values (:
            obj:*tuple(tuple(torch.Tensor))*, *optional*, returned when `use_cache=True` is passed or when
            `config.use_cache=True`): Tuple of `tuple(torch.Tensor)` of length `config.n_layers`, with each tuple
        ...
        inputs_embeds (:
            obj:*torch.Tensor* of shape `(batch_size, sequence_length, hidden_size)`, *optional*): Optionally,
        ...
        decoder_inputs_embeds (:
            obj:*torch.Tensor* of shape `(batch_size, target_sequence_length, hidden_size)`, *optional*):

...
class PLBartTokenizerFast(PreTrainedTokenizerFast):
    ...
    def _build_translation_inputs(
        ...
        if src_lang is None or tgt_lang is None: # TODO: Check how to deal with this. We allow src_lang and tgt_lang to be None in general. Should this also be done for translation inputs?

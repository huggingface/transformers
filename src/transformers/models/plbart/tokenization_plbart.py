...
class PLBartTokenizer(BartTokenizer):
    """
    Construct a PLBART tokenizer.

    :class:`~transformers.PLBartTokenizer` is identical to :class:`~transformers.BartTokenizer` and runs end-to-end

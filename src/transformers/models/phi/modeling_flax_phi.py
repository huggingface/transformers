...
class FlaxPhiRotaryEmbedding(nn.Module):
    ...
    def setup(self):
        ...
        # TODO: take into account config.partial_rotary_factor
        self.sincos = create_sinusoidal_positions(self.config.max_position_embeddings, head_dim // 2)
...
class FlaxPhiAttention(nn.Module):
    ...
    def setup(self):
        ...
        self.q_proj, self.k_proj, self.v_proj = dense_layer(), dense_layer(), dense_layer()
    ...
    def __call__(
        ...
        # [batch_size, seq_length, hidden_dim] -> [batch_size, seq_length, num_heads, head_dim]

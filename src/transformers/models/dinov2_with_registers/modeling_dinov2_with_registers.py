...
"""PyTorch Dinov2 With Registers model."""
...
# Copied from transformers.models.dinov2.modeling_dinov2.Dinov2PatchEmbeddings with Dinov2->Dinov2WithRegisters
...
# Copied from transformers.models.dinov2.modeling_dinov2.Dinov2LayerScale with Dinov2->Dinov2WithRegisters
...
# Copied from transformers.models.dinov2.modeling_dinov2.Dinov2MLP with Dinov2->Dinov2WithRegisters
...
# Copied from transformers.models.dinov2.modeling_dinov2.Dinov2SwiGLUFFN with Dinov2->Dinov2WithRegisters
...
# Copied from transformers.models.dinov2.modeling_dinov2.Dinov2Layer with Dinov2->Dinov2WithRegisters
    ...
    def _init_weights(self, module: Union[nn.Linear, nn.Conv2d, nn.LayerNorm]) -> None:
        ...
        if isinstance(module, (nn.Linear, nn.Conv2d)):
            ...
            if module.register_tokens is not None:
                nn.init.normal_(module.register_tokens, std=1e-6)
...
# Copied from transformers.models.dinov2.modeling_dinov2.Dinov2Model with DINOV2->DINOV2_WITH_REGISTERS,Dinov2->Dinov2WithRegisters

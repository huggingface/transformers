...
class Wav2Vec2ConformerForPreTraining(Wav2Vec2ConformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers import AutoFeatureExtractor, Wav2Vec2ConformerConformerForPreTraining
        >>> from transformers.models.wav2vec2_conformer_conformer.modeling_wav2vec2_conformer_conformer import (
        ...
        ... )
        >>> model = Wav2Vec2ConformerConformerForPreTraining.from_pretrained(
        ...     "facebook/wav2vec2_conformer-conformer-rel-pos-large"
        ... )

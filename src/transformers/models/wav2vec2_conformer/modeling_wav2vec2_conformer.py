...
@add_start_docstrings("""Wav2Vec2Conformer Model with a `language modeling` head on top.""", WAV2VEC2_CONFORMER_START_DOCSTRING)
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForMaskedLM with Wav2Vec2->Wav2Vec2Conformer,wav2vec2->wav2vec2_conformer,WAV_2_VEC_2->WAV2VEC2_CONFORMER
class Wav2Vec2ConformerForMaskedLM(Wav2Vec2ConformerPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

        warnings.warn(
            "The class `Wav2Vec2ConformerForMaskedLM` is deprecated. Please use `Wav2Vec2ConformerForCTC` instead.", FutureWarning
        )

...
class InternS1DropPath(nn.Module):
    """Drop paths (Stochastic Depth) per sample (when applied in main path of residual blocks)."""
...
class InternS1VisionPreTrainedModel(PreTrainedModel):
    ...
    _can_record_outputs = {
        "hidden_states": InternS1VisionLayer,
...
class InternS1ModelOutputWithPast(BaseModelOutputWithPast):
    r"""
...
class InternS1ForConditionalGeneration(InternS1PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        aux_loss = None
        if hasattr(outputs, "router_logits") and labels is not None:

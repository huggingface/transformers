...
@auto_docstring
class Glm4vMoeModel(Glm4vMoePreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
class Glm4vMoeForConditionalGeneration(Glm4vMoePreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

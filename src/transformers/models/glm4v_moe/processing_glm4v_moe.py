...
class Glm4v_moeVideosProcessorKwargs(VideosKwargs, total=False):
    fps: Union[list[float], float]


class Glm4v_moeImagesKwargs(ImagesKwargs):
    patch_size: Optional[int]
    temporal_patch_size: Optional[int]
    merge_size: Optional[int]


class Glm4v_moeProcessorKwargs(ProcessingKwargs, total=False):
    images_kwargs: Glm4v_moeImagesKwargs
    videos_kwargs: Glm4v_moeVideosProcessorKwargs
    _defaults = {
        "text_kwargs": {
            "padding": False,
...
class Glm4v_moeProcessor(ProcessorMixin):
    r"""
    Constructs a GLM-4V processor which wraps a GLM-4V image processor and a GLM-4 tokenizer into a single processor.
    [`~Glm4v_moeProcessor.__call__`] and [`~Glm4v_moeProcessor.decode`] for more information.
    Args:
        image_processor ([`Glm4v_moeProcessor`], *optional*):
            The image processor is a required input.
        tokenizer ([`PreTrainedTokenizerFast`], *optional*):
            The tokenizer is a required input.
        video_processor ([`Glm4v_moeVideoProcessor`], *optional*):
    ...
    def __call__(
        ...
        **kwargs: Unpack[Glm4v_moeProcessorKwargs],
    ) -> BatchFeature:
        """
    ...
    def _get_num_multimodal_tokens(self, image_sizes=None, video_sizes=None, **kwargs):
        ...
        if image_sizes is not None:
            images_kwargs = Glm4v_moeProcessorKwargs._defaults.get("images_kwargs", {})
        ...
        if video_sizes is not None:
            videos_kwargs = Glm4v_moeProcessorKwargs._defaults.get("videos_kwargs", {})

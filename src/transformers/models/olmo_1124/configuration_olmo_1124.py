...
"""OLMo November 2024 model configuration"""
...
class Olmo1124Config(PretrainedConfig):
    ...
    defaults will yield a similar configuration to that of the [allenai/OLMo November 2024-7B-hf](https://huggingface.co/allenai/OLMo November 2024-7B-hf).
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 50304):
            Vocabulary size of the OLMo November 2024 model. Defines the number of different tokens that can be represented by the

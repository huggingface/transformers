...
"""PyTorch OLMo November 2024 model."""
...
# Copied from transformers.models.olmo.modeling_olmo.OlmoLayerNorm with Olmo->Olmo1124
class Olmo1124LayerNorm(nn.Module):
...
ALL_LAYERNORM_LAYERS.append(Olmo1124LayerNorm)


# copied from transformers.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Olmo1124
# TODO(joao): add me back asap :)
# Copied from transformers.models.olmo.modeling_olmo.OlmoRotaryEmbedding with Olmo->Olmo1124
...
# TODO(joao): add me back asap :)
# Copied from transformers.models.olmo.modeling_olmo.OlmoLinearScalingRotaryEmbedding with Olmo->Olmo1124
...
# TODO(joao): add me back asap :)
# Copied from transformers.models.olmo.modeling_olmo.OlmoDynamicNTKScalingRotaryEmbedding with Olmo->Olmo1124
...
# Copied from transformers.models.olmo.modeling_olmo.OlmoMLP with Olmo->Olmo1124
...
# Copied from transformers.models.olmo.modeling_olmo.OlmoAttention with Olmo->Olmo1124
...
# Copied from transformers.models.olmo.modeling_olmo.OlmoFlashAttention2 with Olmo->Olmo1124,OLMo->OLMo November 2024
class Olmo1124FlashAttention2(Olmo1124Attention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # in fp32. (Olmo1124RMSNorm handles it correctly)
...
# Copied from transformers.models.olmo.modeling_olmo.OlmoSdpaAttention with Olmo->Olmo1124,OLMo->OLMo November 2024
class Olmo1124SdpaAttention(Olmo1124Attention):
    """
    OLMo November 2024 attention module using torch.nn.functional.scaled_dot_product_attention. This module inherits from
...
# Copied from transformers.models.olmo.modeling_olmo.OlmoDecoderLayer with OLMO->OLMO_1124,Olmo->Olmo1124
class Olmo1124DecoderLayer(nn.Module):
    def __init__(self, config: Olmo1124Config, layer_idx: int):
        ...
        self.input_layernorm = Olmo1124LayerNorm(config.hidden_size)
        self.post_attention_layernorm = Olmo1124LayerNorm(config.hidden_size)
...
# Copied from transformers.models.llama.modeling_llama.LlamaPreTrainedModel with Llama->Olmo1124
...
# Copied from transformers.models.olmo.modeling_olmo.OlmoModel with OLMO->OLMO_1124,Olmo->Olmo1124
class Olmo1124Model(Olmo1124PreTrainedModel):
    ...
    def __init__(self, config: Olmo1124Config):
        ...
        self.norm = Olmo1124LayerNorm(config.hidden_size)
...
# Copied from transformers.models.llama.modeling_llama.LlamaForCausalLM with LLAMA->OLMO_1124,Llama->Olmo1124
class Olmo1124ForCausalLM(Olmo1124PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        >>> model = Olmo1124ForCausalLM.from_pretrained("allenai/OLMo-7B-1124-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("allenai/OLMo-7B-1124-hf")

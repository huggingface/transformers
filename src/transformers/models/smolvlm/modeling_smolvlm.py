...
# Copied from transformers.models.siglip.modeling_siglip.SiglipAttention with Siglip->SmolVLMVision
...
# Copied from transformers.models.idefics2.modeling_idefics2.Idefics2VisionFlashAttention2 with Idefics2->SmolVLM
...
# Copied from transformers.models.siglip.modeling_siglip.SiglipMLP with Siglip->SmolVLMVision
...
# Copied from transformers.models.idefics2.modeling_idefics2.Idefics2EncoderLayer with Idefics2->SmolVLM
...
# Copied from transformers.models.siglip.modeling_siglip.SiglipEncoder with Siglip->SmolVLM
...
# Copied from transformers.models.llama.modeling_llama.LlamaRMSNorm with Llama->SmolVLM
...
class SmolVLMForConditionalGeneration(SmolVLMPreTrainedModel, GenerationMixin):
    ...
    # Copied from transformers.models.idefics2.modeling_idefics2.Idefics2ForConditionalGeneration.__init__ with Idefics2->SmolVLM
    def __init__(self, config):
        super().__init__(config)

...
from ...utils import ModelOutput, TransformersKwargs, auto_docstring, can_return_tuple, is_flash_attn_2_available
...
class LocateAnythingTextRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        LocateAnythingTextRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()

...
from ...modeling_outputs import BaseModelOutput, CausalLMOutput, BaseModelOutputWithNoAttention
...
from .configuration_parakeet import PreTrainedConfig, ParakeetCTCConfig, ParakeetTDTConfig, ParakeetEncoderConfig, ParakeetTDTDecoderConfig, ParakeetTDTJointConfig
...
class ParakeetEncoderAttention(LlamaAttention):
    ...
    def __init__(self, config: ParakeetEncoderConfig, layer_idx: int):
        ...
        # W_{k,R} projection
        self.relative_k_proj = nn.Linear(config.hidden_size, config.num_attention_heads * self.head_dim, bias=config.attention_bias)
        # global content bias
...
class ParakeetPreTrainedModel(PreTrainedModel):
    ...
    def _get_subsampling_output_length(self, input_lengths: torch.Tensor):
        encoder_config = self.config.encoder_config if isinstance(self.config, (ParakeetCTCConfig, ParakeetTDTConfig)) else self.config
...
__all__ = ["ParakeetForCTC", "ParakeetForTDT", "ParakeetEncoder", "ParakeetTDTDecoder", "ParakeetTDTJoint", "ParakeetPreTrainedModel"]

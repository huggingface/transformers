...
@auto_docstring
class PaddleOCRVLModel(PaddleOCRVLPreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
class PaddleOCRVLForConditionalGeneration(PaddleOCRVLPreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

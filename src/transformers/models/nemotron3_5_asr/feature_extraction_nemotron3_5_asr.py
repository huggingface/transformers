...
class Nemotron3_5AsrFeatureExtractor(SequenceFeatureExtractor):
    r"""
    Constructs a Nemotron3_5Asr feature extractor.
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # Nemotron3_5Asr never normalizes the mel features
...
__all__ = ["Nemotron3_5AsrFeatureExtractor"]

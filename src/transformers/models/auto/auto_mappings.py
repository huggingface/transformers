...
CONFIG_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("edgetam_mask_decoder", "EdgeTamMaskDecoderConfig"),
        ("edgetam_prompt_encoder", "EdgeTamPromptEncoderConfig"),
        ("edgetam_video", "EdgeTamVideoConfig"),
        ("edgetam_video_mask_decoder", "EdgeTamVideoMaskDecoderConfig"),
        ("edgetam_video_prompt_encoder", "EdgeTamVideoPromptEncoderConfig"),
        ...
        ("esmfold2_atom_encoder", "EsmFold2AtomEncoderConfig"),
        ("esmfold2_confidence_head", "EsmFold2ConfidenceHeadConfig"),
        ("esmfold2_diffusion", "EsmFold2DiffusionModuleConfig"),
        ("esmfold2_lm_encoder", "EsmFold2LmEncoderConfig"),
        ("esmfold2_mas_encoder", "EsmFold2MsaEncoderConfig"),
        ("esmfold2_structure_encoder", "EsmFold2StructureHeadConfig"),
        ...
        ("flava", "FlavaConfig"),
        ("flava_image_codebook", "FlavaImageCodebookConfig"),
        ...
        ("got_ocr2_vision", "GotOcr2VisionConfig"),
        ("gpt2", "GPT2Config"),
        ...
        ("opt", "OPTConfig"),
        ("ovis2", "Ovis2Config"),
        ("ovis2_vision", "Ovis2VisionConfig"),
        ("owlv2", "Owlv2Config"),
        ...
        ("pp_chart2table_vision", "PPChart2TableVisionConfig"),
        ("pp_doclayout_v2", "PPDocLayoutV2Config"),
        ("pp_doclayout_v3", "PPDocLayoutV3Config"),
        ("pp_formulanet", "PPFormulaNetConfig"),
        ("pp_formulanet_text", "PPFormulaNetTextConfig"),
        ("pp_formulanet_vision", "PPFormulaNetVisionConfig"),
        ...
        ("sam2_mask_decoder", "Sam2MaskDecoderConfig"),
        ("sam2_prompt_encoder", "Sam2PromptEncoderConfig"),
        ("sam2_video", "Sam2VideoConfig"),
        ("sam2_video_mask_decoder", "Sam2VideoMaskDecoderConfig"),
        ("sam2_video_prompt_encoder", "Sam2VideoPromptEncoderConfig"),
        ...
        ("sam3_tracker_mask_decoder", "Sam3TrackerMaskDecoderConfig"),
        ("sam3_tracker_prompt_encoder", "Sam3TrackerPromptEncoderConfig"),
        ("sam3_tracker_video", "Sam3TrackerVideoConfig"),
        ("sam3_tracker_video_mask_decoder", "Sam3TrackerVideoMaskDecoderConfig"),
        ("sam3_tracker_video_prompt_encoder", "Sam3TrackerVideoPromptEncoderConfig"),
        ("sam3_video", "Sam3VideoConfig"),
        ("sam3_vision_model", "Sam3VisionConfig"),
        ("sam3_vit_model", "Sam3ViTConfig"),
        ("sam_hq", "SamHQConfig"),
        ("sam_hq_mask_decoder", "SamHQMaskDecoderConfig"),
        ("sam_hq_prompt_encoder", "SamHQPromptEncoderConfig"),
        ("sam_hq_vision_model", "SamHQVisionConfig"),
        ("sam_mask_decoder", "SamMaskDecoderConfig"),
        ("sam_prompt_encoder", "SamPromptEncoderConfig"),
        ...
        ("slanext_vision", "SLANeXtVisionConfig"),
        ...
        ("vibevoice_diffusion", "VibeVoiceDiffusionHeadConfig"),
...
SPECIAL_MODEL_TYPE_TO_MODULE_NAME = OrderedDict(
    [
        ...
        ("donut-swin", "donut"),
        ("edgetam_mask_decoder", "edgetam"),
        ("edgetam_prompt_encoder", "edgetam"),
        ("edgetam_video_mask_decoder", "edgetam_video"),
        ("edgetam_video_prompt_encoder", "edgetam_video"),
        ...
        ("esmfold2_atom_encoder", "esmfold2"),
        ("esmfold2_confidence_head", "esmfold2"),
        ("esmfold2_diffusion", "esmfold2"),
        ("esmfold2_lm_encoder", "esmfold2"),
        ("esmfold2_mas_encoder", "esmfold2"),
        ("esmfold2_structure_encoder", "esmfold2"),
        ...
        ("pp_chart2table_vision", "pp_chart2table"),
        ("pp_formulanet_text", "pp_formulanet"),
        ("pp_formulanet_vision", "pp_formulanet"),
        ...
        ("sam2_mask_decoder", "sam2"),
        ("sam2_prompt_encoder", "sam2"),
        ("sam2_video_mask_decoder", "sam2_video"),
        ("sam2_video_prompt_encoder", "sam2_video"),
        ...
        ("sam3_tracker_mask_decoder", "sam3_tracker"),
        ("sam3_tracker_prompt_encoder", "sam3_tracker"),
        ("sam3_tracker_video_mask_decoder", "sam3_tracker_video"),
        ("sam3_tracker_video_prompt_encoder", "sam3_tracker_video"),
        ("sam3_vision_model", "sam3"),
        ("sam3_vit_model", "sam3"),
        ("sam_hq_mask_decoder", "sam_hq"),
        ("sam_hq_prompt_encoder", "sam_hq"),
        ("sam_hq_vision_model", "sam_hq"),
        ("sam_mask_decoder", "sam"),
        ("sam_prompt_encoder", "sam"),

...
VIDEO_PROCESSOR_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("glm46v", {"torchvision": "Glm46VVideoProcessor"}),
        ("glm4v", {"torchvision": "Glm4vVideoProcessor"}),
        ("glm5_next", {"torchvision": "Glm5NextVideoProcessor"}),
        ("glmga", {"torchvision": "GlmgaVideoProcessor"}),
        ("instructblipvideo", {"torchvision": "InstructBlipVideoVideoProcessor"}),
        ("internvl", {"torchvision": "InternVLVideoProcessor"}),
        ("kimi_k25", {"torchvision": "Kimi_K25VideoProcessor"}),
        ("llava_next_video", {"torchvision": "LlavaNextVideoVideoProcessor"}),
        ("llava_onevision", {"torchvision": "LlavaOnevisionVideoProcessor"}),
        ...
        ("qwen3_vl", {"torchvision": "Qwen3VLVideoProcessor"}),
        ("sam2_video", {"torchvision": "Sam2VideoVideoProcessor"}),
        ("smolvlm", {"torchvision": "SmolVLMVideoProcessor"}),
        ("timesformer", {"torchvision": "TimesformerVideoProcessor"}),
        ("video_llama_3", {"torchvision": "VideoLlama3VideoProcessor"}),
        ("video_llava", {"torchvision": "VideoLlavaVideoProcessor"}),
        ("videomae", {"torchvision": "VideoMAEVideoProcessor"}),
        ("videomt", {"torchvision": "VideomtVideoProcessor"}),
        ("vivit", {"torchvision": "VivitVideoProcessor"}),
        ("vjepa2", {"torchvision": "VJEPA2VideoProcessor"}),
    ]
)

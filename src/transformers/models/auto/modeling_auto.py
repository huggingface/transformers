...
MODEL_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("pe_audio_encoder", "PEAudioModel"),
        ("pe_audio_text", "PEAudioWithTextModel"),
        ("pe_audio_video_encoder", "PEAudioVideoModel"),
        ("pe_audio_video_text", "PEAudioVideoWithTextModel"),
        ("pe_video_encoder", "PEVideoModel"),
        ("pe_video_text", "PEVideoWithTextModel"),

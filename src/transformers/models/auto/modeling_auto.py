...
MODEL_FOR_AUTOMATIC_MASK_GENERATION_NAMES = OrderedDict(
    [
...
MODEL_FOR_AUTOMATIC_MASK_GENERATION_MAPPING = _LazyAutoMapping(CONFIG_MAPPING_NAMES, MODEL_FOR_AUTOMATIC_MASK_GENERATION_NAMES)

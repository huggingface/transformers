...
MODEL_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("perception_encoder_audio", "PerceptionEncoderAudioModel"),
        ("perception_encoder_audio_video", "PerceptionEncoderAudioVideoModel"),
        ("perception_encoder_video", "PerceptionEncoderVideoModel"),

...
MODEL_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("dinat", "DinatModel"),
        ("dinov2", "Dinov2Model"),
        ("dinov2-with-registers", "Dinov2WithRegistersModel"),
...
MODEL_FOR_IMAGE_CLASSIFICATION_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("dinov2-with-registers", "Dinov2WithRegistersForImageClassification"),
        (
            "efficientformer",
            (
...
MODEL_FOR_BACKBONE_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("dinov2-with-registers", "Dinov2WithRegistersBackbone"),

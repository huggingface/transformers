...
from ..trans_coder.modeling_trans_coder import (
...
MODEL_MAPPING = OrderedDict(
    [
        # Base model mapping
        (TransCoderConfig, TransCoderModel),
...
MODEL_WITH_LM_HEAD_MAPPING = OrderedDict(
    [
        ...
        (TransCoderConfig, TransCoderForConditionalGeneration),
...
MODEL_FOR_CAUSAL_LM_MAPPING = OrderedDict(
    [
        ...
        (TransCoderConfig, TransCoderForCausalLM),
...
MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING = OrderedDict(
    [
        ...
        (TransCoderConfig, TransCoderForSequenceClassification),
...
MODEL_FOR_QUESTION_ANSWERING_MAPPING = OrderedDict(
    [
        ...
        (TransCoderConfig, TransCoderForQuestionAnswering),

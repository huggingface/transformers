...
from ..vilbert.modeling_vilbert import (
    VilbertForMaskedLM,
    VilbertForCausalLM,
...
(VilbertConfig, VilbertForMaskedLM),
...
MODEL_FOR_CAUSAL_LM_MAPPING = OrderedDict(
    [
        ...
        (VilbertConfig, VilbertForCausalLM),
...
MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING = OrderedDict(
    [
        ...
        (VilbertConfig, VilbertForSequenceClassification),
...
MODEL_FOR_QUESTION_ANSWERING_MAPPING = OrderedDict(
    [
        ...
        (VilbertConfig, VilbertForQuestionAnswering),
...
(VilbertConfig, VilbertForTokenClassification),
...
(VilbertConfig, VilbertForMultipleChoice),

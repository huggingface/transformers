...
MODEL_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("hyperclovax", "HCXVisionModel"),
        ("hyperclovax_text", "HyperClovaXModel"),
        ("ibert", "IBertModel"),
        ...
        ("qwen2_5_vl_image", "Qwen2_5_VisionTransformerPretrainedModel"),
...
MODEL_FOR_CAUSAL_LM_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("hyperclovax_text", "HyperClovaXForCausalLM"),
...
MODEL_FOR_IMAGE_TEXT_TO_TEXT_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("got_ocr2", "GotOcr2ForConditionalGeneration"),
        ("hyperclovax", "HCXVisionForConditionalGeneration"),
        ("idefics", "IdeficsForVisionText2Text"),
        ("idefics2", "Idefics2ForConditionalGeneration"),
        ("idefics3", "Idefics3ForConditionalGeneration"),

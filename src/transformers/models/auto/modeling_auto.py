...
MODEL_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("nemotron_h_dense", "NemotronHDenseModel"),
        ("nemotron_h_sparse", "NemotronHSparseModel"),
...
MODEL_FOR_CAUSAL_LM_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("nemotron_h_dense", "NemotronHDenseForCausalLM"),
        ("nemotron_h_sparse", "NemotronHSparseForCausalLM"),

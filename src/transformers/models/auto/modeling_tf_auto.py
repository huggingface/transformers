...
TF_MODEL_MAPPING = LazyAutoMapping(CONFIG_MAPPING_NAMES, TF_MODEL_MAPPING_NAMES)
TF_MODEL_FOR_PRETRAINING_MAPPING = LazyAutoMapping(CONFIG_MAPPING_NAMES, TF_FOR_PRETRAINING_MAPPING_NAMES)
TF_MODEL_WITH_LM_HEAD_MAPPING = LazyAutoMapping(CONFIG_MAPPING_NAMES, TF_WITH_LM_HEAD_MAPPING_NAMES)
TF_MODEL_FOR_CAUSAL_LM_MAPPING = LazyAutoMapping(CONFIG_MAPPING_NAMES, TF_FOR_CAUSAL_LM_MAPPING_NAMES)
TF_MODEL_FOR_MASKED_LM_MAPPING = LazyAutoMapping(CONFIG_MAPPING_NAMES, TF_FOR_MASKED_LM_MAPPING_NAMES)
TF_MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING = LazyAutoMapping(CONFIG_MAPPING_NAMES, TF_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING_NAMES)
TF_MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING = LazyAutoMapping(CONFIG_MAPPING_NAMES, TF_FOR_SEQUENCE_CLASSIFICATION_MAPPING_NAMES)
TF_MODEL_FOR_QUESTION_ANSWERING_MAPPING = LazyAutoMapping(CONFIG_MAPPING_NAMES, TF_FOR_QUESTION_ANSWERING_MAPPING_NAMES)
TF_MODEL_FOR_TOKEN_CLASSIFICATION_MAPPING = LazyAutoMapping(CONFIG_MAPPING_NAMES, TF_FOR_TOKEN_CLASSIFICATION_MAPPING_NAMES)
TF_MODEL_FOR_NEXT_SENTENCE_PREDICTION_MAPPING = LazyAutoMapping(CONFIG_MAPPING_NAMES, TF_FOR_NEXT_SENTENCE_PREDICTION_MAPPING_NAMES)

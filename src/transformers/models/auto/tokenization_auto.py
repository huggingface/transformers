        ...
        if config_tokenizer_class is None:
            if not isinstance(config, PreTrainedConfig):
                if gguf_file:
                    ...
                    # Improved tokenizer loading error message for better user guidance
                    ...
                    try:
                        ...
                        raise EnvironmentError(
                            ...
                            "1. The tokenizer or model name is correct and not misspelled.\n"
                            "2. The model/tokenizer exists on the Hugging Face Hub:\n"
                            "   https://huggingface.co/models\n"
                            "3. The tokenizer configuration files are available in the repository.\n"
                        ) from err

...
TOKENIZER_MAPPING_NAMES = OrderedDict[str, str | None](
    [
        ...
        ("byt5", "ByT5Tokenizer"),
        ("camembert", "TokenizersBackend" if is_tokenizers_available() else None),
        ...
        ("deberta-v2", "TokenizersBackend" if is_tokenizers_available() else None),
        ("dia", "DiaTokenizer"),
        ...
        ("rembert", "TokenizersBackend" if is_tokenizers_available() else None),
        ...
        ("xlm", "XLMTokenizer"),
        ("xlm-roberta", "TokenizersBackend" if is_tokenizers_available() else None),
        ("xlm-roberta-xl", "TokenizersBackend" if is_tokenizers_available() else None),
        ("xlnet", "TokenizersBackend" if is_tokenizers_available() else None),
        ("xlstm", "GPTNeoXTokenizer" if is_tokenizers_available() else None),
        ("xmod", "TokenizersBackend" if is_tokenizers_available() else None),
        ("yoso", "TokenizersBackend" if is_tokenizers_available() else None),
    ]
)

...
class AutoProcessor:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        explicit_local_code = (
            has_local_code
            and not (processor_class or PROCESSOR_MAPPING[type(config)]).__module__.startswith("transformers.")
            and not (processor_class or PROCESSOR_MAPPING[type(config)]).__module__.startswith(

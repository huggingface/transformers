...
CONFIG_MAPPING_NAMES = OrderedDict(
    [
        # Add configs here
        ("mixformer_sequential", "MixFormerSequentialConfig"),
        ("albert", "AlbertConfig"),
        ("align", "AlignConfig"),
...
CONFIG_ARCHIVE_MAP_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("mixformer_sequential", "MIXFORMER_SEQUENTIAL_PRETRAINED_CONFIG_ARCHIVE_MAP"),
...
MODEL_NAMES_MAPPING = OrderedDict(
    [
        ...
        ("mixformer_sequential", "MixFormerSequential"),
        ("albert", "ALBERT"),
        ("align", "ALIGN"),
        ("altclip", "AltCLIP"),

...
CONFIG_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("trillsson_efficientnet", "TrillssonEfficientNetConfig"),
        ("trocr", "TrOCRConfig"),
...
CONFIG_ARCHIVE_MAP_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("trillsson_efficientnet", "TRILLSSON_EFFICIENTNET_PRETRAINED_CONFIG_ARCHIVE_MAP"),
...
MODEL_NAMES_MAPPING = OrderedDict(
    [
        ...
        ("trillsson_efficientnet", "TrillssonEfficientNet"),
        ("trocr", "TrOCR"),
        ("ul2", "UL2"),
        ("unispeech", "UniSpeech"),

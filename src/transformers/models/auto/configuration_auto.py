...
class AutoConfig:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: str | os.PathLike[str], **kwargs):
        ...
        explicit_local_code = (
            has_local_code
            and not CONFIG_MAPPING[config_dict["model_type"]].__module__.startswith("transformers.")
            and not CONFIG_MAPPING[config_dict["model_type"]].__module__.startswith("transformers_modules.")
        )
        if has_remote_code:

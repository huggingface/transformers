...
CONFIG_MAPPING_NAMES = OrderedDict[str, str](
    [
        ...
        ("cohere_asr_decoder", "CohereAsrDecoderConfig"),
        ("cohere_asr_encoder", "CohereAsrEncoderConfig"),
...
MODEL_NAMES_MAPPING = OrderedDict[str, str](
    [
        ...
        ("cohere_asr_decoder", "CohereASR Decoder"),
        ("cohere_asr_encoder", "CohereASR Encoder"),
...
SPECIAL_MODEL_TYPE_TO_MODULE_NAME = OrderedDict[str, str](
    [
        ...
        ("cohere_asr_encoder", "cohere_asr"),
        ("cohere_asr_decoder", "cohere_asr"),
        ("lw_detr_vit", "lw_detr"),
        ("parakeet_ctc", "parakeet"),
        ("lasr_encoder", "lasr"),
        ("lasr_ctc", "lasr"),

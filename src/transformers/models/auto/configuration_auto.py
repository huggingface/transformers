...
CONFIG_MAPPING_NAMES = OrderedDict[str, str](
    [
        ...
        ("hyperclovax", "HCXVisionConfig"),
        ("hyperclovax_text", "HyperClovaXConfig"),
        ("ibert", "IBertConfig"),
...
MODEL_NAMES_MAPPING = OrderedDict[str, str](
    [
        ...
        ("hyperclovax", "HyperClovaXVision"),
        ("hyperclovax_text", "HyperClovaXVision"),
        ("ibert", "I-BERT"),
        ("idefics", "IDEFICS"),
        ("idefics2", "Idefics2"),
        ("idefics3", "Idefics3"),
...
SPECIAL_MODEL_TYPE_TO_MODULE_NAME = OrderedDict[str, str](
    [
        ...
        ("hyperclovax_text", "hyperclovax_vision"),

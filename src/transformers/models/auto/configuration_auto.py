...
CONFIG_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("trillsson_efficient", "Trillsson_efficientConfig"),
        ("trocr", "TrOCRConfig"),
...
CONFIG_ARCHIVE_MAP_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("trillsson_efficient", "TRILLSSON_EFFICIENT_PRETRAINED_CONFIG_ARCHIVE_MAP"),
...
MODEL_NAMES_MAPPING = OrderedDict(
    [
        ...
        ("trillsson_efficient", "Trillsson Efficientnet"),
        ("trocr", "TrOCR"),
        ("ul2", "UL2"),
        ("unispeech", "UniSpeech"),

...
FEATURE_EXTRACTOR_MAPPING_NAMES = OrderedDict(
    [
        ("audio-spectrogram-transformer", {"torch": "ASTFeatureExtractor"}),
        ("clap", {"torch": "ClapFeatureExtractor"}),
        ("clvp", {"torch": "ClvpFeatureExtractor"}),
        ("cohere_asr", {"torch": "CohereAsrFeatureExtractor"}),
        ("dac", {"torch": "DacFeatureExtractor"}),
        ("dia", {"torch": "DiaFeatureExtractor"}),
        ("encodec", {"torch": "EncodecFeatureExtractor"}),
        ("gemma3n", {"torch": "Gemma3nAudioFeatureExtractor"}),
        ("gemma4", {"torch": "Gemma4AudioFeatureExtractor"}),
        ("gemma4_unified", {"torch": "Gemma4UnifiedAudioFeatureExtractor"}),
        ("granite_speech", {"torch": "GraniteSpeechFeatureExtractor"}),
        ("kyutai_speech_to_text", {"torch": "KyutaiSpeechToTextFeatureExtractor"}),
        ("musicgen_melody", {"torch": "MusicgenMelodyFeatureExtractor"}),
        ("nemotron_asr_streaming", {"torch": "NemotronAsrStreamingFeatureExtractor"}),
        ("pe_audio", {"torch": "PeAudioFeatureExtractor"}),
        ("phi4_multimodal", {"torch": "Phi4MultimodalFeatureExtractor"}),
        ("pop2piano", {"torch": "Pop2PianoFeatureExtractor"}),
        ("qwen3_asr", {"torch": "Qwen3ASRFeatureExtractor"}),
        ("seamless_m4t", {"torch": "SeamlessM4TFeatureExtractor"}),
        ("speech_to_text", {"torch": "Speech2TextFeatureExtractor"}),
        ("speecht5", {"torch": "SpeechT5FeatureExtractor"}),
        ("univnet", {"torch": "UnivNetFeatureExtractor"}),
        ("vibevoice_acoustic_tokenizer", {"torch": "VibeVoiceAcousticTokenizerFeatureExtractor"}),
        ("voxtral_realtime", {"torch": "VoxtralRealtimeFeatureExtractor"}),
        ("wav2vec2", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("whisper", {"torch": "WhisperFeatureExtractor"}),
        ("xcodec2", {"torch": "Xcodec2FeatureExtractor"}),
        ("audioflamingo3", {"torch": "WhisperFeatureExtractor"}),
        ("csm", {"torch": "EncodecFeatureExtractor"}),
        ("data2vec-audio", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("glmasr", {"torch": "WhisperFeatureExtractor"}),
        ("granite_speech_plus", {"torch": "GraniteSpeechFeatureExtractor"}),
        ("higgs_audio_v2_tokenizer", {"torch": "DacFeatureExtractor"}),
        ("hubert", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("inkling_mm_model", {"torch": "InklingFeatureExtractor"}),
        ("lasr_ctc", {"torch": "LasrFeatureExtractor"}),
        ("lasr_encoder", {"torch": "LasrFeatureExtractor"}),
        ("mimi", {"torch": "EncodecFeatureExtractor"}),
        ("moonshine", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("moshi", {"torch": "EncodecFeatureExtractor"}),
        ("musicgen", {"torch": "EncodecFeatureExtractor"}),
        ("nemotron3_5_asr", {"torch": "NemotronAsrStreamingFeatureExtractor"}),
        ("nemotron_asr_streaming_encoder", {"torch": "NemotronAsrStreamingFeatureExtractor"}),
        ("parakeet_ctc", {"torch": "ParakeetFeatureExtractor"}),
        ("parakeet_encoder", {"torch": "ParakeetFeatureExtractor"}),
        ("parakeet_rnnt", {"torch": "ParakeetFeatureExtractor"}),
        ("parakeet_tdt", {"torch": "ParakeetFeatureExtractor"}),
        ("pe_audio_video", {"torch": "PeAudioFeatureExtractor"}),
        ("qwen2_5_omni", {"torch": "WhisperFeatureExtractor"}),
        ("qwen2_audio", {"torch": "WhisperFeatureExtractor"}),
        ("qwen3_omni_moe", {"torch": "WhisperFeatureExtractor"}),
        ("seamless_m4t_v2", {"torch": "SeamlessM4TFeatureExtractor"}),
        ("sew", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("sew-d", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("unispeech", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("unispeech-sat", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("vibevoice_asr", {"torch": "VibeVoiceAcousticTokenizerFeatureExtractor"}),
        ("voxtral", {"torch": "WhisperFeatureExtractor"}),
        ("wav2vec2-bert", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("wav2vec2-conformer", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("wavlm", {"torch": "Wav2Vec2FeatureExtractor"}),
        ("xcodec", {"torch": "DacFeatureExtractor"}),
    ]
)

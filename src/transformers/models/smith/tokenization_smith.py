...
class SmithTokenizer(BertTokenizer):
    r"""
    Construct a SMITH tokenizer.

    :class:`~transformers.SmithTokenizer` is identical to :class:`~transformers.BertTokenizer` and runs end-to-end

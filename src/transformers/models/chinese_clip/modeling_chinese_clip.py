...
from .configuration_chinese_clip import ChineseCLIPConfig, ChineseCLIPVisionConfig
...
@dataclass
# Copied from transformers.models.clip.modeling_clip.CLIPVisionModelOutput with CLIP->ChineseCLIP
...
# Copied from transformers.models.clip.modeling_clip.CLIPAttention with CLIP->ChineseCLIP
...
# Copied from transformers.models.clip.modeling_clip.CLIPMLP with CLIP->ChineseCLIP
...
# Copied from transformers.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->ChineseCLIP
...
# Copied from transformers.models.clip.modeling_clip.CLIPEncoder with CLIP->ChineseCLIP
...
class ChineseCLIPModel(ChineseCLIPPreTrainedModel):
    ...
    def __init__(self, config: ChineseCLIPConfig):
        ...
        self.text_model = BertModel(text_config, add_pooling_layer=False)

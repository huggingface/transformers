...
@dataclass
# Copied from transformers.models.clip.modeling_clip.CLIPVisionModelOutput with CLIPVisionModel->ChineseCLIPVision
class ChineseCLIPVisionOutput(ModelOutput):
    """
...
# Copied from transformers.models.clip.modeling_clip.CLIPAttention with CLIP->ChineseCLIPVision

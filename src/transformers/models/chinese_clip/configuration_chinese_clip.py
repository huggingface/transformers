...
class ChineseCLIPConfig(PreTrainedConfig):
    ...
    projection_dim: int = 512
    logit_scale_init_value: float | int = 2.6592
    initializer_factor: float = 1.0
    initializer_range: float = 0.02
            ...
            for key, value in _text_config_dict.items():
                if key in text_config and value != text_config[key] and key != "transformers_version":
                    ...
                    # If inferred from default argument values (just to be super careful)
                        ...
                        message = (
                            f"`text_config_dict` is provided which will be used to initialize `ChineseCLIPTextConfig`. The "
            ...
            for key, value in _vision_config_dict.items():
                if key in vision_config and value != vision_config[key] and key != "transformers_version":
                    ...
                    # If inferred from default argument values (just to be super careful)
                        ...
                        message = (
                            f"`vision_config_dict` is provided which will be used to initialize `ChineseCLIPVisionConfig`. "

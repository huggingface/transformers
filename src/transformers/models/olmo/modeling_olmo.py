...
_CHECKPOINT_FOR_DOC = "meta-olmo/Olmo-2-7b-hf"
...
@add_start_docstrings(
    """
    The Olmo Model transformer with a token classification head on top (a linear layer on top of the hidden-states
...
@add_start_docstrings(
    """
    The Olmo Model transformer with a sequence classification head on top (linear layer).

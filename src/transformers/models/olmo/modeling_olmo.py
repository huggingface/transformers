...
# Copied from transformers.models.llama.modeling_llama.LlamaYaRNScalingRotaryEmbedding with Llama->Olmo
...
# Copied from transformers.models.llama.modeling_llama.LlamaDynamicYaRNScalingRotaryEmbedding with Llama->Olmo
class OlmoDynamicYaRNScalingRotaryEmbedding(OlmoYaRNScalingRotaryEmbedding):
    def __init__(
        self,
        dim,
        max_position_embeddings=2048,
    ...
    def _init_rope(self):
        if self.config.rope_scaling is None:
            ...
            if scaling_type == "linear":
                ...
                self.rotary_emb = OlmoDynamicYaRNScalingRotaryEmbedding(
                    self.head_dim,
                    max_position_embeddings=self.max_position_embeddings,
                    scaling_factor=scaling_factor,
                    base=self.rope_theta,

...
class MRAConfig(PretrainedConfig):
    ...
    Args:
        ...
        use_expectation (`bool`, *optional*, defaults to `True`):
            Whether or not to use MRA Expectation. Overrides any effect of num_hash.
        ...
        num_hash (`int`, *optional*, defaults to 64):
            Number of hash functions used in [`MRASelfAttention`].
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.block_per_row = 4
        self.approx_mode = "full"
        self.initial_prior_first_n_blocks = 0
        self.initial_prior_diagonal_n_blocks = 0

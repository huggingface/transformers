...
from transformers import CLIPTokenizerFast, Sam2ImageProcessorFast, Sam3Config, Sam3Model, Sam3Processor
...
ORIGINAL_TO_CONVERTED_KEY_MAPPING = {
    ...
    r"^geometry_encoder\.mask_encoder\.fuser\.":                            r"geometry_encoder.mask_encoder.mask_fuser.",
    r"^geometry_encoder\.mask_encoder\.mask_fuser\.layers\.(\d+)\.gamma":   r"geometry_encoder.mask_encoder.mask_fuser.layers.\1.scale",
    r"^geometry_encoder\.mask_encoder\.mask_fuser\.layers\.(\d+)\.dwconv\.": r"geometry_encoder.mask_encoder.mask_fuser.layers.\1.depthwise_conv.",
    r"^geometry_encoder\.mask_encoder\.mask_fuser\.layers\.(\d+)\.norm\.":  r"geometry_encoder.mask_encoder.mask_fuser.layers.\1.layer_norm.",
    r"^geometry_encoder\.mask_encoder\.mask_fuser\.layers\.(\d+)\.pwconv1\.": r"geometry_encoder.mask_encoder.mask_fuser.layers.\1.pointwise_conv1.",
    r"^geometry_encoder\.mask_encoder\.mask_fuser\.layers\.(\d+)\.pwconv2\.": r"geometry_encoder.mask_encoder.mask_fuser.layers.\1.pointwise_conv2.",
    # Mask downsampler: encoder.0/1 → layers.0.conv/layer_norm, encoder.3/4 → layers.1.conv/layer_norm, encoder.6 → final_conv
    r"^geometry_encoder\.mask_encoder\.mask_downsampler\.encoder\.0\.":    r"geometry_encoder.mask_encoder.mask_downsampler.layers.0.conv.",
    r"^geometry_encoder\.mask_encoder\.mask_downsampler\.encoder\.1\.":    r"geometry_encoder.mask_encoder.mask_downsampler.layers.0.layer_norm.",
    r"^geometry_encoder\.mask_encoder\.mask_downsampler\.encoder\.3\.":    r"geometry_encoder.mask_encoder.mask_downsampler.layers.1.conv.",
    r"^geometry_encoder\.mask_encoder\.mask_downsampler\.encoder\.4\.":    r"geometry_encoder.mask_encoder.mask_downsampler.layers.1.layer_norm.",
    r"^geometry_encoder\.mask_encoder\.mask_downsampler\.encoder\.6\.":    r"geometry_encoder.mask_encoder.mask_downsampler.final_conv.",
    r"^geometry_encoder\.mask_encoder\.pix_feat_proj\.":                    r"geometry_encoder.mask_encoder.feature_projection.",
    r"^geometry_encoder\.mask_encoder\.out_proj\.":                         r"geometry_encoder.mask_encoder.projection.",
...
def convert_sam3_checkpoint(
    ...
    tokenizer = CLIPTokenizerFast.from_pretrained("tokenizer_fast")

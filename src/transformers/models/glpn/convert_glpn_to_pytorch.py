...
@torch.no_grad()
def convert_glpn_checkpoint(model_name, checkpoint_path, pytorch_dump_folder_path, push_to_hub=False):
    """
    Copy/paste/tweak model's weights to our GLPN structure.
    """

    # load GLPN configuration (B4 size)
    ...
    feature_extractor = ViTFeatureExtractor(size=224)
...
if __name__ == "__main__":
    ...
    convert_glpn_checkpoint(args.model_name, args.checkpoint_path, args.pytorch_dump_folder_path, args.push_to_hub)

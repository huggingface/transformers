...
@add_start_docstrings(
    ...
    """
        do_center_crop (`bool`, *optional*, defaults to `True`):
            ...
            is padded with zeros and then center cropped.
        crop_size (`Dict[str, int]`, *optional*, defaults to `{"height": 18, "width": 18}`):
...
class EfficientFormerImageProcessorFast(BaseImageProcessorFast):
    ...
    def save_pretrained(self, save_directory, **kwargs):
        ...
        [`~EfficientFormerImageProcessorFast.from_pretrained`] class method.
    ...
    def from_dict(cls, config_dict, **kwargs):
        """
        Instantiates a [`EfficientFormerImageProcessorFast`] from a Python dictionary of parameters.
        ...
        Returns:
            [`EfficientFormerImageProcessorFast`]: The image processor object instantiated from those parameters.
        """
    ...
    def center_crop(self, image: "torch.Tensor", crop_size: Dict[str, int]) -> "torch.Tensor":
        """
    ...
    def resize(self, image: "torch.Tensor", size: SizeDict, interpolation: Optional["F.InterpolationMode"] = None) -> "torch.Tensor":
        """

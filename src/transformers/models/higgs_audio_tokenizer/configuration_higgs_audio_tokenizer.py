...
class HiggsAudioTokenizerConfig(PreTrainedConfig):
    ...
    HiggsAudioTokenizer model according to the specified arguments, defining the model architecture. Instantiating a configuration
        ...
        **kwargs,
        ...
        if acoustic_model_config is None:
            self.acoustic_model_config = DacConfig(
                ...
                # (not sure if intentional by HiggsAudioTokenizer but we keep it)

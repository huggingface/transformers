...
@auto_docstring
class Qwen4ExpModel(Qwen4ExpPreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
@auto_docstring
class Qwen4ExpForConditionalGeneration(Qwen4ExpPreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

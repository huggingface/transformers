...
class PerceiverTokenizer(BertTokenizer):
    r"""
    Construct a Perceiver tokenizer.

    :class:`~transformers.PerceiverTokenizer` is identical to :class:`~transformers.BertTokenizer` and runs end-to-end

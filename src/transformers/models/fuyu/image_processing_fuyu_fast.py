...
from .image_processing_fuyu import FuyuBatchFeature, make_list_of_list_of_images
...
class FuyuImageProcessorFast(BaseImageProcessorFast):
    ...
    def patchify_image(self, image: torch.Tensor, patch_size: Optional[SizeDict] = None) -> torch.Tensor:
        ...
        Returns:
            `torch.Tensor`: Patches with shape [batch, num_patches, channels * patch_height * patch_width]
        """
    ...
    def preprocess_with_tokenizer_info(
        ...
        Returns:
            `FuyuBatchFeature`: Batch feature containing processed images and metadata.
        """
        requires_backends(self, ["torch"])

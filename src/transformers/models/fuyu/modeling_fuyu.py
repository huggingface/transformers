...
class FuyuModel(FuyuPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if encoder_outputs.get("images") is None and image_patches is not None:
            encoder_outputs["images"] = self.get_image_features(image_patches, return_dict=True)

        if encoder_outputs.get("images") is not None:
            patch_embeddings = encoder_outputs["images"].last_hidden_state.to(

...
class HiggsAudioV2Config(PreTrainedConfig):
    ...
    defaults will yield a similar configuration to that of the HiggsAudioV2-7B.
    e.g. [meta-higgs_audio_v2/HiggsAudioV2-2-7b-hf](https://huggingface.co/meta-higgs_audio_v2/HiggsAudioV2-2-7b-hf)
    ...
    >>> # Initializing a HiggsAudioV2 higgs_audio_v2-7b style configuration
    >>> configuration = HiggsAudioV2Config()

    >>> # Initializing a model from the higgs_audio_v2-7b style configuration

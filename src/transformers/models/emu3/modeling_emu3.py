...
class Emu3RotaryEmbedding(nn.Module):
    ...
    @staticmethod
    @deprecate_kwarg("device", version="5.18")
    def compute_default_rope_parameters(config: Emu3Config, device=None, **kwargs) -> tuple[torch.Tensor, float]:
        """
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if mm_encoder_outputs.get("images") is None and pixel_values is not None:
            mm_encoder_outputs["images"] = self.get_image_features(pixel_values, image_sizes)

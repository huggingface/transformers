...
_import_structure = {
    "configuration_vmamba": ["VMAMBA_PRETRAINED_CONFIG_ARCHIVE_MAP", "VMambaConfig"],
    "tokenization_vmamba": ["VMambaTokenizer"],
}
...
try:
    ...
    _import_structure["tokenization_vmamba_fast"] = ["VMambaTokenizerFast"]

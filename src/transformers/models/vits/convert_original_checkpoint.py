...
MAPPING_STOCHASTIC_DURATION_PREDICTOR = {
    ...
    "dp.convs.convs_sep.*" : "duration_predictor.convs.convs_sep.*",
    "dp.convs.convs_1x1.*" : "duration_predictor.convs.convs_1x1.*",
    ...
    "dp.post_pre" : "duration_predictor.post_pre",
    "dp.post_proj" : "duration_predictor.post_proj",
    "dp.post_convs.convs_sep.*" : "duration_predictor.post_convs.convs_sep.*",
    "dp.post_convs.convs_1x1.*" : "duration_predictor.post_convs.convs_1x1.*",
    "dp.post_convs.norms_1.*.gamma" : "duration_predictor.post_convs.norms_1.*.weight",
    "dp.post_convs.norms_1.*.beta" : "duration_predictor.post_convs.norms_1.*.bias",
    "dp.post_convs.norms_2.*.gamma" : "duration_predictor.post_convs.norms_2.*.weight",
    "dp.post_convs.norms_2.*.beta" : "duration_predictor.post_convs.norms_2.*.bias",
    "dp.post_flows.0.logs" : "duration_predictor.post_flows.0.logs",
    "dp.post_flows.0.m" : "duration_predictor.post_flows.0.m",
    "dp.post_flows.*.pre" : "duration_predictor.post_flows.*.pre",
    "dp.post_flows.*.proj" : "duration_predictor.post_flows.*.proj",
    "dp.post_flows.*.convs.convs_1x1.0" : "duration_predictor.post_flows.*.convs.convs_1x1.0",
    "dp.post_flows.*.convs.convs_1x1.1" : "duration_predictor.post_flows.*.convs.convs_1x1.1",
    "dp.post_flows.*.convs.convs_1x1.2" : "duration_predictor.post_flows.*.convs.convs_1x1.2",
    "dp.post_flows.*.convs.convs_sep.0" : "duration_predictor.post_flows.*.convs.convs_sep.0",
    "dp.post_flows.*.convs.convs_sep.1" : "duration_predictor.post_flows.*.convs.convs_sep.1",
    "dp.post_flows.*.convs.convs_sep.2" : "duration_predictor.post_flows.*.convs.convs_sep.2",
    "dp.post_flows.*.convs.norms_1.0.gamma" : "duration_predictor.post_flows.*.convs.norms_1.0.weight",
    "dp.post_flows.*.convs.norms_1.0.beta" : "duration_predictor.post_flows.*.convs.norms_1.0.bias",
    "dp.post_flows.*.convs.norms_1.1.gamma" : "duration_predictor.post_flows.*.convs.norms_1.1.weight",
    "dp.post_flows.*.convs.norms_1.1.beta" : "duration_predictor.post_flows.*.convs.norms_1.1.bias",
    "dp.post_flows.*.convs.norms_1.2.gamma" : "duration_predictor.post_flows.*.convs.norms_1.2.weight",
    "dp.post_flows.*.convs.norms_1.2.beta" : "duration_predictor.post_flows.*.convs.norms_1.2.bias",
    "dp.post_flows.*.convs.norms_2.0.gamma" : "duration_predictor.post_flows.*.convs.norms_2.0.weight",
    "dp.post_flows.*.convs.norms_2.0.beta" : "duration_predictor.post_flows.*.convs.norms_2.0.bias",
    "dp.post_flows.*.convs.norms_2.1.gamma" : "duration_predictor.post_flows.*.convs.norms_2.1.weight",

...
class MiniCPM3Attention(nn.Module):
    def __init__(self, config: MiniCPM3Config, layer_idx: int):
        ...
        self.kv_a_layernorm = MiniCPM3RMSNorm(self.kv_lora_rank)
...
class MiniCPM3ForTokenClassification(GenericForTokenClassification, MiniCPM3PreTrainedModel):
    pass

...
class MiniCPM3Config(PretrainedConfig):
    ...
    e.g. [openbmb/MiniCPM3-4B](https://huggingface.co/openbmb/MiniCPM3-4B)
    ...
    Args:
            ...
            v_head_dim (`int`, *optional*):
                Dimension of the value heads. If None, defaults to `hidden_size // num_attention_heads`.
            hidden_act (`str` or `function`, *optional*, defaults to `"silu"`):
                The non-linear activation function (function or string) in the decoder.
            max_position_embeddings (`int`, *optional*, defaults to 32768):
                The maximum sequence length that this model might ever be used with. MiniCPM3 supports up to 4096 tokens
                MiniCPM3-4B supports a 32k context window. When equipped with LLMxMapReduce, it can theoretically handle infinite context without requiring a large amount of memory.
            ...
            dim_model_base (`float`, *optional*):
                Base dimension for model scaling. If None, defaults to `hidden_size`.
            scale_depth (`float`, *optional*):
                Depth scaling factor for residual connections. If None, defaults to `sqrt(num_hidden_layers)`.

...
@auto_docstring
class Qwen3VLMoeModel(Qwen3VLMoePreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
class Qwen3VLMoeForConditionalGeneration(Qwen3VLMoePreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

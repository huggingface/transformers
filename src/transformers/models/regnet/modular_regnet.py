...
class RegNetConvLayer(ResNetConvLayer):
    pass
...
class RegNetShortCut(ResNetShortCut):
    pass
...
@auto_docstring
class RegNetPreTrainedModel(ResNetPreTrainedModel):
    config: RegNetConfig
...
class RegNetEncoder(ResNetEncoder):
...
class RegNetModel(RegNetPreTrainedModel, ResNetModel):
...
class RegNetForImageClassification(RegNetPreTrainedModel, ResNetForImageClassification):

...
def convert_weight_and_push(
    ...
    if push_to_hub:
        our_model.push_to_hub(repo_id=name, commit_message="Add model", use_temp_dir=True)
        ...
        image_processor.push_to_hub(repo_id=name, commit_message="Add image processor", use_temp_dir=True)

...
from .configuration_lumma import LummaConfig


@use_kernel_forward_from_hub("RMSNorm")
class LummaRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        LummaRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class LummaRotaryEmbedding(nn.Module):
    @deprecate_kwarg("device", version="5.18")
    def __init__(self, config: LummaConfig, device=None):
        super().__init__()
    ...
    @staticmethod
    @deprecate_kwarg("device", version="5.18")
    def compute_default_rope_parameters(config: LummaConfig, device=None, **kwargs) -> tuple[torch.Tensor, float]:
        """
...
@auto_docstring
class LummaPreTrainedModel(PreTrainedModel):
    config: LummaConfig
...
@auto_docstring
class LummaForCausalLM(LummaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, LummaForCausalLM

        >>> model = LummaForCausalLM.from_pretrained("meta-lumma/Lumma-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-lumma/Lumma-2-7b-hf")
...
__all__ = ["LummaPreTrainedModel", "LummaModel", "LummaForCausalLM"]

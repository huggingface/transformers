...
See https://github.com/lyuwenyu/RTDetrv2/blob/5b628eaa0a2fc25bdafec7e6148d5296b144af85/rtdetr_pytorch/src/nn/backbone/presnet.py#L126 for details.
"""
...
# Base docstring
_CHECKPOINT_FOR_DOC = "jadechoghari/rtdetrv2"
...
# Copied from transformers.models.rt_detr.modeling_rt_detr_resnet.RTDetrResNetEmbeddings with RTDetr->RTDetrv2
...
# Copied from transformers.models.rt_detr.modeling_rt_detr_resnet.RTDetrResNetBasicLayer with RTDetr->RTDetrv2,RT-DETR->RTDetrv2
class RTDetrv2ResNetBasicLayer(nn.Module):
    """
    A classic ResNet's residual layer composed by two `3x3` convolutions.
    See https://github.com/lyuwenyu/RTDetrv2/blob/5b628eaa0a2fc25bdafec7e6148d5296b144af85/rtdetr_pytorch/src/nn/backbone/presnet.py#L34.
    """
    ...
    def __init__(
        ...
        if in_channels != out_channels:
            self.shortcut = (
                nn.Sequential(
                    *[nn.AvgPool2d(2, 2, 0, ceil_mode=True), RTDetrv2ResNetShortCut(in_channels, out_channels, stride=1)]
                )
...
# Copied from transformers.models.rt_detr.modeling_rt_detr_resnet.RTDetrResNetBottleNeckLayer with RTDetr->RTDetrv2
...
# Copied from transformers.models.rt_detr.modeling_rt_detr_resnet.RTDetrResNetStage with RTDetr->RTDetrv2
...
# Copied from transformers.models.rt_detr.modeling_rt_detr_resnet.RTDetrResNetBackbone with RTDETR->RTDETRV2,RTDetr->RTDetrv2

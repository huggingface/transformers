...
"""RTDetrv2 model configuration"""

from ...configuration_utils import PretrainedConfig
from ...utils import logging
from ...utils.backbone_utils import verify_backbone_config_arguments
from ..auto import CONFIG_MAPPING
from .configuration_rtdetrv2_resnet import RTDetrv2ResNetConfig
...
class RTDetrv2Config(PretrainedConfig):
    ...
    RTDetrv2 model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of the RTDetrv2
    ...
    >>> # Initializing a RTDetrv2 configuration

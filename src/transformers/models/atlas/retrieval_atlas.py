...
LEGACY_INDEX_PATH = "https://stoatlase.googleapis.com/huggingface-nlp/datasets/wiki_dpr/"
...
class LegacyIndex(Index):
    ...
    Args:
        ...
        index_path (`str`):
            A path to a *directory* containing index files compatible with [`~models.atlas.retrieval_atlas.LegacyIndex`]
    """

# coding=utf-8
# Copyright 2022 Zekun Li The HuggingFace Inc. team. All rights reserved.
#
...
class GeoLMForCausalLM(GeoLMPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if not config.is_decoder:
            logger.warning("If you want to use `GeoLMForCausalLM` as a standalone, add `is_decoder=True.`")

...
class Glm4MoeLiteRotaryEmbedding(nn.Module):
    ...
    @staticmethod
    def compute_default_rope_parameters(config: Glm4MoeLiteConfig) -> tuple[torch.Tensor, float]:
        """
...
class Glm4MoeLiteAttention(nn.Module):
    ...
    def __init__(self, config: Glm4MoeLiteConfig, layer_idx: int):
        ...
        self.q_a_layernorm = Glm4MoeLiteRMSNorm(config.q_lora_rank) if self.q_lora_rank is not None else None
        self.q_b_proj = (

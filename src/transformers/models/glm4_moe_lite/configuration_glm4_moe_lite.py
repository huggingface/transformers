...
class Glm4MoeLiteConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Glm4MoeLiteModel`]. It is used to instantiate a
    Glm4MoeLite model according to the specified arguments, defining the model architecture. Instantiating a configuration
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 151552):
            Vocabulary size of the Glm4MoeLite model. Defines the number of different tokens that can be represented by the
    ...
    # Default tensor parallel plan for base model `Glm4MoeLite`
    base_model_tp_plan = {

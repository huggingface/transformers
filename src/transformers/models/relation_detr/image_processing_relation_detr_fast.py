...
"""Fast Image processor class for Relation DETR."""
...
class RelationDetrImageProcessorFast(BaseImageProcessorFast):
    r"""
    Constructs a fast Relation DETR image processor.
...
__all__ = ["RelationDetrImageProcessorFast"]

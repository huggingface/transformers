...
try:
    ...
    _import_structure["feature_extraction_relation_detr"] = ["RelationDetrFeatureExtractor"]
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .feature_extraction_relation_detr import RelationDetrFeatureExtractor

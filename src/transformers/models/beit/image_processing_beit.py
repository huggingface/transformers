...
class BeitTorchVisionBackend(TorchVisionBackend):
    """TorchVision backend for BEiT with reduce_label support."""
...
class BeitPilBackend(PilBackend):
...
class BeitImageProcessor(BaseImageProcessor):
    ...
    _backend_classes = {
        "torchvision": BeitTorchVisionBackend,
        "pil": BeitPilBackend,
    }

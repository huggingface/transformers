...
MOT_PRETRAINED_MODEL_ARCHIVE_LIST = [
    "mot-base",
    # See all MoT models at https://huggingface.co/models?filter=mot
]
...
# Copied from transformers.models.gpt2.modeling_gpt2.GPT2PreTrainedModel with GPT2->MoT,gpt2->mot,OpenAI GPT-2->MoT
class MoTPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        # Reinitialize selected weights subject to the MoT Paper Scheme:
...
@dataclass
# Copied from transformers.models.gpt2.modeling_gpt2.GPT2DoubleHeadsModelOutput with GPT2->MoT
class MoTDoubleHeadsModelOutput(ModelOutput):
    """
    ...
    Args:
        ...
        attentions (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`):
            ...
            MoTAttentions weights after the attention softmax, used to compute the weighted average in the
...
class MoTDoubleHeadsModel(MoTPreTrainedModel):
    _tied_weights_keys = ["lm_head.weight"]
    ...
    def parallelize(self, device_map=None):
        warnings.warn(
            "`MoTDoubleHeadsModel.parallelize` is deprecated and will be removed in v5 of Transformers, you should"
    ...
    @add_start_docstrings_to_model_forward(MOT_INPUTS_DOCSTRING)
    @replace_return_docstrings(output_type=MoTDoubleHeadsModelOutput, config_class=_CONFIG_FOR_DOC)
    def forward(
        self,
        input_ids: Optional[torch.LongTensor] = None,
        past_key_values: Optional[Tuple[Tuple[torch.Tensor]]] = None,
        ...
        return_dict: Optional[bool] = None,
        **kwargs,
    ) -> Union[Tuple, MoTDoubleHeadsModelOutput]:
        r"""
        ...
        return MoTDoubleHeadsModelOutput(
            loss=lm_loss,
            mc_loss=mc_loss,
            logits=lm_logits,
            mc_logits=mc_logits,

...
class RFDetrConfig(BackboneConfigMixin, PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`RFDetrModel`]. It is used to instantiate an
    RFDetr model according to the specified arguments, defining the model architecture. Instantiating a configuration
    ...
    >>> # Initializing a RFDetr base style configuration

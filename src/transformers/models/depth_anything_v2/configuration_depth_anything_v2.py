...
class DepthAnythingV2Config(PretrainedConfig):
    r"""
    ...
    ```python
    >>> from transformers import DepthAnythingV2Config, DepthAnythingV2ForDepthEstimation

    >>> # Initializing a DepthAnythingV2 small style configuration
    >>> configuration = DepthAnythingV2Config()

    >>> # Initializing a model from the DepthAnythingV2 small style configuration
    >>> model = DepthAnythingV2ForDepthEstimation(configuration)

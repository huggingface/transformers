...
def convert_dpt_checkpoint(model_name, pytorch_dump_folder_path, push_to_hub, verify_logits):
    ...
    if verify_logits:
        ...
        if model_name == "depth-anything-v2-small":
    ...
    if push_to_hub:
        ...
        model.push_to_hub(repo_id=f"MackinationsAi/{model_name}-hf")
        processor.push_to_hub(repo_id=f"MackinationsAi/{model_name}-hf")

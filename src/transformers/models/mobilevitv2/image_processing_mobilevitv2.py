...
"""Image processor class for MobileViTv2."""
...
class MobileViTv2ImageProcessor(BaseImageProcessor):
    r"""
    Constructs a MobileViTv2 image processor.
    ...
    def post_process_semantic_segmentation(self, outputs, target_sizes: List[Tuple] = None):
        """
        Converts the output of [`MobileViTv2ForSemanticSegmentation`] into semantic segmentation maps. Only supports
        PyTorch.

        Args:
            outputs ([`MobileViTv2ForSemanticSegmentation`]):

#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/principle/modular_principle.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_principle.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
@add_start_docstrings(
    "The bare Principle Model outputting raw hidden-states without any specific head on top.",
...
class PrinciplePreTrainedModel(PreTrainedModel):
    ...
    _no_split_modules = ["PrincipleDecoderLayer"]
...
class PrincipleModel(PrinciplePreTrainedModel):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`PrincipleDecoderLayer`]
...
@add_start_docstrings(
    """
    The Principle Model transformer with a sequence classification head on top (linear layer).

    [`PrincipleForSequenceClassification`] uses the last token in order to do the classification, as other causal models
    (e.g. GPT-2) do.
...
@add_start_docstrings(
    """
    The Principle Model transformer with a token classification head on top (a linear layer on top of the hidden-states
...
@add_start_docstrings(
    """
The Principle Model transformer with a span classification head on top for extractive question-answering tasks like

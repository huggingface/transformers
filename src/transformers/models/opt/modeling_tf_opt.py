...
@add_start_docstrings(
    "The OPT Model with a language modeling head. Can be used for summarization.",
    OPT_START_DOCSTRING,
)
# Copied from transformers.models.bart.modeling_tf_bart.TFBartForConditionalGeneration with BART->OPT,Bart->OPT
class TFOPTForConditionalGeneration(TFOPTPretrainedModel, TFCausalLanguageModelingLoss):

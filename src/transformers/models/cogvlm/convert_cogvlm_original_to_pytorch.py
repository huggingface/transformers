...
def get_blip2_config(model_name, eos_token_id):
    ...
    vision_config = CogVLMVisionConfig(image_size=image_size).to_dict()
    ...
    config = CogVLMConfig(vision_config=vision_config, text_config=text_config)
...
def convert_blip2_checkpoint(model_name, pytorch_dump_folder_path=None, push_to_hub=False):
    ...
    hf_model = CogVLMForConditionalGeneration(config).eval()

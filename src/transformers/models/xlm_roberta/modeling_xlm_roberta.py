...
class XLMRobertaPreTrainedModel(PreTrainedModel):
    ...
    # Copied from transformers.models.bert.modeling_bert.BertPreTrainedModel._init_weights with Bert->XLMRoberta
    def _init_weights(self, module):
        ...
        elif isinstance(module, XLMRobertaLMPredictionHead):
            module.bias.data.zero_()

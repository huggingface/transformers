...
"""Convert NllbMoeX checkpoints from the original repository to JAX/FLAX model."""
...
def convert_flax_checkpoint_to_pytorch(
    ...
    if gin_file is not None:
        ...
        config = NllbMoeConfig.from_pretrained(config_file)

    pt_model = NllbMoeForConditionalGeneration(config)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "The config json file corresponding to the pre-trained NllbMoe model. \nThis specifies the"
    ...
    parser.add_argument("--config_name", default=None, type=str, required=False, help="Config name of NllbMoe model.")
    parser.add_argument(

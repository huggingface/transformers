...
from transformers.models.nllb_moe.convert_nllb_moe_original_flax_checkpoint_to_pytorch import (
    rename_keys,
)
...
def sanity_check():
    from transformers import NllbMoeConfig, NllbMoeForConditionalGeneration, NllbTokenizer

    config = NllbMoeConfig.from_pretrained("facebook/nllb-moe")
    config.save_pretrained("/home/arthur_huggingface_co/transformers/switch_converted")
    model = NllbMoeForConditionalGeneration.from_pretrained(
        "/home/arthur_huggingface_co/transformers/switch_converted", device_map="auto"
    )

    tokenizer = NllbTokenizer.from_pretrained("t5-small")

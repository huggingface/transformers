#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/conversational_speech_model/modular_conversational_speech_model.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_conversational_speech_model.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
class ConversationalSpeechModelRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        ConversationalSpeechModelRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class ConversationalSpeechModelRotaryEmbedding(nn.Module):
    def __init__(self, config: ConversationalSpeechModelConfig, device=None):
        super().__init__()
...
class ConversationalSpeechModelMLP(nn.Module):
...
class ConversationalSpeechModelAttention(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    def __init__(self, config: ConversationalSpeechModelConfig, layer_idx: int):
        super().__init__()
        self.config = config
...
class ConversationalSpeechModelDecoderLayer(nn.Module):
    def __init__(self, config: ConversationalSpeechModelConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size

        self.self_attn = ConversationalSpeechModelAttention(config=config, layer_idx=layer_idx)

        self.mlp = ConversationalSpeechModelMLP(config)
        self.input_layernorm = ConversationalSpeechModelRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.post_attention_layernorm = ConversationalSpeechModelRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        if labels is not None:
            ...
            depth_decoder_labels = labels[:, :, : self.config.audio_num_codebooks].view(
                -1, self.config.audio_num_codebooks
            )

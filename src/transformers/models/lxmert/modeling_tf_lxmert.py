...
from ...modeling_tf_utils import TFPreTrainedModel, get_initializer, unpack_inputs, keras_serializable, shape_list
    ...
    def call(
        ...
        **kwargs,
        ...
        embedding_output = self.embeddings(
            input_ids, token_type_ids, inputs_embeds, training= training
        )

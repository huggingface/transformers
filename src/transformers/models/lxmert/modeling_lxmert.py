    ...
    def resize_num_qa_labels(self, num_labels):
        ...
        Args:
            num_labels (:obj:`int`, `optional`):
                ...
                just returns a pointer to the qa labels :obj:`nn.Linear`` module of the model without doing anything.

        Return:
            :obj:`nn.Linear`: Pointer to the resized Linear layer or the old Linear layer
        """

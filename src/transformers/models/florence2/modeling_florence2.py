...
class Florence2LanguageFlashAttention2(Florence2LanguageAttention):
    ...
    def forward(
        ...
        if output_attentions:
            raise ValueError(
                "Florence2LanguageSdpaAttention2 attention does not support `output_attentions`. "
...
class Florence2LanguageSdpaAttention(Florence2LanguageAttention):
    def forward(
        ...
        if output_attentions:
            ...
            logger.warning_once(
                "Florence2LanguageModel is using Florence2LanguageSdpaAttention, but `torch.nn.functional.scaled_dot_product_attention` does not support `output_attentions=True` . Falling back to the manual attention"

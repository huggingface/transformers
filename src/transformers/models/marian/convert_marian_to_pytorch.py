...
if __name__ == "__main__":
    ...
    # Required parameters
    parser.add_argument("--src", type=str, help="path to marian model sub dir. yaml.load will be used to load the configuration file, please be weary of which file you're loading.", default="en-de")

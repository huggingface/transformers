...
# new 
class MarianFlashAttention(nn.Module):
    """Multi-headed Flash Attention for Marian models"""
    ...
    def forward(
        ...
        attn_output, attn_weights = self.flash_attention(query_states, key_states, value_states, attention_mask)

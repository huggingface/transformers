...
class SegformerConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.sr_ratios = [8, 4, 2, 1] if sr_ratios is None else sr_ratios
        self.hidden_sizes = [32, 64, 160, 256] if hidden_sizes is None else hidden_sizes
        self.downsampling_rates = [1, 4, 8, 16] if downsampling_rates is None else downsampling_rates
        self.patch_sizes = [7, 3, 3, 3] if patch_sizes is None else patch_sizes
        self.strides = [4, 2, 2, 2] if strides is None else strides
        self.num_attention_heads = [1, 2, 5, 8] if num_attention_heads is None else num_attention_heads
        self.mlp_ratios = [4, 4, 4, 4] if mlp_ratios is None else mlp_ratios

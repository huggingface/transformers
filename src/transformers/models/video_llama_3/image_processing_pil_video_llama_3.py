...
# Copied from transformers.models.video_llama_3.image_processing_video_llama_3.VideoLlama3ImageProcessorKwargs
...
# Copied from transformers.models.video_llama_3.image_processing_video_llama_3.smart_resize
def smart_resize(

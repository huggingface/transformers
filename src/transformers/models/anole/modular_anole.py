...
class AnoleModel(ChameleonModel):
    ...
    def get_image_tokens(self, pixel_values: torch.FloatTensor):
        ...
        device = image_toks.device
        img_tokens = self.img2bpe_mapping_tensor[image_toks.to(self.img2bpe_mapping_tensor.device)]
    ...
    def decode_image_tokens(self, bpe_tokens: torch.LongTensor) -> torch.LongTensor:
        ...
        image_tensor = self.bpe2img_mapping_tensor[bpe_tokens.to(self.bpe2img_mapping_tensor.device)]

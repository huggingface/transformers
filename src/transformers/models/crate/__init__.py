...
_import_structure = {
    "configuration_crate": ["CRATE_PRETRAINED_CONFIG_ARCHIVE_MAP", "CrateConfig", "CrateOnnxConfig"],
}
...
if TYPE_CHECKING:
    from .configuration_crate import CRATE_PRETRAINED_CONFIG_ARCHIVE_MAP, CrateConfig, CrateOnnxConfig

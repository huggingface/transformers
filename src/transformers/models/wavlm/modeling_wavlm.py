...
_SEQ_CLASS_CHECKPOINT = "microsoft/wavlm-large-1500h-cv"
...
# Copied from transformers.models.bart.modeling_bart.BartAttention with Bart->WavLM
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2EncoderLayer with Wav2Vec2->WavLM

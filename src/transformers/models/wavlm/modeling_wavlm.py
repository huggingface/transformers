...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2Model with Wav2Vec2BaseModelOutput->Wav2Vec2BaseModelOutput, Wav2Vec2->WavLM, wav2vec2->wavlm, WAV_2_VEC_2->WAVLM

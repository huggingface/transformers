...
class GPTJAttention(nn.Module):
    ...
    def _split_heads(self, tensor: torch.Tensor, transpose: bool = True) -> torch.Tensor:
        """
        Splits hidden dim into attn_head_size and num_attention_heads
        """
        new_shape = tensor.size()[:-1] + (self.num_attention_heads, self.head_dim)

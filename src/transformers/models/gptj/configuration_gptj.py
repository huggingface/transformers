...
GPT_J_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "EleutherAI/gptj-6B": "https://huggingface.co/EleutherAI/gptj-6B/resolve/main/config.json",
...
class GPTJConfig(PretrainedConfig):
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50257):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers.GPTJModel`. Vocabulary size of the model.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformers.GPTJModel`.

...
if is_vision_available():
    from .image_processing_apertus1p5 import Apertus1p5ImageProcessorKwargs, smart_resize


class Apertus1p5TextKwargs(TextKwargs, total=False):
    """
...
class Apertus1p5ProcessorKwargs(ProcessingKwargs, total=False):
    text_kwargs: Apertus1p5TextKwargs
...
class Apertus1p5Processor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs: Unpack[Apertus1p5ProcessorKwargs],
    ) -> BatchFeature:
        r"""
        Returns:

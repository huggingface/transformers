...
# Apertus1p5 needs a fast image processor after which we can add the new backends. We keep it current way
...
class Apertus1p5ImageProcessor(BaseImageProcessor):
    r"""
    Constructs a Apertus1p5 image processor that dynamically resizes images based on the original images.

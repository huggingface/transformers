# coding=utf-8
# Copyright 2020, The FusionInDecoder Authors and HuggingFace Inc.
#
...
""" FusionInDecoder model configuration"""
...
class FusionInDecoderConfig(PretrainedConfig):
    ...
    instantiate a FusionInDecoder model according to the specified arguments, defining the model architecture. Instantiating a
    configuration with the defaults will yield a similar configuration to that of the FusionInDecoder
    [google-t5/t5-base](https://huggingface.co/google-t5/t5-base) architecture.
    ...
    Arguments:
        vocab_size (`int`, *optional*, defaults to 32128):
            Vocabulary size of the FusionInDecoder model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`FusionInDecoderModel`] or [`TFFusionInDecoderModel`].
        ...
        d_ff (`int`, *optional*, defaults to 2048):
            Size of the intermediate feed forward layer in each `FusionInDecoderBlock`.

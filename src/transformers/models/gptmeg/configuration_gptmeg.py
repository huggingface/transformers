...
class GPTMegConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers.GPTMegModel`.
    It is used to instantiate an GPTMeg model according to the specified arguments, defining the model
    architecture. Instantiating a configuration with the defaults will yield a similar configuration to that of
    the GPTMeg `gptmeg <https://huggingface.co/gptmeg>`__ architecture.

#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/llava_next_video2/modular_llava_next_video2.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_llava_next_video2.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
_CONFIG_FOR_DOC = "LlavaNextVideo2Config"


class LlavaNextVideo2Pooler(nn.Module):
...
@dataclass
class LlavaNextVideo2CausalLMOutputWithPast(ModelOutput):
    """
    Base class for LlavaNextVideo2 causal language model (or autoregressive) outputs.
...
class LlavaNextVideo2MultiModalProjector(nn.Module):
    def __init__(self, config: LlavaNextVideo2Config):
        super().__init__()
...
LLAVA_NEXT_VIDEO2_START_DOCSTRING = r"""
    ...
    Parameters:
        config ([`LlavaNextVideo2Config`] or [`LlavaNextVideo2VisionConfig`]):
...
@add_start_docstrings(
    ...
    LLAVA_NEXT_VIDEO2_START_DOCSTRING,
)
class LlavaNextVideo2PreTrainedModel(PreTrainedModel):
    config_class = LlavaNextVideo2Config
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["LlavaNextVideo2VisionAttention"]
    ...
    def _init_weights(self, module):
        # important: this ported version of LlavaNextVideo2 isn't meant for training from scratch - only
        # inference and fine-tuning - so the proper init weights code has been removed - the original codebase
        # https://github.com/haotian-liu/LLaVA/tree/main/llava_next_video2 should serve for that purpose
        std = (
...
LLAVA_NEXT_VIDEO2_INPUTS_DOCSTRING = r"""
    Args:
        ...
        pixel_values (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)):
            ...
            [`AutoImageProcessor`]. See [`LlavaNextVideo2ImageProcessor.__call__`] for details. [`LlavaProcessor`] uses
            [`LlavaNextVideo2ImageProcessor`] for processing images.
...
class LlavaNextVideo2ForConditionalGeneration(LlavaNextVideo2PreTrainedModel, GenerationMixin):
    def __init__(
        self,
        ...
        self.multi_modal_projector = LlavaNextVideo2MultiModalProjector(config)
        ...
        self.vision_resampler = LlavaNextVideo2Pooler(config)
        self.post_init()
    ...
    @add_start_docstrings_to_model_forward(LLAVA_NEXT_VIDEO2_INPUTS_DOCSTRING)
    @replace_return_docstrings(output_type=LlavaNextVideo2CausalLMOutputWithPast, config_class=_CONFIG_FOR_DOC)
    def forward(
        self,
    ...
    ) -> Union[Tuple, LlavaNextVideo2CausalLMOutputWithPast]:
        r"""
        Args:
            pixel_values_videos (`torch.FloatTensor` of shape `(batch_size, num_frames, num_channels, image_size, image_size)):
                The tensors corresponding to the input videos. Pixel values can be obtained using
                [`AutoImageProcessor`]. See [`LlavaNextVideo2VideoProcessor.__call__`] for details. [`LlavaProcessor`] uses
                [`LlavaNextVideo2VideoProcessor`] for processing videos.
        ...
        >>> import requests
        >>> import av
        >>> from transformers import AutoProcessor, LlavaNextVideo2ForConditionalGeneration
        ...
        >>> model = LlavaNextVideo2ForConditionalGeneration.from_pretrained("llava-hf/LLaVA-NeXT-Video-7B-hf", device_map="auto")
        ...
        return LlavaNextVideo2CausalLMOutputWithPast(
            loss=loss,
            logits=logits,

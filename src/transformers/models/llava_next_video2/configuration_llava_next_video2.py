...
class LlavaNextVideo2Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`LlavaNextVideo2ForConditionalGeneration`]. It is used to instantiate an
    ...
    ```python
    >>> from transformers import LlavaNextVideo2ForConditionalGeneration, LlavaNextVideo2Config, CLIPVisionConfig, LlamaConfig
    ...
    >>> configuration = LlavaNextVideo2Config(vision_config, text_config)

    >>> model = LlavaNextVideo2ForConditionalGeneration(configuration)

...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "uclanlp/scibart-base": "https://huggingface.co/uclanlp/scibart-base/resolve/main/sentencepiece.bpe.model",
        "uclanlp/scibart-large": "https://huggingface.co/uclanlp/scibart-large/resolve/main/sentencepiece.bpe.model",
    }
}

PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {
    "uclanlp/scibart-base": 1024,
    "uclanlp/scibart-large": 1024,
}
...
class SciBartTokenizer(PreTrainedTokenizer):
    ...
    prefix_tokens: List[int] = [2]
    suffix_tokens: List[int] = [3]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.fairseq_tokens_to_ids = {"<unk>": 0, "<pad>": 1, "<s>": 2, "</s>": 3}

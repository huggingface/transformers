...
FASTVIT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "apple/fastvit-t8": "https://huggingface.co/fastvit-t8/resolve/main/config.json",
...
class FastViTConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`FastViTModel`]. It is used to instantiate a FastViT
    ...
    >>> # Initializing a ViT fastvit-t8 style configuration

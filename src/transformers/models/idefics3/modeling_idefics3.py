...
class Idefics3Model(Idefics3PreTrainedModel):
    ...
    def inputs_merger(
        ...
        reshaped_image_hidden_states = reshaped_image_hidden_states.to(device=self.device, dtype=inputs_embeds.dtype)
        reshaped_image_hidden_states = reshaped_image_hidden_states.to(device=inputs_embeds.device, dtype=inputs_embeds.dtype)

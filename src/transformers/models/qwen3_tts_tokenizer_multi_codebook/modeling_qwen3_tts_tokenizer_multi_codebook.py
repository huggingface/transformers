...
class Qwen3TTSTokenizerMultiCodebookCausalConvNet(nn.Module):
    def __init__(
        self,
        in_channels,
        out_channels,
...
class Qwen3TTSTokenizerMultiCodebookCausalTransConvNet(nn.Module):
...
class Qwen3TTSTokenizerMultiCodebookConvNeXtBlock(nn.Module):
    def __init__(self, dim: int):
        super().__init__()
        self.dwconv = Qwen3TTSTokenizerMultiCodebookCausalConvNet(
            dim,
            dim,
            kernel_size=7,
            groups=dim,
...
class Qwen3TTSTokenizerMultiCodebookRotaryEmbedding(nn.Module):
    inv_freq: torch.Tensor  # fix linting for `register_buffer`

    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookConfig, device=None):
        super().__init__()
    ...
    def compute_default_rope_parameters(
        config: Qwen3TTSTokenizerMultiCodebookConfig | None = None,
...
class Qwen3TTSTokenizerMultiCodebookAttention(nn.Module):
...
class Qwen3TTSTokenizerMultiCodebookRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        Qwen3TTSTokenizerMultiCodebookRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class Qwen3TTSTokenizerMultiCodebookMlp(nn.Module):
...
class Qwen3TTSTokenizerMultiCodebookResidualUnit(nn.Module):
    def __init__(self, dim: int = 16, dilation: int = 1):
        ...
        self.conv1 = Qwen3TTSTokenizerMultiCodebookCausalConvNet(dim, dim, kernel_size=7, dilation=dilation)
        self.act2 = SnakeBeta(dim)
        self.conv2 = Qwen3TTSTokenizerMultiCodebookCausalConvNet(dim, dim, kernel_size=1)
...
@use_kernelized_func(apply_rotary_pos_emb)
class Qwen3TTSTokenizerMultiCodebookCode2WavAttention(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookCode2WavConfig, layer_idx):
        super().__init__()
        self.layer_type = config.layer_types[layer_idx] if hasattr(config, "layer_types") else None
        self.config = config
        self.layer_idx = layer_idx
...
class Qwen3TTSTokenizerMultiCodebookCode2WavMlp(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
        self.hidden_size = config.hidden_size
...
@use_kernel_forward_from_hub("RMSNorm")
class Qwen3TTSTokenizerMultiCodebookCode2WavRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        Qwen3TTSTokenizerMultiCodebookCode2WavRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
        self.weight = nn.Parameter(torch.ones(hidden_size))
        self.variance_epsilon = eps
...
class Qwen3TTSTokenizerMultiCodebookCode2WavLayerScale(nn.Module):
...
class Qwen3TTSTokenizerMultiCodebookBlock(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookCode2WavConfig, layer_idx):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = Qwen3TTSTokenizerMultiCodebookCode2WavAttention(config, layer_idx)
        self.mlp = Qwen3TTSTokenizerMultiCodebookCode2WavMlp(config)
        self.input_layernorm = Qwen3TTSTokenizerMultiCodebookCode2WavRMSNorm(config.hidden_size, config.rms_norm_eps)
        self.post_attention_layernorm = Qwen3TTSTokenizerMultiCodebookCode2WavRMSNorm(
            config.hidden_size, config.rms_norm_eps
        )
        self.self_attn_layer_scale = Qwen3TTSTokenizerMultiCodebookCode2WavLayerScale(config)
        self.mlp_layer_scale = Qwen3TTSTokenizerMultiCodebookCode2WavLayerScale(config)
...
class Qwen3TTSTokenizerMultiCodebookConv1dPaddingCache:
    """
    Padding cache for Qwen3TTSTokenizerMultiCodebookConv1d causal convolutions in order to support streaming via cache padding.
    ...
    Hidden states are cached from the previous call to the Qwen3TTSTokenizerMultiCodebookConv1d forward pass, given the padding size.
    """
...
class Qwen3TTSTokenizerMultiCodebookEncoderOutput(ModelOutput):
    ...
    padding_cache (`Qwen3TTSTokenizerMultiCodebookConv1dPaddingCache`, *optional*):
        Padding cache for Qwen3TTSTokenizerMultiCodebookConv1d causal convolutions in order to support streaming via cache padding.
    """

    audio_codes: torch.LongTensor | None = None
    encoder_past_key_values: Cache | None = None
    padding_cache: Qwen3TTSTokenizerMultiCodebookConv1dPaddingCache | None = None
...
class Qwen3TTSTokenizerMultiCodebookConv1d(nn.Module):
    ...
    def __init__(
        ...
        if stride > 1 and dilation > 1:
            logger.warning(
                "Qwen3TTSTokenizerMultiCodebookConv1d has been initialized with stride > 1 and dilation > 1"
    ...
    def _get_output_length(self, input_length: torch.LongTensor) -> torch.LongTensor:
        """
        Return the length of the output of the Qwen3TTSTokenizerMultiCodebookConv1d.
        """
        # padding size
...
class Qwen3TTSTokenizerMultiCodebookLayerScale(nn.Module):
    """Layer scale from [Touvron et al 2021] (https://huggingface.co/papers/2103.17239).
    This rescales diagonally the residual outputs close to 0, with a learnt scale.
    """
...
@auto_docstring
class Qwen3TTSTokenizerMultiCodebookPreTrainedModel(PreTrainedModel):
    ...
    _no_split_modules = [
        "Qwen3TTSTokenizerMultiCodebookResidualVectorQuantizer",
        "Qwen3TTSTokenizerMultiCodebookTransformerLayer",
    ]
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, Qwen3TTSTokenizerMultiCodebookLayerScale):
            init.constant_(module.scale, self.config.layer_scale_initial_scale)
        elif isinstance(module, Qwen3TTSTokenizerMultiCodebookConv1d):
        ...
        elif isinstance(module, Qwen3TTSTokenizerMultiCodebookEuclideanCodebook):
            init.ones_(module.initialized)
            init.ones_(module.cluster_usage)
            init.zeros_(module.embed_sum)
        elif isinstance(module, Qwen3TTSTokenizerMultiCodebookRotaryEmbedding):
            rope_fn = (
...
class Qwen3TTSTokenizerMultiCodebookCode2WavDecoderResidualUnit(nn.Module):
    def __init__(self, dim: int = 16, dilation: int = 1):
        super().__init__()
...
class Qwen3TTSTokenizerMultiCodebookDecoderBlock(Qwen3TTSTokenizerMultiCodebookPreTrainedModel):
    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookCode2WavConfig, layer_idx):
        super().__init__(config)
        ...
        block = [
            SnakeBeta(in_dim),
            Qwen3TTSTokenizerMultiCodebookCausalTransConvNet(in_dim, out_dim, 2 * upsample_rate, upsample_rate),
        ]

        for dilation in (1, 3, 9):
            block.append(Qwen3TTSTokenizerMultiCodebookCode2WavDecoderResidualUnit(out_dim, dilation))
...
class Qwen3TTSTokenizerMultiCodebookVectorQuantization(nn.Module):
    """
    ...
    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookConfig):
        super().__init__()
        self.codebook = Qwen3TTSTokenizerMultiCodebookEuclideanCodebook(config)
...
class Qwen3TTSTokenizerMultiCodebookResidualVectorQuantizer(nn.Module):
    """Residual Vector Quantizer."""

    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookConfig, num_quantizers: int | None = None):
        super().__init__()
        self.codebook_size = config.codebook_size
        self.frame_rate = config.frame_rate
        self.num_quantizers = num_quantizers if num_quantizers is not None else config.num_quantizers
        self.layers = nn.ModuleList(
            [Qwen3TTSTokenizerMultiCodebookVectorQuantization(config) for _ in range(self.num_quantizers)]
        )
...
class Qwen3TTSTokenizerMultiCodebookSplitResidualVectorQuantizer(nn.Module):
    ...
    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookConfig):
        ...
        self.semantic_residual_vector_quantizer = Qwen3TTSTokenizerMultiCodebookResidualVectorQuantizer(
            config, self.num_semantic_quantizers
        )
        self.acoustic_residual_vector_quantizer = Qwen3TTSTokenizerMultiCodebookResidualVectorQuantizer(
...
class Qwen3TTSTokenizerMultiCodebookResnetBlock(nn.Module):
    """
    Residual block from SEANet model as used by Qwen3TTSTokenizerMultiCodebook.
    """

    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookConfig, dim: int, dilations: list[int]):
        super().__init__()
        ...
        for i, (kernel_size, dilation) in enumerate(zip(kernel_sizes, dilations)):
            ...
            block += [nn.ELU()]
            block += [Qwen3TTSTokenizerMultiCodebookConv1d(config, in_chs, out_chs, kernel_size, dilation=dilation)]
        self.block = nn.ModuleList(block)

        if config.use_conv_shortcut:
            self.shortcut = Qwen3TTSTokenizerMultiCodebookConv1d(config, dim, dim, kernel_size=1)
        else:
    ...
    def forward(self, hidden_states, padding_cache=None):
        ...
        for layer in self.block:
            if isinstance(layer, Qwen3TTSTokenizerMultiCodebookConv1d):
                hidden_states = layer(hidden_states, padding_cache=padding_cache)
            else:
                hidden_states = layer(hidden_states)

        if isinstance(self.shortcut, Qwen3TTSTokenizerMultiCodebookConv1d):
...
class Qwen3TTSTokenizerMultiCodebookEncoder(nn.Module):
    """SEANet encoder as used by Qwen3TTSTokenizerMultiCodebook."""

    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookConfig):
        super().__init__()
        model = [
            Qwen3TTSTokenizerMultiCodebookConv1d(config, config.audio_channels, config.num_filters, config.kernel_size)
        ]
        scaling = 1
        ...
        for ratio in reversed(config.upsampling_ratios):
            ...
            for j in range(config.num_residual_layers):
                ...
                model += [
                    Qwen3TTSTokenizerMultiCodebookResnetBlock(
    ...
    def forward(self, hidden_states, padding_cache=None):
        for layer in self.layers:
            if isinstance(layer, (Qwen3TTSTokenizerMultiCodebookConv1d, Qwen3TTSTokenizerMultiCodebookResnetBlock)):
                hidden_states = layer(hidden_states, padding_cache=padding_cache)
            else:
                hidden_states = layer(hidden_states)
        return hidden_states
...
# NO LONGER EXIST Copied from transformers.models.gemma.modeling_gemma.GemmaFlashAttention2 with Gemma->Qwen3TTSTokenizerMultiCodebook
# TODO cyril: modular
class Qwen3TTSTokenizerMultiCodebookFlashAttention2(Qwen3TTSTokenizerMultiCodebookAttention):
    """
    Qwen3TTSTokenizerMultiCodebook flash attention module. This module inherits from `Qwen3TTSTokenizerMultiCodebookAttention` as the weights of the module stays
    ...
    def forward(
        ...
        **kwargs,
        ...
        # in fp32. (Qwen3TTSTokenizerMultiCodebookRMSNorm handles it correctly)
...
# NO LONGER EXIST Copied from transformers.models.gemma.modeling_gemma.GemmaSdpaAttention with Gemma->Qwen3TTSTokenizerMultiCodebook
# TODO cyril: modular
class Qwen3TTSTokenizerMultiCodebookSdpaAttention(Qwen3TTSTokenizerMultiCodebookAttention):
    """
    Qwen3TTSTokenizerMultiCodebook attention module using torch.nn.functional.scaled_dot_product_attention. This module inherits from
    `Qwen3TTSTokenizerMultiCodebookAttention` as the weights of the module stays untouched. The only changes are on the forward pass to adapt to
    SDPA API.
    """

    # Adapted from Qwen3TTSTokenizerMultiCodebookAttention.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: torch.Tensor | None = None,
...
QWEN3_TTS_TOKENIZER_MULTI_CODEBOOK_ATTENTION_CLASSES = {
    "eager": Qwen3TTSTokenizerMultiCodebookAttention,
    "flash_attention_2": Qwen3TTSTokenizerMultiCodebookFlashAttention2,
    "sdpa": Qwen3TTSTokenizerMultiCodebookSdpaAttention,
}


class Qwen3TTSTokenizerMultiCodebookTransformerLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size

        self.self_attn = QWEN3_TTS_TOKENIZER_MULTI_CODEBOOK_ATTENTION_CLASSES[config._attn_implementation](
            config=config, layer_idx=layer_idx
        )

        self.mlp = Qwen3TTSTokenizerMultiCodebookMLP(config)
        self.input_layernorm = nn.LayerNorm(config.hidden_size, eps=config.norm_eps)
        self.post_attention_layernorm = nn.LayerNorm(config.hidden_size, eps=config.norm_eps)
        self.self_attn_layer_scale = Qwen3TTSTokenizerMultiCodebookLayerScale(config)
        self.mlp_layer_scale = Qwen3TTSTokenizerMultiCodebookLayerScale(config)
...
class Qwen3TTSTokenizerMultiCodebookTransformerModel(nn.Module):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`Qwen3TTSTokenizerMultiCodebookTransformerLayer`]
    ...
    def __init__(self, config: Qwen3TTSTokenizerMultiCodebookConfig):
        ...
        self.layers = nn.ModuleList(
            [
                Qwen3TTSTokenizerMultiCodebookTransformerLayer(config, layer_idx)
...
class Qwen3TTSTokenizerMultiCodebookEncoderModel(Qwen3TTSTokenizerMultiCodebookPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.config = config

        self.encoder = Qwen3TTSTokenizerMultiCodebookEncoder(config)
        self.encoder_transformer = Qwen3TTSTokenizerMultiCodebookTransformerModel(config)

        self.downsample = None
        self.upsample = None
        if config.frame_rate != config.encodec_frame_rate:
            self.downsample = Qwen3TTSTokenizerMultiCodebookConv1d(
                config,
                config.hidden_size,
                config.hidden_size,
        ...
        self.quantizer = Qwen3TTSTokenizerMultiCodebookSplitResidualVectorQuantizer(config)
    ...
    def encode(
        ...
        use_streaming: bool | None = None,
        return_dict: bool | None = None,
    ) -> tuple[torch.Tensor, torch.Tensor | None] | Qwen3TTSTokenizerMultiCodebookEncoderOutput:
        """
        ...
        return Qwen3TTSTokenizerMultiCodebookEncoderOutput(encoded_frames, encoder_past_key_values, padding_cache)
    ...
    def decode(
        ...
        decoder_past_key_values: Cache | None = None,
        return_dict: bool | None = None,
    ) -> tuple[torch.Tensor, torch.Tensor] | Qwen3TTSTokenizerMultiCodebookDecoderOutput:
        """
        ...
        return Qwen3TTSTokenizerMultiCodebookDecoderOutput(audio_values, decoder_past_key_values)
    ...
    def forward(
        ...
        **kwargs,
        ...
        >>> from transformers import AutoFeatureExtractor, Qwen3TTSTokenizerMultiCodebookEncoderModel

        >>> dataset = load_dataset("hf-internal-testing/ashraq-esc50-1-dog-example")
        >>> audio_sample = dataset["train"]["audio"][0]["array"]

        >>> model_id = "kyutai/qwen3_t_t_s_tokenizer_multi_codebook_encoder"
        >>> model = Qwen3TTSTokenizerMultiCodebookEncoderModel.from_pretrained(model_id)

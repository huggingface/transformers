...
class Exaone4_5_ImageProcessorKwargs(ImagesKwargs, total=False):
    r"""
...
@auto_docstring
class Exaone4_5_ImageProcessor(TorchvisionBackend):
    do_resize = True
    ...
    merge_size = 2
    valid_kwargs = Exaone4_5_ImageProcessorKwargs
    model_input_names = ["pixel_values", "image_grid_thw"]

    def __init__(self, **kwargs: Unpack[Exaone4_5_ImageProcessorKwargs]):
    ...
    def preprocess(
        self,
        images: ImageInput,
        **kwargs: Unpack[Exaone4_5_ImageProcessorKwargs],
    ) -> BatchFeature:

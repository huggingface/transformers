...
from .image_processing_exaone4_5 import smart_resize


class Exaone4_5_VideoProcessorInitKwargs(VideosKwargs, total=False):
    min_pixels: int
    max_pixels: int
    patch_size: int
...
class Exaone4_5_VideoProcessor(BaseVideoProcessor):
    ...
    valid_kwargs = Exaone4_5_VideoProcessorInitKwargs
    model_input_names = ["pixel_values_videos", "video_grid_thw"]

    def __init__(self, **kwargs: Unpack[Exaone4_5_VideoProcessorInitKwargs]):
...
__all__ = ["Exaone4_5_VideoProcessor"]

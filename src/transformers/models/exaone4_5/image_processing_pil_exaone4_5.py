...
# Adapted from transformers.models.exaone4_5.image_processing_exaone4_5.Exaone4_5_ImageProcessorKwargs
...
# Adapted from transformers.models.exaone4_5.image_processing_exaone4_5.smart_resize
def smart_resize(
...
@auto_docstring
class Exaone4_5_ImageProcessorPil(PilBackend):
    do_resize = True
...
__all__ = ["Exaone4_5_ImageProcessorPil"]

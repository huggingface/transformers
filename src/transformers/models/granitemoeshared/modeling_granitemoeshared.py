...
class GraniteMoeSharedForCausalLM(GraniteMoeSharedPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> model = GraniteMoeSharedForCausalLM.from_pretrained("mistralai/GraniteMoeShared-8x7B-v0.1")
        >>> tokenizer = AutoTokenizer.from_pretrained("mistralai/GraniteMoeShared-8x7B-v0.1")

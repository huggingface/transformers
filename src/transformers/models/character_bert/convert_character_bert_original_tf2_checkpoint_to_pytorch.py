...
"""
This script can be used to convert a head-less TF2.x CharacterBert model to PyTorch, as published on the official (now
deprecated) GitHub: https://github.com/tensorflow/models/tree/v2.3.0/official/nlp/character_bert

TF2.x uses different variable names from the original CHARACTER_BERT (TF 1.4) implementation. The script re-maps the TF2.x CharacterBert
...
def load_tf2_weights_in_character_bert(model, tf_checkpoint_path, config):
...
def convert_tf2_checkpoint_to_pytorch(tf_checkpoint_path, config_path, pytorch_dump_path):
    ...
    load_tf2_weights_in_character_bert(model, tf_checkpoint_path, config)
...
if __name__ == "__main__":
    ...
    convert_tf2_checkpoint_to_pytorch(args.tf_checkpoint_path, args.character_bert_config_file, args.pytorch_dump_path)

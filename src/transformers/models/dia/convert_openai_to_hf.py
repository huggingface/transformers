...
_MODELS = {
    "tiny.en": "https://openaipublic.azureedge.net/main/dia/models/d3dd57d32accea0b295c96e26691aa14d8822fac7d9d27d5dc00b4ca2826dd03/tiny.en.pt",
    "tiny": "https://openaipublic.azureedge.net/main/dia/models/65147644a518d12f04e32d6f3b26facc3f8dd46e5390956a9424a650c0ce22b9/tiny.pt",
    "base.en": "https://openaipublic.azureedge.net/main/dia/models/25a8566e1d0c1e2231d1c762132cd20e0f96a85d16145c3a00adf5d1ac670ead/base.en.pt",
    "base": "https://openaipublic.azureedge.net/main/dia/models/ed3a0b6b1c0edf879ad9b11b1af5a0e6ab5db9205f891f668f8b0e6c6326e34e/base.pt",
    "small.en": "https://openaipublic.azureedge.net/main/dia/models/f953ad0fd29cacd07d5a9eda5624af0f6bcf2258be67c92b79389873d91e0872/small.en.pt",
    "small": "https://openaipublic.azureedge.net/main/dia/models/9ecf779972d90ba49c06d968637d720dd632c55bbf19d441fb42bf17a411e794/small.pt",
    "medium.en": "https://openaipublic.azureedge.net/main/dia/models/d7440d1dc186f76616474e0ff0b3b6b879abc9d1a4926b7adfa41db2d497ab4f/medium.en.pt",
    "medium": "https://openaipublic.azureedge.net/main/dia/models/345ae4da62f9b3d59415adc60127b97c714f32e89e936602e85993674d08dcb1/medium.pt",
    "large": "https://openaipublic.azureedge.net/main/dia/models/e4b87e7e0bf463eb8e6956e646f1e277e901512310def2c24bf0e11bd3c28e9a/large.pt",
    "large-v2": "https://openaipublic.azureedge.net/main/dia/models/81f7c96c852ee8fc832187b0132e569d6c3065a3252ed18e56effd0b6a73e524/large-v2.pt",
    "large-v3": "https://openaipublic.azureedge.net/main/dia/models/e5b1a55b89c1367dacf97e3e19bfd829a01529dbfdeefa8caeb59b3f1b81dadb/large-v3.pt",
}


_TOKENIZERS = {
    "multilingual": "https://raw.githubusercontent.com/openai/dia/main/dia/assets/multilingual.tiktoken",
    "english": "https://raw.githubusercontent.com/openai/dia/main/dia/assets/gpt2.tiktoken",
}
...
def _get_generation_config(
    ...
    if openai_version is not None:
        repo = f"openai/dia-{openai_version}"
    elif not is_multilingual:
        repo = "openai/dia-medium.en"
    elif num_languages < 100:
        repo = "openai/dia-large-v2"
    else:
        repo = "openai/dia-large-v3"
    ...
    if openai_version is None:
        ...
        warnings.warn(
            ...
            "If you want to use word-level timestamps with a custom version of Dia,"
            "see https://github.com/openai/dia/blob/main/notebooks/Multilingual_ASR.ipynb"
...
def convert_openai_dia_to_tfms(
    checkpoint_path, pytorch_dump_folder_path
) -> Tuple[DiaForConditionalGeneration, bool, int]:
    ...
    # determine those parameters from a model checkpoint as Dia repo does
...
def convert_tiktoken_to_hf(
    ...
    # requires dia, unless we use the path to the tiktoken file
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        hf_tokenizer = DiaTokenizer(vocab_file, merge_file)

...
from .tokenization_dia import LANGUAGES, TASK_IDS, TO_LANGUAGE_CODE, DiaTokenizer, _decode_asr
...
class DiaTokenizerFast(PreTrainedTokenizerFast):
    ...
    Args:
        ...
        add_prefix_space (`bool`, *optional*, defaults to `False`):
            ...
            other word. (Dia tokenizer detect beginning of words by the preceding space).
    ...
    slow_tokenizer_class = DiaTokenizer
    ...
    def _normalize(self, text):
        warnings.warn(
            ...
            "You can normalize an input string using the Dia English normalizer using the `normalize` method."
        )
    ...
    def _basic_normalize(self, text, remove_diacritics=False):
        warnings.warn(
            ...
            "You can normalize an input string using the Dia basic normalizer using the `basic_normalize` method."
        )
    ...
    def set_prefix_tokens(
        ...
        >>> tokenizer = DiaTokenizerFast.from_pretrained("nari-labs/Dia-1.6B", language="spanish")
    ...
    def get_prompt_ids(self, text: str, return_tensors="np"):
        """Converts prompt text to IDs that can be passed to [`~DiaForConditionalGeneration.generate`]."""

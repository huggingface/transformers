...
from ..pegasus.modeling_pegasus import PegasusPreTrainedModel
...
class DiaPreTrainedModel(PegasusPreTrainedModel):
    ...
    def forward(
        ...
        if debug:
            if input_ids is not None:
                ...
                input_ids = torch.cat([input_ids, unconditioned_input_ids], dim=0)

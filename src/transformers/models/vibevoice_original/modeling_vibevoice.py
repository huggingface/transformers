...
from .configuration_vibevoice import VibeVoiceOriginalConfig
...
class VibeVoicePreTrainedModel(PreTrainedModel):
    config_class = VibeVoiceOriginalConfig
...
AutoModel.register(VibeVoiceOriginalConfig, VibeVoiceModel)
AutoModelForCausalLM.register(VibeVoiceOriginalConfig, VibeVoiceForConditionalGeneration)

...
class Quatfit1ImageProcessorKwargs(ImagesKwargs, total=False):
    """
...
@auto_docstring(custom_intro="Constructs a Quatfit1 image processor.")
class Quatfit1ImageProcessorPil(PilBackend):
    valid_kwargs = Quatfit1ImageProcessorKwargs
    ...
    def __init__(self, **kwargs: Unpack[Quatfit1ImageProcessorKwargs]) -> None:
    ...
    def preprocess(
        self,
        images: ImageInput,
        **kwargs: Unpack[Quatfit1ImageProcessorKwargs],
    ) -> BatchFeature:
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        for image in images:
            ...
            # Step 3: Identity normalization because Quatfit1 was trained with pixels in [0, 1]
            if do_normalize:
...
__all__ = ["Quatfit1ImageProcessorPil"]

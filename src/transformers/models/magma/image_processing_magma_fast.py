...
"""Fast Image processor class for Magma."""
...
class MagmaFastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
    """
...
@auto_docstring
class MagmaImageProcessorFast(BaseImageProcessorFast):
    ...
    valid_kwargs = MagmaFastImageProcessorKwargs

    def __init__(self, **kwargs: Unpack[MagmaFastImageProcessorKwargs]):
        super().__init__(**kwargs)

    @auto_docstring
    def preprocess(self, images: ImageInput, **kwargs: Unpack[MagmaFastImageProcessorKwargs]) -> BatchFeature:
...
__all__ = ["MagmaImageProcessorFast"]

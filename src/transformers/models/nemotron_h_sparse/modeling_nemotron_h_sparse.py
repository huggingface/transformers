#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/nemotron_h_sparse/modular_nemotron_h_sparse.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_nemotron_h_sparse.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
class NemotronHSparseMamba2Mixer(nn.Module):
    """
    ...
    def __init__(self, config: NemotronHSparseConfig, layer_idx: int | None = None):
        super().__init__()
        self.config = config
...
class NemotronHSparseRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        NemotronHSparseRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class NemotronHSparseAttention(nn.Module):
...
class NemotronHSparseTopkRouter(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
...
class NemotronHSparsePreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, NemotronHSparseMamba2Mixer):
...
class NemotronHSparseForCausalLM(NemotronHSparsePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers import AutoTokenizer, NemotronHSparseForCausalLM

        >>> model = NemotronHSparseForCausalLM.from_pretrained("Zyphra/NemotronHSparse-7B-v1")
        >>> tokenizer = AutoTokenizer.from_pretrained("Zyphra/NemotronHSparse-7B-v1")
...
__all__ = ["NemotronHSparsePreTrainedModel", "NemotronHSparseModel", "NemotronHSparseForCausalLM"]

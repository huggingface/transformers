...
class AudioFlamingoNextProcessorKwargs(ProcessingKwargs, total=False):
    _defaults = {
        "text_kwargs": {
            "padding": True,
        },
...
class AudioFlamingoNextProcessor(ProcessorMixin):
    r"""
    ...
    def __call__(
        ...
        **kwargs: Unpack[AudioFlamingoNextProcessorKwargs],
    ) -> BatchFeature:
        r"""
        ...
        call_kwargs = self._merge_kwargs(
            AudioFlamingoNextProcessorKwargs,
...
__all__ = ["AudioFlamingoNextProcessor"]

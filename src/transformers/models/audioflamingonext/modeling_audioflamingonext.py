...
from .configuration_audioflamingonext import AudioFlamingoNextConfig
...
class AudioFlamingoNextRotaryEmbedding(nn.Module):
    """Rotary time embedding module used by AudioFlamingoNext checkpoints.
    ...
    def __init__(self, config: AudioFlamingoNextConfig, device=None):
        super().__init__()
    ...
    def compute_default_rope_parameters(
        config: AudioFlamingoNextConfig | None = None,
...
class AudioFlamingoNextPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, AudioFlamingoNextRotaryEmbedding):
            buffer_value = module._compute_position_angles(module.inv_freq)
            init.copy_(module.position_angles, buffer_value)


class AudioFlamingoNextMultiModalProjector(nn.Module):
    """
    Audio adaptor (small MLP) that projects AudioFlamingoNextEncoder features
...
class AudioFlamingoNextForConditionalGeneration(AudioFlamingoNextPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config: AudioFlamingoNextConfig):
        ...
        self.multi_modal_projector = AudioFlamingoNextMultiModalProjector(config)
        self.pos_emb = AudioFlamingoNextRotaryEmbedding(config)
...
__all__ = ["AudioFlamingoNextPreTrainedModel", "AudioFlamingoNextForConditionalGeneration"]

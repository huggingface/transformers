...
from .configuration_granite_docling_hybrid import GraniteDoclingHybridConfig, GraniteDoclingHybridVisionConfig
...
class HybridMambaAttentionDynamicCache:
    ...
    def __init__(self, config: GraniteDoclingHybridConfig, batch_size, dtype=torch.float16, device=None):
...
class GraniteDoclingHybridRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        GraniteDoclingHybridRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class GraniteDoclingHybridPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, (nn.Linear, nn.Conv2d)):
            ...
            module.bias.data.zero_()
        elif isinstance(module, GraniteDoclingHybridRMSNorm):
            module.weight.data.fill_(1.0)
...
class GraniteDoclingHybridModel(GraniteDoclingHybridPreTrainedModel):
    ...
    ) -> Union[tuple, GraniteDoclingHybridBaseModelOutputWithPast]:
        r"""
...
class GraniteDoclingHybridForConditionalGeneration(GraniteDoclingHybridPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
    ) -> Union[tuple, GraniteDoclingHybridCausalLMOutputWithPast]:
        r"""
        pixel_attention_mask (`torch.Tensor` of shape `(batch_size, image_size, image_size)`, *optional*):
            Mask to avoid performing attention on padding pixel indices.
        image_hidden_states (`torch.FloatTensor` of shape `(batch_size, num_channels, image_size, image_size)`):

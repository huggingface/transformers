...
class GraniteDoclingHybridVisionConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`GraniteDoclingHybridVisionModel`]. It is used to instantiate a
    GraniteDoclingHybrid vision encoder according to the specified arguments, defining the model architecture. Instantiating a
    configuration with the defaults will yield a similar configuration to that of the SigLIP checkpoint
    [google/siglip-base-patch16-224](https://huggingface.co/google/siglip-base-patch16-224) used in the GraniteDoclingHybrid model
    [HuggingFaceM4/GraniteDoclingHybrid-8B-Llama3](https://huggingface.co/HuggingFaceM4/GraniteDoclingHybrid-8B-Llama3).
...
class GraniteDoclingHybridGraniteMoeHybridConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`GraniteDoclingHybridGraniteMoeHybridConfig`]. It is used to
    instantiate an GraniteDoclingHybridGraniteMoeHybrid model according to the specified arguments, defining the model architecture.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 32000):
            Vocabulary size of the GraniteDoclingHybridGraniteMoeHybrid model. Defines the number of different tokens that
            can be represented by the `inputs_ids` passed when calling [`GraniteDoclingHybridGraniteMoeHybridModel`]

...
class Starcoder2SdpaAttention(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""
...
class Starcoder2FlashAttention2(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""
...
class Starcoder2ForCausalLM(Starcoder2PreTrainedModel):
    ...
    def forward(
        ...
        >>> model = Starcoder2ForCausalLM.from_pretrained("meta-llama/Starcoder2-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-llama/Starcoder2-2-7b-hf")

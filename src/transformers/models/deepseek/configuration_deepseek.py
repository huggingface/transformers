...
class DeepseekConfig(PretrainedConfig):
    ...
    Setting `n_shared_experts` and `n_routed_experts` will result in a MoE model, e.g. [deepseek-ai/deepseek-moe-16b-base](https://huggingface.co/deepseek-ai/deepseek-moe-16b-base).
    ...
    Args:
        ...
        seq_aux (`bool`, *optional*, defaults to `True`): Whether to compute the auxiliary loss for each individual sample.

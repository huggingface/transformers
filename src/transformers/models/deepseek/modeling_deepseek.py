...
# Copied from transformers.models.llama.modeling_llama.LlamaRMSNorm with Llama->Deepseek
...
# Copied from transformers.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Deepseek
...
class DeepseekMLP(nn.Module):
    ...
    # Copied from transformers.models.llama.modeling_llama.LlamaMLP.forward
    def forward(self, x):
...
# Copied from transformers.models.llama.modeling_llama.LlamaPreTrainedModel with Llama->Deepseek
...
# Copied from transformers.models.llama.modeling_llama.LlamaModel with Llama->Deepseek, LLAMA->Deepseek
...
# Copied from transformers.models.llama.modeling_llama.LlamaForCausalLM with Llama->Deepseek, LLAMA->Deepseek
class DeepseekForCausalLM(DeepseekPreTrainedModel):
    ...
    def forward(
        ...
        >>> model = DeepseekForCausalLM.from_pretrained("meta-llama/Deepseek-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-llama/Deepseek-2-7b-hf")
...
# Copied from transformers.models.llama.modeling_llama.LlamaForSequenceClassification with Llama->Deepseek, LLAMA->Deepseek
...
@add_start_docstrings(
    """
The Deepseek Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layer on top of the hidden-states output to compute `span start logits` and `span end logits`).
    """,
    Deepseek_START_DOCSTRING,
)
# Copied from transformers.models.llama.modeling_llama.LlamaForQuestionAnswering with Llama->Deepseek, LLAMA->Deepseek
class DeepseekForQuestionAnswering(DeepseekPreTrainedModel):
    base_model_prefix = "transformer"

    # Copied from transformers.models.bloom.modeling_bloom.BloomForQuestionAnswering.__init__ with Bloom->Deepseek
    def __init__(self, config):
        super().__init__(config)
        self.transformer = DeepseekModel(config)
...
@add_start_docstrings(
    """
    The Deepseek Model transformer with a token classification head on top (a linear layer on top of the hidden-states
    output) e.g. for Named-Entity-Recognition (NER) tasks.
    """,
    Deepseek_START_DOCSTRING,
)
# Copied from transformers.models.llama.modeling_llama.LlamaForTokenClassification with Llama->Deepseek, LLAMA->Deepseek
class DeepseekForTokenClassification(DeepseekPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.model = DeepseekModel(config)

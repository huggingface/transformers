...
class BigBirdPegasusTokenizer(BartTokenizer):
    """
    Construct a BigBirdPegasus tokenizer.

    :class:`~transformers.BigBirdPegasusTokenizer` is identical to :class:`~transformers.BartTokenizer` and runs end-to-end

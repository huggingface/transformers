...
MAPPING = {
    "model": "pegasus",
    "self_attn_layer_norm": "attention/self/LayerNorm",
    "self.self_attn": "attention/self",
...
def convert_bigbird_pegasus(tf_weights: dict, config_dict: dict) -> BigBirdPegasusForConditionalGeneration:

    cfg = BigBirdPegasusConfig(**config_dict)
...
def convert_bigbird_pegasus_ckpt_to_pytorch(ckpt_path: str, save_dir: str):
    ...
    torch_model = convert_bigbird_pegasus(tf_weights, cfg_updates)
...
if __name__ == "__main__":
    ...
    convert_bigbird_pegasus_ckpt_to_pytorch(args.tf_ckpt_path, args.save_dir)

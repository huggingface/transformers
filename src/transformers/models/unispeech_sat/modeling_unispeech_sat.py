...
class UniSpeechSatForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformers.UniSpeechSatForPreTrainingOutput`, with potential hidden states and attentions.
...
class UniSpeechSatPreTrainedModel(PreTrainedModel):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, (UniSpeechSatEncoder, UniSpeechSatEncoderStableLayerNorm)):
...
UNISPEECH_SAT_INPUTS_DOCSTRING = r"""
    Args:
        input_values (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            soundfile`). To prepare the array into `input_values`, the :class:`~transformers.UniSpeechSatProcessor` should

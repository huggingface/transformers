...
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {"mctc-large": sys.maxsize}

MCTC_KWARGS_DOCSTRING = r"""
...
class MCTCTokenizerOutput(ModelOutput):
    """
    Output type of [` MCTCTokenizer`], with transcription.
...
class MCTCTokenizer(PreTrainedTokenizer):

    """
    Constructs a MCTC tokenizer.
    ...
    def batch_decode(
        ...
        **kwargs
        ...
        if output_char_offsets or output_word_offsets:
            ...
            return MCTCTokenizerOutput({k: [d[k] for d in batch_decoded] for k in batch_decoded[0]})
    ...
    def decode(
        ...
        **kwargs
        ...
        >>> model = AutoModelForCTC.from_pretrained("mctc-large")
        >>> tokenizer = AutoTokenizer.from_pretrained("mctc-large")
        >>> feature_extractor = AutoFeatureExtractor.from_pretrained("mctc-large")

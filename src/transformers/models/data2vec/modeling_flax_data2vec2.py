...
overwrite_call_docstring(
    FlaxWav2Vec2Model,
    DATA2VEC_AUDIO_INPUTS_DOCSTRING + FLAX_WAV2VEC2_MODEL_DOCSTRING,
)
append_replace_return_docstrings(
    FlaxWav2Vec2Model, output_type=Data2VecAudioBaseModelOutput, config_class=Wav2Vec2Config
)
...
overwrite_call_docstring(
    FlaxWav2Vec2ForCTC,
    DATA2VEC_AUDIO_INPUTS_DOCSTRING + FLAX_WAV2VEC2_FOR_CTC_DOCSTRING,
)
...
@add_start_docstrings("""Wav2Vec2 Model with a quantizer and `VQ` head on top.""", DATA2VEC_AUDIO_START_DOCSTRING)
...
overwrite_call_docstring(
    ...
    DATA2VEC_AUDIO_INPUTS_DOCSTRING + FLAX_WAV2VEC2_FOR_PRETRAINING_DOCSTRING,
)
append_replace_return_docstrings(

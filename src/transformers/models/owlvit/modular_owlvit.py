...
class OwlViTVisionEmbeddings(CLIPVisionEmbeddings):
...
class OwlViTTextEmbeddings(CLIPTextEmbeddings):
    def forward(
        self,
...
class OwlViTEncoderLayer(CLIPEncoderLayer):
...
class OwlViTEncoder(CLIPEncoder):

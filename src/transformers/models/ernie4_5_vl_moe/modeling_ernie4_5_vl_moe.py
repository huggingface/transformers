...
@auto_docstring
class Ernie4_5_VLMoeModel(Ernie4_5_VLMoePreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
class Ernie4_5_VLMoeForConditionalGeneration(
    Ernie4_5_VLMoePreTrainedModel, MultiModalGenerationMixin, GenerationMixin
):

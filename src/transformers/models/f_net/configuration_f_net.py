...
F_NET_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "fnet-base-uncased": "https://huggingface.co/fnet-base-uncased/resolve/main/config.json",
...
class FNetConfig(PretrainedConfig):
    ...
    the FNet `fnet-base-uncased <https://huggingface.co/fnet-base-uncased>`__ architecture.
    ...
    Args:
        ...
        >>> # Initializing a FNet fnet-base-uncased style configuration
        >>> configuration = FNetConfig()

        >>> # Initializing a model from the fnet-base-uncased style configuration

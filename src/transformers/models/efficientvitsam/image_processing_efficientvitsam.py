...
"""Image processor for EfficientViT-SAM."""

from .image_processing_pil_efficientvitsam import (
    EfficientvitsamImageProcessorPil,
    EfficientvitsamImageProcessorPilKwargs,
)


class EfficientvitsamImageProcessorKwargs(EfficientvitsamImageProcessorPilKwargs):
    pass


class EfficientvitsamImageProcessor(EfficientvitsamImageProcessorPil):
    pass


__all__ = ["EfficientvitsamImageProcessor", "EfficientvitsamImageProcessorKwargs"]
# stale generated tail below is intentionally disabled
'''
# Copyright 2026 the HuggingFace Team. All rights reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
...
class EfficientvitsamImageProcessorKwargs(SamImageProcessorKwargs, total=False):
...
class EfficientvitsamImageProcessor(SamImageProcessor):
    ...
    def __init__(
        self, prompt_size: dict[str, int] | None = None, **kwargs: Unpack[EfficientvitsamImageProcessorKwargs]
    ):
...
class EfficientvitsamImageProcessor(SamImageProcessor):
    ...
    def __init__(self, prompt_size: dict[str, int] | None = None, **kwargs: Unpack[EfficientvitsamImageProcessorKwargs]):
        super().__init__(**kwargs)
        self.prompt_size = prompt_size if prompt_size is not None else {"longest_edge": 1024}
...
@auto_docstring
class EfficientvitsamImageProcessor(TorchvisionBackend):
    valid_kwargs = EfficientvitsamImageProcessorKwargs

...
from ..sam.image_processing_pil_sam import SamImageProcessorKwargs
...
class EfficientvitsamImageProcessorPil(PilBackend):
    ...
    valid_kwargs = EfficientvitsamImageProcessorKwargs

    def __init__(self, **kwargs: Unpack[EfficientvitsamImageProcessorKwargs]):
        super().__init__(**kwargs)
    ...
    def preprocess(
        ...
        **kwargs: Unpack[EfficientvitsamImageProcessorKwargs],
    ) -> BatchFeature:
        r"""

...
"""Processor class for EfficientViT-SAM."""
...
class EfficientvitsamProcessor(SamProcessor):
    def __init__(self, image_processor):
        ...
        prompt_size = getattr(image_processor, "prompt_size", None)
        if isinstance(prompt_size, dict) and "longest_edge" in prompt_size:
            self.target_size = prompt_size["longest_edge"]
...
class EfficientvitsamProcessor(SamProcessor):
    def __init__(self, image_processor):
        super().__init__(image_processor)
        prompt_size = getattr(image_processor, "prompt_size", None)
        self.target_size = prompt_size["longest_edge"] if isinstance(prompt_size, dict) else self.target_size


__all__ = ["EfficientvitsamProcessor"]
# removed stale delimiter
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
class EfficientvitsamImagesKwargs(ImagesKwargs, total=False):
    """
...
class EfficientvitsamProcessorKwargs(ProcessingKwargs, total=False):
    images_kwargs: EfficientvitsamImagesKwargs
    _defaults = {
        "images_kwargs": {
            "point_pad_value": -10,
        }
    ...
    def __call__(
        ...
        **kwargs,
        ...
        output_kwargs = self._merge_kwargs(
            EfficientvitsamProcessorKwargs,

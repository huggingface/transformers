...
class MT5Model(T5PreTrainedModel):
    r"""
    ...
    # Copied from transformers.models.t5.modeling_t5.T5Model.__init__
    ...
    # Copied from transformers.models.t5.modeling_t5.T5Model.forward
    def forward(
        self,
...
class MT5EncoderModel(T5PreTrainedModel):
    r"""

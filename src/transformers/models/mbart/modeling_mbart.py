...
class MBartForConditionalGeneration(MBartPreTrainedModel):
    ...
    def adjust_logits_during_generation(self, logits, cur_len, max_length, prefix_token):
        if cur_len == 1 and self.config.force_lang_token_to_be_generated:
            self._force_token_id_to_be_generated(logits, prefix_token)

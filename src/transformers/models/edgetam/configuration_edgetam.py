...
class EdgeTamVisionBackboneConfig(PretrainedConfig):
    r"""
    ...
    Configuration objects inherit from [`EdgeTamVisionBackboneConfig`] and can be used to control the model outputs. Read the
    documentation from [`EdgeTamVisionBackboneConfig`] for more information.
    ...
    Example:
    ```python
    >>> from transformers import EdgeTamVisionBackboneConfig, TimmWrapper

    >>> # Initializing a TimmWrapper gemma3n_vision-E4B-style configuration
    >>> configuration = EdgeTamVisionBackboneConfig()
    ...
    model_type = "edgetam_vision_backbone"

    def __init__(
        self,
        architecture: str = "repvit_m1.dist_in1k",
...
class EdgeTamVisionConfig(PretrainedConfig):
    ...
    sub_configs = {
        "backbone_config": EdgeTamVisionBackboneConfig,
    }
    ...
    def __init__(
        ...
        **kwargs,
        ...
        elif isinstance(backbone_config, EdgeTamVisionBackboneConfig):
...
class EdgeTamConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        memory_attention_rope_feat_sizes=[128, 128],
        memory_attention_rope_q_sizes=[128, 128],
        memory_attention_rope_k_sizes=[32, 32],

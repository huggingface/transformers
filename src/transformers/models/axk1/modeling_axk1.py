...
class AXK1MoE(nn.Module):
    ...
    def __init__(self, config: AXK1Config):
        super().__init__()
        self.config = config
        self.experts = AXK1Experts(config)
...
class AXK1ForCausalLM(AXK1PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> model = AXK1ForCausalLM.from_pretrained("meta-axk1/AXK1-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-axk1/AXK1-2-7b-hf")
...
__all__ = ["AXK1PreTrainedModel", "AXK1Model", "AXK1ForCausalLM", "AXK1ForSequenceClassification", "AXK1ForTokenClassification"]

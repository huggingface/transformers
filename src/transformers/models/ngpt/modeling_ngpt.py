...
_CHECKPOINT_FOR_DOC = ""  # FIXME: add checkpoint
...
@add_start_docstrings(
    "The bare nGPT Model outputting raw hidden-states without any specific head on top.",
...
class NGPTModel(NGPTPreTrainedModel):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`NGPTDecoderLayer`]
...
class NGPTForCausalLM(NGPTPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        >>> model = NGPTForCausalLM.from_pretrained("")  # FIXME: add checkpoint

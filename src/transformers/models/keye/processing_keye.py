...
class KeyeImagesKwargs(ImagesKwargs):
...
class KeyeProcessorKwargs(ProcessingKwargs, total=False):
    images_kwargs: KeyeImagesKwargs
    _defaults = {
        "text_kwargs": {
            "padding": False,
...
class KeyeProcessor(ProcessorMixin):
    ...
    Args:
        ...
        video_processor ([`KeyeVideoProcessor`], *optional*):
    ...
    def _get_num_multimodal_tokens(self, image_sizes=None, video_sizes=None, **kwargs):
        ...
        if image_sizes is not None:
            images_kwargs = KeyeProcessorKwargs._defaults.get("images_kwargs", {})
        ...
        if video_sizes is not None:
            videos_kwargs = KeyeProcessorKwargs._defaults.get("videos_kwargs", {})

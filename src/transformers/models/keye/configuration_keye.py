...
class KeyeConfig(PretrainedConfig):
    ...
    Args:
        text_config (`Union[PreTrainedConfig, dict]`, *optional*, defaults to `KeyeTextConfig`):
            The config object or dictionary of the text backbone.
        vision_config (`Union[PreTrainedConfig, dict]`,  *optional*, defaults to `KeyeVisionConfig`):
...
__all__ = ["KeyeConfig", "KeyeTextConfig"]

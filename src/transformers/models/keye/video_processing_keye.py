...
if is_vision_available():
    from .image_processing_keye import smart_resize


class KeyeVideoProcessorInitKwargs(VideosKwargs):
...
class KeyeVideoProcessor(BaseVideoProcessor):
    ...
    valid_kwargs = KeyeVideoProcessorInitKwargs
    model_input_names = ["pixel_values_videos", "video_grid_thw"]

    def __init__(self, **kwargs: Unpack[KeyeVideoProcessorInitKwargs]):

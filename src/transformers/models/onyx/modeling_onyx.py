...
class OnyxModel(OnyxPreTrainedModel):
    def __init__(self, config: OnyxConfig):
        ...
        # Onyx3 downcasts the below to bfloat16, causing sqrt(3072)=55.4256 to become 55.5. See https://github.com/huggingface/transformers/pull/29402
        self.embed_tokens = OnyxTextScaledWordEmbedding(
...
class OnyxForSequenceClassification(GenericForSequenceClassification, OnyxPreTrainedModel):
    pass


class OnyxForTokenClassification(GenericForTokenClassification, OnyxPreTrainedModel):
    pass

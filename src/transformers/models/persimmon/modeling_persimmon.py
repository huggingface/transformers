...
class PersimmonAttention(nn.Module):
    ...
    def forward(
        ...
        query_rot = self.rotary_emb(query_rot, seq_len=kv_seq_len, position_ids=position_ids)
        key_rot = self.rotary_emb(key_rot, seq_len=kv_seq_len, position_ids=position_ids)

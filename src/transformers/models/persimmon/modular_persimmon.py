...
class PersimmonRotaryEmbedding(LlamaRotaryEmbedding):
    @staticmethod
    # Ignore copy
...
class PersimmonModel(LlamaModel):
...
class PersimmonForSequenceClassification(LlamaForSequenceClassification):
    pass


class PersimmonForTokenClassification(LlamaForTokenClassification):
    pass


__all__ = [
    "PersimmonPreTrainedModel",  # noqa: F822
    "PersimmonModel",

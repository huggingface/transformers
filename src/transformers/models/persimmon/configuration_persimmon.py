...
PERSIMMON_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "adept/persimmon-8b": "https://huggingface.co/adept/persimmon-8b/resolve/main/config.json",
}
...
class PersimmonConfig(PretrainedConfig):
    ...
    Args:
        ...
        max_position_embeddings (`int`, *optional*, defaults to 2048):
            The maximum sequence length that this model might ever be used with. Persimmon 1 supports up to 2048 tokens,
            Persimmon 2 up to 4096, CodePersimmon up to 16384.
    ...
    >>> # Initializing a model from the persimmon-7b style configuration
    >>> model = PersimmonModel(configuration)

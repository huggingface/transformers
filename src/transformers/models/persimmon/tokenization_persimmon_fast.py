...
if is_sentencepiece_available():
    from .tokenization_persimmon import PersimmonTokenizer
else:
    PersimmonTokenizer = None
...
class PersimmonTokenizerFast(PreTrainedTokenizerFast):
    """
    Construct a Persimmon tokenizer. Based on byte-level Byte-Pair-Encoding.
    ...
    tokenizer = PersimmonTokenizerFast.from_pretrained("hf-internal-testing/persimmon-tokenizer")
    ...
    slow_tokenizer_class = PersimmonTokenizer
    padding_side = "left"

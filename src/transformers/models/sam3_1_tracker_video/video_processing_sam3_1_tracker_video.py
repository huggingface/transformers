...
from .modeling_sam3_1_tracker_video import Sam31TrackerVideoInferenceSession


@requires(backends=("torch",))
@auto_docstring
class Sam3_1TrackerVideoProcessor(ProcessorMixin):
    def __init__(
    ...
    def init_video_session(
        ...
        Args:
            ...
            max_vision_features_cache_size (`int`, *optional*):
                Caps cached FPN frames for propagation memory. `None` (default) keeps every loaded frame.
...
__all__ = ["Sam3_1TrackerVideoProcessor"]

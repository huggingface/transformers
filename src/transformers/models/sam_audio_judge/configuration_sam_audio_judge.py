...
class SamAudioJudgeConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`SamAudioJudge`]. It is used to instantiate a
    SamAudioJudge model according to the specified arguments, defining the model architecture. Instantiating a configuration
    ...
    def __init__(
        ...
        num_attention_heads: Optional[int] = 3,

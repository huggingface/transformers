...
class GemmaRotaryEmbedding(nn.Module):
    def __init__(
        ...
        if config is None:
            logger.warning_once(
                "`GemmaRotaryEmbedding` can now be fully parameterized by passing the model config through the "
...
class GemmaLinearScalingRotaryEmbedding(GemmaRotaryEmbedding):
    ...
    def __init__(self, *args, **kwargs):
        logger.warning_once(
            "`GemmaLinearScalingRotaryEmbedding` is deprecated an will be removed in v4.45. Please use "
            "`GemmaRotaryEmbedding`, which now also does linear scaling (simply pass the model config to __init__)."
        )
...
class GemmaDynamicNTKScalingRotaryEmbedding(GemmaRotaryEmbedding):
    ...
    def __init__(self, *args, **kwargs):
        logger.warning_once(
            "`GemmaDynamicNTKScalingRotaryEmbedding` is deprecated an will be removed in v4.45. Please use "
            "`GemmaRotaryEmbedding`, which now also does dynamic ntk scaling (simply pass the model config to "
            "__init__)."
        )
...
class GemmaAttention(nn.Module):
    ...
    def __init__(self, config: GemmaConfig, layer_idx: Optional[int] = None):
        ...
        self.rotary_emb = GemmaRotaryEmbedding(config=self.config)

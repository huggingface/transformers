...
"""Image processor class for Ernie 4.5 VL."""
...
class Ernie4_5_VLImageProcessor(BaseImageProcessor):
    ...
    def preprocess(
        ...
        temporal_patch_size = None  # TODO: not used
        ...
        if videos is not None:
            logger.warning(
                "`Ernie4_5_VLImageProcessor` works only with image inputs and doesn't process videos anymore. "
                "This is a deprecated behavior and will be removed in v5.0. "
                "Your videos should be forwarded to `Ernie4_5_VLVideoProcessor`. "
            )

...
class Ernie4_5_VLTextConfig(Qwen2VLTextConfig):
    model_type = "ernie4_5_vl_text"


class Ernie4_5_VLConfig(Qwen2VLConfig):
    model_type = "ernie4_5_vl"
...
class Ernie4_5_VLPatchMerger(PatchMerger):
    def __init__(self, dim: int, context_dim: int, spatial_merge_size: int = 2) -> None:
        super().__init__(dim, context_dim, spatial_merge_size)
        self.ln_q = Qwen2RMSNorm(context_dim, eps=1e-6)


class Ernie4_5_VLVisionAttention(VisionAttention):
...
class Ernie4_5_VLVisionBlock(GradientCheckpointingLayer):
    def __init__(self, config, attn_implementation: str = "sdpa") -> None:
        ...
        self.mlp = Ernie4_5_VLMLP(config, bias=True)
...
class Ernie4_5_VLPreTrainedModel(Qwen2VLPreTrainedModel):
...
class Qwen2_5_VisionTransformerPretrainedModel(Ernie4_5_VLPreTrainedModel):
    ...
    def __init__(self, config, *inputs, **kwargs) -> None:
        ...
        self.merger = Ernie4_5_VLPatchMerger(
...
class Ernie4_5_VLModelOutputWithPast(Qwen2VLModelOutputWithPast):
    pass


class Ernie4_5_VLModel(Qwen2VLModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
    ) -> Union[tuple, Ernie4_5_VLModelOutputWithPast]:
        r"""
        image_grid_thw (`torch.LongTensor` of shape `(num_images, 3)`, *optional*):
            The temporal, height and width of feature shape of each image in LLM.
        video_grid_thw (`torch.LongTensor` of shape `(num_videos, 3)`, *optional*):
        ...
        output = Ernie4_5_VLModelOutputWithPast(
...
class Ernie4_5_VLCausalLMOutputWithPast(Qwen2VLCausalLMOutputWithPast):
    pass


class Ernie4_5_VLForConditionalGeneration(Qwen2VLForConditionalGeneration):
    def forward(
        self,
        input_ids: torch.LongTensor = None,
        attention_mask: Optional[torch.Tensor] = None,
        ...
        **kwargs: Unpack[TransformersKwargs],
    ) -> Union[tuple, Ernie4_5_VLCausalLMOutputWithPast]:
        r"""
        ...
        return Ernie4_5_VLCausalLMOutputWithPast(
            loss=loss,
            logits=logits,
            past_key_values=outputs.past_key_values,
            hidden_states=outputs.hidden_states,
...
class Ernie4_5_VLVideosProcessorKwargs(VideosKwargs, total=False):
    fps: Union[list[float], float]


class Ernie4_5_VLImagesKwargs(Qwen2VLImagesKwargs):
    pass


class Qwen2_5_VLProcessorKwargs(ProcessingKwargs, total=False):
    images_kwargs: Ernie4_5_VLImagesKwargs
    videos_kwargs: Ernie4_5_VLVideosProcessorKwargs
    _defaults = {
        "text_kwargs": {
            "padding": False,
...
__all__ = [
    ...
    "Qwen2_5_VLProcessor",
    "Ernie4_5_VLTextModel",  # noqa: F822
]

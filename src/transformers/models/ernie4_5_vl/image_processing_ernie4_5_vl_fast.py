...
"""Fast Image processor class for Ernie 4.5 VL."""
...
@auto_docstring
class Ernie4_5_VLImageProcessorFast(BaseImageProcessorFast):
    do_resize = True
    resample = PILImageResampling.BICUBIC
    size = {"shortest_edge": 56 * 56, "longest_edge": 28 * 28 * 6177} # TODO: diff default
    do_rescale = True
    do_normalize = True
    ...
    def _preprocess_image_like_inputs(
        ...
        **kwargs: Unpack[DefaultFastImageProcessorKwargs],
        ...
        if videos is not None:
            logger.warning(
                "`Ernie4_5_VLImageProcessorFast` works only with image inputs and doesn't process videos anymore. "
...
__all__ = ["Ernie4_5_VLImageProcessorFast"]

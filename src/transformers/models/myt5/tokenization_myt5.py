# coding=utf-8
# Copyright 2024 MyT5 Authors and HuggingFace Inc. team.
#
...
class MyT5Tokenizer(PreTrainedTokenizer):
    """
    Construct a MyT5 tokenizer. Based on [SentencePiece](https://github.com/google/sentencepiece).
    ...
    Args:
        ...
        legacy (`bool`, *optional*):
            ...
            >>> tokenizer = MyT5Tokenizer.from_pretrained("google-myt5/myt5-base", legacy=True)
        ...
        if additional_special_tokens is not None:
            ...
            if len(extra_tokens) < 1:
                ...
                raise ValueError(
                    ...
                    " provided to MyT5Tokenizer. In this case the additional_special_tokens must include the extra_ids"
                    " tokens"
                )
        else:
    ...
    @staticmethod
    def _eventually_correct_myt5_max_length(pretrained_model_name_or_path, max_model_length, init_max_model_length):
        if pretrained_model_name_or_path in MyT5Tokenizer.max_model_input_sizes:
            deprecated_max_model_length = MyT5Tokenizer.max_model_input_sizes[pretrained_model_name_or_path]
    ...
    def create_token_type_ids_from_sequences(
        ...
        """
        Create a mask from the two sequences passed to be used in a sequence-pair classification task. MyT5 does not make

...
# Adapted from transformers.models.dots3_note.image_processing_dots3_note.Dots3NoteImageProcessorKwargs
...
@auto_docstring
class Dots3NoteImageProcessor(PilBackend):
    ...
    merge_size = 2
    valid_kwargs = Dots3NoteImageProcessorKwargs
    model_input_names = ["pixel_values", "image_grid_thw"]

    def __init__(self, **kwargs: Unpack[Dots3NoteImageProcessorKwargs]):
    ...
    def preprocess(
        self,
        images: ImageInput,
        **kwargs: Unpack[Dots3NoteImageProcessorKwargs],
    ) -> BatchFeature:

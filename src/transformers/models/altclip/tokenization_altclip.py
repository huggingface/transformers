...
"""Tokenization classes for AltCLIP."""
...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "BAAI/AltCLIP": "https://huggingface.co/BAAI/AltCLIP/resolve/main/vocab.txt",
    },
}
...
class AltCLIPTokenizer(PreTrainedTokenizer):
    ...
    def build_inputs_with_special_tokens(
        ...
        A AltCLIP sequence has the following format:
    ...
    def create_token_type_ids_from_sequences(
        ...
        AltCLIP does not make use of token type ids, therefore a list of zeros is returned.

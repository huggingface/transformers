...
from transformers.models.llama.modeling_llama import LlamaAttention, LlamaDecoderLayer, LlamaFlashAttention2, LlamaRMSNorm, LlamaSdpaAttention, repeat_kv, rotate_half
...
# Adapted from transformers.models.llama.modeling_llama.LlamaSdpaAttention

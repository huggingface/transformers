...
def bamba_split_conv1d_scan_combined(
    zxbcdt: torch.Tensor,
...
def bamba_selective_state_update(
    state: torch.Tensor,
    hidden_states: torch.Tensor,
    dt: torch.Tensor,
    A: torch.Tensor,
...
@use_kernelized_func(
    [
        ...
        bamba_split_conv1d_scan_combined,
        bamba_selective_state_update,
        bamba_chunk_scan,
    ]
)
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.training and cache_params is None:
            fused_output = bamba_split_conv1d_scan_combined(
                projected_states,
        ...
        if use_precomputed_states and seq_len == 1:
            ...
            scan_output = bamba_selective_state_update(
                recurrent_state,
                hidden_states,
                dt,
                A,

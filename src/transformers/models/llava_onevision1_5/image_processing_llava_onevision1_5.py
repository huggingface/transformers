...
class LlavaOnevision1_5ImageProcessorKwargs(ImagesKwargs, total=False):
    r"""
...
@auto_docstring
class LlavaOnevision1_5ImageProcessor(TorchvisionBackend):
    do_resize = True
    ...
    merge_size = 2
    valid_kwargs = LlavaOnevision1_5ImageProcessorKwargs
    model_input_names = ["pixel_values", "image_grid_thw"]

    def __init__(self, **kwargs: Unpack[LlavaOnevision1_5ImageProcessorKwargs]):
    ...
    def preprocess(
        self,
        images: ImageInput,
        **kwargs: Unpack[LlavaOnevision1_5ImageProcessorKwargs],
    ) -> BatchFeature:
...
__all__ = ["LlavaOnevision1_5ImageProcessor"]

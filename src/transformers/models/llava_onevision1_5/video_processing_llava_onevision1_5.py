...
class LlavaOnevision1_5VideoProcessorInitKwargs(VideosKwargs, total=False):
    r"""
...
@auto_docstring
class LlavaOnevision1_5VideoProcessor(BaseVideoProcessor):
    ...
    valid_kwargs = LlavaOnevision1_5VideoProcessorInitKwargs
    model_input_names = ["pixel_values_videos", "video_grid_thw"]

    def __init__(self, **kwargs: Unpack[LlavaOnevision1_5VideoProcessorInitKwargs]):
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        if cap_pixels_per_frame is None:
            logger.warning_once(
                "LlavaOnevision1_5 video processing does not apply the per-frame pixel cap the reference "
...
__all__ = ["LlavaOnevision1_5VideoProcessor"]

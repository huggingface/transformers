# coding=utf-8
# Copyright 2025 Google AI and The HuggingFace Team. All rights reserved.
#
...
_CHECKPOINT_FOR_DOC = "google/siglip2"
...
@dataclass
# Copied from transformers.models.clip.modeling_clip.CLIPVisionModelOutput with CLIP->Siglip2
...
@dataclass
# Copied from transformers.models.clip.modeling_clip.CLIPTextModelOutput with CLIP->Siglip2
class Siglip2TextModelOutput(ModelOutput):
    """
...
@dataclass
# Copied from transformers.models.clip.modeling_clip.CLIPOutput with CLIP->Siglip2
...
# Copied from transformers.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->Siglip2
...
# Copied from transformers.models.clip.modeling_clip.CLIPMLP with CLIP->Siglip2
...
# Copied from transformers.models.altclip.modeling_altclip.AltCLIPEncoder with AltCLIP->Siglip2
...
class Siglip2TextModel(Siglip2PreTrainedModel):
    ...
    def forward(
        ...
        >>> model = Siglip2TextModel.from_pretrained("google/siglip2")
        >>> tokenizer = AutoTokenizer.from_pretrained("google/siglip2")
...
class Siglip2VisionModel(Siglip2PreTrainedModel):
    ...
    def forward(
        ...
        >>> model = Siglip2VisionModel.from_pretrained("google/siglip2")

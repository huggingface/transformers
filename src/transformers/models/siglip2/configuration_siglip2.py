...
class Siglip2TextConfig(PretrainedConfig):
    ...
    [google/siglip2](https://huggingface.co/google/siglip2) architecture.
    ...
    >>> # Initializing a Siglip2TextConfig with google/siglip2 style configuration
    >>> configuration = Siglip2TextConfig()

    >>> # Initializing a Siglip2TextModel (with random weights) from the google/siglip2 style configuration
...
class Siglip2VisionConfig(PretrainedConfig):
    ...
    >>> # Initializing a Siglip2VisionConfig with google/siglip2 style configuration
    >>> configuration = Siglip2VisionConfig()

    >>> # Initializing a Siglip2VisionModel (with random weights) from the google/siglip2 style configuration
...
class Siglip2Config(PretrainedConfig):
    ...
    >>> # Initializing a Siglip2Config with google/siglip2 style configuration
    >>> configuration = Siglip2Config()

    >>> # Initializing a Siglip2Model (with random weights) from the google/siglip2 style configuration

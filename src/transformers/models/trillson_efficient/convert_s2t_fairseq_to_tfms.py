...
from transformers import Trillson_efficientConfig, Trillson_efficientForConditionalGeneration
...
def convert_fairseq_s2t_checkpoint_to_tfms(checkpoint_path, pytorch_dump_folder_path):
    ...
    config = Trillson_efficientConfig(
    ...
    model = Trillson_efficientForConditionalGeneration(config)

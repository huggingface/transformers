...
class UDOPDualPreTrainedModel(PreTrainedModel):
    """
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, (UDOPDualModel, T5ForConditionalGeneration, T5EncoderModel)):
...
class UDOPDualStack(UDOPDualPreTrainedModel):
    """
...
class UDOPDualModel(UDOPDualPreTrainedModel):
...
class T5EncoderModel(UDOPDualPreTrainedModel):

...
class VideoPrismTokenizerFast(PreTrainedTokenizerFast):
    """
    Construct a "fast" VIDEOPRISM tokenizer (backed by HuggingFace's *tokenizers* library). Based on
    ...
    slow_tokenizer_class = VideoPrismTokenizer
    ...
    def _eventually_correct_videoprism_max_length(
        ...
        if pretrained_model_name_or_path in VideoPrismTokenizerFast.max_model_input_sizes:
            deprecated_max_model_length = VideoPrismTokenizerFast.max_model_input_sizes[pretrained_model_name_or_path]
...
__all__ = ["VideoPrismTokenizerFast"]

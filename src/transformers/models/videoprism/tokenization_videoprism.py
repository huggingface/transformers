...
class VideoPrismTokenizer(PreTrainedTokenizer):
    """
    Construct a VIDEOPRISM tokenizer. Based on [SentencePiece](https://github.com/google/sentencepiece).
    ...
    Args:
        ...
        legacy (`bool`, *optional*):
            ...
            >>> tokenizer = VideoPrismTokenizer.from_pretrained("google-videoprism/videoprism-base", legacy=True)
            ...
            >>> tokenizer = VideoPrismTokenizer.from_pretrained("google-videoprism/videoprism-base", legacy=False)
    ...
    @staticmethod
    def _eventually_correct_videoprism_max_length(
        pretrained_model_name_or_path, max_model_length, init_max_model_length
    ):
        if pretrained_model_name_or_path in VideoPrismTokenizer.max_model_input_sizes:
            deprecated_max_model_length = VideoPrismTokenizer.max_model_input_sizes[pretrained_model_name_or_path]

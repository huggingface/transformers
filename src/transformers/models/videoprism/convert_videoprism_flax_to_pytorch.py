...
"""Convert Flax VideoPrism checkpoints from the original repository to PyTorch. URL:
https://github.com/google-research/scenic/tree/main/scenic/projects/videoprism
"""
...
def download_checkpoint(path):
    url = "https://storage.googleapis.com/scenic-bucket/videoprism/kinetics_400/videoprism_base_16x2_unfactorized/checkpoint"
...
def get_videoprism_config() -> VideoPrismConfig:
...
def transform_state(state_dict, classification_head=False):
    ...
    if classification_head:
        new_state = {"videoprism." + k: v for k, v in new_state.items()}
...
# original: https://github.com/google-research/scenic/blob/main/scenic/projects/videoprism/data/video_tfrecord_dataset.py
# dataset specific config:
# https://github.com/google-research/scenic/blob/main/scenic/projects/videoprism/configs/kinetics400/videoprism_base_k400.py
def get_processor() -> VideoPrismImageProcessor:
    extractor = VideoPrismImageProcessor()
    ...
    # which effectively means no normalization (and VideoPrism does not overwrite those when calling this func)

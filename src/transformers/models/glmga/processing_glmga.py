...
class GlmgaProcessorKwargs(ProcessingKwargs, total=False):
    _defaults = {
        "text_kwargs": {
            "padding": False,
...
@auto_docstring
class GlmgaProcessor(ProcessorMixin):
    valid_processor_kwargs = GlmgaProcessorKwargs
    ...
    def replace_video_token(self, video_inputs: dict, video_idx: int) -> str:
        ...
        if metadata.fps is None:
            logger.warning_once(
                "GLMGA requires frame timestamps to construct prompts, but the `fps` of the input video could not be inferred. "
    ...
    def _get_num_multimodal_tokens(self, image_sizes=None, video_sizes=None, **kwargs):
        ...
        if image_sizes is not None:
            images_kwargs = GlmgaProcessorKwargs._defaults.get("images_kwargs", {})
        ...
        if video_sizes is not None:
            videos_kwargs = GlmgaProcessorKwargs._defaults.get("videos_kwargs", {})
    ...
    def create_mm_token_type_ids(self, input_ids: list) -> list[list[int]]:
        ...
        for input in input_ids:
            ...
            # Replace 0 -> 2 only inside video segments because Glmga

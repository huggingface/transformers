...
class ConvBertConfig(PretrainedConfig):
    ...
    a configuration with the defaults will yield a similar configuration to that of the ConvBERT `convbert-base-uncased
    <https://huggingface.co/convbert-base-uncased>`__ architecture.

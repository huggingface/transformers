...
class ConformerProcessorKwargs(ProcessingKwargs, total=False):
    _defaults = {
        "audio_kwargs": {
            "sampling_rate": 16000,
            "padding": "longest",
...
@auto_docstring
class ConformerProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs: Unpack[ConformerProcessorKwargs],
    ):
        r"""

...
def convert_classification(base_model_name, hf_config, downstream_dict):
    model = SpeechT5ForSequenceClassification.from_pretrained(base_model_name, config=hf_config)
...
def convert_diarization(base_model_name, hf_config, downstream_dict):
    model = SpeechT5ForAudioFrameClassification.from_pretrained(base_model_name, config=hf_config)
...
def convert_xvector(base_model_name, hf_config, downstream_dict):
    model = SpeechT5ForXVector.from_pretrained(base_model_name, config=hf_config)

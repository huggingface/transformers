...
_SEQ_CLASS_CHECKPOINT = "superb/speecht5-base-superb-ks"
_SEQ_CLASS_EXPECTED_OUTPUT = "'_unknown_'"
_SEQ_CLASS_EXPECTED_LOSS = 6.54

# Frame class docstring
_FRAME_CLASS_CHECKPOINT = "anton-l/speecht5-base-superb-sd"
_FRAME_EXPECTED_OUTPUT = [0, 0]

# Speaker Verification docstring
_XVECTOR_CHECKPOINT = "anton-l/speecht5-base-superb-sv"
...
@dataclass
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput with Wav2Vec2->Speecht5
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2FeatureExtractor with Wav2Vec2->Speecht5,Wav2Vec2FeatureExtractor->Wav2Vec2FeatureExtractor
class Wav2Vec2FeatureExtractor(Speecht5FeatureEncoder):
    def __init__(self, config):
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2EncoderLayerStableLayerNorm with Wav2Vec2->Speecht5
class Speecht5EncoderLayerStableLayerNorm(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.attention = Speecht5Attention(
            embed_dim=config.hidden_size,
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2Encoder with Wav2Vec2->Speecht5
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2EncoderStableLayerNorm with Wav2Vec2->Speecht5
class Speecht5EncoderStableLayerNorm(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
        self.pos_conv_embed = Speecht5PositionalConvEmbedding(config)
        ...
        self.layers = nn.ModuleList(
            [Speecht5EncoderLayerStableLayerNorm(config) for _ in range(config.num_hidden_layers)]
        )
        self.gradient_checkpointing = False
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2GumbelVectorQuantizer with Wav2Vec2->Speecht5
class Speecht5GumbelVectorQuantizer(nn.Module):
    """
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2Adapter with Wav2Vec2->Speecht5
class Speecht5Adapter(nn.Module):
    def __init__(self, config):
        super().__init__()
        ...
        self.layers = nn.ModuleList(Speecht5AdapterLayer(config) for _ in range(config.num_adapter_layers))
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2AdapterLayer with Wav2Vec2->Speecht5
class Speecht5AdapterLayer(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.conv = nn.Conv1d(
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2PreTrainedModel with Wav2Vec2->Speecht5,wav2vec2->speecht5
...
SPEECHT5_INPUTS_DOCSTRING = r"""
    Args:
        ...
        attention_mask (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
            ...
            [speecht5-base](https://huggingface.co/), `attention_mask` should **not** be passed to avoid degraded
...
class Speecht5Model(Speecht5PreTrainedModel):
    ...
    @add_code_sample_docstrings(
        ...
        output_type=Speecht5BaseModelOutput,
    ...
    def forward(
    ...
    ) -> Union[Tuple, Speecht5BaseModelOutput]:
        ...
        return Speecht5BaseModelOutput(
            last_hidden_state=hidden_states,
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTraining with Wav2Vec2->Speecht5,wav2vec2->speecht5,WAV_2_VEC_2->SPEECHT5
class Speecht5ForPreTraining(Speecht5PreTrainedModel):
    def __init__(self, config: Speecht5Config):
        ...
        self.quantizer = Speecht5GumbelVectorQuantizer(config)
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from transformers import AutoFeatureExtractor, Speecht5ForPreTraining
        >>> from transformers.models.speecht5.modeling_speecht5 import _compute_mask_indices
        >>> from datasets import load_dataset

        >>> feature_extractor = AutoFeatureExtractor.from_pretrained("facebook/speecht5-base")
...
@add_start_docstrings("""Speecht5 Model with a `language modeling` head on top.""", SPEECHT5_START_DOCSTRING)
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForMaskedLM with Wav2Vec2->Speecht5,wav2vec2->speecht5,WAV_2_VEC_2->SPEECHT5
class Speecht5ForMaskedLM(Speecht5PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

        warnings.warn(
            "The class `Speecht5ForMaskedLM` is deprecated. Please use `Speecht5ForCTC` instead.", FutureWarning
        )
...
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForCTC with Wav2Vec2->Speecht5,wav2vec2->speecht5,WAV_2_VEC_2->SPEECHT5
...
@add_start_docstrings(
    """
    Speecht5 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
    SUPERB Keyword Spotting.
    """,
    SPEECHT5_START_DOCSTRING,
)
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForSequenceClassification with Wav2Vec2->Speecht5,wav2vec2->speecht5,WAV_2_VEC_2->SPEECHT5
class Speecht5ForSequenceClassification(Speecht5PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

        if hasattr(config, "add_adapter") and config.add_adapter:
            raise ValueError(
                "Sequence classification does not support the use of Speecht5 adapters (config.add_adapter=True)"
            )
        self.speecht5 = Speecht5Model(config)
...
@add_start_docstrings(
    """
    Speecht5 Model with a frame classification head on top for tasks like Speaker Diarization.
    """,
    SPEECHT5_START_DOCSTRING,
)
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForAudioFrameClassification with Wav2Vec2->Speecht5,wav2vec2->speecht5,WAV_2_VEC_2->SPEECHT5
class Speecht5ForAudioFrameClassification(Speecht5PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

        if hasattr(config, "add_adapter") and config.add_adapter:
            raise ValueError(
                "Audio frame classification does not support the use of Speecht5 adapters (config.add_adapter=True)"
            )
        self.speecht5 = Speecht5Model(config)
        num_layers = config.num_hidden_layers + 1  # transformer layers + input embeddings
        if config.use_weighted_layer_sum:
...
@add_start_docstrings(
    """
    Speecht5 Model with an XVector feature extraction head on top for tasks like Speaker Verification.
    """,
    SPEECHT5_START_DOCSTRING,
)
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForXVector with Wav2Vec2->Speecht5,wav2vec2->speecht5,WAV_2_VEC_2->SPEECHT5
class Speecht5ForXVector(Speecht5PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

...
class SpeechT5Tokenizer(PreTrainedTokenizer):
    ...
    def _decode(
        ...
        """
        special _decode function is needed for SpeechT5Tokenizer because added tokens should be treated exactly the
        ...
        if output_word_offsets or output_char_offsets:
            return SpeechT5TokenizerOutput(
                text=text,
    ...
    def batch_decode(
        ...
        **kwargs
        ...
        Returns:
            `List[str]` or [`~models.speecht5.tokenization_speecht5.SpeechT5TokenizerOutput`]: The list of decoded
            sentences. Will be a [`~models.speecht5.tokenization_speecht5.SpeechT5TokenizerOutput`] when
        ...
        if output_char_offsets or output_word_offsets:
            ...
            return SpeechT5TokenizerOutput({k: [d[k] for d in batch_decoded] for k in batch_decoded[0]})
    ...
    def decode(
        ...
        **kwargs
        ...
        Returns:
            `str` or [`~models.speecht5.tokenization_speecht5.SpeechT5TokenizerOutput`]: The list of decoded sentences.
            Will be a [`~models.speecht5.tokenization_speecht5.SpeechT5TokenizerOutput`] when `output_char_offsets ==
    ...
    def _add_tokens(self, new_tokens: Union[List[str], List[AddedToken]], special_tokens: bool = False) -> int:
        ...
        tokenizer = SpeechT5Tokenizer.from_pretrained("TODO")
...
class SpeechT5Tokenizer(PreTrainedTokenizer):
    """
    Constructs a SpeechT5 tokenizer.
    ...
    Args:
        ...
        do_normalize (`bool`, *optional*, defaults to `False`):
            ...
            [speecht5-lv60](https://huggingface.co/models?search=lv60).
        return_attention_mask (`bool`, *optional*, defaults to `False`):
            Whether or not [`~SpeechT5Tokenizer.__call__`] should return `attention_mask`.

            <Tip>

            SpeechT5 models that have set `config.feat_extract_norm == "group"`, such as
            [speecht5-base](https://huggingface.co/TODO), have **not** been trained using `attention_mask`. For such
            models, `input_values` should simply be padded with 0 and no `attention_mask` should be passed.

            For SpeechT5 models that have set `config.feat_extract_norm == "layer"`, such as
            [speecht5-lv60](https://huggingface.co/facebook/speecht5-large-960h-lv60-self), `attention_mask` should be
    ...
    vocab_files_names = VOCAB_FILES_NAMES
    pretrained_vocab_files_map = {
        "vocab_file": {"TODO": "https://huggingface.co/TODO/resolve/main/vocab.json"},
        "tokenizer_config_file": {
            "TODO": "https://huggingface.co/TODO/resolve/main/tokenizer.json",
        },
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        warnings.warn(
            "The class `SpeechT5Tokenizer` is deprecated and will be removed in version 5 of Transformers. Please use"
            " `SpeechT5Processor` or `SpeechT5Tokenizer` instead.",
            FutureWarning,
        )

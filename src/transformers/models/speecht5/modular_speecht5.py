...
from ..bart.modeling_bart import shift_tokens_right
...
class SpeechT5SinusoidalPositionalEmbedding(Speech2TextSinusoidalPositionalEmbedding):
    pass


class SpeechT5PositionalConvEmbedding(Wav2Vec2PositionalConvEmbedding):
    pass
...
class SpeechT5FeatureEncoder(Wav2Vec2FeatureEncoder):
    pass


class SpeechT5FeatureProjection(Wav2Vec2FeatureProjection):
    pass


@auto_docstring
class SpeechT5PreTrainedModel(UniSpeechPreTrainedModel):

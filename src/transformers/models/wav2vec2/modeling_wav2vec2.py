...
class Wav2Vec2GumbelVectorQuantizer(nn.Module):
    ...
    @staticmethod
    def _compute_perplexity(probs: torch.Tensor, mask=None) -> torch.Tensor:
        if mask is not None:
    ...
    def forward(self, hidden_states: torch.Tensor, mask_time_indices=None) -> Tuple[torch.Tensor, torch.Tensor]:

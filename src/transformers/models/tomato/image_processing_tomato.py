...
"""Image processor class for Tomato."""
...
class TomatoBatchFeature(BatchFeature):
    """
    BatchFeature class for Tomato image processor and processor.
...
class TomatoImageProcessor(BaseImageProcessor):
    """
    This class should handle the image processing part before the main TomatoForCausalLM. In particular, it should
    handle:
    ...
    def preprocess(
        ...
        return TomatoBatchFeature(data=data, tensor_type=return_tensors)

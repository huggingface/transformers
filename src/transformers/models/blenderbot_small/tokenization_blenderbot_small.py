...
class BlenderbotSmallTokenizer(BartTokenizer):
    """
    Construct a BlenderbotSmall tokenizer.

    :class:`~transformers.BlenderbotSmallTokenizer` is identical to :class:`~transformers.BartTokenizer` and runs

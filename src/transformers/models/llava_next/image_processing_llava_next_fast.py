...
class LlavaNextImageProcessorFast(LlavaPatchingMixin, BaseImageProcessorFast):
    r"""
    Constructs a fast LLaVa-NeXT image processor. Based on [`CLIPImageProcessor`] with incorporation of additional techniques

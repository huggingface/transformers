#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/pp_ocrv6_base_det/modular_pp_ocrv6_base_det.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_pp_ocrv6_base_det.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
from .configuration_pp_ocrv6_base_det import PPOCRV6BaseDetConfig


class PPOCRV6BaseDetConvBatchnormLayer(nn.Module):
    """
...
class PPOCRV6BaseDetHead(nn.Module):
    """
    ...
    def __init__(
        self,
        config: PPOCRV6BaseDetConfig,
    ):
        super().__init__()

        in_channels = config.neck_out_channels
        kernel_list = config.kernel_list
        self.conv_down = PPOCRV6BaseDetConvBatchnormLayer(
            in_channels=in_channels,
            out_channels=in_channels // 4,
            kernel_size=kernel_list[0],
            padding=int(kernel_list[0] // 2),
        )
        self.conv_up = PPOCRV6BaseDetConvBatchnormLayer(
...
class PPOCRV6BaseDetIntraclassBlock(nn.Module):
    """
    ...
    def __init__(
        ...
        self.conv_final = PPOCRV6BaseDetConvBatchnormLayer(
...
class PPOCRV6BaseDetNeck(nn.Module):
    """
...
class PPOCRV6BaseDetPreTrainedModel(PreTrainedModel):
    """
    ...
    config: PPOCRV6BaseDetConfig
    base_model_prefix = "pp_ocrv6_base_det"
...
@auto_docstring
class PPOCRV6BaseDetModel(PPOCRV6BaseDetPreTrainedModel):
    def __init__(self, config: PPOCRV6BaseDetConfig):
        super().__init__(config)
        self.backbone = load_backbone(config)
        self.neck = PPOCRV6BaseDetNeck(config)
        self.post_init()
...
class PPOCRV6BaseDetForObjectDetection(PPOCRV6BaseDetPreTrainedModel):
    _keys_to_ignore_on_load_missing = ["num_batches_tracked"]

    def __init__(self, config: PPOCRV6BaseDetConfig):
        super().__init__(config)
        self.model = PPOCRV6BaseDetModel(config)
        self.head = PPOCRV6BaseDetHead(config)
        self.post_init()
...
__all__ = ["PPOCRV6BaseDetForObjectDetection", "PPOCRV6BaseDetModel", "PPOCRV6BaseDetPreTrainedModel"]

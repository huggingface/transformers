...
class RemBertConfig(PretrainedConfig):
    r"""
       This is the configuration class to store the configuration of a :class:`~transformers.RemBertModel`. It is used
       to instantiate an RemBERT model according to the specified arguments, defining the model architecture.
       Instantiating a configuration with the defaults will yield a similar configuration to that of the RemBERT
       architecture.
       ...
       Args:
           vocab_size (:obj:`int`, `optional`, defaults to 250300):
               Vocabulary size of the RemBERT model. Defines the number of different tokens that can be represented by
               the :obj:`inputs_ids` passed when calling :class:`~transformers.RemBertModel` or
               :class:`~transformers.TFRemBertModel`. Vocabulary size of the model. Defines the different tokens that
           ...
           type_vocab_size (:obj:`int`, `optional`, defaults to 2):
               The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~transformers.RemBertModel`
               or :class:`~transformers.TFRemBertModel`.
           ...
           >>> # Initializing a RemBERT rembert-large
    style configuration
           >>> configuration = RemBertConfig()

           >>> # Initializing a model from the rembert-large
    style configuration

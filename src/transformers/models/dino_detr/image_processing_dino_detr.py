...
# inspired by https://github.com/facebookresearch/dino_detr/blob/master/datasets/coco.py#L33
...
# inspired by https://github.com/facebookresearch/dino_detr/blob/master/datasets/coco.py#L50
def prepare_coco_detection_annotation(
    ...
    """
    Convert the target in COCO format into the format expected by DINO_DETR.
    """
...
def prepare_coco_panoptic_annotation(
    ...
    """
    Prepare a coco panoptic annotation for DINO_DETR.
    """
    image_height, image_width = get_image_size(image, channel_dim=input_data_format)
...
class DinoDetrImageProcessor(BaseImageProcessor):
    r"""
    Constructs a DinoDetr image processor.
    ...
    def prepare_annotation(
        ...
        """
        Prepare an annotation for feeding into DINO_DETR model.
        """
    ...
    def preprocess(
        ...
        **kwargs,
        ...
        # prepare (COCO annotations as a list of Dict -> DINO_DETR target as a single Dict per image)
        if annotations is not None:
            prepared_images = []
    ...
    def post_process_segmentation(self, outputs, target_sizes, threshold=0.9, mask_threshold=0.5):
        """
        Converts the output of [`DinoDetrForSegmentation`] into image segmentation predictions. Only supports PyTorch.
    ...
    # inspired by https://github.com/facebookresearch/dino_detr/blob/master/models/segmentation.py#L218
    def post_process_instance(self, results, outputs, orig_target_sizes, max_target_sizes, threshold=0.5):
        """
        Converts the output of [`DinoDetrForSegmentation`] into actual instance segmentation predictions. Only supports
        PyTorch.
    ...
    # inspired by https://github.com/facebookresearch/dino_detr/blob/master/models/segmentation.py#L241
    def post_process_panoptic(self, outputs, processed_sizes, target_sizes=None, is_thing_map=None, threshold=0.85):
        """
        Converts the output of [`DinoDetrForSegmentation`] into actual panoptic predictions. Only supports PyTorch.
    ...
    def post_process_semantic_segmentation(self, outputs, target_sizes: Optional[list[tuple[int, int]]] = None):
        """
        Converts the output of [`DinoDetrForSegmentation`] into semantic segmentation maps. Only supports PyTorch.
    ...
    def post_process_instance_segmentation(
        ...
        """
        Converts the output of [`DinoDetrForSegmentation`] into instance segmentation predictions. Only supports PyTorch.
    ...
    def post_process_panoptic_segmentation(
        ...
        """
        Converts the output of [`DinoDetrForSegmentation`] into image panoptic segmentation predictions. Only supports
        PyTorch.

        Args:
            outputs ([`DinoDetrForSegmentation`]):
                The outputs from [`DinoDetrForSegmentation`].
            threshold (`float`, *optional*, defaults to 0.5):
                The probability score threshold to keep predicted instance masks.
            mask_threshold (`float`, *optional*, defaults to 0.5):
                Threshold to use when turning the predicted masks into binary values.

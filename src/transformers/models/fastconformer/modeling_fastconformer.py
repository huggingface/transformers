...
from ...modeling_outputs import BaseModelOutput, CausalLMOutput, Seq2SeqLMOutput
    ...
    def forward(
        ...
        if output_attentions:
            ...
            _, attn_weights = self.self_attn(
                self.norm_self_att(hidden_states), attention_mask=attention_mask, pos_emb=pos_emb, output_attentions=True
            )

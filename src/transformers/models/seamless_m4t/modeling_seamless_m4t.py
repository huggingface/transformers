...
class SeamlessM4TTextToUnitForConditionalGeneration(GenerationMixin, SeamlessM4TPreTrainedModel):
...
class SeamlessM4TForTextToText(GenerationMixin, SeamlessM4TPreTrainedModel):

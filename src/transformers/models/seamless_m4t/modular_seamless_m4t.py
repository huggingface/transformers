...
from ..bart.modeling_bart import BartAttention, shift_tokens_right
...
from ..wav2vec2.modeling_wav2vec2 import Wav2Vec2PositionalConvEmbedding
...
class SeamlessM4TConformerPositionalConvEmbedding(Wav2Vec2PositionalConvEmbedding):
    def __init__(self, config):
        super().__init__()
        self.activation = ACT2FN[config.speech_encoder_hidden_act]


class SeamlessM4TConformerRotaryPositionalEmbedding(Wav2Vec2ConformerRotaryPositionalEmbedding):
    def __init__(self, config):
        super().__init__()
...
class SeamlessM4TConformerRelPositionalEmbedding(Wav2Vec2ConformerRelPositionalEmbedding):
    pass
...
class SeamlessM4TConformerSelfAttention(Wav2Vec2ConformerSelfAttention, nn.Module):
...
class SeamlessM4TScaledWordEmbedding(M2M100ScaledWordEmbedding):
    pass


class SeamlessM4TSinusoidalPositionalEmbedding(M2M100SinusoidalPositionalEmbedding):
    pass


class SeamlessM4TAttention(BartAttention):
...
class SeamlessM4TFeedForwardNetwork(NllbMoeDenseActDense):

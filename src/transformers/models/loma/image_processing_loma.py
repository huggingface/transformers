...
if TYPE_CHECKING:
    from .modeling_loma import LoMaKeypointMatchingOutput


class LoMaImageProcessorKwargs(ImagesKwargs, total=False):
    r"""
...
@auto_docstring
class LoMaImageProcessor(TorchvisionBackend):
    valid_kwargs = LoMaImageProcessorKwargs
    ...
    def __init__(self, **kwargs: Unpack[LoMaImageProcessorKwargs]):
        super().__init__(**kwargs)

    @auto_docstring
    def preprocess(self, images: ImageInput, **kwargs: Unpack[LoMaImageProcessorKwargs]) -> BatchFeature:
    ...
    def post_process_keypoint_matching(
        self,
        outputs: "LoMaKeypointMatchingOutput",
        target_sizes: TensorType | list[tuple],
        threshold: float = 0.0,
    ) -> list[dict[str, torch.Tensor]]:
        """
        Converts the raw output of [`LoMaKeypointMatchingOutput`] into lists of keypoints, scores and descriptors

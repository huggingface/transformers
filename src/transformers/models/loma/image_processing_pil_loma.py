...
# Adapted from transformers.models.loma.image_processing_loma.validate_and_format_image_pairs
...
class LoMaImageProcessorPil(PilBackend):
    ...
    def visualize_keypoint_matching(
        ...
        Args:
            images (`ImageInput`):
                Image pairs to plot. Same as `LoMaImageProcessor.preprocess`. Expects either a list of 2

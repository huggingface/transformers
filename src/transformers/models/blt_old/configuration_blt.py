...
class BLTConfig(PretrainedConfig):
    ...
    Args:
        ...
        boe_token_id (`int`, *optional*, defaults to 3):
            Beginning of encoding token
        ...
        patch_size (`int`, *optional*, defaults to 4):
            The size of the patches for the patching mechanism.
        patching_mode (`str`, *optional*, defaults to "fixed"):
            The mode of the patching mechanism. Can be "fixed" or "entropy".
        patching_threshold (`float`, *optional*, defaults to 0.5):
            The threshold for the patching mechanism.
        use_cross_attention (`bool`, *optional*, defaults to True):
            Whether to use cross-attention in the patching mechanism.
        cross_attention_window (`int`, *optional*):
            The window size for cross-attention.
    ...
    def __init__(
        ...
        mlp_bias: bool = False,
        patch_size: int = 4,
        patching_mode: str = "fixed",
        patching_threshold: float = 0.5,
        use_cross_attention: bool = True,
        cross_attention_window: Optional[int] = None,

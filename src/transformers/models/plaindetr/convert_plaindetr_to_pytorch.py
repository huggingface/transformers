...
from transformers import PlainDetrConfig, PlainDetrForObjectDetection, DeformableDetrImageProcessor
...
@torch.no_grad()
def convert_plaindetr_checkpoint(
    checkpoint_path,
    single_scale,
    dilation,
    with_box_refine,
    ...
    model = PlainDetrForObjectDetection(config)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint_path",
        type=str,
        default="/home/niels/checkpoints/plaindetr/r50_plaindetr-checkpoint.pth",

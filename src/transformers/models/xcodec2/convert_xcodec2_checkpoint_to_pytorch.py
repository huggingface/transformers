...
# https://huggingface.co/HKUSTAudio/xcodec2/blob/main/pytorch_model.bin
...
def recursively_load_weights(orig_dict, hf_model, model_name):
    ...
    if model_name in ["xcodec2_24khz", "xcodec2_32khz"]:
        MAPPING = MAPPING_24K
    elif model_name == "xcodec2_48khz":
        MAPPING = MAPPING_48K
    else:
...
def convert_checkpoint(
    ...
    if model_name == "xcodec2_24khz":
        pass  # config is already correct
    elif model_name == "xcodec2_32khz":
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        default="xcodec2_24khz",
        type=str,
        help="The model to convert. Should be one of 'xcodec2_24khz', 'xcodec2_32khz', 'xcodec2_48khz'.",
    )

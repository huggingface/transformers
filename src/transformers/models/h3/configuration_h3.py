...
class H3Config(PretrainedConfig):
    ...
    [h3](https://huggingface.co/h3) architecture.
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 50257):
            ...
            `inputs_ids` passed when calling [`H3Model`] or [`TFH3Model`].
        ...
        summary_type (`string`, *optional*, defaults to `"cls_index"`):
            Argument used when doing sequence summary, used in the models [`H3DoubleHeadsModel`] and
            [`TFH3DoubleHeadsModel`].
...
class H3OnnxConfig(OnnxConfigWithPast):
    def __init__(
        self,

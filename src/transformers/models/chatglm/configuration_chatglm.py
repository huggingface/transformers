...
class ChatGlmConfig(PretrainedConfig):
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 32000):
            ...
            `inputs_ids` passed when calling [`ChatGlmModel`]
        ...
        max_position_embeddings (`int`, *optional*, defaults to 2048):
            The maximum sequence length that this model might ever be used with. ChatGlm 1 supports up to 2048 tokens,
            ChatGlm 2 up to 4096, CodeChatGlm up to 16384.
        ...
        rope_scaling (`Dict`, *optional*):
            ...
            https://www.reddit.com/r/LocalChatGLM/comments/14mrgpr/dynamically_scaled_rope_further_increases/. This is an
    ...
    >>> # Initializing a ChatGLM chatglm-7b style configuration
    >>> configuration = ChatGlmConfig()

    >>> # Initializing a model from the chatglm-7b style configuration

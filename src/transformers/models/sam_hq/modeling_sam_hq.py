...
_CHECKPOINT_FOR_DOC = "sam-hq-vit-base"


@dataclass
# Copied from transformers.models.sam.modeling_sam.SamVisionEncoderOutput with Sam->SAMHQ,sam->sam_hq
...
@dataclass
# Copied from transformers.models.sam.modeling_sam.SamImageSegmentationOutput with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamPatchEmbeddings with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamMLPBlock with Sam->SAMHQ
...
# Copied from transformers.models.convnext.modeling_convnext.ConvNextLayerNorm with ConvNext->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamAttention with SAM->SAM_HQ,Sam->SAMHQ,sam->sam_hq
class SAMHQAttention(nn.Module):
    ...
    def __init__(self, config, downsam_hqple_rate=None):
        super().__init__()
        self.hidden_size = config.hidden_size

        downsam_hqple_rate = config.attention_downsam_hqple_rate if downsam_hqple_rate is None else downsam_hqple_rate

        self.internal_dim = config.hidden_size // downsam_hqple_rate
...
# Copied from transformers.models.sam.modeling_sam.SamTwoWayAttentionBlock with Sam->SAMHQ,sam->sam_hq
class SAMHQTwoWayAttentionBlock(nn.Module):
    def __init__(self, config, attention_downsam_hqple_rate: int = 2, skip_first_layer_pe: bool = False):
        """
        ...
        Arguments:
            ...
            attention_downsam_hqple_rate (*optionalk*, int, defaults to 2):
                The downsam_hqple ratio of the block used to reduce the inner dim of the attention.
        ...
        self.self_attn = SAMHQAttention(config, downsam_hqple_rate=1)
        self.layer_norm1 = nn.LayerNorm(self.hidden_size, eps=self.layer_norm_eps)

        self.cross_attn_token_to_image = SAMHQAttention(config, downsam_hqple_rate=attention_downsam_hqple_rate)
        ...
        self.cross_attn_image_to_token = SAMHQAttention(config, downsam_hqple_rate=attention_downsam_hqple_rate)
...
# Copied from transformers.models.sam.modeling_sam.SamTwoWayTransformer with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamFeedForward with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamMaskDecoder with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamMaskEmbedding with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamPromptEncoder with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamVisionAttention with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamVisionLayer with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamVisionNeck with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamVisionEncoder with Sam->SAMHQ
...
# Copied from transformers.models.sam.modeling_sam.SamPreTrainedModel with Sam->SAMHQ,sam->sam_hq
...
SAM_HQ_INPUTS_DOCSTRING = r"""
    Args:
        ...
        attention_similarity (`torch.FloatTensor`, *optional*):
            ...
            model is used for personalization as introduced in [PerSAM_HQ](https://arxiv.org/abs/2305.03048).
        target_embedding (`torch.FloatTensor`, *optional*):
            Embedding of the target concept, to be provided to the mask decoder for target-semantic prompting in case
            the model is used for personalization as introduced in [PerSAM_HQ](https://arxiv.org/abs/2305.03048).
        output_attentions (`bool`, *optional*):
...
# Copied from transformers.models.sam.modeling_sam.SamModel with SAM->SAM_HQ,Sam->SAMHQ,sam->sam_hq
class SAMHQModel(SAMHQPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        >>> model = AutoModel.from_pretrained("facebook/sam_hq-vit-base")
        >>> processor = AutoProcessor.from_pretrained("facebook/sam_hq-vit-base")

        >>> img_url = "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/model_doc/sam_hq-car.png"
        ...
        if input_points is not None and image_embeddings.shape[0] != input_points.shape[0]:
            raise ValueError(
                "The batch size of the image embeddings and the input points must be the sam_hqe. ",
                "Got {} and {} respectively.".format(image_embeddings.shape[0], input_points.shape[0]),
                " if you want to pass multiple points for the sam_hqe image, make sure that you passed ",

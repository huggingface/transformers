...
# Copied from transformers.models.sam.modeling_sam.SamAttention with Sam->SamHQ
...
# Copied from transformer.models.sam.modeling_sam.SamTwoWayAttentionBlock with Sam->SamHQ

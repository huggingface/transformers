...
class PixoPatchEmbeddings(Dinov2PatchEmbeddings):
    def forward(self, pixel_values: torch.Tensor) -> torch.Tensor:
...
class PixoSelfAttention(Dinov2SelfAttention):
    pass


class PixoSelfOutput(Dinov2SelfOutput):
    pass


class PixoAttention(Dinov2Attention):
    pass
...
class PixoPreTrainedModel(Dinov2PreTrainedModel):
    @torch.no_grad()

...
class ICTConfig(PretrainedConfig):
    ...
    defaults will yield a similar configuration to that of the ICT
    [google/ict-base-patch16-224](https://huggingface.co/google/ict-base-patch16-224) architecture.
    ...
    >>> # Initializing a ICT ict-base-patch16-224 style configuration
    >>> configuration = ICTConfig()

    >>> # Initializing a model (with random weights) from the ict-base-patch16-224 style configuration

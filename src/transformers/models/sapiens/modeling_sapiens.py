...
# Copied from transformers.models.vit.modeling_vit.ViTForMaskedImageModeling with VIT->SAPIENS,ViT->Sapiens,vit->sapiens,google/vit-base-patch16-224-in21k->facebook/sapiens-hf
class SapiensForMaskedImageModeling(SapiensPreTrainedModel):
    ...
    def forward(
        ...
        >>> image_processor = AutoImageProcessor.from_pretrained("facebook/sapiens-hf")
        >>> model = SapiensForMaskedImageModeling.from_pretrained("facebook/sapiens-hf")

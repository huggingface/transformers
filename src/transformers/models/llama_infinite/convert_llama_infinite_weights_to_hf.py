...
```
python src/transformers/models/llama_infinite/convert_llama_infinite_weights_to_hf.py \
    --input_dir /path/to/downloaded/llama_infinite/weights --model_size 7B --output_dir /output/path
```
...
def main():
    ...
    parser.add_argument(
        "--input_dir",
        help="Location of LlamaInfinite weights, which contains tokenizer.model and model folders",
    )
    parser.add_argument(
        "--model_size",
        choices=["7B", "7Bf", "13B", "13Bf", "30B", "34B", "65B", "70B", "70Bf", "tokenizer_only"],
        help="'f' models correspond to the finetuned versions, and are specific to the LlamaInfinite2 official release. For more details on LlamaInfinite2, checkout the original repo: https://huggingface.co/meta-llama_infinite",
    )
    parser.add_argument(
        "--output_dir",

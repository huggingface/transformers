...
""" LlamaInfinite model configuration"""
...
class LlamaInfiniteConfig(PretrainedConfig):
    ...
    >>> # Initializing a LlamaInfinite llama_infinite-7b style configuration
    >>> configuration = LlamaInfiniteConfig()

    >>> # Initializing a model from the llama_infinite-7b style configuration
    >>> model = LlamaInfiniteModel(configuration)

    >>> # Accessing the model configuration
    >>> configuration = model.config
    ```"""
    model_type = "llama_infinite"

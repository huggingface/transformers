...
class CvTConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers.CvTModel`.
    It is used to instantiate an CvT model according to the specified arguments, defining the model
    architecture. Instantiating a configuration with the defaults will yield a similar configuration to that of
    the CvT `microsoft/cvt-21-384x384 <https://huggingface.co/microsoft/cvt-21-384x384>`__ architecture.
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~transformers.CvTModel` or

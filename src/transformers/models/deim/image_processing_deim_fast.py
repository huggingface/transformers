...
from .image_processing_deim import (
    compute_segments,
...
class DEIMFastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
    r"""
...
class DEIMImageProcessorFast(BaseImageProcessorFast):
    ...
    valid_kwargs = DEIMFastImageProcessorKwargs

    def __init__(self, **kwargs: Unpack[DEIMFastImageProcessorKwargs]) -> None:
    ...
    def from_dict(cls, image_processor_dict: dict[str, Any], **kwargs):
        ...
        created using from_dict and kwargs e.g. `DEIMImageProcessorFast.from_pretrained(checkpoint, size=600,
        max_size=800)`
        """
    ...
    def preprocess(
        ...
        masks_path: Optional[Union[str, pathlib.Path]] = None,
        **kwargs: Unpack[DEIMFastImageProcessorKwargs],
    ) -> BatchFeature:
        r"""
...
__all__ = ["DEIMImageProcessorFast"]

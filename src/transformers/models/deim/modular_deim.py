...
class DeimDecoderLayer(RTDetrDecoderLayer):
    def __init__(self, config: DeimConfig):
...
class DeimPreTrainedModel(RTDetrPreTrainedModel):
...
class DeimDecoderOutput(RTDetrDecoderOutput):
    pass
...
class DeimForObjectDetection(RTDetrForObjectDetection, DeimPreTrainedModel):
    def __init__(self, config: DeimConfig):
        DeimPreTrainedModel.__init__(config)
...
class DeimMLPPredictionHead(RTDetrMLPPredictionHead):
    pass
...
class DeimRepVggBlock(RTDetrRepVggBlock):
...
class DeimEncoder(RTDetrEncoder):
    pass


class DeimHybridEncoder(RTDetrHybridEncoder):
    def __init__(self, config: DeimConfig):

...
"""Convert Wav2Vec2BERT checkpoint."""
...
def recursively_load_weights(fairseq_model, hf_model, is_headless):
    ...
    feature_extractor = hf_model.wav2vec2_bert.feature_extractor
    ...
    for name, value in fairseq_dict.items():
        ...
        if "conv_layers" in name:
            ...
            for key, mapped_key in MAPPING.items():
                mapped_key = "wav2vec2_bert." + mapped_key if mapped_key not in TOP_LEVEL_KEYS else mapped_key
...
def convert_wav2vec2_bert_checkpoint(
    ...
    if is_finetuned:
        if dict_path:
            ...
            tokenizer = Wav2Vec2BERTTokenizer(
                vocab_path,
        ...
        hf_wav2vec = Wav2Vec2BERTForCTC(config)
    else:

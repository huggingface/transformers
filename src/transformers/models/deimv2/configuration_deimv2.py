...
class Deimv2Config(PreTrainedConfig):
    ...
    def __init__(
        ...
        dinov3_backbone_config=None,
        dinov3_interaction_indexes=None,
        dinov3_hidden_dim=None,
        ...
        **kwargs,
        ...
        self.dinov3_backbone_config = dinov3_backbone_config
        self.dinov3_interaction_indexes = dinov3_interaction_indexes
        self.dinov3_hidden_dim = dinov3_hidden_dim
        self.dinov3_apply_layernorm = dinov3_apply_layernorm
...
class Deimv2DINOv3ViTConfig(BackboneConfigMixin, PreTrainedConfig):
    r"""
    ...
    ```python
    >>> from transformers import Deimv2DINOv3ViTConfig, Deimv2DINOv3ViTModel

    >>> # Initializing a DINOv3 ViT-small style configuration
    >>> config = Deimv2DINOv3ViTConfig()

    >>> # Initializing a model (with random weights) from the config
    >>> model = Deimv2DINOv3ViTModel(config)

...
def build_2d_sinusoidal_position_embedding(
    ...
    Args:
        ...
        dtype: Output dtype; frequency arithmetic runs in float32 internally (the
            precision the reference weights were generated with) before casting,
            which keeps precision for float16/bfloat16 outputs.

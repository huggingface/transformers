...
"""Tokenization classes for Nystromformer."""
...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "nystromformer-roberta": "https://huggingface.co/nystromformer-roberta/resolve/main/vocab.txt",
    }
}

PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {
    "nystromformer-roberta": 512,
}


PRETRAINED_INIT_CONFIGURATION = {
    "nystromformer-roberta": {"do_lower_case": False},
}

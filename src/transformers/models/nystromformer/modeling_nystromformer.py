...
class NystromformerForCausalLM(NystromformerPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> tokenizer = NystromformerTokenizer.from_pretrained('nystromformer-base-512')
            >>> config = NystromformerConfig.from_pretrained("nystromformer-base-512")
            >>> config.is_decoder = True
            >>> model = NystromformerForCausalLM.from_pretrained('nystromformer-base-512', config=config)

...
NYSTROMFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "nystromformer-roberta": "https://huggingface.co/nystromformer-roberta/resolve/main/config.json",
...
class NystromformerConfig(PretrainedConfig):
    ...
    the Nystromformer `nystromformer-roberta <https://huggingface.co/nystromformer-roberta>`__ architecture.
    ...
    Args:
        ...
        >>> # Initializing a Nystromformer nystromformer-roberta style configuration
        >>> configuration = NystromformerConfig()

        >>> # Initializing a model from the nystromformer-roberta style configuration

...
"""Convert ResNetD checkpoints from timm."""
...
from transformers import AutoFeatureExtractor, ResNetDConfig, ResNetDForImageClassification
...
def convert_weight_and_push(
    ...
    with torch.no_grad():
        ...
        our_model = ResNetDForImageClassification(config).eval()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="The name of the model you wish to convert, it must be one of the supported resnetd* architecture, currently: resnetd18,26,34,50,101,152. If `None`, all of them will the converted.",
    )
    parser.add_argument(

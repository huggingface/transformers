...
class EfficientLoFTRConfig(PretrainedConfig):
    ...
    EfficientLoFTR [stevenbucaille/efficientloftr](https://huggingface.co/stevenbucaille/efficient_loftr) architecture.
...
class EfficientLoFTRForKeypointMatching(EfficientLoFTRPreTrainedModel):
    ...
    def forward(
        ...
        matching_keypoints = self._fine_matching(
            fine_features_0, fine_features_1, coarse_matched_keypoints, fine_scale
        )
        ...
        if not return_dict:
            return (match_indices, matching_scores, matching_keypoints, mask) + model_outputs[1:]

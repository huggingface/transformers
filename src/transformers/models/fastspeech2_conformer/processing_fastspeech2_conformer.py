...
"""Speech processor class for FastSpeech2Conformer."""

from ...processing_utils import ProcessorMixin


class FastSpeech2ConformerProcessor(ProcessorMixin):
    r"""
    Constructs a FastSpeech2Conformer processor which wraps a feature extractor and a tokenizer into a single processor.

    [`FastSpeech2ConformerProcessor`] offers all the functionalities of [`FastSpeech2ConformerFeatureExtractor`] and [`FastSpeech2ConformerTokenizer`]. See
    the docstring of [`~FastSpeech2ConformerProcessor.__call__`] and [`~FastSpeech2ConformerProcessor.decode`] for more information.

    Args:
        feature_extractor (`FastSpeech2ConformerFeatureExtractor`):
            An instance of [`FastSpeech2ConformerFeatureExtractor`]. The feature extractor is a required input.
        tokenizer (`FastSpeech2ConformerTokenizer`):
            An instance of [`FastSpeech2ConformerTokenizer`]. The tokenizer is a required input.
    """
    feature_extractor_class = "FastSpeech2ConformerFeatureExtractor"
    ...
    def __call__(self, *args, **kwargs):
        ...
        `audio_target`. This forwards the arguments to FastSpeech2ConformerFeatureExtractor's
        [`~FastSpeech2ConformerFeatureExtractor.__call__`].

        You can process text by using the argument `text`, or process text labels by using the argument `text_target`.
        This forwards the arguments to FastSpeech2ConformerTokenizer's [`~FastSpeech2ConformerTokenizer.__call__`].
    ...
    def pad(self, *args, **kwargs):
        ...
        Audio inputs are padded by FastSpeech2ConformerFeatureExtractor's [`~FastSpeech2ConformerFeatureExtractor.pad`]. Text inputs are padded
        by FastSpeech2ConformerTokenizer's [`~FastSpeech2ConformerTokenizer.pad`].
    ...
    def batch_decode(self, *args, **kwargs):
        """
        This method forwards all its arguments to FastSpeech2ConformerTokenizer's [`~FastSpeech2ConformerTokenizer.batch_decode`]. Please refer
    ...
    def decode(self, *args, **kwargs):
        """
        This method forwards all its arguments to FastSpeech2ConformerTokenizer's [`~FastSpeech2ConformerTokenizer.decode`]. Please refer to

...
"""Feature extractor class for FastSpeech2Conformer."""
...
class FastSpeech2ConformerFeatureExtractor(SequenceFeatureExtractor):
    r"""
    Constructs a FastSpeech2Conformer feature extractor.

    This class can pre-process a raw speech signal by (optionally) normalizing to zero-mean unit-variance, for use by
    the FastSpeech2Conformer speech encoder prenet.

    This class can also extract log-mel filter bank features from raw speech, for use by the FastSpeech2Conformer speech decoder
    prenet.
    ...
    Args:
        ...
        return_attention_mask (`bool`, *optional*, defaults to `True`):
            Whether or not [`~FastSpeech2ConformerFeatureExtractor.__call__`] should return `attention_mask`.
    """

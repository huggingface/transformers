# coding=utf-8
# Copyright 2023 The Suno Inc. and HuggingFace Inc. team. All rights reserved.
#
...
# TODO(SG): move weights to Suno AI on the Hub
...
BARK_START_DOCSTRING = r"""
    ...
    Parameters:
        config ([`BarkConfig`]): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the
            configuration. Check out the [`~PreTrainedModel.from_pretrained`] method to load the model weights.
"""

BARK_INPUTS_DOCSTRING = r"""
    Args:

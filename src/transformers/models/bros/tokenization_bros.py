...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "bros-base-uncased": "https://huggingface.co/bros-base-uncased/resolve/main/vocab.txt",
    }
}

PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {
    "bros-base-uncased": 512,
}


PRETRAINED_INIT_CONFIGURATION = {
    "bros-base-uncased": {"do_lower_case": False},
}


class BrosTokenizer(BertTokenizer):
    r"""
    Construct a Bros tokenizer.

    [`~BrosTokenizer`] is identical to [`BertTokenizer`] and runs end-to-end

...
# Copied from transformers.model.roberta.tokenization_roberta
class ESMTokenizer(GPT2Tokenizer):
    """
    Constructs a ESM tokenizer, derived from the GPT-2 tokenizer, using byte-level Byte-Pair-Encoding.
    ...
    def build_inputs_with_special_tokens(
        ...
        adding special tokens. A ESM sequence has the following format:
    ...
    def create_token_type_ids_from_sequences(
        ...
        """
        Create a mask from the two sequences passed to be used in a sequence-pair classification task. ESM does not

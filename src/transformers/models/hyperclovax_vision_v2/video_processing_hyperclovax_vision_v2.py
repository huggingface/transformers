...
from .image_processing_hyperclovax_vision_v2 import smart_resize


class HyperCLOVAXVisionV2VideoProcessorInitKwargs(VideosKwargs, total=False):
    min_pixels: int
    max_pixels: int
    patch_size: int
...
class HyperCLOVAXVisionV2VideoProcessor(BaseVideoProcessor):
    ...
    valid_kwargs = HyperCLOVAXVisionV2VideoProcessorInitKwargs
    model_input_names = ["pixel_values_videos", "video_grid_thw"]

    def __init__(self, **kwargs: Unpack[HyperCLOVAXVisionV2VideoProcessorInitKwargs]):
...
__all__ = ["HyperCLOVAXVisionV2VideoProcessor"]

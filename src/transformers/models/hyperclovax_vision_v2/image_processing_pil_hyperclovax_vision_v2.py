...
# Adapted from transformers.models.hyperclovax_vision_v2.image_processing_hyperclovax_vision_v2.smart_resize
def smart_resize(
...
@auto_docstring
class HyperCLOVAXVisionV2ImageProcessorPil(PilBackend):
    r"""
...
__all__ = ["HyperCLOVAXVisionV2ImageProcessorPil"]

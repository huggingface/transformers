...
class HyperCLOVAXVisionV2ImageProcessorKwargs(ImagesKwargs, total=False):
    r"""
...
@auto_docstring
class HyperCLOVAXVisionV2ImageProcessor(TorchvisionBackend):
    r"""
    ...
    merge_size = 2
    valid_kwargs = HyperCLOVAXVisionV2ImageProcessorKwargs
    model_input_names = ["pixel_values", "image_grid_thw"]

    def __init__(self, **kwargs: Unpack[HyperCLOVAXVisionV2ImageProcessorKwargs]):
    ...
    def preprocess(
        self,
        images: ImageInput,
        **kwargs: Unpack[HyperCLOVAXVisionV2ImageProcessorKwargs],
    ) -> BatchFeature:
...
__all__ = ["HyperCLOVAXVisionV2ImageProcessor"]

...
class MiniCPMScaledWordEmbedding(nn.Embedding):
    """
...
class MiniCPMRotaryEmbedding(nn.Module):
    ...
    @staticmethod
    @deprecate_kwarg("device", version="5.18")
    def compute_default_rope_parameters(config: MiniCPMConfig, device=None, **kwargs) -> tuple[torch.Tensor, float]:
        """
...
class MiniCPMPreTrainedModel(PreTrainedModel):
    ...
    _can_record_outputs = {
        "hidden_states": MiniCPMDecoderLayer,
        "attentions": MiniCPMAttention,
    }
...
class MiniCPMForSequenceClassification(GenericForSequenceClassification, MiniCPMPreTrainedModel):
    pass


__all__ = ["MiniCPMPreTrainedModel", "MiniCPMModel", "MiniCPMForCausalLM", "MiniCPMForSequenceClassification"]

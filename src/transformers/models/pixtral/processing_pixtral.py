...
class PixtralProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs: Unpack[PixtralProcessorKwargs],
        ...
        # Remove return_token_type_ids as TokenizersBackend doesn't need it for Mistral models
        output_kwargs["text_kwargs"].pop("return_token_type_ids", None)
        text_inputs = self.tokenizer(
            prompt_strings, **output_kwargs["text_kwargs"], return_tensors=None, return_token_type_ids=False
        )

...
@auto_docstring
class Sam3LiteTextProcessor(ProcessorMixin):
    def __init__(
    ...
    def post_process_semantic_segmentation(self, outputs, target_sizes=None, threshold=0.5):
        """
        Converts the output of [`Sam3LiteTextModel`] into semantic segmentation maps.

        Args:
            outputs ([`Sam3LiteTextImageSegmentationOutput`]):
    ...
    def post_process_object_detection(self, outputs, threshold=0.3, target_sizes=None):
        """
        Converts the raw output of [`Sam3LiteTextModel`] into final bounding boxes in (top_left_x, top_left_y,
        ...
        >>> model = AutoModel.from_pretrained("facebook/sam3_lite_text-base")
        >>> processor = AutoProcessor.from_pretrained("facebook/sam3_lite_text-base")
    ...
    def post_process_instance_segmentation(
        ...
        """
        Converts the raw output of [`Sam3LiteTextModel`] into instance segmentation predictions with bounding boxes and masks.

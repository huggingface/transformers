...
class EVEV2ImageProcessor(BaseImageProcessor):
    r"""
    Constructs a E_V_E_V2 image processor.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.image_mean = image_mean if image_mean is not None else OPENAI_E_V_E_V2_MEAN
        self.image_std = image_std if image_std is not None else OPENAI_E_V_E_V2_STD

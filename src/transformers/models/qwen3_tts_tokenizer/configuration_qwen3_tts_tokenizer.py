...
class Qwen3TTSTokenizerConfig(PreTrainedConfig):
    ...
    def __post_init__(self, **kwargs):
        ...
        if isinstance(self.decoder_config, dict):
            self.decoder_config["model_type"] = self.decoder_config.get("model_type", "qwen3_tts_tokenizer_code2wav")
...
__all__ = ["Qwen3TTSTokenizerConfig", "Qwen3TTSTokenizerCode2WavConfig"]

#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/qwen3_tts_tokenizer/modular_qwen3_tts_tokenizer.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_qwen3_tts_tokenizer.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
from .configuration_qwen3_tts_tokenizer import (
    ...
    Qwen3TTSTokenizerQuantizerConfig,
)
...
class Qwen3TTSTokenizerConv1dPaddingCache:
    """
    Padding cache for Qwen3TTSTokenizerConv1d causal convolutions in order to support streaming via cache padding.
    ...
    Hidden states are cached from the previous call to the Qwen3TTSTokenizerConv1d forward pass, given the padding size.
    """
...
class Qwen3TTSTokenizerEncoderOutput(ModelOutput):
    ...
    padding_cache (`Qwen3TTSTokenizerConv1dPaddingCache`, *optional*):
        Padding cache for Qwen3TTSTokenizerConv1d causal convolutions in order to support streaming via cache padding.
    """

    audio_codes: torch.LongTensor | None = None
    encoder_past_key_values: Cache | None = None
    padding_cache: Qwen3TTSTokenizerConv1dPaddingCache | None = None
...
class Qwen3TTSTokenizerDecoderOutput(ModelOutput):
    ...
    audio_values (`torch.FloatTensor`  of shape `(batch_size, input_length)`, *optional*):
        Decoded audio values, obtained using the decoder part of Qwen3TTSTokenizer.
    """
...
@auto_docstring
@dataclass
class Qwen3TTSTokenizerOutput(ModelOutput):
    r"""
...
class Qwen3TTSTokenizerConv1d(nn.Module):
    ...
    def __init__(
        ...
        if stride > 1 and dilation > 1:
            logger.warning(
                "Qwen3TTSTokenizerConv1d has been initialized with stride > 1 and dilation > 1"
    ...
    def _get_output_length(self, input_length: torch.LongTensor) -> torch.LongTensor:
        """
        Return the length of the output of the Qwen3TTSTokenizerConv1d.
        """
        # padding size
...
class Qwen3TTSTokenizerLayerScale(nn.Module):
...
class Qwen3TTSTokenizerPreTrainedModel(PreTrainedModel):
    ...
    _no_split_modules = ["Qwen3TTSTokenizerSplitResidualVectorQuantizer", "Qwen3TTSTokenizerTransformerLayer"]
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, Qwen3TTSTokenizerLayerScale):
            init.constant_(module.scale, self.config.layer_scale_initial_scale)
        elif isinstance(module, Qwen3TTSTokenizerConv1d):
        ...
        elif isinstance(module, Qwen3TTSTokenizerEuclideanCodebook):
...
class Qwen3TTSTokenizerCode2WavDecoderResidualUnit(nn.Module):
    def __init__(self, dim: int = 16, dilation: int = 1):
        super().__init__()

        self.act1 = Qwen3TTSTokenizerSnakeBeta(dim)
        self.conv1 = Qwen3TTSTokenizerCausalConvNet(dim, dim, kernel_size=7, dilation=dilation)
        self.act2 = Qwen3TTSTokenizerSnakeBeta(dim)
...
class Qwen3TTSTokenizerDecoderBlock(Qwen3TTSTokenizerPreTrainedModel):
    def __init__(self, config: Qwen3TTSTokenizerCode2WavConfig, layer_idx):
        ...
        block = [
            Qwen3TTSTokenizerSnakeBeta(in_dim),
            Qwen3TTSTokenizerCausalTransConvNet(in_dim, out_dim, 2 * upsample_rate, upsample_rate),
        ]

        for dilation in (1, 3, 9):
            block.append(Qwen3TTSTokenizerCode2WavDecoderResidualUnit(out_dim, dilation))
...
class Qwen3TTSTokenizerSnakeBeta(nn.Module):
    """
...
class Qwen3TTSTokenizerEuclideanCodebook(nn.Module):
...
class Qwen3TTSTokenizerVectorQuantization(nn.Module):
    """
    ...
    def __init__(self, config: Qwen3TTSTokenizerConfig):
        super().__init__()
        self.codebook = Qwen3TTSTokenizerEuclideanCodebook(config)
...
class Qwen3TTSTokenizerResidualVectorQuantizer(nn.Module):
    """Residual Vector Quantizer."""

    def __init__(self, config: Qwen3TTSTokenizerConfig, num_quantizers: int | None = None):
        super().__init__()
        self.codebook_size = config.codebook_size
        self.frame_rate = config.frame_rate
        self.num_quantizers = num_quantizers if num_quantizers is not None else config.num_quantizers
        self.layers = nn.ModuleList([Qwen3TTSTokenizerVectorQuantization(config) for _ in range(self.num_quantizers)])
...
class Qwen3TTSTokenizerSplitResidualVectorQuantizer(nn.Module):
    ...
    def __init__(self, config: Qwen3TTSTokenizerConfig):
        ...
        self.semantic_residual_vector_quantizer = Qwen3TTSTokenizerResidualVectorQuantizer(
            config, self.num_semantic_quantizers
        )
        self.acoustic_residual_vector_quantizer = Qwen3TTSTokenizerResidualVectorQuantizer(
...
class Qwen3TTSTokenizerRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        Qwen3TTSTokenizerRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class Qwen3TTSTokenizerRotaryEmbedding(nn.Module):
    @deprecate_kwarg("device", version="5.18")
    def __init__(self, config: Qwen3TTSTokenizerConfig, device=None):
        super().__init__()
    ...
    def compute_default_rope_parameters(
        config: Qwen3TTSTokenizerConfig, device=None, **kwargs
...
class Qwen3TTSTokenizerCode2WavAttention(nn.Module):
...
class Qwen3TTSTokenizerCode2WavMlp(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
...
@use_kernel_forward_from_hub("RMSNorm")
class Qwen3TTSTokenizerCode2WavRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        Qwen3TTSTokenizerCode2WavRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
        self.weight = nn.Parameter(torch.ones(hidden_size))
        self.variance_epsilon = eps
...
class Qwen3TTSTokenizerCode2WavLayerScale(nn.Module):
    """Layer scale from [Touvron et al 2021] (https://huggingface.co/papers/2103.17239).
    This rescales diagonally the residual outputs close to 0, with a learnt scale.
    """
...
class Qwen3TTSTokenizerCode2WavTransformerLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3TTSTokenizerCode2WavConfig, layer_idx):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = Qwen3TTSTokenizerCode2WavAttention(config, layer_idx)
        self.mlp = Qwen3TTSTokenizerCode2WavMlp(config)
        self.input_layernorm = Qwen3TTSTokenizerCode2WavRMSNorm(config.hidden_size, config.rms_norm_eps)
        self.post_attention_layernorm = Qwen3TTSTokenizerCode2WavRMSNorm(config.hidden_size, config.rms_norm_eps)
        self.self_attn_layer_scale = Qwen3TTSTokenizerCode2WavLayerScale(config)
        self.mlp_layer_scale = Qwen3TTSTokenizerCode2WavLayerScale(config)
...
@auto_docstring
class Qwen3TTSTokenizerDecoderTransformerModel(Qwen3TTSTokenizerPreTrainedModel):
    _can_record_outputs = {
        "hidden_states": Qwen3TTSTokenizerCode2WavTransformerLayer,
        "attentions": Qwen3TTSTokenizerCode2WavAttention,
    }

    def __init__(self, config: Qwen3TTSTokenizerCode2WavConfig):
        super().__init__(config)
        self.layers = nn.ModuleList(
            [
                Qwen3TTSTokenizerCode2WavTransformerLayer(config, layer_idx)
                for layer_idx in range(config.num_hidden_layers)
            ]
        )
        self.norm = Qwen3TTSTokenizerRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = Qwen3TTSTokenizerRotaryEmbedding(config=config)
...
class Qwen3TTSTokenizerConvTranspose1d(nn.Module):
...
class Qwen3TTSTokenizerResnetBlock(nn.Module):
    """
    Residual block from SEANet model as used by Qwen3TTSTokenizer.
    """

    def __init__(self, config: Qwen3TTSTokenizerConfig, dim: int, dilations: list[int]):
        super().__init__()
        ...
        for i, (kernel_size, dilation) in enumerate(zip(kernel_sizes, dilations)):
            ...
            block += [nn.ELU()]
            block += [Qwen3TTSTokenizerConv1d(config, in_chs, out_chs, kernel_size, dilation=dilation)]
        self.block = nn.ModuleList(block)

        if config.use_conv_shortcut:
            self.shortcut = Qwen3TTSTokenizerConv1d(config, dim, dim, kernel_size=1)
        else:
    ...
    def forward(self, hidden_states, padding_cache=None):
        ...
        for layer in self.block:
            if isinstance(layer, Qwen3TTSTokenizerConv1d):
                hidden_states = layer(hidden_states, padding_cache=padding_cache)
            else:
                hidden_states = layer(hidden_states)

        if isinstance(self.shortcut, Qwen3TTSTokenizerConv1d):
...
class Qwen3TTSTokenizerEncoder(nn.Module):
    """SEANet encoder as used by Qwen3TTSTokenizer."""

    def __init__(self, config: Qwen3TTSTokenizerConfig):
        super().__init__()
        model = [Qwen3TTSTokenizerConv1d(config, config.audio_channels, config.num_filters, config.kernel_size)]
        scaling = 1

        # keep track of Qwen3TTSTokenizerConv1d submodule layer names for easy encoded length computation
        ...
        for ratio in reversed(config.upsampling_ratios):
            ...
            for j in range(config.num_residual_layers):
                ...
                model += [Qwen3TTSTokenizerResnetBlock(config, current_scale, [config.dilation_growth_rate**j, 1])]
            # Add downsampling layers
            model += [nn.ELU()]
            qwen3_tts_tokenizer_12hzconv1d_layer_names.append(f"layers.{len(model)}")
            model += [
                Qwen3TTSTokenizerConv1d(config, current_scale, current_scale * 2, kernel_size=ratio * 2, stride=ratio)
            ]
            scaling *= 2
        ...
        qwen3_tts_tokenizer_12hzconv1d_layer_names.append(f"layers.{len(model)}")
        model += [
            Qwen3TTSTokenizerConv1d(config, scaling * config.num_filters, config.hidden_size, config.last_kernel_size)
        ]

        self.layers = nn.ModuleList(model)
        self._qwen3_tts_tokenizer_12hzconv1d_layer_names = qwen3_tts_tokenizer_12hzconv1d_layer_names

        # initialize layer_idx for Qwen3TTSTokenizerConv1d submodules, necessary for padding_cache
    ...
    def forward(self, hidden_states, padding_cache=None):
        for layer in self.layers:
            if isinstance(layer, (Qwen3TTSTokenizerConv1d, Qwen3TTSTokenizerResnetBlock)):
                hidden_states = layer(hidden_states, padding_cache=padding_cache)
            else:
                hidden_states = layer(hidden_states)
        return hidden_states
...
class Qwen3TTSTokenizerMLP(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
...
class Qwen3TTSTokenizerAttention(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    def __init__(self, config: Qwen3TTSTokenizerConfig, layer_idx: int | None = None):
        super().__init__()
        self.config = config
        self.layer_idx = layer_idx
...
class Qwen3TTSTokenizerTransformerLayer(GradientCheckpointingLayer):
    def __init__(self, config: Qwen3TTSTokenizerConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size

        self.self_attn = Qwen3TTSTokenizerAttention(config=config, layer_idx=layer_idx)

        self.mlp = Qwen3TTSTokenizerMLP(config)
        self.input_layernorm = nn.LayerNorm(config.hidden_size, eps=config.norm_eps)
        self.post_attention_layernorm = nn.LayerNorm(config.hidden_size, eps=config.norm_eps)
        self.self_attn_layer_scale = Qwen3TTSTokenizerLayerScale(config)
        self.mlp_layer_scale = Qwen3TTSTokenizerLayerScale(config)
...
class Qwen3TTSTokenizerTransformerModel(nn.Module):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`Qwen3TTSTokenizerTransformerLayer`]
    ...
    def __init__(self, config: Qwen3TTSTokenizerConfig):
        ...
        self.layers = nn.ModuleList(
            [Qwen3TTSTokenizerTransformerLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)]
        )
        self.rotary_emb = Qwen3TTSTokenizerRotaryEmbedding(config)
...
class Qwen3TTSTokenizerEncoderModel(Qwen3TTSTokenizerPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.config = config

        self.encoder = Qwen3TTSTokenizerEncoder(config)
        self.encoder_transformer = Qwen3TTSTokenizerTransformerModel(config)

        self.downsample = None
        self.upsample = None
        if config.frame_rate != config.encodec_frame_rate:
            self.downsample = Qwen3TTSTokenizerConv1d(
                config,
                config.hidden_size,
                config.hidden_size,
            ...
            self.upsample = Qwen3TTSTokenizerConvTranspose1d(
                config,
                config.hidden_size,
                config.hidden_size,
                kernel_size=2 * int(config.encodec_frame_rate / config.frame_rate),
        ...
        self.quantizer = Qwen3TTSTokenizerSplitResidualVectorQuantizer(config)
    ...
    def encode(
        ...
        use_streaming: bool | None = None,
        return_dict: bool | None = None,
    ) -> tuple[torch.Tensor, torch.Tensor | None] | Qwen3TTSTokenizerEncoderOutput:
        """
        ...
        if use_streaming and padding_cache is None:
            ...
            padding_cache = Qwen3TTSTokenizerConv1dPaddingCache(
        ...
        return Qwen3TTSTokenizerEncoderOutput(encoded_frames, encoder_past_key_values, padding_cache)
    ...
    def decode(
        ...
        return_dict: bool | None = None,
    ) -> tuple[torch.Tensor, torch.Tensor] | Qwen3TTSTokenizerDecoderOutput:
        """
        ...
        return Qwen3TTSTokenizerDecoderOutput(audio_values, decoder_past_key_values)
    ...
    def forward(
        ...
        return_dict: bool | None = None,
        **kwargs,
    ) -> tuple[torch.Tensor, torch.Tensor] | Qwen3TTSTokenizerOutput:
        r"""
        ...
        >>> from transformers import AutoFeatureExtractor, Qwen3TTSTokenizerEncoderModel

        >>> dataset = load_dataset("hf-internal-testing/ashraq-esc50-1-dog-example")
        >>> audio_sample = dataset["train"]["audio"][0]["array"]

        >>> model_id = "kyutai/qwen3_tts_tokenizer_12hz"
        >>> model = Qwen3TTSTokenizerEncoderModel.from_pretrained(model_id)
...
__all__ = ["Qwen3TTSTokenizerModel", "Qwen3TTSTokenizerPreTrainedModel"]

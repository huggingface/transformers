...
class M2M100DecoderModel(M2M100PreTrainedModel):
    ...
    def __init__(self, config: M2M100Config):
        ...
        self.decoder = M2M100Decoder(decoder_config, self.shared)
...
@add_start_docstrings(
    "The M2M100 (SONAR) transformer model outputting encoder's raw hidden states. Can be used for embedding sentences.",
    M2M_100_START_DOCSTRING,
)
class M2M100EncoderModel(M2M100PreTrainedModel):
    ...
    def forward(
        ...
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
        pool_last_hidden_state: bool = False,
        ...
        ```python
        >>> from transformers import AutoTokenizer, M2M100EncoderModel
        ...
        if pool_last_hidden_state:
            last_hidden_state = encoder_outputs.last_hidden_state
            if attention_mask is None:
                mean_state = last_hidden_state.mean(1, keepdims=True)
            else:

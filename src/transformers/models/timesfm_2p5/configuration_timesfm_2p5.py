...
class Timesfm2P5Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Timesfm2P5ModelForPrediction`] or a [`TFTimesFmModel`]. It is used to
    instantiate a Timesfm2P5 model according to the specified arguments, defining the model architecture. Instantiating a
    configuration with the defaults will yield a similar configuration to that of the Timesfm2P5
    [google/timesfm_2p5-2.0-500m-pytorch](https://huggingface.co/google/timesfm_2p5-2.0-500m-pytorch) architecture.

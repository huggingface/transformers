#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/kormo/modular_kormo.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_kormo.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
from .configuration_kormo import KORMoConfig


@use_kernel_forward_from_hub("RMSNorm")
class KORMoRMSNorm(nn.Module):
...
class KORMoRotaryEmbedding(nn.Module):
...
class KORMoAttention(nn.Module):
...
class KORMoDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: KORMoConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size

        self.self_attn = KORMoAttention(config=config, layer_idx=layer_idx)

        self.mlp = KORMoMLP(config)
...
class KORMoPreTrainedModel(PreTrainedModel):
    ...
    _no_split_modules = ["KORMoDecoderLayer"]
    ...
    _can_record_outputs = {
        "hidden_states": KORMoDecoderLayer,
        "attentions": KORMoAttention,
    }
...
class KORMoModel(KORMoPreTrainedModel):
    def __init__(self, config: KORMoConfig):
        ...
        self.layers = nn.ModuleList(
            [KORMoDecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)]
        )
        self.norm = KORMoRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = KORMoRotaryEmbedding(config=config)
...
class KORMoForSequenceClassification(GenericForSequenceClassification, KORMoPreTrainedModel):
    pass


class KORMoForTokenClassification(GenericForTokenClassification, KORMoPreTrainedModel):
    pass


class KORMoForQuestionAnswering(GenericForQuestionAnswering, KORMoPreTrainedModel):

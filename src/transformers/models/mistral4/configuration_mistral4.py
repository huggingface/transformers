...
class Mistral4Config(PreTrainedConfig):
    ...
    defaults will yield a similar configuration to that of the Mistral-Small-4.
    e.g. [mistralai/{Mistral-Small-4-119B-260}](https://huggingface.co/mistralai/Mistral-Small-4-119B-2602)

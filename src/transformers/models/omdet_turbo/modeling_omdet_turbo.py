...
class OmDetTurboDecoderOutput(ModelOutput):
    ...
    Args:
        ...
        hidden_states (`Optionaltuple[torch.FloatTensor]]`, *optional*, returned when `output_hidden_states=True` is passed or when `config.output_hidden_states=True`):
        ...
        attentions (`Optionaltuple[Tuple[torch.FloatTensor]]]`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`):

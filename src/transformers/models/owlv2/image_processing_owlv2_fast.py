...
class Owlv2ImageProcessorFast(BaseImageProcessorFast):
    ...
    def _pad_image(self, image: "torch.Tensor", constant_value: float = 0.5) -> "torch.Tensor":
        """
        ...
        padding = (0, 0, pad_bottom, pad_right)
        padded_image = F.pad(image, padding, fill=constant_value)
        return padded_image
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        processed_images = reorder_images(processed_images_grouped, grouped_images_index)
        self.normalized = processed_images

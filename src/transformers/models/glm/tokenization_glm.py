...
class GLMTokenizer(BertTokenizer):
    r"""
    Construct a GLM tokenizer.

    :class:`~transformers.GLMTokenizer` is identical to :class:`~transformers.BertTokenizer` and runs end-to-end

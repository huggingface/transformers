...
class SelfAttention(torch.nn.Module):
    ...
    def __init__(self, config: GLMConfig, layer_number, device=None):
        ...
        self.hidden_size_per_attention_head = (
            self.projection_size // config.num_key_value_heads
        )
...
class GLMAttention(nn.Module):
    ...
    def __init__(self, config: GLMConfig, layer_number):
        ...
        self.hidden_size_per_attention_head = (
            projection_size // config.num_key_value_heads
        )
        self.num_key_value_heads_per_partition = config.num_key_value_heads
...
# Copied from transformers.models.llama.modeling_llama.LlamaFlashAttention2 with Llama->GLM

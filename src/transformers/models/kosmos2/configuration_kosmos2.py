...
KOSMOS2_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "ydshieh/temp-testing-kosmos-2-rename-001": (
        "https://huggingface.co/ydshieh/temp-testing-kosmos-2-rename-001/resolve/main/config.json"
    ),
...
class Kosmos2TextConfig(PretrainedConfig):
    ...
    [ydshieh/temp-testing-kosmos-2-rename-001](https://huggingface.co/ydshieh/temp-testing-kosmos-2-rename-001)
    architecture.

...
class Qwen2VLVisionRotaryEmbedding(nn.Module):
    ...
    @deprecate_kwarg("device", version="5.18")
    def __init__(self, config: Qwen2VLVisionConfig, device=None):
        super().__init__()
        self.config = config
...
@auto_docstring
class Qwen2VLModel(Qwen2VLPreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
class Qwen2VLForConditionalGeneration(Qwen2VLPreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

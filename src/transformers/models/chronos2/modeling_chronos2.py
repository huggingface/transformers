...
from .configuration_chronos2 import Chronos2Config
...
class Chronos2LayerNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        Construct a layernorm module in the CHRONOS2 style. No bias and no subtraction of mean.
        """
        super().__init__()
    ...
    def forward(self, hidden_states):
        # CHRONOS2 uses a layer_norm which only scales and doesn't shift, which is also known as Root Mean
...
__all__ = ["Chronos2Model", "Chronos2Output", "Chronos2PreTrainedModel"]

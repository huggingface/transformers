...
@dataclass
# Copied from transformers.models.qwen2_vl.modeling_qwen2_vl.Qwen2VLCausalLMOutputWithPast with Qwen2VL->Qwen2_5_VL
...
# Copied from transformers.models.qwen2_vl.modeling_qwen2_vl.Qwen2VLRotaryEmbedding with Qwen2VL->Qwen2_5_VL
...
class PatchEmbed(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        hidden_states = self.proj(hidden_states.to(dtype=target_dtype)).view(-1, self.hidden_size)
...
# Copied from transformers.models.qwen2_vl.modeling_qwen2_vl.VisionAttention
...
# Copied from transformers.models.qwen2_vl.modeling_qwen2_vl.VisionSdpaAttention
...
# Copied from transformers.models.qwen2_vl.modeling_qwen2_vl.Qwen2VLAttention with Qwen2VL->Qwen2_5_VL
class Qwen2_5_VLAttention(nn.Module):
    ...
    def forward(
        ...
        # Fix precision issues in Qwen2.5-VL float16 inference
...
# Copied from transformers.models.qwen2_vl.modeling_qwen2_vl.Qwen2VLFlashAttention2 with Qwen2VL->Qwen2_5_VL
...
# Copied from transformers.models.qwen2_vl.modeling_qwen2_vl.Qwen2VLSdpaAttention with Qwen2VL->Qwen2_5_VL
class Qwen2_5_VLSdpaAttention(Qwen2_5_VLAttention):
    """
    Qwen2_5 Sdpaattention module using torch.nn.functional.scaled_dot_product_attention. This module inherits from
    `Qwen2_5_VLSdpaAttention` as the weights of the module stays untouched. The only changes are on the forward pass to adapt to
    SDPA API.
    """
...
# Copied from transformers.models.qwen2_vl.modeling_qwen2_vl.Qwen2VLPreTrainedModel with Qwen2VL->Qwen2_5_VL
...
# Copied from transformers.models.qwen2_vl.modeling_qwen2_vl.Qwen2VLModel with Qwen2VL->Qwen2_5_VL

...
class MvpConfig(PretrainedConfig):
    ...
    Args:
        ...
        forced_bos_token_id (`int`, *optional*, defaults to 0):
            The id of the token to force as the first generated token after the `decoder_start_token_id`. Usually set
            to `bos_token_id`.
        ...
        lightweight (`bool`, *optional*, defaults to `False`):
            Whether or not to use prompt lightweight tuning.
    Example:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.lightweight_tuning = lightweight_tuning
...
class MvpOnnxConfig(OnnxSeq2SeqConfigWithPast):
    @property

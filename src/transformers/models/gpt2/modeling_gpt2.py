        ...
        if use_cache:
            if past_key_values is None:
                ...
                logger.warning_once(
                    ...
                    "This behavior is deprecated and will be changed in Transformers v4.52.0. "
                ...
                return_legacy_cache = True
                logger.warning_once(
                    "Passing a tuple of `past_key_values` is deprecated and will be removed in Transformers v4.52.0. "

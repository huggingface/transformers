...
from transformers import Ernie4_5Config, Ernie4_5ForCausalLM, GenerationConfig, LlamaTokenizer, PreTrainedTokenizerFast
...
```
python src/transformers/models/ernie4_5/convert_ernie4_5_weights_to_hf.py \
    --input_dir /path/to/downloaded/ernie4_5/weights --model_size 1B --ernie4_5_version 3.2 --output_dir /output/path
```

Thereafter, models can be loaded via:

```py
from transformers import Ernie4_5ForCausalLM, LlamaTokenizer

model = Ernie4_5ForCausalLM.from_pretrained("/output/path")
...
DEFAULT_ERNIE4_5_SPECIAL_TOKENS = {
    "3": [
        "<|begin_of_text|>",
        "<|end_of_text|>",
...
def write_model(
    ...
    if base > 10000.0 and not is_ernie4_5_3(ernie4_5_version):
        max_position_embeddings = 16384
    else:
        max_position_embeddings = CONTEXT_LENGTH_FOR_VERSION[ernie4_5_version]
    ...
    with tempfile.TemporaryDirectory() as tmp_model_path:
        ...
        if num_shards == 1:
            ...
            concat_dim = 0 if is_ernie4_5_3(ernie4_5_version) else 1
            state_dict = {
        ...
        if is_ernie4_5_3(ernie4_5_version):
            bos_token_id = 128000
        ...
        if ernie4_5_version in ["3.1", "3.2", "Guard-3"]:
            rope_scaling = {
                "factor": 32.0 if ernie4_5_version == "3.2" else 8.0,
                "low_freq_factor": 1.0,
        ...
        config = Ernie4_5Config(
            ...
            tie_word_embeddings=True if ernie4_5_version in ["3.2"] else False,
        )
        ...
        print("Loading the checkpoint in a Ernie4_5 model.")
        model = Ernie4_5ForCausalLM.from_pretrained(tmp_model_path, torch_dtype=torch.bfloat16)
...
class Ernie4_53Converter(TikTokenConverter):
    def __init__(self, vocab_file, special_tokens=None, instruct=False, ernie4_5_version="3.2", **kwargs):
        ...
        templates_for_version = {
            "2": ("meta-ernie4_5/Ernie4_5-2-7b-chat-hf", "f5db02db724555f92da89c216ac04704f23d4590"),
            "3": ("meta-ernie4_5/Meta-Ernie4_5-3-8B-Instruct", "5f0b02c75b57c5855da9ae460ce51323ea669d8a"),
            "3.1": ("meta-ernie4_5/Ernie4_5-3.1-8B-Instruct", "0e9e39f249a16976918f6564b8830bc894c89659"),
            "3.2": ("meta-ernie4_5/Ernie4_5-3.2-1B-Instruct", "e9f8effbab1cbdc515c11ee6e098e3d5a9f51e14"),
            "Guard-3": ("meta-ernie4_5/Ernie4_5-Guard-3-1B", "acf7aafa60f0410f8f42b1fa35e077d705892029"),
        }
        ...
        additional_kwargs = {}
        if instruct or ernie4_5_version in ["Guard-3"]:
            model_id, revision = templates_for_version.get(ernie4_5_version, (None, None))
        ...
        self.converted_tokenizer = PreTrainedTokenizerFast(
            ...
            model_max_length=CONTEXT_LENGTH_FOR_VERSION[ernie4_5_version],
...
def write_tokenizer(
    tokenizer_path, input_tokenizer_path, ernie4_5_version="2", special_tokens=None, instruct=False, push_to_hub=False
):
    print("Converting the tokenizer.")
    tokenizer_class = LlamaTokenizer if LlamaTokenizerFast is None else LlamaTokenizerFast
    if is_ernie4_5_3(ernie4_5_version):
        tokenizer = Ernie4_53Converter(
...
def main():
    ...
    parser.add_argument(
        "--input_dir",
        help="Location of Ernie4_5 weights, which contains tokenizer.model and model folders",
    )
    parser.add_argument(
        "--model_size",
        default=None,
        help="'f' Deprecated in favor of `num_shards`: models correspond to the finetuned versions, and are specific to the Ernie4_52 official release. For more details on Ernie4_52, check out the original repo: https://huggingface.co/meta-ernie4_5",
    )
    parser.add_argument(
        "--output_dir",
    ...
    # Different Ernie4_5 versions used different default values for max_position_embeddings, hence the need to be able to specify which version is being used.
    parser.add_argument(
        "--ernie4_5_version",
        choices=["1", "2", "3", "3.1", "3.2", "Guard-3"],
        default="1",
        type=str,
        help="Version of the Ernie4_5 model to convert. Currently supports Ernie4_51 and Ernie4_52. Controls the context size",
    )
    parser.add_argument(
        "--num_shards",
        default=None,
    ...
    if args.special_tokens is None:
        ...
        args.special_tokens = DEFAULT_ERNIE4_5_SPECIAL_TOKENS.get(str(args.ernie4_5_version), [])
    ...
    vocab_size = len(
        write_tokenizer(
            args.output_dir,
            spm_path,
            ernie4_5_version=args.ernie4_5_version,

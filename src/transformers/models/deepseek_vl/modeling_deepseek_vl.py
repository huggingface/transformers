...
class DeepseekVLModel(DeepseekVLPreTrainedModel):
    ...
    # Copied from transformers.models.janus.modeling_janus.JanusModel.get_input_embeddings with Janus->DeepseekVL
    def get_input_embeddings(self):
        return self.language_model.get_input_embeddings()

    # Copied from transformers.models.janus.modeling_janus.JanusModel.set_input_embeddings with Janus->DeepseekVL
    def set_input_embeddings(self, value):
        self.language_model.set_input_embeddings(value)

    # Copied from transformers.models.janus.modeling_janus.JanusModel.get_image_features with Janus->DeepseekVL
    ...
    @can_return_tuple
    @auto_docstring
    # Copied from transformers.models.janus.modeling_janus.JanusModel.forward with Janus->DeepseekVL
    def forward(
        self,
...
class DeepseekVLForConditionalGeneration(DeepseekVLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        output = DeepseekVLCausalLMOutputWithPast(
            loss=loss,
            logits=logits,

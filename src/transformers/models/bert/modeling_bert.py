...
class BertSelfOutput(nn.Module):
    ...
    The self-attention path no longer uses this: its projection is `BertAttention.o_proj` and its
    LayerNorm belongs to `BertLayer`. Cross-attention keeps the original layout deliberately, so

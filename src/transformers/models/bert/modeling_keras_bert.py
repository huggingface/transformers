...
class TFBertSelfAttention(keras.Layer):
    def __init__(self, config: BertConfig, **kwargs):
        super().__init__(**kwargs)
...
class TFBertSelfOutput(keras.Layer):
    def __init__(self, config: BertConfig, **kwargs):
        super().__init__(**kwargs)
...
class TFBertAttention(keras.Layer):
    def __init__(self, config: BertConfig, **kwargs):
        super().__init__(**kwargs)
...
class TFBertIntermediate(keras.Layer):
    def __init__(self, config: BertConfig, **kwargs):
        super().__init__(**kwargs)
...
class TFBertOutput(keras.Layer):
    def __init__(self, config: BertConfig, **kwargs):
        super().__init__(**kwargs)
...
class TFBertEncoder(keras.Layer):
    def __init__(self, config: BertConfig, **kwargs):
        super().__init__(**kwargs)
        self.config = config
...
class TFBertPooler(keras.Layer):
    def __init__(self, config: BertConfig, **kwargs):
        super().__init__(**kwargs)
...
class TFBertPredictionHeadTransform(keras.Layer):
    def __init__(self, config: BertConfig, **kwargs):
        super().__init__(**kwargs)
...
class TFBertLMPredictionHead(keras.Layer):
    def __init__(self, config: BertConfig, input_embeddings: keras.Layer, **kwargs):
        super().__init__(**kwargs)
...
class TFBertMLMHead(keras.Layer):
    def __init__(self, config: BertConfig, input_embeddings: keras.Layer, **kwargs):
        super().__init__(**kwargs)
...
class TFBertNSPHead(keras.Layer):
    def __init__(self, config: BertConfig, **kwargs):
        super().__init__(**kwargs)
...
@keras_serializable
class TFBertMainLayer(keras.Layer):
...
class KerasBertPreTrainedModel(KerasPreTrainedModel):
    """
...
class KerasBertModel(KerasBertPreTrainedModel):
...
class KerasBertForPreTraining(KerasBertPreTrainedModel, TFBertPreTrainingLoss):
...
class KerasBertForMaskedLM(KerasBertPreTrainedModel, TFMaskedLanguageModelingLoss):
    # names with a '.' represents the authorized unexpected/missing layers when a TF model is loaded from a PT model
    _keys_to_ignore_on_load_unexpected = [
        r"pooler",
...
class KerasBertLMHeadModel(KerasBertPreTrainedModel, TFCausalLanguageModelingLoss):
    # names with a '.' represents the authorized unexpected/missing layers when a TF model is loaded from a PT model
    _keys_to_ignore_on_load_unexpected = [
        r"pooler",
        r"cls.seq_relationship",
...
class KerasBertForNextSentencePrediction(KerasBertPreTrainedModel, TFNextSentencePredictionLoss):
    # names with a '.' represents the authorized unexpected/missing layers when a TF model is loaded from a PT model
...
class KerasBertForSequenceClassification(KerasBertPreTrainedModel, TFSequenceClassificationLoss):
    # names with a '.' represents the authorized unexpected/missing layers when a TF model is loaded from a PT model
...
class KerasBertForMultipleChoice(KerasBertPreTrainedModel, TFMultipleChoiceLoss):
    # names with a '.' represents the authorized unexpected/missing layers when a TF model is loaded from a PT model
    _keys_to_ignore_on_load_unexpected = [r"mlm___cls", r"nsp___cls", r"cls.predictions", r"cls.seq_relationship"]
    _keys_to_ignore_on_load_missing = [r"dropout"]
...
class KerasBertForTokenClassification(KerasBertPreTrainedModel, TFTokenClassificationLoss):
    # names with a '.' represents the authorized unexpected/missing layers when a TF model is loaded from a PT model
    _keys_to_ignore_on_load_unexpected = [
        r"pooler",
        r"mlm___cls",
...
class KerasBertForQuestionAnswering(KerasBertPreTrainedModel, TFQuestionAnsweringLoss):
    # names with a '.' represents the authorized unexpected/missing layers when a TF model is loaded from a PT model
    _keys_to_ignore_on_load_unexpected = [
        r"pooler",
        r"mlm___cls",

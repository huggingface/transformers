...
"""Fast Image processor class for ConFiDeNet."""
...
class ConFiDeNetImageProcessorFast(BaseImageProcessorFast):
    ...
    # ConFiDeNet resizes image after rescaling and normalizing,
    ...
    # Copied from transformers.models.depth_pro.image_processing_depth_pro.ConFiDeNetImageProcessor.post_process_depth_estimation
...
__all__ = ["ConFiDeNetImageProcessorFast"]

...
class DepthProConfig(PretrainedConfig):
    ...
    Args:
        ...
        image_model_config (`Uniondict[str, Any], PretrainedConfig]`, *optional*):
        ...
        patch_model_config (`Uniondict[str, Any], PretrainedConfig]`, *optional*):
            The configuration of the patch encoder model, which is loaded using the [`AutoModel`] API.
            By default, Dinov2 model is used as backbone.
        fov_model_config (`Uniondict[str, Any], PretrainedConfig]`, *optional*):

...
####################################################
@keras_serializable
class TFT5PerformerMainLayer(tf.keras.layers.Layer):
...
####################################################
class TFT5PerformerPreTrainedModel(TFPreTrainedModel):
    """
...
class TFT5PerformerModel(TFT5PerformerPreTrainedModel):
    def __init__(self, config, *inputs, **kwargs):
        ...
        self.encoder = TFT5PerformerMainLayer(encoder_config, embed_tokens, name="encoder")

        decoder_config = copy.deepcopy(config)
        decoder_config.is_decoder = True
        self.decoder = TFT5PerformerMainLayer(decoder_config, embed_tokens, name="decoder")
...
class TFT5PerformerForConditionalGeneration(TFT5PerformerPreTrainedModel, TFCausalLanguageModelingLoss):
    def __init__(self, config, *inputs, **kwargs):
        super().__init__(config, *inputs, **kwargs)
...
class TFT5PerformerEncoderModel(TFT5PerformerPreTrainedModel):
    def __init__(self, config, *inputs, **kwargs):
        super().__init__(config, *inputs, **kwargs)
        self.shared = TFSharedEmbeddings(config.vocab_size, config.d_model, name="shared")

...
class Kimi26ImageProcessorKwargs(ImagesKwargs, total=False):
    r"""
...
@auto_docstring
class Kimi26ImageProcessor(TorchvisionBackend):
    do_resize = True
    ...
    merge_size = 2
    valid_kwargs = Kimi26ImageProcessorKwargs
    model_input_names = ["pixel_values", "image_grid_thw"]

    def __init__(self, **kwargs: Unpack[Kimi26ImageProcessorKwargs]):
    ...
    def preprocess(
        self,
        images: ImageInput,
        **kwargs: Unpack[Kimi26ImageProcessorKwargs],
    ) -> BatchFeature:

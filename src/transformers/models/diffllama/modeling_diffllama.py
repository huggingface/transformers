...
from ..llama.modeling_llama import LlamaRMSNorm, LlamaRotaryEmbedding, LlamaDecoderLayer, LlamaPreTrainedModel, LlamaModel
...
class DiffLlamaForCausalLM(DiffLlamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> model = DiffLlamaForCausalLM.from_pretrained("kajuma/DiffLlama-0.3B-handcut")

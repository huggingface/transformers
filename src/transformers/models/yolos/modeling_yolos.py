...
class YolosObjectDetectionOutput(ModelOutput):
    ...
    Args:
        ...
        last_hidden_state (`torch.Tensor` of shape `(batch_size, sequence_length, hidden_size)`, *optional*):
...
class YolosForObjectDetection(YolosPreTrainedModel):
    ...
    def forward(
        ...
        labels (`List[Dict]` of len `(batch_size,)`, *optional*):
            ...
            boxes in the image,)` and the boxes a `torch.Tensor` of shape `(number of bounding boxes in the image,
            4)`.

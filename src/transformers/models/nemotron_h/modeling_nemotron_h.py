...
def nemotron_h_mamba2_split_conv1d_scan_combined(
    zxbcdt: torch.Tensor,
...
def nemotron_h_mamba2_selective_state_update(
    state: torch.Tensor,
    hidden_states: torch.Tensor,
    dt: torch.Tensor,
    A: torch.Tensor,
...
def nemotron_h_mamba2_chunk_scan(
    hidden_states: torch.Tensor,
    dt: torch.Tensor,
    A: torch.Tensor,
    B: torch.Tensor,
...
@use_kernelized_func(
    [
        ...
        nemotron_h_mamba2_split_conv1d_scan_combined,
        nemotron_h_mamba2_selective_state_update,
        nemotron_h_mamba2_chunk_scan,
    ]
)
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.training and cache_params is None:
            fused_output = nemotron_h_mamba2_split_conv1d_scan_combined(
                projected_states,
        ...
        if use_precomputed_states and seq_len == 1:
            ...
            scan_output = nemotron_h_mamba2_selective_state_update(
                recurrent_state,
                hidden_states,
                dt,
                A,
        ...
        # Chunk form
            ...
            scan_result = nemotron_h_mamba2_chunk_scan(

...
class NemotronHConfig(PreTrainedConfig):
    ...
    def __post_init__(self, **kwargs):
        ...
        if "hybrid_override_pattern" in kwargs:
            ...
            self.layer_types = ["linear_attention_mamba2", "moe", "full_attention", "mlp"]
        else:
        ...
        if self.mtp_layers_block_type is None:
            ...
            self.mtp_layers_block_type = remap_legacy_layer_types(self.mtp_layers_block_type, "mamba2")
    ...
    def validate_layer_type(self):
        ...
        valid_types = {"full_attention", "linear_attention_mamba2", "moe", "mlp"}
    ...
    def _list_to_pattern(layers_list: list) -> str:
        ...
        reverse_mapping = {"linear_attention_mamba2": "M", "moe": "E", "full_attention": "*", "mlp": "-"}
    ...
    def _pattern_to_list(pattern: str) -> list:
        ...
        pattern_mapping = {"M": "linear_attention_mamba2", "E": "moe", "*": "full_attention", "-": "mlp"}

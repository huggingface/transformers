...
class NemotronHConfig(PretrainedConfig):
    ...
    Args:
            ...
            mamba_ssm_cache_dtype (`str`, *optional*, defaults to `"float32"`):
                Data type for Mamba SSM cache states. Set to "float32" for numerical stability.
            ...
            moe_latent_size (`int` or `None`, *optional*):
            ...
            mtp_layers_block_type (`List[str]`, *optional*, defaults to `['attention', 'moe']`):
                Explicit list of layer types for multi-token prediction layers when `num_nextn_predict_layers` > 0.
                Each element must be one of: "mamba", "attention", or "moe".
                If not provided, defaults to `["attention", "moe"]` for NemotronH-Super.

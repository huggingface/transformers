...
class CogViewConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers.CogViewModel`. It is used to
    instantiate an CogView model according to the specified arguments, defining the model architecture. Instantiating a
    configuration with the defaults will yield a similar configuration to that of the CogView
    `brand-new-bert-base-cased <https://huggingface.co/brand-new-bert-base-cased>`__ architecture.

    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if position_ids is None:
            ...
            is_legacy_batch_first = position_ids.shape[0] == inputs_embeds.shape[0] and position_ids.shape[1] in {
                num_xdrope_axes,
                num_xdrope_axes + 1,
            }
            is_channel_first = position_ids.shape[1] == inputs_embeds.shape[0] and position_ids.shape[0] in {
                num_xdrope_axes,
                num_xdrope_axes + 1,
            }
...
__all__ = ["HunYuanVLPreTrainedModel", "HunYuanVLModel", "HunYuanVLTextModel", "HunYuanVLForConditionalGeneration"]

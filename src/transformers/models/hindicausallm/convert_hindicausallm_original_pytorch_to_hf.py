...
def convert_hindicausallm_checkpoint(checkpoint_path, pytorch_dump_folder_path, config_path=None):
    ...
    if not os.path.isfile(config_path):
        ...
        if os.path.isfile(params_path):
            ...
            config_dict = {
                ...
                "num_key_value_heads": params.get("n_kv_heads", params.get("n_heads")),  # Handle GQA
    ...
    if os.path.isfile(tokenizer_model_path):
        ...
        if os.path.isfile(special_tokens_map_path):
            copyfile(special_tokens_map_path, os.path.join(pytorch_dump_folder_path, "special_tokens_map.json"))

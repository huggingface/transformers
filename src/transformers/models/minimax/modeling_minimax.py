...
class MiniMaxModel(MiniMaxPreTrainedModel):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`MiniMaxDecoderLayer`]
    ...
    @add_start_docstrings_to_model_forward(MINIMAX_INPUTS_DOCSTRING)
    def forward(
        self,
            ...
            if attention_mask is not None and past_key_values is not None:
                ...
                if is_padding_right:
                    raise ValueError(
                        ...
                        " this may lead to unexpected behaviour for Flash Attention version of MiniMax. Make sure to "
...
@add_start_docstrings(
    """
    The MiniMax Model transformer with a token classification head on top (a linear layer on top of the hidden-states
...
@add_start_docstrings(
    """
The MiniMax Model transformer with a span classification head on top for extractive question-answering tasks like

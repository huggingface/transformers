...
class BlipTextLMHeadModel(BlipTextPreTrainedModel):
    ...
    def forward(
        ...
        Returns:
        Example::
            >>> from transformers import BlipTextTokenizer, BlipTextLMHeadModel, BlipTextConfig
            >>> import torch
            >>> tokenizer = BlipTextTokenizer.from_pretrained('bert-base-cased')
            >>> config = BlipTextConfig.from_pretrained("bert-base-cased")
            >>> model = BlipTextLMHeadModel.from_pretrained('bert-base-cased', config=config)

...
_import_structure = {
    "configuration_crystalcoder": ["CRYSTALCODER_PRETRAINED_CONFIG_ARCHIVE_MAP", "CrystalCoderConfig"],
    "tokenization_crystalcoder": ["CrystalCoderTokenizerFast"],
}
...
try:
    ...
    _import_structure["tokenization_crystalcoder_fast"] = ["CrystalCoderTokenizerFast"]
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .tokenization_crystalcoder_fast import CrystalCoderTokenizerFast

...
@auto_docstring
class Glm46VModel(Glm46VPreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
class Glm46VForConditionalGeneration(Glm46VPreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

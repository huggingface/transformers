...
UNISPEECH_START_DOCSTRING = r"""
    UniSpeech was proposed in `UniSpeech: Unified Speech Representation Learning with Labeled and Unlabeled Data
...
@add_start_docstrings(
    """
    UniSpeech Model with a frame classification head on top for tasks like Speaker Diarization.
    """,
    UNISPEECH_START_DOCSTRING,
)
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForAudioFrameClassification with Wav2Vec2->UniSpeech, wav2vec2->unispeech, WAV_2_VEC_2->UNISPEECH
class UniSpeechForAudioFrameClassification(UniSpeechPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
@add_start_docstrings(
    """
    UniSpeech Model with an XVector feature extraction head on top for tasks like Speaker Verification.
    """,
    UNISPEECH_START_DOCSTRING,
)
# Copied from transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForXVector with Wav2Vec2->UniSpeech, wav2vec2->unispeech, WAV_2_VEC_2->UNISPEECH
class UniSpeechForXVector(UniSpeechPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

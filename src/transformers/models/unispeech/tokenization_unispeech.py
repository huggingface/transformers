...
"""Tokenization class for UniSpeech."""
...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "facebook/unispeech-base-960h": "https://huggingface.co/facebook/unispeech-base-960h/resolve/main/vocab.json",
    },
    "tokenizer_config_file": {
        "facebook/unispeech-base-960h": "https://huggingface.co/facebook/unispeech-base-960h/resolve/main/tokenizer_config.json",
    },
}

# UniSpeech has no max input length
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {"facebook/unispeech-base-960h": sys.maxsize}

UNISPEECH_KWARGS_DOCSTRING = r"""
...
class UniSpeechCTCTokenizer(PreTrainedTokenizer):

    """
    Constructs a UniSpeechCTC tokenizer.
    ...
    def _decode(
        ...
        """
        special _decode function is needed for UniSpeechTokenizer because added tokens should be treated exactly the
    ...
    def _add_tokens(self, new_tokens: Union[List[str], List[AddedToken]], special_tokens: bool = False) -> int:
        ...
        Examples::
            ...
            tokenizer = UniSpeechCTCTokenizer.from_pretrained('facebook/unispeech-base-960h')
            model = UniSpeechForCTC.from_pretrained('facebook/unispeech-base-960h')
...
class UniSpeechTokenizer(PreTrainedTokenizer):
    """
    Constructs a UniSpeech tokenizer.
    ...
    Args:
        ...
        do_normalize (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            improve the performance for some models, *e.g.*, `unispeech-lv60
            <https://huggingface.co/models?search=lv60>`__.
        return_attention_mask (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not :meth:`~transformers.UniSpeechTokenizer.__call__` should return :obj:`attention_mask`.

            .. note::

                UniSpeech models that have set ``config.feat_extract_norm == "group"``, such as `unispeech-base
                <https://huggingface.co/facebook/unispeech-base-960h>`__, have **not** been trained using
                ...
                For UniSpeech models that have set ``config.feat_extract_norm == "layer"``, such as `unispeech-lv60
                <https://huggingface.co/facebook/unispeech-large-960h-lv60-self>`__, :obj:`attention_mask` should be
    ...
    pretrained_vocab_files_map = {
        ...
        "tokenizer_config_file": {
            "facebook/unispeech-base-960h": "https://huggingface.co/facebook/unispeech-base-960h/resolve/main/tokenizer.json",
        },
    }
    ...
    def __init__(
        ...
        **kwargs
        ...
        warnings.warn(
            "The class `UniSpeechTokenizer` is deprecated and will be removed in version 5 of Transformers. Please use `UniSpeechProcessor` or `UniSpeechCTCTokenizer` instead.",
            FutureWarning,
        )
    ...
    @add_end_docstrings(UNISPEECH_KWARGS_DOCSTRING)
    def __call__(
        self,

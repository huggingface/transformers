...
class LukeTokenizer(PreTrainedTokenizer):
        ...
        **kwargs,
        ...
        Args:
            ...
            text_pair (`str`, list[str]`, list[List[str]]`):
                The sequence or batch of sequences to be encoded. Each sequence must be a string. Note that this
                tokenizer does not support tokenization based on pretokenized strings.
            entity_spans (`Listtuple[int, int]]`, list[Listtuple[int, int]]]`, *optional*):
            ...
            entity_spans_pair (`Listtuple[int, int]]`, list[Listtuple[int, int]]]`, *optional*):
                The sequence or batch of sequences of entity spans to be encoded. Each sequence consists of tuples each
    ...
    def prepare_for_model(
        ...
        **kwargs,
        ...
        Args:
            ...
            entity_token_spans (`Listtuple[int, int]]`, *optional*):
                Entity spans of the first sequence.
            pair_entity_token_spans (`Listtuple[int, int]]`, *optional*):
    ...
    def pad(
        ...
        Args:
            encoded_inputs ([`BatchEncoding`], list of [`BatchEncoding`], dict[str,list[int]]`, dict[str,list[List[int]]` or `Listdict[str,list[int]]]`):
                Tokenized inputs. Can represent one input ([`BatchEncoding`] or dict[str,list[int]]`) or a batch of
                tokenized inputs (list of [`BatchEncoding`], dict[str,list[List[int]]]* or *Listdict[str,

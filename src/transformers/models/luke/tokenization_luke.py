...
"""
# Copied from transformers.models.roberta.tokenization_roberta.lru_cache
@lru_cache()
...
class LukeTokenizer(PreTrainedTokenizer):
    ...
    # Copied from transformers.models.roberta.get_special_tokens_mask
    ...
    # Copied from transformers.models.roberta.create_token_type_ids_from_sequences
    ...
    # Copied from transformers.models.roberta.tokenization_roberta.prepare_for_tokenization
    ...
    # Copied from transformers.models.roberta.tokenization_roberta._tokenize
    ...
    # Copied from transformers.models.roberta.tokenization_roberta._convert_id_to_token
    def _convert_id_to_token(self, index):
        """Converts an index (integer) in a token (str) using the vocab."""
        return self.decoder.get(index)

    # Copied from transformers.models.roberta.tokenization_roberta.convert_tokens_to_string

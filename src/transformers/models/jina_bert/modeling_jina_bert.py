...
class JinaBertModel(JinaBertPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(JINA_BERT_INPUTS_DOCSTRING.format("batch_size, sequence_length"))
    @add_code_sample_docstrings(
...
class JinaBertForPreTraining(JinaBertPreTrainedModel):
    ...
    def forward(
        ...
        >>> tokenizer = AutoTokenizer.from_pretrained("google-jina_bert/jina_bert-base-uncased")
        >>> model = JinaBertForPreTraining.from_pretrained("google-jina_bert/jina_bert-base-uncased")
...
@add_start_docstrings(
    """JinaBert Model with a `language modeling` head on top for CLM fine-tuning.""", JINA_BERT_START_DOCSTRING
)
...
@add_start_docstrings("""JinaBert Model with a `language modeling` head on top.""", JINA_BERT_START_DOCSTRING)
...
class JinaBertForNextSentencePrediction(JinaBertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        >>> tokenizer = AutoTokenizer.from_pretrained("google-jina_bert/jina_bert-base-uncased")
        >>> model = JinaBertForNextSentencePrediction.from_pretrained("google-jina_bert/jina_bert-base-uncased")
...
class JinaBertForMultipleChoice(JinaBertPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(
        JINA_BERT_INPUTS_DOCSTRING.format("batch_size, num_choices, sequence_length")
    )
    @add_code_sample_docstrings(
        checkpoint=_CHECKPOINT_FOR_DOC,

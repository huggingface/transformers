...
"""VibeVoice model implementation - supports both 1.5B and Realtime 0.5B variants."""
...
class VibeVoiceAcousticCodecConfig(PreTrainedConfig):
    r"""
    Configuration class for the VibeVoice Acoustic Tokenizer (σ-VAE).
...
class VibeVoiceAcousticEncoder(nn.Module):
    """Encoder for the acoustic tokenizer (σ-VAE).
...
class VibeVoiceAcousticDecoder(nn.Module):
    """Decoder for the acoustic tokenizer (σ-VAE).
...
class VibeVoiceAcousticCodec(PreTrainedModel):
    """
    VibeVoice Acoustic Tokenizer (σ-VAE).

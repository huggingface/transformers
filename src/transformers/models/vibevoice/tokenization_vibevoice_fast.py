...
class VibeVoiceTokenizerFast(PreTrainedTokenizerFast):
    """
    ...
    ```python
    >>> from transformers import VibeVoiceTokenizerFast

    >>> tokenizer = VibeVoiceTokenizerFast.from_pretrained("Qwen/Qwen-tokenizer")

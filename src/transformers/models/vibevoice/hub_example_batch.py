...
conversations = [
    ...
    [
        ...
        {"role": "3", "content": [
            ...
            {"type": "audio", "path": load_audio_librosa("https://hf.co/datasets/bezzam/vibevoice_samples/resolve/main/voices/en-Maya_woman.wav", sampling_rate=sampling_rate)}
        ]},
    ],
]
...
# Save audio
for i, speech_output in enumerate(outputs.speech_outputs):
    output_fp = f"vibevoice_output_{i}.wav"
    processor.save_audio(speech_output, output_fp)

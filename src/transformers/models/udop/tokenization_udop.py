...
class UdopTokenizer(PreTrainedTokenizer):
    ...
    def batch_encode_plus_boxes(
        ...
        **kwargs,
        ...
        Args:
            batch_text_or_text_pairs (list[str]`, `Listtuple[str, str]]`, list[List[str]]`, `Listtuplelist[str],list[str]]]`, and for not-fast tokenizers, also list[List[int]]`, `Listtuplelist[int],list[int]]]`):

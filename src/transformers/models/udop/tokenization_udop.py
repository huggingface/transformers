# coding=utf-8
# Copyright 2023 UDOP Authors and HuggingFace Inc. team.
#
...
class UdopTokenizer(PreTrainedTokenizer):
    """
    Construct a UDOP tokenizer. Identical to the T5 tokenizer, with some additional special visual tokens like
    <loc_{}>, etc.

    The tokenization algorithm itself is based on [SentencePiece](https://github.com/google/sentencepiece).

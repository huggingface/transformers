...
@auto_docstring
class Qwen3_5MoeModel(Qwen3_5MoePreTrainedModel, MultiModalPreTrainedModelMixin):
    base_model_prefix = "model"
...
class Qwen3_5MoeForConditionalGeneration(Qwen3_5MoePreTrainedModel, MultiModalGenerationMixin, GenerationMixin):

...
class ZagrosNextConfig(PretrainedConfig):
    ...
    Args:
        ...
        mlp_only_layers (`list[int]`, *optional*, defaults to `[]`):
            Indicate which layers use ZagrosNextMLP rather than ZagrosNextSparseMoeBlock
    ...
    ```python
    >>> from transformers import ZagrosNextModel, ZagrosNextConfig

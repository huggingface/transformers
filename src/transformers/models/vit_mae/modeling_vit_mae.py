...
class ViTMAEEmbeddings(nn.Module):
    ...
    def initialize_weights(self):
        ...
        nn.init.copy_(self.position_embeddings, torch.from_numpy(pos_embed).float().unsqueeze(0))
...
class ViTMAEPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, (nn.Linear, nn.Conv2d)):
            ...
            nn.init.zeros_(module.decoder_pos_embed)
...
class ViTMAEDecoder(nn.Module):
    ...
    def initialize_weights(self, num_patches):
        ...
        nn.init.copy_(self.decoder_pos_embed, torch.from_numpy(decoder_pos_embed).float().unsqueeze(0))

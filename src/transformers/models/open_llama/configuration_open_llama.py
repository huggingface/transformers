...
class OpenLlamaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.use_memory_efficient_attention = kwargs['use_memorry_efficient_attention'] if 'use_memorry_efficient_attention' in kwargs else use_memory_efficient_attention

...
# List of model weight URLs to download and upload. Add or remove entries as needed.
urls = [
    # # W2V
    "https://dl.fbaipublicfiles.com/mms/omniASR-W2V-300M.pt",
    # "https://dl.fbaipublicfiles.com/mms/omniASR-W2V-1B.pt",
    # "https://dl.fbaipublicfiles.com/mms/omniASR-W2V-3B.pt",
    # "https://dl.fbaipublicfiles.com/mms/omniASR-W2V-7B.pt",
    # C2C
    "https://dl.fbaipublicfiles.com/mms/omniASR-CTC-300M.pt",
    # "https://dl.fbaipublicfiles.com/mms/omniASR-CTC-1B.pt",
    # "https://dl.fbaipublicfiles.com/mms/omniASR-CTC-3B.pt",
    # "https://dl.fbaipublicfiles.com/mms/omniASR-CTC-7B.pt",
    # # LLM
    # "https://dl.fbaipublicfiles.com/mms/omniASR-LLM-300M.pt",
    # "https://dl.fbaipublicfiles.com/mms/omniASR-LLM-1B.pt",
    # "https://dl.fbaipublicfiles.com/mms/omniASR-LLM-3B.pt",
    # "https://dl.fbaipublicfiles.com/mms/omniASR-LLM-7B.pt",
    # "https://dl.fbaipublicfiles.com/mms/omniASR-LLM-7B-ZS.pt"
]

# Create HfApi once and reuse
api = HfApi()
...
for url in urls:
    ...
    # ---  Clean up the local files for this iteration ---
    try:
        os.remove(output)
    except OSError:
        pass

...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitModelOutputWithPooling with Beit->Data2VecVision
class FlaxData2VecVisionModelOutputWithPooling(FlaxBaseModelOutputWithPooling):
    """
    Class for outputs of [`FlaxData2VecVisionModel`].
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitDropPath with Beit->Data2VecVision
class FlaxData2VecVisionDropPath(nn.Module):
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitPatchEmbeddings with Beit->Data2VecVision
class FlaxData2VecVisionPatchEmbeddings(nn.Module):
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitEmbeddings with Beit->Data2VecVision
class FlaxData2VecVisionEmbeddings(nn.Module):
    ...
    def setup(self):
        ...
        self.patch_embeddings = FlaxData2VecVisionPatchEmbeddings(self.config, dtype=self.dtype)
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitRelativePositionBias with Beit->Data2VecVision
class FlaxData2VecVisionRelativePositionBias(nn.Module):
    config: Data2VecVisionConfig
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitSelfAttention with Beit->Data2VecVision
class FlaxData2VecVisionSelfAttention(nn.Module):
    config: Data2VecVisionConfig
    window_size: Tuple[int, int]
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
    ...
    def setup(self):
        ...
        self.relative_position_bias = (
            FlaxData2VecVisionRelativePositionBias(self.config, window_size=self.window_size, dtype=self.dtype)
            if self.window_size
            else None
        )
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitSelfOutput with Beit->Data2VecVision
class FlaxData2VecVisionSelfOutput(nn.Module):
    config: Data2VecVisionConfig
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitAttention with Beit->Data2VecVision
class FlaxData2VecVisionAttention(nn.Module):
    config: Data2VecVisionConfig
    window_size: Tuple[int, int]
    dtype: jnp.dtype = jnp.float32

    def setup(self):
        self.attention = FlaxData2VecVisionSelfAttention(self.config, self.window_size, dtype=self.dtype)
        self.output = FlaxData2VecVisionSelfOutput(self.config, dtype=self.dtype)
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitIntermediate with Beit->Data2VecVision
class FlaxData2VecVisionIntermediate(nn.Module):
    config: Data2VecVisionConfig
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitOutput with Beit->Data2VecVision
class FlaxData2VecVisionOutput(nn.Module):
    config: Data2VecVisionConfig
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitLayer with Beit->Data2VecVision,BEiT->Data2VecVision
class FlaxData2VecVisionLayer(nn.Module):
    config: Data2VecVisionConfig
    window_size: Tuple[int, int]
    ...
    def setup(self):
        self.attention = FlaxData2VecVisionAttention(self.config, self.window_size, dtype=self.dtype)
        self.intermediate = FlaxData2VecVisionIntermediate(self.config, dtype=self.dtype)
        self.output = FlaxData2VecVisionOutput(self.config, dtype=self.dtype)
        self.layernorm_before = nn.LayerNorm(epsilon=self.config.layer_norm_eps, dtype=self.dtype)
        self.drop_path = FlaxData2VecVisionDropPath(rate=self.drop_path_rate)
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitLayerCollection with Beit->Data2VecVision
class FlaxData2VecVisionLayerCollection(nn.Module):
    config: Data2VecVisionConfig
    window_size: Tuple[int, int]
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitEncoder with Beit->Data2VecVision
class FlaxData2VecVisionEncoder(nn.Module):
    config: Data2VecVisionConfig
    window_size: Tuple[int, int]
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
    ...
    def setup(self):
        if self.config.use_shared_relative_position_bias:
            self.relative_position_bias = FlaxData2VecVisionRelativePositionBias(
        ...
        self.layer = FlaxData2VecVisionLayerCollection(
            self.config,
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitPreTrainedModel with BEIT->DATA2VEC_VISION,Beit->Data2VecVision,beit->data2vec_vision
class FlaxData2VecVisionPreTrainedModel(FlaxPreTrainedModel):
    """
    ...
    @add_start_docstrings_to_model_forward(DATA2VEC_VISION_INPUTS_DOCSTRING.format("batch_size, sequence_length"))
    def __call__(
        self,
        pixel_values,
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitPooler with Beit->Data2VecVision
class FlaxData2VecVisionPooler(nn.Module):
    config: Data2VecVisionConfig
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitModule with Beit->Data2VecVision
class FlaxData2VecVisionModule(nn.Module):
    config: Data2VecVisionConfig
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation
    add_pooling_layer: bool = True

    def setup(self):
        self.embeddings = FlaxData2VecVisionEmbeddings(self.config, dtype=self.dtype)
        self.encoder = FlaxData2VecVisionEncoder(
            self.config, window_size=self.embeddings.patch_embeddings.patch_shape, dtype=self.dtype
        )
        if not self.config.use_mean_pooling:
            self.layernorm = nn.LayerNorm(epsilon=self.config.layer_norm_eps, dtype=self.dtype)
        self.pooler = FlaxData2VecVisionPooler(self.config, dtype=self.dtype) if self.add_pooling_layer else None
    ...
    def __call__(
        ...
        return FlaxData2VecVisionModelOutputWithPooling(
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitModel with Beit->Data2VecVision
class FlaxData2VecVisionModel(FlaxData2VecVisionPreTrainedModel):
    module_class = FlaxData2VecVisionModule


FLAX_DATA2VEC_VISION_MODEL_DOCSTRING = """
    Returns:

    Examples:

    ```python
    >>> from transformers import BeitFeatureExtractor, FlaxData2VecVisionModel
    ...
    >>> feature_extractor = BeitFeatureExtractor.from_pretrained("facebook/data2vec-vision-base-ft-ft22k")
    >>> model = FlaxData2VecVisionModel.from_pretrained("facebook/data2vec-vision-base-ft-ft22k")
...
class FlaxData2VecVisionForMaskedImageModelingModule(nn.Module):
    config: Data2VecVisionConfig
    dtype: jnp.dtype = jnp.float32  # the dtype of the computation

    def setup(self):
        self.data2vec_vision = FlaxData2VecVisionModule(self.config, add_pooling_layer=False, dtype=self.dtype)
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitForMaskedImageModeling with Beit->Data2VecVision
class FlaxData2VecVisionForMaskedImageModeling(FlaxData2VecVisionPreTrainedModel):
    module_class = FlaxData2VecVisionForMaskedImageModelingModule


FLAX_DATA2VEC_VISION_MLM_DOCSTRING = """
...
overwrite_call_docstring(FlaxData2VecVisionForMaskedImageModeling, FLAX_DATA2VEC_VISION_MLM_DOCSTRING)
append_replace_return_docstrings(
    FlaxData2VecVisionForMaskedImageModeling, output_type=FlaxMaskedLMOutput, config_class=Data2VecVisionConfig
)


# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitForImageClassificationModule with Beit->Data2VecVision,beit->data2vec_vision
class FlaxData2VecVisionForImageClassificationModule(nn.Module):
    config: Data2VecVisionConfig
    dtype: jnp.dtype = jnp.float32

    def setup(self):
        self.data2vec_vision = FlaxData2VecVisionModule(config=self.config, dtype=self.dtype, add_pooling_layer=True)
...
# Copied from transformers.models.beit.modeling_flax_beit.FlaxBeitForImageClassification with Beit->Data2VecVision
class FlaxData2VecVisionForImageClassification(FlaxData2VecVisionPreTrainedModel):
    module_class = FlaxData2VecVisionForImageClassificationModule


FLAX_DATA2VEC_VISION_CLASSIF_DOCSTRING = """
    Returns:

    Example:

    ```python
    >>> from transformers import BeitFeatureExtractor, FlaxData2VecVisionForImageClassification
    >>> from PIL import Image
    >>> import requests
    ...
    >>> feature_extractor = BeitFeatureExtractor.from_pretrained("microsoft/data2vec_vision-base-patch16-224")
    >>> model = FlaxData2VecVisionForImageClassification.from_pretrained("microsoft/data2vec_vision-base-patch16-224")

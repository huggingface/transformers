...
class GlmMoeDsaIndexer(nn.Module):
    ...
    **Cache strategy**: The Indexer manages its own key cache (`_cached_keys`) separately
    ...
    def forward(
        ...
        q = q.view(input_shape[0], input_shape[1], self.n_heads, self.head_dim)  # [B, S, H, D]
    ...
    **FP8 compatibility**: all weight accesses use standard nn.Linear forward calls (never
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        kv_expanded = kv_expanded.view(input_shape[0], input_shape[1], -1, self.qk_nope_head_dim + self.v_head_dim)
        ...
        k_pe = k_pe.view(input_shape[0], 1, input_shape[1], self.qk_rope_head_dim)  # [B, 1, S, rope_D]

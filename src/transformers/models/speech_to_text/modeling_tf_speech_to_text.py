...
class TFSpeech2TextMainLayer(layers.Layer):
    ...
    def __init__(self, config: Speech2TextConfig, load_weight_prefix=None, **kwargs):
        ...
        self.shared = TFSharedEmbeddings(
            config.vocab_size, config.d_model, config.pad_token_id, name="model.decoder.embed_tokens"
        )
        ...
        self.decoder = TFSpeech2TextDecoder(config, embed_tokens, name="decoder")

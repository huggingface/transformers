...
class LwDetrFastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
    r"""
...
# inspired by https://github.com/facebookresearch/lw_detr/blob/master/datasets/coco.py#L33
...
# inspired by https://github.com/facebookresearch/lw_detr/blob/master/datasets/coco.py#L50
def prepare_coco_detection_annotation(
    ...
    """
    Convert the target in COCO format into the format expected by LW_DETR.
    """
...
def prepare_coco_panoptic_annotation(
    ...
    """
    Prepare a coco panoptic annotation for LW_DETR.
    """
...
class LwDetrImageProcessorFast(BaseImageProcessorFast):
    ...
    def from_dict(cls, image_processor_dict: dict[str, Any], **kwargs):
        ...
        created using from_dict and kwargs e.g. `LwDetrImageProcessorFast.from_pretrained(checkpoint, size=600,
        max_size=800)`
        """
    ...
    def prepare_annotation(
        ...
        """
        Prepare an annotation for feeding into LW_DETR model.
        """
    ...
    def preprocess(
        ...
        masks_path: Optional[Union[str, pathlib.Path]] = None,
        **kwargs: Unpack[LwDetrFastImageProcessorKwargs],
    ) -> BatchFeature:
        r"""
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        for image, annotation in zip(images, annotations if annotations is not None else [None] * len(images)):
            # prepare (COCO annotations as a list of Dict -> LW_DETR target as a single Dict per image)
            if annotations is not None:
...
__all__ = ["LwDetrImageProcessorFast"]

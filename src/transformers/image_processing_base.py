...
class ImageProcessingMixin(PreprocessingMixin):
    ...
    def get_config_dict(
        ...
        # Subclasses such as `TimmWrapperImageProcessor` override `get_image_processor_dict`.
        return cls.get_image_processor_dict(pretrained_model_name_or_path, **kwargs)

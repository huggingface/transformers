...
from .utils import get_torch_device_module
...
class OffloadingManager:
    ...
    def __init__(
        ...
        self.device_module = get_torch_device_module(cache.device) if cache.device.type in ("cuda", "xpu") else None
    ...
    def _stream_ctx(self):
        ...
        return self.device_module.stream(self._compute_stream) if self._compute_stream is not None else nullcontext()

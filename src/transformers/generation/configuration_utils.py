...
class GenerationConfig(PushToHubMixin):
    ...
    Arg:
        ...
        max_assistant_tokens (`int`, *optional*, defaults to 5):
            ...
            checked by the target model at each iteration. Higher values for `max_assistant_tokens` make the generation
        ...
        max_assistant_tokens_schedule (`str`, *optional*, defaults to `"heuristic"`):
            ...
            - `"_heuristic_`: When all _speculative_ tokens are correct, increase `max_assistant_tokens` by 2 else
              reduce by 1

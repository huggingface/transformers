...
class GenerationConfig(PushToHubMixin):
    ...
    Arg:
        ...
        stop_strings (`str orlist[str]`, *optional*):
        ...
        force_words_ids (list[List[int]]` or list[Listlist[int]]]`, *optional*):
            List of token ids that must be generated. If given a list[List[int]]`, this is treated as a simple list of
            words that must be included, the opposite to `bad_words_ids`. If given list[Listlist[int]]]`, this
        ...
        forced_bos_token_id (`int`, *optional*, defaults to `model.config.forced_bos_token_id`):
            ...
            language token.
        forced_eos_token_id (`int` orlist[int]`, *optional*, defaults to `model.config.forced_eos_token_id`):
        ...
        sequence_bias (dicttuple[int], float]`, *optional*)):

...
class AssistedCandidateGenerator(CandidateGenerator):
    ...
    def update_candidate_strategy(self, input_ids: torch.LongTensor, scores: torch.FloatTensor, num_matches: int):
        ...
        if self.assistant_model.generation_config.num_assistant_tokens_schedule == "heuristic" or \
            self.assistant_model.generation_config.num_assistant_tokens_schedule == "heuristic_transient":

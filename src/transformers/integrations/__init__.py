...
_import_structure = {
    ...
    "compressed_tensors_fp8": ["CompressedTensorsFP8Linear", "replace_with_compressed_tensors_fp8_linear"],
    "deepspeed": [
        "HfDeepSpeedConfig",
...
if TYPE_CHECKING:
    ...
    from .compressed_tensors_fp8 import CompressedTensorsFP8Linear, replace_with_compressed_tensors_fp8_linear

...
_import_structure = {
    ...
    "finegrained_fp8": ["FP8Linear", "replace_with_fp8_linear", "add_fp8_qat_hook", "remove_fp8_qat_hook"],
...
if TYPE_CHECKING:
    ...
    from .finegrained_fp8 import FP8Linear, replace_with_fp8_linear, add_fp8_qat_hook, remove_fp8_qat_hook

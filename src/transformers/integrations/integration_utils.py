...
class TrackioCallback(TrainerCallback):
    ...
    **Requires**:
    ...
    def _point_model_card_at_static_space(self, model, gradio_space_id: str, static_space_id: str) -> None:
        """Update model tags and the autogenerated model card link to prefer the frozen static Space."""
    ...
    def on_train_end(self, args: TrainingArguments, state, control, model=None, processing_class=None, **kwargs):
        ...
        if args.trackio_static_space_id is False or args.trackio_space_id is None:
            return

...
from ..models.llama.modeling_llama import LlamaRMSNorm, LlamaMLP
from ..models.qwen2.modeling_qwen2 import Qwen2RMSNorm, Qwen2MLP
...
from ..models.qwen2_moe.modeling_qwen2_moe import Qwen2MoeRMSNorm, Qwen2MoeMLP
...
from ..models.qwen3.modeling_qwen3 import Qwen3RMSNorm, Qwen3MLP
from ..models.qwen3_moe.modeling_qwen3_moe import Qwen3MoeRMSNorm, Qwen3MoeMLP
...
def silu_forward(self, hidden_state):
    ...
    return self.down_proj(
        torch_npu.npu_swiglu(torch.cat((self.gate_proj(hidden_state), 
        self.up_proj(hidden_state)), dim=-1), dim=-1)
    )

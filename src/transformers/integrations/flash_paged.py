...
def paged_attention_forward(
    ...
    **kwargs,
    ...
    # Otherwise, use flash_attn_with_kvcache which updates the cache in-place and computes attention
        ...
        # TODO: restore the commented decode fast path below once it is adapted to the sector-based cache
        raise NotImplementedError(
            "The decode fast path (flash_attn_with_kvcache + block table) is temporarily disabled with the "
            "sector-based cache rework."
        )

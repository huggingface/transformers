...
def convert_roberta_checkpoint_to_pytorch(roberta_checkpoint_path, pytorch_dump_folder_path, classification_head):
    ...
    emb.word_embeddings.weight = roberta_sent_encoder.embed_tokens.weight
    emb.position_embeddings.weight = roberta_sent_encoder.embed_positions.weight
    emb.token_type_embeddings.weight.data = torch.zeros_like(
        emb.token_type_embeddings.weight
    )  # just zero them out b/c RoBERTa doesn't use them.
    emb.LayerNorm.weight = roberta_sent_encoder.emb_layer_norm.weight
    emb.LayerNorm.bias = roberta_sent_encoder.emb_layer_norm.bias

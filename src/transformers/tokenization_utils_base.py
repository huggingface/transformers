...
class BatchEncoding(UserDict):
    ...
    def encodings(self) -> Optional[list[EncodingFast]]:
        """
        `Optionallist[tokenizers.Encoding]]`: The list all encodings from the tokenization process. Returns `None` if
...
class PreTrainedTokenizerBase(SpecialTokensMixin, PushToHubMixin):
    ...
    def apply_chat_template(
        ...
        **kwargs,
        ...
        Args:
            conversation (Union[Listdict[str, str]],list[Listdict[str, str]]]]): A list of dicts
            ...
            documents (`Listdict[str, str]]`, *optional*):
        ...
        Returns:
            `Unionlist[int], Dict]`: A list of token ids representing the tokenized chat so far, including control tokens. This

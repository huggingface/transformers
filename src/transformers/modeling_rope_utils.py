...
class RopeParameters(TypedDict, total=False):
    ...
    Args:
        ...
        rope_type (`str`):
            ...
            'llama3'], with 'default' being the original RoPE implementation. This value will default to "default" if
            not constructed by `standardize_rope_params()` from a legacy config without a `rope_parameters` or

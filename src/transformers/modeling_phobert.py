...
class PhobertModel(RobertaModel):
    """
...
class PhobertForSequenceClassification(RobertaForSequenceClassification):
    """
...
class PhobertForMultipleChoice(RobertaForMultipleChoice):
    """
...
class PhobertForTokenClassification(RobertaForTokenClassification):
    """
...
class PhobertForQuestionAnswering(RobertaForQuestionAnswering):
    """

...
class FlaxAutoModel(object):
    ...
    def from_config(cls, config):
        ...
        Args:
            config (:class:`~transformers.PretrainedConfig`):
                ...
                - isInstance of `bert` configuration class: :class:`~transformers.FlaxBertModel` (Bert model) Examples:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        `pretrained_model_name_or_path` string (in the following order): - contains `roberta`:
        :class:`~transformers.FlaxRobertaModel` (RoBERTa model) - contains `bert`: :class:`~transformers.FlaxBertModel`
        (Bert model)

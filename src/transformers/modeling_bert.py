...
class BertForPreTraining(BertPreTrainedModel):
    ...
    def forward(
        ...
        r"""
        masked_labels (``torch.LongTensor`` of shape ``(batch_size, sequence_length)``, `optional`, defaults to :obj:`None`):
...
class BertForMaskedLM(BertPreTrainedModel):
    ...
    Returns:
        ...
        # 2. If `labels` is provided we are in a causal scenario where we

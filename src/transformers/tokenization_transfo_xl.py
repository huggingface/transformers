...
def tokenize_numbers(text_array: List[str]) -> List[str]:
    ...
    dots with ' @.@ '. Args: text_array: An already tokenized text as list Returns: A list of strings with tokenized
    numbers Example:: >>> tokenize_numbers(["$", "5,000", "1.73", "m"]) ["$", "5", "@,@", "000", "1", "@.@", "73", "m"]
    """
    tokenized = []
...
def detokenize_numbers(text: str) -> str:
    """
    Inverts the operation of `tokenize_numbers`. This is replacing ' @,@ ' and ' @.@' by ',' and '.'. Args: text: A
    string where the number should be detokenized Returns: A detokenized string Example:: >>> detokenize_numbers("$ 5
    @,@ 000 1 @.@ 73 m") "$ 5,000 1.73 m"
    """
...
class TransfoXLTokenizer(PreTrainedTokenizer):
    ...
    def moses_pipeline(self, text: str) -> List[str]:
        ...
        @,@ 000 people are 1 @.@ 80m tall". Args: text: Text to be tokenized Returns: A list of tokenized strings
        Example:: >>> tokenizer = TransfoXLTokenizer.from_pretrained("transfo-xl-wt103") >>>
        tokenizer.moses_pipeline("23,000 people are 1.80 m tall") ['23', '@,@', '000', 'people', 'are', '1', '@.@',
        '80', 'm', 'tall']
        """

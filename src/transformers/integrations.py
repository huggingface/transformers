    ...
    def setup(self, args, state, model):
        ...
        Environment:
            HF_MLFLOW_LOG_ARTIFACTS (:obj:`str`, `optional`):
                ...
                whatever is in :class:`~transformers.TrainingArguments`'s output_dir to the local or remote artifact
                storage. Using it without a remote storage will just copy the files to your artifact location.
        """

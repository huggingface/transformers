...
from .utils import is_flash_attn_2_available, is_flash_attn_greater_or_equal, is_torch_npu_available, logging
...
# patch functions in package `flash-attn` when using FlashAttention2 on Ascend NPU.

...
# TODO Deprecate when all have models have the attention interface
    ...
    **kwargs,
    ...
    # Padding free, i.e. sequences flattened into one total sequence
        ...
        if cu_seq_lens_q is None or cu_seq_lens_k is None:
            q, k, v, indices_q, (cu_seq_lens_q, cu_seq_lens_k), (max_length_q, max_length_k) = _prepare_from_posids(

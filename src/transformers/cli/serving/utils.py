...
class GenerateManager(BaseGenerateManager):
    ...
    def generate_streaming(
        ...
        streamer = DirectStreamer(processor._tokenizer, loop, queue, skip_special_tokens=True)  # type: ignore[union-attr]
...
class CBGenerateManager(BaseGenerateManager):
    ...
    def generate_streaming(
        ...
        streamer = CBStreamer(cb, request_id, processor._tokenizer, loop, text_queue)  # type: ignore[union-attr]

...
class TFPreTrainedModel(tf.keras.Model, TFModelUtilsMixin, TFGenerationMixin, PushToHubMixin):
    ...
    def train_step(self, data):
        ...
        additional loss function that reduces a `loss` output, and the model will output a `loss` component (notice 
        the name matching) containing the loss that was used to train the pre-trained model.
        """

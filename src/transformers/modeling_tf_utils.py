...
class TFPreTrainedModel(tf.keras.Model, TFModelUtilsMixin, TFGenerationMixin):
    ...
    Class attributes (overridden by derived classes):
        ...
        - **_keys_to_ignore_on_load_missing** (:obj:`List[str]`, `optional`) -- A list of re pattern of tensor names to ignore
          from the model when loading the model weights (and avoid unnecessary warnings).
        - **_keys_to_ignore_on_load_unexpected** (:obj:`List[str]`, `optional`) -- A list of re pattern of tensor names to

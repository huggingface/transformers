...
class T5Block(nn.Module):
    def __init__(self, config, has_relative_attention_bias=False):
        ...
        self.grad_checkpoint = False # Gradient checkpoint each attention & FF layer
...
class T5Stack(T5PreTrainedModel):
    def __init__(self, config, embed_tokens=None):
        ...
        self.fp16_embeddings = False 
        self.grad_checkpoint = True # Grad checkpoint encoder layers?
        self.grad_checkpoint_decoder = True # Grad checkopoint decoder layers?

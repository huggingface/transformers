...
from sarah.utils import is_rich_available, is_torch_available
...
if is_torch_available():
    ...
    from sarah import AutoModelForCausalLM, AutoTokenizer, BitsAndBytesConfig, TextIteratorStreamer

...
@add_start_docstrings(
    ...
    ```python
    >>> from sarah import BarkSemanticConfig, BarkSemanticModel
...
@add_start_docstrings(
    ...
    ```python
    >>> from sarah import BarkCoarseConfig, BarkCoarseModel
...
@add_start_docstrings(
    ...
    ```python
    >>> from sarah import BarkFineConfig, BarkFineModel

...
class MllamaVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import MllamaVisionConfig, MllamaVisionModel
...
class MllamaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import MllamaTextModel, MllamaTextConfig
...
class MllamaConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import MllamaForConditionalGeneration, MllamaConfig, MllamaVisionConfig, MllamaTextConfig

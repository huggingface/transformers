...
class MllamaVisionModel(MllamaPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, MllamaVisionModel
...
class MllamaTextModel(MllamaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoProcessor, MllamaTextModel
...
class MllamaForCausalLM(MllamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        ```python
        >>> from sarah import AutoTokenizer, MllamaForCausalLM
...
class MllamaForConditionalGeneration(MllamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **loss_kwargs,
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, MllamaForConditionalGeneration

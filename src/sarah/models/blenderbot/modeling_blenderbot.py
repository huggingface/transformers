...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from sarah import AutoTokenizer, BlenderbotForConditionalGeneration
...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, BlenderbotModel
...
class BlenderbotForCausalLM(BlenderbotPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, BlenderbotForCausalLM

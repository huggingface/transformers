...
class LayoutLMModel(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, LayoutLMModel
        >>> import torch
...
class LayoutLMForMaskedLM(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, LayoutLMForMaskedLM
        >>> import torch
...
class LayoutLMForSequenceClassification(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, LayoutLMForSequenceClassification
        >>> import torch
...
class LayoutLMForTokenClassification(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, LayoutLMForTokenClassification
        >>> import torch
...
class LayoutLMForQuestionAnswering(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, LayoutLMForQuestionAnswering

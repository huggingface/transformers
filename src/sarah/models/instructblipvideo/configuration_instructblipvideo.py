...
class InstructBlipVideoVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import InstructBlipVideoVisionConfig, InstructBlipVideoVisionModel
...
class InstructBlipVideoQFormerConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import InstructBlipVideoQFormerConfig, InstructBlipVideoQFormerModel

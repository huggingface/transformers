...
class LayoutLMv2Model(LayoutLMv2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoProcessor, LayoutLMv2Model, set_seed
...
class LayoutLMv2ForSequenceClassification(LayoutLMv2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoProcessor, LayoutLMv2ForSequenceClassification, set_seed
        >>> from PIL import Image
        >>> import torch
        >>> from datasets import load_dataset
...
class LayoutLMv2ForTokenClassification(LayoutLMv2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoProcessor, LayoutLMv2ForTokenClassification, set_seed
        >>> from PIL import Image
        >>> from datasets import load_dataset
...
class LayoutLMv2ForQuestionAnswering(LayoutLMv2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoProcessor, LayoutLMv2ForQuestionAnswering, set_seed
        >>> import torch
        >>> from PIL import Image
        >>> from datasets import load_dataset

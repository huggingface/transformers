...
MVP_CONDITIONAL_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from sarah import AutoTokenizer, MvpForConditionalGeneration
...
MVP_SEQUENCE_CLASSIFICATION_SAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from sarah import AutoTokenizer, MvpForSequenceClassification
...
MVP_QUESTION_ANSWERING_SAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from sarah import AutoTokenizer, MvpForQuestionAnswering
...
class MvpForCausalLM(MvpPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, MvpForCausalLM

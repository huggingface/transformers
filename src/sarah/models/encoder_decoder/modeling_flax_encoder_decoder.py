...
class FlaxEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from sarah import FlaxEncoderDecoderModel, BertTokenizer
    ...
    def __call__(
        ...
        ```python
        >>> from sarah import FlaxEncoderDecoderModel, BertTokenizer, GPT2Tokenizer
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import FlaxEncoderDecoderModel

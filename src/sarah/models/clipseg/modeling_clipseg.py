...
class CLIPSegTextModel(CLIPSegPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, CLIPSegTextModel
...
class CLIPSegVisionModel(CLIPSegPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, CLIPSegVisionModel
...
class CLIPSegModel(CLIPSegPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import AutoTokenizer, CLIPSegModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, CLIPSegModel
...
class CLIPSegForImageSegmentation(CLIPSegPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoProcessor, CLIPSegForImageSegmentation
        >>> from PIL import Image
        >>> import requests

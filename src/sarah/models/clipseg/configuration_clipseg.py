...
class CLIPSegTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import CLIPSegTextConfig, CLIPSegTextModel
...
class CLIPSegVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import CLIPSegVisionConfig, CLIPSegVisionModel
...
class CLIPSegConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import CLIPSegConfig, CLIPSegModel

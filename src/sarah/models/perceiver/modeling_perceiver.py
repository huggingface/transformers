...
class PerceiverModel(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import PerceiverConfig, PerceiverTokenizer, PerceiverImageProcessor, PerceiverModel
        >>> from sarah.models.perceiver.modeling_perceiver import (
...
class PerceiverForMaskedLM(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, PerceiverForMaskedLM
        >>> import torch
...
class PerceiverForSequenceClassification(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, PerceiverForSequenceClassification
...
class PerceiverForImageClassificationLearned(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoImageProcessor, PerceiverForImageClassificationLearned
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationFourier(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoImageProcessor, PerceiverForImageClassificationFourier
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForImageClassificationConvProcessing(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoImageProcessor, PerceiverForImageClassificationConvProcessing
        >>> from PIL import Image
        >>> import requests
...
class PerceiverForOpticalFlow(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import PerceiverForOpticalFlow
        >>> import torch
...
class PerceiverForMultimodalAutoencoding(PerceiverPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import PerceiverForMultimodalAutoencoding
        >>> import torch
        >>> import numpy as np

...
from sarah import Olmo2Config, Olmo2ForCausalLM
from sarah.models.gpt2.tokenization_gpt2_fast import GPT2TokenizerFast
...
```py
from sarah import Olmo2ForCausalLM, AutoTokenizer

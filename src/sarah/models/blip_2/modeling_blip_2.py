...
class Blip2Model(Blip2PreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> import torch
        >>> from sarah import AutoTokenizer, Blip2Model
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, Blip2Model
    ...
    def get_qformer_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import Blip2Processor, Blip2Model
...
class Blip2TextModelWithProjection(Blip2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import AutoProcessor, Blip2TextModelWithProjection
...
class Blip2VisionModelWithProjection(Blip2PreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, Blip2VisionModelWithProjection
...
class Blip2ForConditionalGeneration(Blip2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import Blip2Processor, Blip2ForConditionalGeneration
        >>> import torch
...
class Blip2ForImageTextRetrieval(Blip2PreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, Blip2ForImageTextRetrieval

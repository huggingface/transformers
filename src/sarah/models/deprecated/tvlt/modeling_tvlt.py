...
class TvltModel(TvltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import TvltProcessor, TvltModel
        >>> import numpy as np
        >>> import torch
...
class TvltForPreTraining(TvltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import TvltProcessor, TvltForPreTraining
        >>> import numpy as np
        >>> import torch
...
class TvltForAudioVisualClassification(TvltPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from sarah import TvltProcessor, TvltForAudioVisualClassification
        >>> import numpy as np
        >>> import torch

...
class XLMProphetNetEncoder(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, XLMProphetNetEncoder
        >>> import torch
...
class XLMProphetNetDecoder(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, XLMProphetNetDecoder
        >>> import torch
...
class XLMProphetNetModel(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, XLMProphetNetModel
...
class XLMProphetNetForConditionalGeneration(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, XLMProphetNetForConditionalGeneration
...
class XLMProphetNetForCausalLM(XLMProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, XLMProphetNetForCausalLM
        >>> import torch

...
class RealmEmbedder(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, RealmEmbedder
        >>> import torch
...
class RealmScorer(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import AutoTokenizer, RealmScorer
...
class RealmKnowledgeAugEncoder(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import AutoTokenizer, RealmKnowledgeAugEncoder
...
class RealmForOpenQA(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import RealmForOpenQA, RealmRetriever, AutoTokenizer

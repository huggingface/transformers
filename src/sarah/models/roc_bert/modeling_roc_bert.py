...
class RoCBertForPreTraining(RoCBertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import AutoTokenizer, RoCBertForPreTraining
        >>> import torch
...
class RoCBertForMaskedLM(RoCBertPreTrainedModel):
    ...
    def forward(
        ...
        Example:
        ```python
        >>> from sarah import AutoTokenizer, RoCBertForMaskedLM
        >>> import torch
...
class RoCBertForCausalLM(RoCBertPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import AutoTokenizer, RoCBertForCausalLM, RoCBertConfig
        >>> import torch

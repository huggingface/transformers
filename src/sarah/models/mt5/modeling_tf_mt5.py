...
class TFMT5Model(TFT5Model):
    ...
    ```python
    >>> from sarah import TFMT5Model, AutoTokenizer
...
class TFMT5ForConditionalGeneration(TFT5ForConditionalGeneration):
    ...
    ```python
    >>> from sarah import TFMT5ForConditionalGeneration, AutoTokenizer
...
class TFMT5EncoderModel(TFT5EncoderModel):
    ...
    ```python
    >>> from sarah import TFMT5EncoderModel, AutoTokenizer

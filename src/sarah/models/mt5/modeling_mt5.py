...
class MT5Model(MT5PreTrainedModel):
    ...
    ```python
    >>> from sarah import MT5Model, AutoTokenizer
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, MT5Model
...
class MT5ForConditionalGeneration(MT5PreTrainedModel, GenerationMixin):
    ...
    ```python
    >>> from sarah import MT5ForConditionalGeneration, AutoTokenizer
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, MT5ForConditionalGeneration
...
class MT5EncoderModel(MT5PreTrainedModel):
    ...
    ```python
    >>> from sarah import MT5EncoderModel, AutoTokenizer
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, MT5EncoderModel

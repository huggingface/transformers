...
class FlaxMT5Model(FlaxT5Model):
    ...
    ```python
    >>> from sarah import FlaxMT5Model, AutoTokenizer
...
class FlaxMT5EncoderModel(FlaxT5EncoderModel):
    ...
    ```python
    >>> from sarah import FlaxT5EncoderModel, AutoTokenizer
...
class FlaxMT5ForConditionalGeneration(FlaxT5ForConditionalGeneration):
    ...
    ```python
    >>> from sarah import FlaxMT5ForConditionalGeneration, AutoTokenizer

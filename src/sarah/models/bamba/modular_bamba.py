...
import sarah.models.jamba.modeling_jamba as modeling_jamba
from sarah.activations import ACT2FN
from sarah.models.jamba.modeling_jamba import JambaAttentionDecoderLayer
from sarah.models.llama.modeling_llama import (
    LlamaAttention,
    LlamaForCausalLM,
    LlamaMLP,
    LlamaRMSNorm,
...
from sarah.models.mamba2.modeling_mamba2 import (
    MambaRMSNormGated,
    pad_tensor_by_size,
    reshape_into_chunks,
    segment_sum,
...
class BambaForCausalLM(LlamaForCausalLM):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import AutoTokenizer, BambaForCausalLM

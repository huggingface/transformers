...
BLENDERBOT_SMALL_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from sarah import AutoTokenizer, BlenderbotSmallForConditionalGeneration
...
class BlenderbotSmallModel(BlenderbotSmallPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, BlenderbotSmallModel
...
class BlenderbotSmallForCausalLM(BlenderbotSmallPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, BlenderbotSmallForCausalLM

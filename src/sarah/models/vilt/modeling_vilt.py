...
class ViltModel(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import ViltProcessor, ViltModel
...
class ViltForMaskedLM(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import ViltProcessor, ViltForMaskedLM
        >>> import requests
        >>> from PIL import Image
        >>> import re
        >>> import torch
...
class ViltForQuestionAnswering(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import ViltProcessor, ViltForQuestionAnswering
        >>> import requests
        >>> from PIL import Image
...
class ViltForImageAndTextRetrieval(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import ViltProcessor, ViltForImageAndTextRetrieval
        >>> import requests
        >>> from PIL import Image
...
class ViltForImagesAndTextClassification(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import ViltProcessor, ViltForImagesAndTextClassification
        >>> import requests
        >>> from PIL import Image

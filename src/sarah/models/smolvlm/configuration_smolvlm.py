...
class SmolVLMVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah.models.smolvlm.modeling_smolvlm import SmolVLMVisionTransformer
    >>> from sarah.models.smolvlm.configuration_smolvlm import SmolVLMVisionConfig
...
class SmolVLMConfig(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from sarah import SmolVLMModel, SmolVLMConfig

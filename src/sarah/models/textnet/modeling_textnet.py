...
from sarah.activations import ACT2CLS
...
from sarah.models.textnet.configuration_textnet import TextNetConfig
...
from sarah.utils.backbone_utils import BackboneMixin
...
class TextNetForImageClassification(TextNetPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> import requests
        >>> from sarah import TextNetForImageClassification, TextNetImageProcessor

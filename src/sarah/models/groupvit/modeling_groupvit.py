...
class GroupViTTextModel(GroupViTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import CLIPTokenizer, GroupViTTextModel
...
class GroupViTVisionModel(GroupViTPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, GroupViTVisionModel
...
class GroupViTModel(GroupViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import CLIPTokenizer, GroupViTModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, GroupViTModel

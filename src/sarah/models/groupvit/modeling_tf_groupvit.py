...
class TFGroupViTTextModel(TFGroupViTPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from sarah import CLIPTokenizer, TFGroupViTTextModel
...
class TFGroupViTVisionModel(TFGroupViTPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, TFGroupViTVisionModel
...
class TFGroupViTModel(TFGroupViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import CLIPTokenizer, TFGroupViTModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, TFGroupViTModel

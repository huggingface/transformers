...
class Wav2Vec2ConformerForPreTraining(Wav2Vec2ConformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import AutoFeatureExtractor, Wav2Vec2ConformerForPreTraining
        >>> from sarah.models.wav2vec2_conformer.modeling_wav2vec2_conformer import _compute_mask_indices, _sample_negative_indices

...
from sarah import RegNetConfig
from sarah.modeling_flax_outputs import (
    FlaxBaseModelOutputWithNoAttention,
    FlaxBaseModelOutputWithPooling,
    FlaxBaseModelOutputWithPoolingAndNoAttention,
    FlaxImageClassifierOutputWithNoAttention,
)
from sarah.modeling_flax_utils import (
    ACT2FN,
    FlaxPreTrainedModel,
...
FLAX_VISION_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from sarah import AutoImageProcessor, FlaxRegNetModel
...
FLAX_VISION_CLASSIF_DOCSTRING = """
    ...
    ```python
    >>> from sarah import AutoImageProcessor, FlaxRegNetForImageClassification
    >>> from PIL import Image
    >>> import jax
    >>> import requests

...
class ChineseCLIPVisionModel(ChineseCLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from sarah import CLIPProcessor, ChineseCLIPVisionModel
...
class ChineseCLIPModel(ChineseCLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import AutoTokenizer, ChineseCLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, ChineseCLIPModel

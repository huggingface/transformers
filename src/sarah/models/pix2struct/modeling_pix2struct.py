...
class Pix2StructVisionModel(Pix2StructPreTrainedModel):
    ...
    def forward(
        ...
        >>> from sarah import AutoProcessor, Pix2StructVisionModel
...
class Pix2StructTextModel(Pix2StructPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import AutoProcessor, Pix2StructTextModel
...
class Pix2StructForConditionalGeneration(Pix2StructPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, Pix2StructForConditionalGeneration

...
class Pix2StructTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import Pix2StructTextConfig, Pix2StructTextModel
...
class Pix2StructVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import Pix2StructVisionConfig, Pix2StructVisionModel
...
class Pix2StructConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import Pix2StructConfig, Pix2StructForConditionalGeneration

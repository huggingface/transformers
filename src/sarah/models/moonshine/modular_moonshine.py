...
class MoonshineConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import MoonshineModel, MoonshineConfig
...
class MoonshineModel(WhisperModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import AutoFeatureExtractor, MoonshineModel
...
class MoonshineForConditionalGeneration(MoonshinePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import AutoProcessor, MoonshineForConditionalGeneration
        >>> from datasets import load_dataset

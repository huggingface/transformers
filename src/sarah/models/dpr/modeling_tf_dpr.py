...
class TFDPRContextEncoder(TFDPRPretrainedContextEncoder):
    ...
    def call(
        ...
        ```python
        >>> from sarah import TFDPRContextEncoder, DPRContextEncoderTokenizer
...
class TFDPRQuestionEncoder(TFDPRPretrainedQuestionEncoder):
    ...
    def call(
        ...
        ```python
        >>> from sarah import TFDPRQuestionEncoder, DPRQuestionEncoderTokenizer
...
class TFDPRReader(TFDPRPretrainedReader):
    ...
    def call(
        ...
        ```python
        >>> from sarah import TFDPRReader, DPRReaderTokenizer

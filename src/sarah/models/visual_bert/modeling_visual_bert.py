...
class VisualBertModel(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        from sarah import AutoTokenizer, VisualBertModel
        import torch
...
class VisualBertForPreTraining(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        from sarah import AutoTokenizer, VisualBertForPreTraining
...
class VisualBertForMultipleChoice(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from sarah import AutoTokenizer, VisualBertForMultipleChoice
        import torch
...
class VisualBertForQuestionAnswering(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from sarah import AutoTokenizer, VisualBertForQuestionAnswering
        import torch
...
class VisualBertForVisualReasoning(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from sarah import AutoTokenizer, VisualBertForVisualReasoning
        import torch
...
class VisualBertForRegionToPhraseAlignment(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from sarah import AutoTokenizer, VisualBertForRegionToPhraseAlignment
        import torch

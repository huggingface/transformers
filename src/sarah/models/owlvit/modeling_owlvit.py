...
class OwlViTTextModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from sarah import AutoProcessor, OwlViTTextModel
...
class OwlViTVisionModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, OwlViTVisionModel
...
class OwlViTModel(OwlViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        Examples:
        ```python
        >>> from sarah import AutoProcessor, OwlViTModel
...
class OwlViTForObjectDetection(OwlViTPreTrainedModel):
    ...
    def image_guided_detection(
        ...
        >>> from PIL import Image
        >>> import torch
        >>> from sarah import AutoProcessor, OwlViTForObjectDetection
    ...
    def forward(
        ...
        >>> from sarah import OwlViTProcessor, OwlViTForObjectDetection

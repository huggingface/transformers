...
class WhisperModel(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        Example:
         ```python
         >>> import torch
         >>> from sarah import AutoFeatureExtractor, WhisperModel
...
class WhisperForCausalLM(WhisperPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import WhisperForCausalLM, WhisperForConditionalGeneration, WhisperProcessor
        >>> import torch
        >>> from datasets import load_dataset
...
class WhisperForAudioClassification(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import AutoFeatureExtractor, WhisperForAudioClassification
        >>> from datasets import load_dataset

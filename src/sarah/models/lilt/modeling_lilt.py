...
class LiltModel(LiltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, AutoModel
...
class LiltForSequenceClassification(LiltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, AutoModelForSequenceClassification
        >>> from datasets import load_dataset
...
class LiltForTokenClassification(LiltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, AutoModelForTokenClassification
        >>> from datasets import load_dataset
...
class LiltForQuestionAnswering(LiltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, AutoModelForQuestionAnswering
        >>> from datasets import load_dataset

...
class SpeechT5ForSpeechToText(SpeechT5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import SpeechT5Processor, SpeechT5ForSpeechToText
...
class SpeechT5ForTextToSpeech(SpeechT5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import SpeechT5Processor, SpeechT5ForTextToSpeech, SpeechT5HifiGan, set_seed
        >>> import torch
...
class SpeechT5ForSpeechToSpeech(SpeechT5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import SpeechT5Processor, SpeechT5ForSpeechToSpeech, SpeechT5HifiGan, set_seed
        >>> from datasets import load_dataset
        >>> import torch

...
from sarah.models.sam.modeling_sam import SamMLPBlock, SamVisionAttention, SamVisionEncoder, SamVisionLayer
...
class GotOcr2Config(PretrainedConfig):
    ...
    ```python
    >>> from sarah import GotOcr2ForConditionalGeneration, GotOcr2Config

...
class FlaxCLIPPreTrainedModel(FlaxPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import AutoTokenizer, FlaxCLIPModel
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, FlaxCLIPModel
...
FLAX_CLIP_TEXT_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from sarah import AutoTokenizer, FlaxCLIPTextModel
...
FLAX_CLIP_TEXT_MODEL_WITH_PROJECTION_DOCSTRING = """
    ...
    ```python
    >>> from sarah import AutoTokenizer, FlaxCLIPTextModelWithProjection
...
FLAX_CLIP_VISION_MODEL_DOCSTRING = """
    ...
    >>> from PIL import Image
    >>> import requests
    >>> from sarah import AutoProcessor, FlaxCLIPVisionModel

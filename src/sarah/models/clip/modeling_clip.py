...
class CLIPTextModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, CLIPTextModel
...
class CLIPVisionModel(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, CLIPVisionModel
...
class CLIPModel(CLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import AutoTokenizer, CLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, CLIPModel
...
class CLIPTextModelWithProjection(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, CLIPTextModelWithProjection
...
class CLIPVisionModelWithProjection(CLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, CLIPVisionModelWithProjection

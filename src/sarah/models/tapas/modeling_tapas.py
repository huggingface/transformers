...
class TapasModel(TapasPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, TapasModel
        >>> import pandas as pd
...
class TapasForMaskedLM(TapasPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import AutoTokenizer, TapasForMaskedLM
        >>> import pandas as pd
...
class TapasForQuestionAnswering(TapasPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, TapasForQuestionAnswering
        >>> import pandas as pd
...
class TapasForSequenceClassification(TapasPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, TapasForSequenceClassification
        >>> import torch
        >>> import pandas as pd

...
class FlavaImageConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import FlavaImageConfig, FlavaImageModel
...
class FlavaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import FlavaTextConfig, FlavaTextModel
...
class FlavaMultimodalConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import FlavaMultimodalConfig, FlavaMultimodalModel
...
class FlavaImageCodebookConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import FlavaImageCodebookConfig, FlavaImageCodebook
...
class FlavaConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import FlavaConfig, FlavaModel, FlavaForPreTraining

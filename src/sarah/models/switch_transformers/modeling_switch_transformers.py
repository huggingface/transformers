...
class SwitchTransformersModel(SwitchTransformersPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, SwitchTransformersModel
...
class SwitchTransformersForConditionalGeneration(SwitchTransformersPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, SwitchTransformersForConditionalGeneration
...
class SwitchTransformersEncoderModel(SwitchTransformersPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, SwitchTransformersEncoderModel

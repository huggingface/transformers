...
from sarah.models.switch_transformers.convert_switch_transformers_original_flax_checkpoint_to_pytorch import (
    rename_keys,
)
from sarah.utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME
from sarah.utils.hub import convert_file_size_to_int
...
def sanity_check():
    from sarah import SwitchTransformersConfig, SwitchTransformersForConditionalGeneration, T5Tokenizer

...
from sarah.modeling_outputs import (
    BaseModelOutputWithNoAttention,
)
from sarah.models.superpoint.configuration_superpoint import SuperPointConfig
...
class SuperPointForKeypointDetection(SuperPointPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoImageProcessor, SuperPointForKeypointDetection
        >>> import torch

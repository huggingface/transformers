...
class Idefics3VisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah.models.idefics3.modeling_idefics3 import Idefics3VisionTransformer
    >>> from sarah.models.idefics3.configuration_idefics3 import Idefics3VisionConfig
...
class Idefics3Config(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from sarah import Idefics3Model, Idefics3Config

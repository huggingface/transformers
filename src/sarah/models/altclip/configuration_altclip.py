...
class AltCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import AltCLIPTextModel, AltCLIPTextConfig
...
class AltCLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import AltCLIPVisionConfig, AltCLIPVisionModel
...
class AltCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import AltCLIPConfig, AltCLIPModel

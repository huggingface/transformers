...
class VisionTextDualEncoderModel(PreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import VisionTextDualEncoderModel, AutoTokenizer
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from sarah import VisionTextDualEncoderModel, AutoImageProcessor
    ...
    def from_vision_text_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import VisionTextDualEncoderModel

...
class TFVisionTextDualEncoderModel(TFPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import TFVisionTextDualEncoderModel, AutoTokenizer
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from sarah import TFVisionTextDualEncoderModel, AutoImageProcessor
    ...
    def from_vision_text_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import TFVisionTextDualEncoderModel

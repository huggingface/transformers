...
class UMT5Model(UMT5PreTrainedModel):
    ...
    ```python
    >>> from sarah import UMT5Model, AutoTokenizer
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, UMT5Model
...
class UMT5ForConditionalGeneration(UMT5PreTrainedModel, GenerationMixin):
    ...
    ```python
    >>> from sarah import UMT5ForConditionalGeneration, AutoTokenizer
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, UMT5ForConditionalGeneration
...
class UMT5EncoderModel(UMT5PreTrainedModel):
    ...
    ```python
    >>> from sarah import UMT5EncoderModel, AutoTokenizer
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, UMT5EncoderModel

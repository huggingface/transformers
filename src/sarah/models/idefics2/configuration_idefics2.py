...
class Idefics2VisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah.models.idefics2.modeling_idefics2 import Idefics2VisionTransformer
    >>> from sarah.models.idefics2.configuration_idefics2 import Idefics2VisionConfig
...
class Idefics2Config(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from sarah import Idefics2Model, Idefics2Config

...
class LongformerModel(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import LongformerModel, AutoTokenizer
...
class LongformerForMaskedLM(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, LongformerForMaskedLM
...
class LongformerForQuestionAnswering(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, LongformerForQuestionAnswering
        >>> import torch

...
class BrosModel(BrosPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import BrosProcessor, BrosModel
...
class BrosForTokenClassification(BrosPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import BrosProcessor, BrosForTokenClassification
...
class BrosSpadeEEForTokenClassification(BrosPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import BrosProcessor, BrosSpadeEEForTokenClassification
...
class BrosSpadeELForTokenClassification(BrosPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from sarah import BrosProcessor, BrosSpadeELForTokenClassification

...
class ProphetNetEncoder(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, ProphetNetEncoder
        >>> import torch
...
class ProphetNetDecoder(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, ProphetNetDecoder
        >>> import torch
...
class ProphetNetModel(ProphetNetPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, ProphetNetModel
...
class ProphetNetForConditionalGeneration(ProphetNetPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, ProphetNetForConditionalGeneration
...
class ProphetNetForCausalLM(ProphetNetPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, ProphetNetForCausalLM
        >>> import torch
        ...
        >>> from sarah import BertTokenizer, EncoderDecoderModel, AutoTokenizer
        >>> import torch

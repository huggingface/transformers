...
from sarah.modeling_attn_mask_utils import _prepare_4d_attention_mask
...
class Phi4MultimodalVisionConfig(SiglipVisionConfig):
    ...
    ```python
    >>> from sarah import Phi4MultimodalVisionConfig
...
class Phi4MultimodalAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import Phi4MultimodalAudioConfig
...
class Phi4MultimodalConfig(Phi3Config):
    ...
    ```python
    >>> from sarah import Phi4MultimodalModel, Phi4MultimodalConfig
...
class Phi4MultimodalForCausalLM(Phi3ForCausalLM, nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        Example:
        ```python
        >>> from sarah import AutoTokenizer, Phi4MultimodalForCausalLM

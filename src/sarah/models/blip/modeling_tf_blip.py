...
class TFBlipModel(TFBlipPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, TFBlipModel
...
class TFBlipForConditionalGeneration(TFBlipPreTrainedModel):
    ...
    def call(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, TFBlipForConditionalGeneration
...
class TFBlipForQuestionAnswering(TFBlipPreTrainedModel):
    ...
    def call(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, TFBlipForQuestionAnswering
...
class TFBlipForImageTextRetrieval(TFBlipPreTrainedModel):
    ...
    def call(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, TFBlipForImageTextRetrieval

...
class BlipModel(BlipPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import AutoProcessor, BlipModel
...
class BlipForConditionalGeneration(BlipPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, BlipForConditionalGeneration
...
class BlipForQuestionAnswering(BlipPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, BlipForQuestionAnswering
...
class BlipForImageTextRetrieval(BlipPreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, BlipForImageTextRetrieval

...
class VideoMAEModel(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        >>> from sarah import AutoImageProcessor, VideoMAEModel
...
class VideoMAEForPreTraining(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from sarah import AutoImageProcessor, VideoMAEForPreTraining
        >>> import numpy as np
        >>> import torch
...
class VideoMAEForVideoClassification(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        >>> from sarah import AutoImageProcessor, VideoMAEForVideoClassification
        >>> from huggingface_hub import hf_hub_download

...
class ClvpEncoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import ClvpEncoderConfig, ClvpEncoder
...
class ClvpDecoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import ClvpDecoderConfig, ClvpDecoder
...
class ClvpConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import ClvpConfig, ClvpModelForConditionalGeneration
    ...
    >>> from sarah import ClvpEncoderConfig, ClvpDecoderConfig

...
class Qwen2AudioEncoderConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import Qwen2AudioEncoderConfig, Qwen2AudioEncoder
...
class Qwen2AudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import Qwen2AudioForConditionalGeneration, Qwen2AudioConfig, Qwen2AudioEncoderConfig, Qwen2Config

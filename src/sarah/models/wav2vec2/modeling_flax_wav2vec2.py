...
FLAX_WAV2VEC2_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from sarah import AutoProcessor, FlaxWav2Vec2Model
...
FLAX_WAV2VEC2_FOR_CTC_DOCSTRING = """
    ...
    ```python
    >>> import jax.numpy as jnp
    >>> from sarah import AutoProcessor, FlaxWav2Vec2ForCTC
    >>> from datasets import load_dataset
    >>> import soundfile as sf
...
FLAX_WAV2VEC2_FOR_PRETRAINING_DOCSTRING = """
    ...
    >>> import numpy as np
    >>> import jax.numpy as jnp
    >>> from sarah import AutoFeatureExtractor, FlaxWav2Vec2ForPreTraining
    >>> from sarah.models.wav2vec2.modeling_flax_wav2vec2 import _compute_mask_indices
    >>> from datasets import load_dataset
    >>> import soundfile as sf

...
class Owlv2TextModel(Owlv2PreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from sarah import AutoProcessor, Owlv2TextModel
...
class Owlv2VisionModel(Owlv2PreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, Owlv2VisionModel
...
class Owlv2Model(Owlv2PreTrainedModel):
    ...
    def get_text_features(
        ...
        Examples:
        ```python
        >>> from sarah import AutoProcessor, Owlv2Model
...
class Owlv2ForObjectDetection(Owlv2PreTrainedModel):
    ...
    def image_guided_detection(
        ...
        >>> from PIL import Image
        >>> import torch
        >>> from sarah import AutoProcessor, Owlv2ForObjectDetection
    ...
    def forward(
        ...
        >>> from sarah import Owlv2Processor, Owlv2ForObjectDetection

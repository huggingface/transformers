...
class Siglip2TextConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import Siglip2TextConfig, Siglip2TextModel
...
class Siglip2Config(PretrainedConfig):
    ...
    ```python
    >>> from sarah import Siglip2Config, Siglip2Model
    ...
    >>> from sarah import Siglip2TextConfig, Siglip2VisionConfig

...
class Siglip2TextModel(Siglip2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, Siglip2TextModel
...
class Siglip2VisionModel(Siglip2PreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, Siglip2VisionModel
...
class Siglip2Model(Siglip2PreTrainedModel):
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, AutoModel
        >>> import torch
...
class Siglip2ForImageClassification(Siglip2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoImageProcessor, Siglip2ForImageClassification
        >>> import torch
        >>> from PIL import Image
        >>> import requests

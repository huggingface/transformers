...
from sarah.models.siglip.configuration_siglip import SiglipConfig, SiglipTextConfig, SiglipVisionConfig
from sarah.models.siglip.modeling_siglip import (
    BaseModelOutput,
...
class Siglip2VisionConfig(SiglipVisionConfig):
    ...
    ```python
    >>> from sarah import Siglip2VisionConfig, Siglip2VisionModel

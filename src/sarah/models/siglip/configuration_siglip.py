...
class SiglipTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import SiglipTextConfig, SiglipTextModel
...
class SiglipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import SiglipVisionConfig, SiglipVisionModel
...
class SiglipConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import SiglipConfig, SiglipModel
    ...
    >>> from sarah import SiglipTextConfig, SiglipVisionConfig

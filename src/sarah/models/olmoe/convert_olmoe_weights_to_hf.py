...
3. Load model via:
```
from sarah import OlmoeForCausalLM, AutoTokenizer
import torch
...
from sarah import OlmoeConfig, OlmoeForCausalLM
from sarah.models.gpt_neox.tokenization_gpt_neox_fast import GPTNeoXTokenizerFast

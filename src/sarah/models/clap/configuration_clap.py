...
class ClapTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import ClapTextConfig, ClapTextModel
...
class ClapAudioConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import ClapAudioConfig, ClapAudioModel
...
class ClapConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import ClapConfig, ClapModel
    ...
    >>> from sarah import ClapTextConfig, ClapAudioConfig

...
class ClapAudioModel(ClapPreTrainedModel):
    ...
    def forward(
        ...
        >>> from sarah import AutoProcessor, ClapAudioModel
...
class ClapModel(ClapPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import AutoTokenizer, ClapModel
    ...
    def get_audio_features(
        ...
        ```python
        >>> from sarah import AutoFeatureExtractor, ClapModel
        >>> import torch
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from sarah import AutoProcessor, ClapModel
...
class ClapTextModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, ClapTextModelWithProjection
...
class ClapAudioModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from sarah import ClapAudioModelWithProjection, ClapProcessor

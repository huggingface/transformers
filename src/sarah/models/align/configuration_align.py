...
class AlignTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import AlignTextConfig, AlignTextModel
...
class AlignVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import AlignVisionConfig, AlignVisionModel
...
class AlignConfig(PretrainedConfig):
    ...
    ```python
    >>> from sarah import AlignConfig, AlignModel
    ...
    >>> from sarah import AlignTextConfig, AlignVisionConfig

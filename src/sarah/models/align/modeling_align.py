...
class AlignTextModel(AlignPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, AlignTextModel
...
class AlignVisionModel(AlignPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from sarah import AutoProcessor, AlignVisionModel
...
class AlignModel(AlignPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from sarah import AutoTokenizer, AlignModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from sarah import AutoProcessor, AlignModel

...
class DetrModel(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoImageProcessor, DetrModel
...
class DetrForObjectDetection(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoImageProcessor, DetrForObjectDetection
        >>> import torch
        >>> from PIL import Image
        >>> import requests
...
class DetrForSegmentation(DetrPreTrainedModel):
    ...
    def forward(
        ...
        >>> from sarah import AutoImageProcessor, DetrForSegmentation
        >>> from sarah.image_transforms import rgb_to_id

...
class BridgeTowerModel(BridgeTowerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import BridgeTowerProcessor, BridgeTowerModel
...
class BridgeTowerForMaskedLM(BridgeTowerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import BridgeTowerProcessor, BridgeTowerForMaskedLM
        >>> from PIL import Image
        >>> import requests
...
class BridgeTowerForImageAndTextRetrieval(BridgeTowerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import BridgeTowerProcessor, BridgeTowerForImageAndTextRetrieval
        >>> import requests
        >>> from PIL import Image
...
class BridgeTowerForContrastiveLearning(BridgeTowerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import BridgeTowerProcessor, BridgeTowerForContrastiveLearning
        >>> import requests
        >>> from PIL import Image
        >>> import torch

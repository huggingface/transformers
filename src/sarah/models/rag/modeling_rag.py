...
class RagModel(RagPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from sarah import AutoTokenizer, RagRetriever, RagModel
        >>> import torch
...
class RagSequenceForGeneration(RagPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> from sarah import AutoTokenizer, RagRetriever, RagSequenceForGeneration
        >>> import torch
...
class RagTokenForGeneration(RagPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> from sarah import AutoTokenizer, RagRetriever, RagTokenForGeneration
        >>> import torch

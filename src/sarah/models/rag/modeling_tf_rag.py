...
class TFRagPreTrainedModel(TFPreTrainedModel):
    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import RagRetriever, TFRagModel
...
class TFRagModel(TFRagPreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import AutoTokenizer, RagRetriever, TFRagModel
        >>> import torch
...
class TFRagTokenForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> import tensorflow as tf
        >>> from sarah import AutoTokenizer, RagRetriever, TFRagTokenForGeneration
...
class TFRagSequenceForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> from sarah import AutoTokenizer, RagRetriever, TFRagSequenceForGeneration

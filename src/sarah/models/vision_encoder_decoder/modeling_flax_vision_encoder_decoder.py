...
class FlaxVisionEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from sarah import AutoImageProcessor, FlaxVisionEncoderDecoderModel
    ...
    def __call__(
        ...
        ```python
        >>> from sarah import FlaxVisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
        >>> from PIL import Image
        >>> import requests
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import FlaxVisionEncoderDecoderModel

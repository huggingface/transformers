...
class VisionEncoderDecoderModel(PreTrainedModel, GenerationMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from sarah import VisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
        ...
        if from_tf:
            from sarah import TFVisionEncoderDecoderModel
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import VisionEncoderDecoderModel
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import AutoProcessor, VisionEncoderDecoderModel
        >>> import requests
        >>> from PIL import Image
        >>> import torch

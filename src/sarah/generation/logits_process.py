...
class TemperatureLogitsWarper(LogitsProcessor):
    ...
    ```python
    >>> import torch
    >>> from sarah import AutoTokenizer, AutoModelForCausalLM, set_seed
...
class RepetitionPenaltyLogitsProcessor(LogitsProcessor):
    ...
    ```py
    >>> from sarah import AutoTokenizer, AutoModelForCausalLM
...
class HammingDiversityLogitsProcessor(LogitsProcessor):
    ...
    ```python
    >>> from sarah import AutoTokenizer, AutoModelForSeq2SeqLM
    >>> import torch
...
class WhisperTimeStampLogitsProcessor(LogitsProcessor):
    ...
    ``` python
    >>> import torch
    >>> from sarah import AutoProcessor, WhisperForConditionalGeneration, GenerationConfig
    >>> from datasets import load_dataset
...
class WatermarkLogitsProcessor(LogitsProcessor):
    ...
    ```python
    >>> from sarah import AutoTokenizer, AutoModelForCausalLM, WatermarkingConfig
    ...
    >>> from sarah import WatermarkDetector

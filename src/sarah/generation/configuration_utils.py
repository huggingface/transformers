...
class GenerationConfig(PushToHubMixin):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from sarah import GenerationConfig
...
class SynthIDTextWatermarkingConfig(BaseWatermarkingConfig):
    ...
    Examples:
    ```python
    >>> from sarah import AutoModelForCausalLM, AutoTokenizer, SynthIDTextWatermarkingConfig
...
class CompileConfig:
    ...
    Examples:
    ```python
    >>> from sarah import AutoModelForCausalLM, AutoTokenizer, CompileConfig

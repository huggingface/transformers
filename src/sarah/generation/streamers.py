...
class TextStreamer(BaseStreamer):
    ...
    Examples:
        ...
        ```python
        >>> from sarah import AutoModelForCausalLM, AutoTokenizer, TextStreamer
...
class TextIteratorStreamer(TextStreamer):
    ...
    Examples:
        ...
        ```python
        >>> from sarah import AutoModelForCausalLM, AutoTokenizer, TextIteratorStreamer
...
class AsyncTextIteratorStreamer(TextStreamer):
    ...
    Examples:
        ...
        ```python
        >>> from sarah import AutoModelForCausalLM, AutoTokenizer, AsyncTextIteratorStreamer
        >>> from threading import Thread
        >>> import asyncio

...
from sarah import logging as transformers_logging
...
class CaptureLogger:
    ...
    >>> from sarah.testing_utils import CaptureLogger
...
class TestCasePlus(unittest.TestCase):
    ...
    def python_one_liner_max_rss(self, one_liner_str):
        ...
        ```
        one_liner_str = 'from sarah import AutoModel; AutoModel.from_pretrained("google-t5/t5-large")'

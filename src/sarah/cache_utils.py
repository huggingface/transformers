...
from sarah.pytorch_utils import is_torch_greater_or_equal_than_2_6
...
class DynamicCache(Cache):
    ...
    Example:
        ...
        ```python
        >>> from sarah import AutoTokenizer, AutoModelForCausalLM, DynamicCache
...
class QuantoQuantizedCache(QuantizedCache):
    ...
    Example:
        ...
        >>> from sarah import AutoTokenizer, AutoModelForCausalLM, QuantoQuantizedCache, QuantizedCacheConfig
...
class HQQQuantizedCache(QuantizedCache):
    ...
    Example:
        ...
        >>> from sarah import AutoTokenizer, AutoModelForCausalLM, HQQQuantizedCache, QuantizedCacheConfig
...
class SinkCache(Cache):
    ...
    Example:
        ...
        ```python
        >>> from sarah import AutoTokenizer, AutoModelForCausalLM, SinkCache
...
class StaticCache(Cache):
    ...
    Example:
        ...
        ```python
        >>> from sarah import AutoTokenizer, AutoModelForCausalLM, StaticCache
...
class SlidingWindowCache(StaticCache):
    ...
    Example:
        ...
        ```python
        >>> from sarah import AutoTokenizer, AutoModelForCausalLM, SlidingWindowCache
...
class EncoderDecoderCache(Cache):
    ...
    Example:
        ...
        ```python
        >>> from sarah import AutoProcessor, AutoModelForCausalLM, DynamicCache, EncoderDecoderCache
...
class HybridCache(Cache):
    ...
    Example:
        ...
        ```python
        >>> from sarah import AutoTokenizer, AutoModelForCausalLM, HybridCache
...
class MambaCache:
    ...
    Example:
        ...
        ```python
        >>> from sarah import AutoTokenizer, MambaForCausalLM, MambaCache
...
class OffloadedStaticCache(StaticCache):
    ...
    Example:
        ...
        ```python
        >>> from sarah import AutoTokenizer, AutoModelForCausalLM, OffloadedStaticCache

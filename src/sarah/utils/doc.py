...
PT_TOKEN_CLASSIFICATION_SAMPLE = r"""
    ...
    ```python
    >>> from sarah import AutoTokenizer, {model_class}
    >>> import torch
...
PT_SPEECH_BASE_MODEL_SAMPLE = r"""
    ...
    ```python
    >>> from sarah import AutoProcessor, {model_class}
    >>> import torch
...
PT_SPEECH_SEQ_CLASS_SAMPLE = r"""
    ...
    ```python
    >>> from sarah import AutoFeatureExtractor, {model_class}
    >>> from datasets import load_dataset
    >>> import torch
...
PT_VISION_BASE_MODEL_SAMPLE = r"""
    ...
    ```python
    >>> from sarah import AutoImageProcessor, {model_class}
    >>> import torch
    >>> from datasets import load_dataset

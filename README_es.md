...
1. **[CLIPVisionModel](https://huggingface.co/docs/transformers/main/model_doc/clip_vision_model)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 

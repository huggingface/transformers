...
1. **[ProPainter](https://huggingface.co/docs/transformers/model_doc/propainter)** released with the paper [ProPainter: Improving Propagation and Transformer for Video Inpainting](https://arxiv.org/abs/2001.04063) by Shangchen Zhou, Chongyi Li, Kelvin C.K. Chan and Chen Change Loy.

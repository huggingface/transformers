...
1. **[LlamaInfinite](https://huggingface.co/docs/transformers/model_doc/llama_infinite)** se aplica [LM-Infinite](https://browse.arxiv.org/abs/2308.16137) propuesto por Chi Han, Qifan Wang, Wenhan Xiong, Yu Chen, Heng Ji, Sinong Wang y toda la familia Llama. Esta técnica permite la generación infinita de texto con una calidad general intacta, sin actualizaciones de parámetros. LlamaInfinite es compatible con todos los puntos de control de Llama existentes con un mínimo esfuerzo de codificación.

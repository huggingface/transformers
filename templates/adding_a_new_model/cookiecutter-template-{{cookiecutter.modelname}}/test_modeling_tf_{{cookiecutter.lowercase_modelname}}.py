...
class TF{{cookiecutter.camelcase_modelname}}ModelIntegrationTest(unittest.TestCase):
    def test_inference_no_head(self):
        model = TF{{cookiecutter.camelcase_modelname}}Model.from_pretrained("facebook/{{cookiecutter.lowercase_modelname}}-large", from_pt=True)
    ...
    def test_cnn_summarization_same_as_fairseq_hard(self):
        hf = TF{{cookiecutter.camelcase_modelname}}ForConditionalGeneration.from_pretrained("facebook/{{cookiecutter.lowercase_modelname}}-large-cnn", from_pt=True)
        tok = self.tok
    ...
    @cached_property
    def tok(self):
        return {{cookiecutter.camelcase_modelname}}Tokenizer.from_pretrained("facebook/{{cookiecutter.lowercase_modelname}}-large")

...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        # full
        test_command = "python -m pytest --junitxml=test-results/junit.xml -n 6 --max-worker-restart=0 --dist=loadfile --make-reports=tests_torch tests/benchmark tests/bettertransformer tests/deepspeed tests/extended tests/fixtures tests/fsdp tests/generation tests/models/ernie tests/models/ernie_m tests/models/esm tests/models/falcon tests/models/fastspeech2_conformer tests/models/flaubert tests/models/flava tests/models/fnet tests/models/focalnet tests/models/fsmt tests/models/funnel tests/models/fuyu tests/models/git tests/models/glpn tests/models/gpt2 tests/models/gptj tests/models/gptsan_japanese tests/models/gpt_bigcode tests/models/gpt_neo tests/models/gpt_neox tests/models/gpt_neox_japanese tests/models/gpt_sw3 tests/models/graphormer tests/models/groupvit tests/models/herbert tests/models/hubert tests/models/ibert tests/models/idefics tests/models/imagegpt tests/models/informer tests/models/instructblip tests/models/jukebox tests/models/kosmos2 tests/models/layoutlm tests/models/layoutlmv2 tests/models/layoutlmv3 tests/models/layoutxlm tests/models/led tests/models/levit tests/models/lilt tests/models/llama tests/models/llava tests/models/longformer tests/models/longt5 tests/models/luke tests/models/lxmert tests/models/m2m_100 tests/models/marian tests/models/markuplm tests/models/mask2former tests/models/maskformer tests/models/mbart tests/models/mbart50 tests/models/mega tests/models/megatron_bert tests/models/megatron_gpt2 tests/models/mgp_str tests/models/mistral tests/models/mixtral tests/models/mluke tests/models/mobilebert tests/models/mobilenet_v1 tests/models/mobilenet_v2 tests/models/mobilevit tests/optimization tests/peft_integration tests/quantization tests/sagemaker tests/test_backbone_common.py tests/test_cache_utils.py tests/test_configuration_common.py tests/test_configuration_utils.py tests/test_feature_extraction_common.py tests/test_feature_extraction_utils.py tests/test_image_processing_common.py tests/test_image_processing_utils.py tests/test_image_transforms.py tests/test_modeling_common.py tests/test_modeling_flax_common.py tests/test_modeling_flax_utils.py tests/test_modeling_tf_common.py tests/test_modeling_tf_utils.py tests/test_pipeline_mixin.py tests/test_sequence_feature_extraction_common.py tests/test_tokenization_common.py tests/test_tokenization_utils.py tests/tokenization tests/tools tests/trainer tests/utils tests/test_modeling_utils.py"

    ...
    if len(test_list) > 0:
        ...
        for job in jobs:
            if job.job_name in ["tests_torch", "tests_tf", "tests_flax"]:
                ...
                job.tests_to_run = [x for x in L if any(y in x for y in ["_bert.py", "_gpt2.py", "_bart.py", "_t5.py", "_roberta.py", "_deberta.py", "_longformer.py", "_led.py", "_albert.py", "_xlm_roberta.py", "_speecht5.py", "_mbart50.py"])]

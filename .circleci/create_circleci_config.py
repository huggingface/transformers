...
torch_and_tf_job = CircleCIJob(
    ...
    install_steps=[
        ...
        "pip install -U --upgrade-strategy eagertensorflow_probability",
        "pip install -U --upgrade-strategy eagergit+https://github.com/huggingface/accelerate",
    ],
...
exotic_models_job = CircleCIJob(
    ...
    install_steps=[
        ...
        "pip install -U --upgrade-strategy eagertorchvision",
        "pip install -U --upgrade-strategy eagerscipy",
        "pip install -U --upgrade-strategy eager'git+https://github.com/facebookresearch/detectron2.git'",
        "sudo apt install tesseract-ocr",
        "pip install -U --upgrade-strategy eagerpytesseract",
        "pip install -U --upgrade-strategy eagernatten",
    ],
    tests_to_run=[

...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        steps = [
            ...
            {"run": {"name": "Get files to test", "command":f'curl -o {self.name}_test_list.txt << pipeline.parameters.{self.name}_test_list >>' if self.name != "pr_documentation_tests" else ''}},

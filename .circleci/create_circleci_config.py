...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        additional_flags = (
            " -p no:warning -o junit_family=xunit1 --junitxml=test-results/junit.xml"
        )
        ...
        steps = [
            ...
            },
            {
                "run": {
                    ...
                    "command": (
                        f"curl -L -o {self.job_name}_test_list.txt <<pipeline.parameters.{self.job_name}_test_list>>"

...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        steps = [
            ...
            {"run": {"name": "", "command": "docker image pull huggingface/transformers-torch-light"}},
            {"run": {"name": "", "command": "export CONTAINER_ID=$(docker run --privileged -d huggingface/transformers-torch-light:dev sleep 3600)"}},
            {"run": {"name": "", "command": "docker cp pytest.sh $CONTAINER_ID:/pytest.sh"}},
            {"run": {"name": "", "command": "docker exec $CONTAINER_ID ls -la /pytest.sh"}},
            {"run": {"name": "", "command": "docker exec $CONTAINER_ID cat /pytest.sh"}},
            {"run": {"name": "", "command": "docker exec $CONTAINER_ID chmod +x /pytest.sh"}},
            {"run": {"name": "", "command": "docker exec $CONTAINER_ID /pytest.sh"}},
            {"run": {"name": "", "command": "docker stop $CONTAINER_ID"}},

...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        steps = [
            ...
            {"run": {"name": "Install torch 2.9 RC", "command": "pip uninstall -y torchcodec && pip3 install torch==2.9.0 torchvision torchaudio --index-url https://download.pytorch.org/whl/test/cpu"}},

...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        # full
        test_command = "python -m pytest --junitxml=test-results/junit.xml -n 6 --max-worker-restart=0 --dist=loadfile --make-reports=tests_torch tests/benchmark tests/bettertransformer tests/deepspeed tests/extended tests/fixtures tests/fsdp tests/generation tests/models/tapas tests/models/timesformer tests/models/time_series_transformer tests/models/timm_backbone tests/models/transfo_xl tests/models/trocr tests/models/tvlt tests/models/tvp tests/models/umt5 tests/models/unispeech tests/models/unispeech_sat tests/models/univnet tests/models/upernet tests/models/videomae tests/models/vilt tests/models/vipllava tests/models/vision_encoder_decoder tests/models/vision_text_dual_encoder tests/models/visual_bert tests/models/vit tests/models/vitdet tests/models/vitmatte tests/models/vits tests/models/vit_hybrid tests/models/vit_mae tests/models/vit_msn tests/models/vivit tests/models/wav2vec2 tests/models/wav2vec2_conformer tests/models/wav2vec2_phoneme tests/models/wav2vec2_with_lm tests/models/wavlm tests/models/whisper tests/models/xglm tests/models/xlm tests/models/xlm_prophetnet tests/models/xlm_roberta tests/models/xlm_roberta_xl tests/models/xlnet tests/models/xmod tests/models/x_clip tests/models/yolos tests/models/yoso tests/models/__init__.py tests/optimization tests/peft_integration tests/quantization tests/sagemaker tests/test_backbone_common.py tests/test_cache_utils.py tests/test_configuration_common.py tests/test_configuration_utils.py tests/test_feature_extraction_common.py tests/test_feature_extraction_utils.py tests/test_image_processing_common.py tests/test_image_processing_utils.py tests/test_image_transforms.py tests/test_modeling_common.py tests/test_modeling_flax_common.py tests/test_modeling_flax_utils.py tests/test_modeling_tf_common.py tests/test_modeling_tf_utils.py tests/test_pipeline_mixin.py tests/test_sequence_feature_extraction_common.py tests/test_tokenization_common.py tests/test_tokenization_utils.py tests/tokenization tests/tools tests/trainer tests/utils tests/test_modeling_utils.py"

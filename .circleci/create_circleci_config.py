...
torch_and_tf_job = CircleCIJob(
    ...
    install_steps=[
        ...
        "pip install -U --upgrade-strategy eager --no-deps git+https://github.com/huggingface/accelerate@main#egg=accelerate",
...
examples_torch_job = CircleCIJob(
    ...
    install_steps=[
        "sudo apt-get -y update && sudo apt-get install -y libsndfile1-dev espeak-ng",
        "pip install --upgrade --upgrade-strategy eager pip",
        "pip install -U --upgrade-strategy eager .[sklearn,torch,sentencepiece,testing,torch-speech,torch-vision]",

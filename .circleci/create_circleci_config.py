...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        if self.parallelism == 1:
            ...
            tests = "tests/benchmark tests/models/idefics/test_modeling_idefics.py tests/models/mamba/test_modeling_mamba.py tests/models/nllb_moe/test_modeling_nllb_moe.py tests/models/qwen2/test_modeling_qwen2.py tests/trainer"
            tests = tests.split()

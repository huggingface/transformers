...
torch_job = CircleCIJob(
    ...
    install_steps=[
        ...
        "uv pip install -U --upgrade-strategy eager -e git+https://github.com/huggingface/accelerate@main#egg=accelerate",
    ],
    parallelism=1,
...
exotic_models_job = CircleCIJob(
    ...
    install_steps=[
        ...
        "uv pip install -U --upgrade-strategy eager torchvision",
        "uv pip install -U --upgrade-strategy eager scipy",
        "uv pip install -U --upgrade-strategy eager 'git+https://github.com/facebookresearch/detectron2.git'",
        "sudo apt install tesseract-ocr",
        "uv pip install -U --upgrade-strategy eager pytesseract",
        "uv pip install -U --upgrade-strategy eager natten==0.15.1+torch210cpu -f https://shi-labs.com/natten/wheels",
        "uv pip install -U --upgrade-strategy eager python-Levenshtein",
        "uv pip install -U --upgrade-strategy eager opencv-python",
        "uv pip install -U --upgrade-strategy eager nltk",

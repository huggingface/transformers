...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        # full
        test_command = "python -m pytest --junitxml=test-results/junit.xml -n 6 --max-worker-restart=0 --dist=loadfile --make-reports=tests_torch tests/benchmark tests/bettertransformer tests/deepspeed tests/extended tests/fixtures tests/fsdp tests/generation tests/models/albert tests/models/align tests/models/altclip tests/models/audio_spectrogram_transformer tests/models/auto tests/models/autoformer tests/models/bark tests/models/bart tests/models/barthez tests/models/bartpho tests/models/beit tests/models/bert tests/models/bertweet tests/models/bert_generation tests/models/bert_japanese tests/models/bigbird_pegasus tests/models/big_bird tests/models/biogpt tests/models/bit tests/models/blenderbot tests/models/blenderbot_small tests/models/blip tests/models/blip_2 tests/models/bloom tests/models/bridgetower tests/models/bros tests/models/byt5 tests/models/camembert tests/models/canine tests/models/chinese_clip tests/models/clap tests/models/clip tests/models/clipseg tests/models/clvp tests/models/codegen tests/models/code_llama tests/models/conditional_detr tests/models/convbert tests/models/convnext tests/models/convnextv2 tests/models/cpm tests/models/cpmant tests/models/ctrl tests/models/cvt tests/models/data2vec tests/models/deberta tests/models/deberta_v2 tests/models/decision_transformer tests/models/deformable_detr tests/models/deit tests/models/deta tests/models/detr tests/models/dinat tests/models/dinov2 tests/models/distilbert tests/models/dit tests/models/donut tests/models/dpr tests/models/dpt tests/models/efficientformer tests/models/efficientnet tests/models/electra tests/models/encodec tests/models/encoder_decoder tests/optimization tests/peft_integration tests/quantization tests/sagemaker tests/test_backbone_common.py tests/test_cache_utils.py tests/test_configuration_common.py tests/test_configuration_utils.py tests/test_feature_extraction_common.py tests/test_feature_extraction_utils.py tests/test_image_processing_common.py tests/test_image_processing_utils.py tests/test_image_transforms.py tests/test_modeling_common.py tests/test_modeling_flax_common.py tests/test_modeling_flax_utils.py tests/test_modeling_tf_common.py tests/test_modeling_tf_utils.py tests/test_pipeline_mixin.py tests/test_sequence_feature_extraction_common.py tests/test_tokenization_common.py tests/test_tokenization_utils.py tests/tokenization tests/tools tests/trainer tests/utils tests/test_modeling_utils.py"

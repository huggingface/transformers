...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        steps = [
            ...
            {"run": {
                "name": "Run tests",
                "command": f"({timeout_cmd} python3 -m pytest {marker_cmd} -n 6 {junit_flags} {repeat_on_failure_flags} {' '.join(pytest_flags)} tests/models/xlm/test_modeling_xlm.py tests/models/bart/test_modeling_bart.py tests/models/conditional_detr/test_modeling_conditional_detr.py tests/models/mask2former/test_modeling_mask2former.py tests/models/beit/test_modeling_beit.py tests/models/rt_detr/test_modeling_rt_detr.py tests/models/swiftformer/test_modeling_swiftformer.py tests/models/rt_detr_v2/test_modeling_rt_detr_v2.py tests/models/qwen2_moe/test_modeling_qwen2_moe.py tests/models/vitmatte/test_modeling_vitmatte.py tests/models/mobilevitv2/test_modeling_mobilevitv2.py tests/models/wav2vec2_bert/test_modeling_wav2vec2_bert.py tests/models/sam_hq/test_modeling_sam_hq.py tests/models/lightglue/test_modeling_lightglue.py tests/models/clip/test_modeling_clip.py tests/models/cvt/test_modeling_cvt.py tests/models/xlstm/test_modeling_xlstm.py tests/models/mt5/test_modeling_mt5.py tests/models/lxmert/test_modeling_lxmert.py tests/models/idefics2/test_modeling_idefics2.py tests/models/granite_speech/test_modeling_granite_speech.py tests/models/blenderbot_small/test_modeling_blenderbot_small.py tests/models/informer/test_modeling_informer.py tests/models/blenderbot/test_modeling_blenderbot.py tests/models/mimi/test_modeling_mimi.py tests/models/llava_next/test_modeling_llava_next.py tests/models/ijepa/test_modeling_ijepa.py tests/models/ernie/test_modeling_ernie.py tests/models/chameleon/test_modeling_chameleon.py tests/models/univnet/test_modeling_univnet.py tests/models/qwen3_vl/test_modeling_qwen3_vl.py tests/models/umt5/test_modeling_umt5.py tests/models/qwen2_5_vl/test_modeling_qwen2_5_vl.py tests/models/qwen2_audio/test_modeling_qwen2_audio.py tests/models/ovis2/test_modeling_ovis2.py tests/models/afmoe/test_modeling_afmoe.py tests/models/yoso/test_modeling_yoso.py tests/models/zoedepth/test_modeling_zoedepth.py tests/models/ctrl/test_modeling_ctrl.py tests/models/deepseek_v3/test_modeling_deepseek_v3.py tests/models/blip/test_modeling_blip_text.py tests/models/phi4_multimodal/test_modeling_phi4_multimodal.py tests/models/pixtral/test_modeling_pixtral.py tests/models/sam3_tracker_video/test_modeling_sam3_tracker_video.py tests/models/ministral/test_modeling_ministral.py tests/models/nemotron/test_modeling_nemotron.py tests/models/flex_olmo/test_modeling_flex_olmo.py tests/models/xlm_roberta/test_modeling_xlm_roberta.py | tee tests_output.txt)"}
            },
            {"run":
                {

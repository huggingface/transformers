...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        # full
        test_command = "python -m pytest --junitxml=test-results/junit.xml -n 6 --max-worker-restart=0 --dist=loadfile --make-reports=tests_torch tests/benchmark tests/bettertransformer tests/deepspeed tests/extended tests/fixtures tests/fsdp tests/generation tests/models/mobilevitv2 tests/models/mpnet tests/models/mpt tests/models/mra tests/models/mt5 tests/models/musicgen tests/models/mvp tests/models/nat tests/models/nezha tests/models/nllb tests/models/nllb_moe tests/models/nougat tests/models/nystromformer tests/models/oneformer tests/models/openai tests/models/opt tests/models/owlv2 tests/models/owlvit tests/models/patchtsmixer tests/models/patchtst tests/models/pegasus tests/models/pegasus_x tests/models/perceiver tests/models/persimmon tests/models/phi tests/models/phobert tests/models/pix2struct tests/models/plbart tests/models/poolformer tests/models/pop2piano tests/models/prophetnet tests/models/pvt tests/models/qdqbert tests/models/rag tests/models/realm tests/models/reformer tests/models/regnet tests/models/rembert tests/models/resnet tests/models/roberta tests/models/roberta_prelayernorm tests/models/roc_bert tests/models/roformer tests/models/rwkv tests/models/sam tests/models/seamless_m4t tests/models/seamless_m4t_v2 tests/models/segformer tests/models/sew tests/models/sew_d tests/models/siglip tests/models/speecht5 tests/models/speech_encoder_decoder tests/models/speech_to_text tests/models/speech_to_text_2 tests/models/splinter tests/models/squeezebert tests/models/swiftformer tests/models/swin tests/models/swin2sr tests/models/swinv2 tests/models/switch_transformers tests/models/t5 tests/models/table_transformer tests/optimization tests/peft_integration tests/quantization tests/sagemaker tests/test_backbone_common.py tests/test_cache_utils.py tests/test_configuration_common.py tests/test_configuration_utils.py tests/test_feature_extraction_common.py tests/test_feature_extraction_utils.py tests/test_image_processing_common.py tests/test_image_processing_utils.py tests/test_image_transforms.py tests/test_modeling_common.py tests/test_modeling_flax_common.py tests/test_modeling_flax_utils.py tests/test_modeling_tf_common.py tests/test_modeling_tf_utils.py tests/test_pipeline_mixin.py tests/test_sequence_feature_extraction_common.py tests/test_tokenization_common.py tests/test_tokenization_utils.py tests/tokenization tests/tools tests/trainer tests/utils tests/test_modeling_utils.py"

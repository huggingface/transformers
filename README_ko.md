...
1. **[TransformerTransducer](https://huggingface.co/docs/transformers/model_doc/Transformer_Transducer)** (Google Inc., USA 에서) Qian Zhang, Han Lu, Hasim Sak, Anshuman Tripathi, Erik McDermott, Stephen Koo, Shankar Kumar 의 [Transformer Transducer: A Streamable Speech Recognition Model with Transformer Encoders and RNN-T Loss](https://arxiv.org/abs/2002.02562) 논문과 함께 발표했습니다.

...
1. **[EfficientFormer](https://huggingface.co/docs/transformers/model_doc/efficientformer)** (Snap Research 에서 제공)은 Yanyu Li, Geng Yuan, Yang Wen, Ju Hu, Georgios Evangelidis, Sergey Tulyakov, Yanzhi Wang, Jian Ren.의 [EfficientFormer: Vision Transformers at MobileNetSpeed](https://arxiv.org/abs/2206.01191)논문과 함께 발표했습니다.
1. **[EfficientNet](https://huggingface.co/docs/transformers/main/model_doc/efficientnet)** (Google Brain 에서 제공)은 Mingxing Tan, Quoc V. Le.의 [EfficientNet: Rethinking Model Scaling for Convolutional Neural Networks](https://arxiv.org/abs/1905.11946)논문과 함께 발표했습니다.

...
1. **[RT-DETR](https://huggingface.co/docs/transformers/main/model_doc/rt_detr)** (Baidu 에서 제공)은 Wenyu Lv, Yian Zhao, Shangliang Xu, Jinman Wei, Guanzhong Wang, Cheng Cui, Yuning Du, Qingqing Dang, Yi Liu.의 [DETRs Beat YOLOs on Real-time Object Detection](https://arxiv.org/abs/2304.08069)논문과 함께 발표했습니다.

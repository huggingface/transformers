...
1. **[SciBart](https://huggingface.co/docs/transformers/model_doc/scibart)** (UCLA NLP 에서 제공)은 Di Wu, Wasi Uddin Ahmad, Kai-Wei Chang.의 [Pre-trained Language Models for Keyphrase Generation: A Thorough Empirical Study](https://arxiv.org/abs/2212.10233)논문과 함께 발표했습니다.

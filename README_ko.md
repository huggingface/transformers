...
1. **[TrillssonEfficientNet](https://huggingface.co/docs/transformers/main/model_doc/trillsson_efficientnet)** (Google AI 에서) Joel Shor, Subhashini Venugopalan 의 [TRILLsson: Distilled Universal Paralinguistic Speech Representations](https://aps.arxiv.org/abs/2203.00236)  논문과 함께 발표했습니다.

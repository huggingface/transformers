...
1. **[CLIPViP](https://huggingface.co/docs/transformers/main/model_doc/clip_vip)** (Microsoft 에서 제공)은 Hongwei Xue, Yuchong Sun, Bei Liu, Jianlong Fu, Ruihua Song, Houqiang Li, Jiebo Luo.의 [CLIP-ViP: Adapting Pre-trained Image-Text Model to Video-Language Representation Alignment](https://arxiv.org/abs/2209.06430)논문과 함께 발표했습니다.

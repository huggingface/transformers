...
1. **[LLaMA-MoE](https://huggingface.co/docs/transformers/main/model_doc/llama_moe)** (Shanghai AI Lab, Soochow University, Shanghai Jiaotong University, and Fudan University 에서 제공)은 LLaMA-MoE Team.의 [LLaMA-MoE: Building Mixture-of-Experts from LLaMA with Continual Pre-training](https://github.com/pjlab-sys4nlp/llama-moe/blob/main/docs/LLaMA_MoE.pdf)논문과 함께 발표했습니다.

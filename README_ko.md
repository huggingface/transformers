...
1. **[LaVIN](https://huggingface.co/docs/transformers/model_doc/lavin)**(출처 중국 샤먼 대학교) [Cheap and Quick: Efficient Vision-Language Instruction Tuning for L arge Language] 논문과 함께 발표 모델](https://arxiv.org/pdf/2305.15023.pdf) Gen Luo, Yiyi Zhou, Tianhe Ren, She ngxin Chen, Xiaoshuai Sun, Rongrong J.

...
1. **[Seaformer](https://huggingface.co/docs/transformers/main/model_doc/seaformer)** (Fudan University and Tencent PCG 에서 제공)은 Qiang Wan, Zilong Huang, Jiachen Lu, Gang Yu, Li Zhang.의 [SeaFormer: Squeeze-enhanced Axial Transformer for Mobile Semantic Segmentation](https://arxiv.org/abs/2301.13156)논문과 함께 발표했습니다.

...
1. **[ALBERT](https://huggingface.co/docs/transformers/model_doc/albert)** (Google Research and the Toyota Technological Institute at Chicago 에서) Zhenzhong Lan, Mingda Chen, Sebastian Goodman, Kevin Gimpel, Piyush Sharma, Radu Soricut 의 [ALBERT: A Lite BERT for Self-supervised Learning of Language Representations](https://arxiv.org/abs/1909.11942), 논문과 함께 발표했습니다.
1. **[Audio Spectrogram Transformer](https://huggingface.co/docs/transformers/model_doc/audio-spectrogram-transformer)** (MIT 에서) Yuan Gong, Yu-An Chung, James Glass 의 [AST: Audio Spectrogram Transformer](https://arxiv.org/abs/2104.01778) 논문과 함께 발표했습니다.
1. **[BART](https://huggingface.co/docs/transformers/model_doc/bart)** (Facebook 에서) Mike Lewis, Yinhan Liu, Naman Goyal, Marjan Ghazvininejad, Abdelrahman Mohamed, Omer Levy, Ves Stoyanov and Luke Zettlemoyer 의 [BART: Denoising Sequence-to-Sequence Pre-training for Natural Language Generation, Translation, and Comprehension](https://arxiv.org/pdf/1910.13461.pdf) 논문과 함께 발표했습니다.
1. **[BARThez](https://huggingface.co/docs/transformers/model_doc/barthez)** (École polytechnique 에서) Moussa Kamal Eddine, Antoine J.-P. Tixier, Michalis Vazirgiannis 의 [BARThez: a Skilled Pretrained French Sequence-to-Sequence Model](https://arxiv.org/abs/2010.12321) 논문과 함께 발표했습니다.
1. **[BARTpho](https://huggingface.co/docs/transformers/model_doc/bartpho)** (VinAI Research 에서) Nguyen Luong Tran, Duong Minh Le and Dat Quoc Nguyen 의 [BARTpho: Pre-trained Sequence-to-Sequence Models for Vietnamese](https://arxiv.org/abs/2109.09701) 논문과 함께 발표했습니다.
1. **[BEiT](https://huggingface.co/docs/transformers/model_doc/beit)** (Microsoft 에서) Hangbo Bao, Li Dong, Furu Wei 의 [BEiT: BERT Pre-Training of Image Transformers](https://arxiv.org/abs/2106.08254) 논문과 함께 발표했습니다.
1. **[BERT](https://huggingface.co/docs/transformers/model_doc/bert)** (Google 에서) Jacob Devlin, Ming-Wei Chang, Kenton Lee and Kristina Toutanova 의 [BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding](https://arxiv.org/abs/1810.04805) 논문과 함께 발표했습니다.
1. **[BERT For Sequence Generation](https://huggingface.co/docs/transformers/model_doc/bert-generation)** (Google 에서) Sascha Rothe, Shashi Narayan, Aliaksei Severyn 의 [Leveraging Pre-trained Checkpoints for Sequence Generation Tasks](https://arxiv.org/abs/1907.12461) 논문과 함께 발표했습니다.
1. **[BERTweet](https://huggingface.co/docs/transformers/model_doc/bertweet)** (VinAI Research 에서) Dat Quoc Nguyen, Thanh Vu and Anh Tuan Nguyen 의 [BERTweet: A pre-trained language model for English Tweets](https://aclanthology.org/2020.emnlp-demos.2/) 논문과 함께 발표했습니다.
1. **[BigBird-Pegasus](https://huggingface.co/docs/transformers/model_doc/bigbird_pegasus)** (Google Research 에서) Manzil Zaheer, Guru Guruganesh, Avinava Dubey, Joshua Ainslie, Chris Alberti, Santiago Ontanon, Philip Pham, Anirudh Ravula, Qifan Wang, Li Yang, Amr Ahmed 의 [Big Bird: Transformers for Longer Sequences](https://arxiv.org/abs/2007.14062) 논문과 함께 발표했습니다.
1. **[BigBird-RoBERTa](https://huggingface.co/docs/transformers/model_doc/big_bird)** (Google Research 에서) Manzil Zaheer, Guru Guruganesh, Avinava Dubey, Joshua Ainslie, Chris Alberti, Santiago Ontanon, Philip Pham, Anirudh Ravula, Qifan Wang, Li Yang, Amr Ahmed 의 [Big Bird: Transformers for Longer Sequences](https://arxiv.org/abs/2007.14062) 논문과 함께 발표했습니다.
1. **[BioGpt](https://huggingface.co/docs/transformers/main/model_doc/biogpt)** (Microsoft Research AI4Science 에서) Renqian Luo, Liai Sun, Yingce Xia, Tao Qin, Sheng Zhang, Hoifung Poon and Tie-Yan Liu 의 [BioGPT: generative pre-trained transformer for biomedical text generation and mining](https://academic.oup.com/bib/advance-article/doi/10.1093/bib/bbac409/6713511?guestAccessKey=a66d9b5d-4f83-4017-bb52-405815c907b9) 논문과 함께 발표했습니다.
1. **[BiT](https://huggingface.co/docs/transformers/main/model_doc/bit)** (Google AI 에서) Alexander Kolesnikov, Lucas Beyer, Xiaohua Zhai, Joan Puigcerver, Jessica Yung, Sylvain Gelly, Neil Houlsby 의 [Big Transfer (BiT) 논문과 함께 발표했습니다.
1. **[Blenderbot](https://huggingface.co/docs/transformers/model_doc/blenderbot)** (Facebook 에서) Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu, Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston 의 [Recipes for building an open-domain chatbot](https://arxiv.org/abs/2004.13637) 논문과 함께 발표했습니다.
1. **[BlenderbotSmall](https://huggingface.co/docs/transformers/model_doc/blenderbot-small)** (Facebook 에서) Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu, Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston 의 [Recipes for building an open-domain chatbot](https://arxiv.org/abs/2004.13637) 논문과 함께 발표했습니다.
1. **[BLIP](https://huggingface.co/docs/transformers/main/model_doc/blip)** (Salesforce 에서) Junnan Li, Dongxu Li, Caiming Xiong, Steven Hoi 의 [BLIP: Bootstrapping Language-Image Pre-training for Unified Vision-Language Understanding and Generation](https://arxiv.org/abs/2201.12086) 논문과 함께 발표했습니다.
...
1. **[FlauBERT](https://huggingface.co/docs/transformers/model_doc/flaubert)** (CNRS 에서) Hang Le, Loïc Vial, Jibril Frej, Vincent Segonne, Maximin Coavoux, Benjamin Lecouteux, Alexandre Allauzen, Benoît Crabbé, Laurent Besacier, Didier Schwab 의 [FlauBERT: Unsupervised Language Model Pre-training for French](https://arxiv.org/abs/1912.05372) 논문과 함께 발표했습니다.
1. **[FLAVA](https://huggingface.co/docs/transformers/model_doc/flava)** (Facebook AI 에서) Amanpreet Singh, Ronghang Hu, Vedanuj Goswami, Guillaume Couairon, Wojciech Galuba, Marcus Rohrbach, and Douwe Kiela 의 [FLAVA: A Foundational Language And Vision Alignment Model](https://arxiv.org/abs/2112.04482) 논문과 함께 발표했습니다.
1. **[FNet](https://huggingface.co/docs/transformers/model_doc/fnet)** (Google Research 에서) James Lee-Thorp, Joshua Ainslie, Ilya Eckstein, Santiago Ontanon 의 [FNet: Mixing Tokens with Fourier Transforms](https://arxiv.org/abs/2105.03824) 논문과 함께 발표했습니다.
1. **[Funnel Transformer](https://huggingface.co/docs/transformers/model_doc/funnel)** (CMU/Google Brain 에서) Zihang Dai, Guokun Lai, Yiming Yang, Quoc V. Le 의 [Funnel-Transformer: Filtering out Sequential Redundancy for Efficient Language Processing](https://arxiv.org/abs/2006.03236) 논문과 함께 발표했습니다.
1. **[GLPN](https://huggingface.co/docs/transformers/model_doc/glpn)** (KAIST 에서) Doyeon Kim, Woonghyun Ga, Pyungwhan Ahn, Donggyu Joo, Sehwan Chun, Junmo Kim 의 [Global-Local Path Networks for Monocular Depth Estimation with Vertical CutDepth](https://arxiv.org/abs/2201.07436) 논문과 함께 발표했습니다.
1. **[GPT](https://huggingface.co/docs/transformers/model_doc/openai-gpt)** (OpenAI 에서) Alec Radford, Karthik Narasimhan, Tim Salimans and Ilya Sutskever 의 [Improving Language Understanding by Generative Pre-Training](https://blog.openai.com/language-unsupervised/) 논문과 함께 발표했습니다.

...
1. **[PerSAM](https://huggingface.co/docs/transformers/main/model_doc/persam)** (Shanghai Artificial Intelligence Laboratory 에서 제공)은 Renrui Zhang, Zhengkai Jiang, Ziyu Guo, Shilin Yan, Junting Pan, Hao Dong, Peng Gao, Hongsheng Li.의 [Personalize Segment Anything Model with One Shot](https://arxiv.org/abs/2305.03048)논문과 함께 발표했습니다.

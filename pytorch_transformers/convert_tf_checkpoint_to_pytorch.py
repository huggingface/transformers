...
from pytorch_transformers.modeling_bert import TFCheckpointConverter, BertConfig, BertForPreTraining, load_tf_weights_in_bert
...
def convert_tf_checkpoint_to_pytorch(tf_checkpoint_path, converter_config_file, pytorch_dump_path):
    ...
    load_tf_weights_in_bert(model, config, tf_checkpoint_path, checkpoint_conv.tf_torch_mappings)

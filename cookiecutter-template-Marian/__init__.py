...
_import_structure = {
    ...
    "tokenization_marian": ["MarianTokenizer"],
}

if is_tokenizers_available():
    _import_structure["tokenization_marian_fast"] = ["MarianTokenizerFast"]
...
if TYPE_CHECKING:
    ...
    if is_tokenizers_available():
        from .tokenization_marian_fast import MarianTokenizerFast
